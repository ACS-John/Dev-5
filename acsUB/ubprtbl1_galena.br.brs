...
10580   fncombof("ubm-act-nam",8,pf,40,env$('Q')&"\UBmstr\Customer.h"&str$(cno),1741,9,41,30,env$('Q')&"\UBmstr\ubindx5.h"&str$(cno),2)
...
11660   let resp$(1)=a$
11670   fncmdset(11): let fnacs(sn$,0,mat resp$,ck)
