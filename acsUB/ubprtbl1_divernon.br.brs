...
00410   kp=1741: kl=9 : dp=41 : dl=30 !:
        fncombof("ubm-act-nam",8,pf,40,env$('Q')&"\UBmstr\Customer.h"&env$('cno'),kp,kl,dp,dl,env$('Q')&"\UBmstr\ubindx5.h"&env$('cno'),2) !:
        resp$(respc+=1)="[All]"
...
00570   open #3: "Name="&env$('Q')&"\UBmstr\UBAdrBil.h"&env$('cno')&",KFName="&env$('Q')&"\UBmstr\adrIndex.h"&env$('cno')&",Shr",internal,input,keyed 
00580   fnopenprn
