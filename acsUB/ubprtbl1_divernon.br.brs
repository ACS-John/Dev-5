...
00150 ! 
00160   open #21: "Name=[Q]\UBmstr\Company.h[cno],Shr",internal,input  !:
...
00410   kp=1741: kl=9 : dp=41 : dl=30 !:
        fncombof("ubm-act-nam",8,pf,40,"[Q]\UBmstr\Customer.h[cno]",kp,kl,dp,dl,"[Q]\UBmstr\ubindx5.h[cno]",2) !:
        resp$(respc+=1)="[All]"
...
00570   open #3: "Name=[Q]\UBmstr\UBAdrBil.h[cno],KFName=[Q]\UBmstr\adrIndex.h[cno],Shr",internal,input,keyed 
00580   fnopenprn
