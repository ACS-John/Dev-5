...
10020   fncno(cno)
10030   open #(h_mstr:=1): "Name=[Q]\UBmstr\customer.h[cno],KFName=[Q]\UBmstr\ubindex.h[cno],SHR",internal,outIn,keyed 
10040   open #(h_trans:=11): "Name=[Q]\UBmstr\ubtransvb.h[cno],KFName=[Q]\UBmstr\ubtrindx.h[cno],SHR",internal,outIn,keyed 
