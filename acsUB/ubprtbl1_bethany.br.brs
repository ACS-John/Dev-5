...
01960   let fnpa_txt(at$(1),xmargin+8,lyne*1-1+ymargin) ! pr #20: 'Call Print.AddText("'&at$(1)&'",'&str$(xmargin+8)&','&str$(lyne*1-1+ymargin)&')'
01970   pr #20: 'Call Print.MyFont("Lucida Console")'
01980   pr #20: 'Call Print.MyFontSize(10)'
01990   pr #20: 'Call Print.MyFontBold(False)'
02000   let fnpa_txt(at$(2),xmargin+6,lyne*2+1+ymargin-.2) ! pr #20: 'Call Print.AddText("'&at$(2)&'",'&str$(xmargin+6)&','&str$(lyne*2+1+ymargin-.2)&')'
02010   let fnpa_txt(at$(3),xmargin+6,lyne*3+1+ymargin) ! pr #20: 'Call Print.AddText("'&at$(3)&'",'&str$(xmargin+6)&','&str$(lyne*3+1+ymargin)&')'
02020   pr #20: 'Call Print.AddText("#'&trim$(z$)&'  '&bulk$&'",'&str$(xmargin+4)&','&str$(lyne*5+ymargin)&')'
02030   let fnpa_txt(e$(1),xmargin+4,lyne*6+ymargin) ! pr #20: 'Call Print.AddText("'&e$(1)&'",'&str$(xmargin+4)&','&str$(lyne*6+ymargin)&')'
