...
02090   if g(7)=0 then goto L2100 else !:
          print #20: 'Call Print.AddText("TRASH   ",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')' !:
...
02230   print #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*26+1+ymargin)&',63,0)'
02240   print #20: 'Call Print.AddText("Phone: 217-643-2675",'&str$(xmargin+1)&','&str$(lyne*27+ymargin)&')'
02250 ! ______________________________________________________________________
02260   let special=28
02270 ! ______________________________________________________________________
02280   print #20: 'Call Print.MyFontSize(7)'
02290   print #20: 'Call Print.AddLine('&str$(xmargin+97)&','&str$(ymargin+0)&',29,'&str$(lyne*5+2)&',TRUE)'
02300   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+0)&',7,0)'
02310   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+2.8)&',7,0)'
02320   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+5.6)&',7,0)'
02330   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+8.4)&',7,0)'
02340   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+11.2)&',7,0)'
02350   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+14)&',7,0)'
02360   print #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+17)&',7,0)'
02370   print #20: 'Call Print.AddText("   Pre-Sorted",'&str$(xmargin+100)&','&str$(lyne*1-1+ymargin)&')'
02380   print #20: 'Call Print.AddText("First Class Mail",'&str$(xmargin+100)&','&str$(lyne*2-1+ymargin)&')'
02390   print #20: 'Call Print.AddText("  U.S. Postage  ",'&str$(xmargin+100)&','&str$(lyne*3-1+ymargin)&')'
02400   print #20: 'Call Print.AddText("      Paid",'&str$(xmargin+100)&','&str$(lyne*4-1+ymargin)&')'
02410   print #20: 'Call Print.AddText("  Permit No 1",'&str$(xmargin+100)&','&str$(lyne*5-1+ymargin)&')'
...
02440   print #20: 'Call Print.AddText("Please return this",'&str$(xmargin+68)&','&str$(lyne*7+ymargin)&')'
02450   print #20: 'Call Print.AddText("side with payment to:",'&str$(xmargin+68)&','&str$(lyne*8+ymargin)&')'
02460   print #20: 'Call Print.AddText("'&cnam$&'",'&str$(xmargin+68)&','&str$(lyne*9+ymargin)&')'
02470   print #20: 'Call Print.MyFontSize(10)'
02480   print #20: 'Call Print.AddText("Pay By '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68)&','&str$(lyne*11+ymargin)&')'
02490   print #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+106)&','&str$(lyne*11+ymargin)&')'
02500   print #20: 'Call Print.AddText("After '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68)&','&str$(lyne*12+ymargin)&')'
02510   fnpa_txt(fnformnumb$(bal+round((bal-g(7))*.10,2),2,9),xmargin+106,lyne*12+ymargin)
02520   print #20: 'Call Print.MyFontSize(9)'
02530   let addy=14
02540   print #20: 'Call Print.AddText("'&mg$(1)&'",'&str$(xmargin+68)&','&str$((addy+=1)*lyne+ymargin)&')'
02550   print #20: 'Call Print.AddText("'&mg$(2)&'",'&str$(xmargin+68)&','&str$((addy+=1)*lyne+ymargin)&')'
02560   print #20: 'Call Print.AddText("'&mg$(3)&'",'&str$(xmargin+68)&','&str$((addy+=1)*lyne+ymargin)&')'
02570   let addy+=1
02580   print #20: 'Call Print.MyFontSize(10)'
02600   if c4>0 then !:
          print #20: 'Call Print.AddText("Final Bill",'&str$(xmargin+1)&','&str$(lyne*(addy+=1)+ymargin)
02610   print #20: 'Call Print.AddText("#'&trim$(z$)&' '&bulk$&'",'&str$(xmargin+68)&','&str$(lyne*(addy+=1)+ymargin)&')'
02620   if pe$(1)<>"" then !:
...
02635   if uprc$(df$)='Y' then !:
          print #20: 'Call Print.AddText("Direct Debit",'&str$(xmargin+36)&','&str$(lyne*(addy)+ymargin)&')'
02640   if pe$(3)<>"" then !:
...
02660   if checkcounter=1 then let checkx=1.375 : let checky=3.6875
02670   if checkcounter=2 then let checkx=6.75 : let checky=3.6875
02680   if checkcounter=3 then let checkx=1.375 : let checky=7.9375
02690   if checkcounter=0 then let checkx=6.75 : let checky=7.9375
02700   let bc$=""
02710   if trim$(bc$)<>"" then print #20: 'Call Print.DisplayBarCode('&str$(checkx)&','&str$(checky)&',"'&bc$&'")'
