...
00810   if resp$(4)="True" then gli=1 else gli=0
...
01290     gln$(j,1)=gl$(1): gln$(j,2)=gl$(2): gln$(j,3)=gl$(3) ! substitute individual breakdown based on water codes, etc into 30 item array used in entry generation
01300 L1300: next j
01310   x=0
01320   for j=1 to 10
01330 L1330: x+=1 : if x=4 then x=0 : goto L1370
...
01400   for j=1 to 10
01410 L1410: x+=1: if x>3 then x=0 : goto L1460
...
02290 gl$(1)=fnagl$(resp$(3))
02300 gl$(2)=fnagl$(resp$(4))
02310 gl$(3)=fnagl$(resp$(5))
