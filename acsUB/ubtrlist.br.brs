...
42160 ! L1230: !
42180 let q5=0
42200 if tcode=1 then code$=" CHG": let pos2=69 : let r2=r2+tamount ! COLUMN 2
42220 if tcode=2 then code$=" PN" : let pos2=69 : let r2=r2+tamount !  COLUMN 2
42240 if tcode=3 then code$=" COL": let pos2=84 : let r3=r3+tamount ! COLUMN 3
42260 if tcode=4 then code$=" CM" : let pos2=84 : let r3=r3+tamount ! COLUMN 3
42280 if tcode=5 then code$=" DM" : let pos2=69 : let r2=r2+tamount ! COLUMN 2
...
44340 !      begbal=bal+tamount : let r1+=begbal
44360 !    end if
44380 !    return  ! /r
46000 PGOF: ! r:
