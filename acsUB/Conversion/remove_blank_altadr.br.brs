...
00110   open #3: "Name="&env$('Q')&"\UBmstr\UBAdrBil.h"&str$(cno)&",KFName="&env$('Q')&"\UBmstr\adrIndex.h"&str$(cno)&",Shr",internal,outin,keyed 
...
00280   execute "list -"&str$(line) !:
        pause  !:
        goto L300
00290   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause 
