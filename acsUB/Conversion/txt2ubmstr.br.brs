...
00610   if rate$(1:3)="SCH" then let a(2)=19: let g(2)=val(line$(227:234)) !:
          let gb(2)=val(line$(219:226))+g(2): goto L920 ! handle school sewer seperately
00620   if rate$(1:3)="HS1" then let a(5)=0: let g(5)=val(line$(227:234)) !:
          let gb(5)=val(line$(219:226))+g(5): let b(5)=val(line$(227:234)): goto L920 ! handle school trash
00630   if rate$(1:3)="MES" then let a(5)=0: let g(5)=val(line$(227:234)) !:
          let gb(5)=val(line$(219:226))+g(5): let b(5)=val(line$(227:234)): goto L920 ! MIDDLE SCHOOL TRASH
00640   if rate$(1:3)="NES" then let a(5)=0: let g(5)=val(line$(227:234)) !:
          let gb(5)=val(line$(219:226))+g(5): let b(5)=val(line$(227:234)): goto L920 ! NORTH ELEMENTRY TRASH
00650   if rate$(1:3)="CME" then let a(4)=2: let a(6)=9: goto L920 ! handle exempt commercial sewer seperately as tax exempt commercial
00660   if rate$(1:3)="MHT" then let a(5)=4: let extra(12)=1: goto L920 ! handle mobile home trash seperately as taxable
...
00690   if rate$(1:3)="WR1" then let a(1)=1 ! residential in
00700   if rate$(1:3)="WR2" then let a(1)=2 ! residential out
00710   if rate$(1:3)="WR3" then let a(1)=2 ! not sure about this - both seem to be residential outside of city
00720   if rate$(1:3)="WR5" then let a(1)=5 ! senior citizens
00730   if rate$(1:3)="WC1" then let a(1)=3 ! commercial in
00740   if rate$(1:3)="WC2" then let a(1)=4 ! commercial out
00750   if rate$(1:3)="WR4" then let a(1)=6 ! two house
00760   if rate$(1:2)="MR" then let a(4)=1 ! residential
00770   if rate$(1:2)="MC" then let a(4)=2 ! commercial
00780   if rate$(1:2)="SR" then let a(2)=1 ! sewer residential
00790   if rate$(1:3)="MHS" then let a(2)=3 ! mobil home sewer
00800   if rate$(1:2)="SC" then let a(2)=2 ! commercial sewer
00810   if rate$(1:2)="TR" then let a(5)=1: let extra(12)=1 ! assume taxable on trash unless changed to not taxable - residential trash
00820   if rate$(1:2)="TC" then let a(5)=2: let extra(12)=1 ! assume taxable on trash unless changed to not taxable - commercial trash
00830   if rate$(1:3)="TCE" or rate$(1:3)="CNE" then let a(5)=2: let extra(12)=9: let g(2)=val(line$(227:234)) !:
...
01260 DONE: ! 
01270   print newpage
01280   print fields "12,20,Cc 40,N": "Please wait: reIndexing Customer file..."
...
01400   print newpage
01410   print fields "11,20,Cc 40,N": "Completed Sucessfully."
01420   print fields "12,20,Cc 40,B,X0D": "Press any key to continue..."
01430   goto XIT
...
01560   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
...
01671   if rate$(1:3)="MHS" then let g(2)=val(line$(227:234)): let gb(2)=val(line$(219:227))+g(2): let b(2)=val(line$(227:234)) ! previous balance of sewer plus current charge  AND STANDARD CHARGE ON MOBILE HOMES
01680   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 11.25 then let a(2)=2 ! residentisl 5 fixtures
01690   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 11.85 then let a(2)=3 ! residentisl 6 fixtures
01700   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 12.37 then let a(2)=4 ! residentisl 7 fixtures
01710   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 17.55 then let a(2)=10 ! small business
01720   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 35.10 then let a(2)=11 ! large business
01730   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 26.33 then let a(2)=12 ! restaurants
01740   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 26.33 then let a(2)=13 ! garages   (can't tell difference in restaurants
01750   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 52.50 then let a(2)=14 ! courthouse
01760   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 17.55 then let a(2)=15 ! churches   (cant tell difference in small business
01770   if (rate$(1:3)="HOS" or rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 192.98 then let a(2)=16 !:
          let g(2)=val(line$(227:234)) !:
          let gb(2)=val(line$(219:226))+g(2) ! dcm hospital
01771   if trim$(z$)="0121046800" and val(line$(227:234))= 348.30 then let a(2)=19 !:
          let g(2)=val(line$(227:234)) !:
          let gb(2)=val(line$(219:226))+g(2): let b(2)=val(line$(227:234)) ! HIGFHSCHOOL SEWER
01780   if rate$(1:3)="HSA" and val(line$(227:234))>0 then let a(5)=0 !:
          let g(5)=val(line$(227:234)) !:
          let gb(5)=val(line$(219:226))+g(5): let b(5)=val(line$(227:234)) ! 
01790   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 224.70 then let a(2)=17 ! nursing home
01800   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 87.75 then let a(2)=18 ! junior high
01810   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 131.63 then let a(2)=19 ! senior high high
01820   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 12.30 then let a(2)=20 ! mobile home
01830   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 14.03 then let a(2)=40 ! motel
01840   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 239.03 then let a(2)=80: let b(2)=val(line$(227:234)) ! housing aut
01850   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 189.53 then let a(2)=80: let b(2)=val(line$(227:234)) ! housing aut
01860   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 18.53 then let a(2)=41: let b(2)=val(line$(227:234)) ! motels
01870   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 23.03 then let a(2)=41: let b(2)=val(line$(227:234)) ! motels
01880   if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 27.53 then let a(2)=41: let b(2)=val(line$(227:234)) ! motels
01890   for j=1 to 60
01900     if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 27.53+(4.50*j) then let a(2)=41: let b(2)=27.53+(4.50*j) ! motels
01910   next j
01920   for j=1 to 60
01930     if (rate$(1:2)="SR" or rate$(1:2)="SC") and val(line$(227:234))= 14.03+(j*4.50) then let a(2)=41: let b(2)=14.03+(j*4.50) ! motels
01940   next j
01950   if rate$(1:2)="SC" and a(2)=1 and val(line$(227:234))<>10.50 and val(line$(227:234))>0 then let a(2)=5: let b(2)=val(line$(227:234)) ! if sewer code 1 and not a normal charge the use as a standard chargerge
01960   if (rate$(1:3)="BPS" or rate$(1:3)="APT") and val(line$(227:234))<>10.50 and val(line$(227:234))>0 then let a(2)=0: let b(2)=val(line$(227:234)) !:
          let g(2)=val(line$(227:234)) !:
...
01980   if rate$(1:2)="SR" and a(2)=2 and val(line$(227:234))<>17.55 and val(line$(227:234))>0 then let a(2)=5: let b(2)=val(line$(227:234)) ! if sewer code 2 and not a normal charge the use as a standard charge
01990   if rate$(1:2)="MT" and val(line$(227:234))>0 then let a(2)=41: let b(2)=val(line$(227:234)) !:
          let g(2)=val(line$(227:234)) !:
...
02010   if rate$(1:3)="MHT" then let g(5)=val(line$(227:234)): let gb(5)=val(line$(219:227))+g(5): let b(5)=val(line$(227:234)) ! previous balance of trash plus  current charge
02020   if rate$(1:3)="MHT" or rate$(1:2)="TR" or rate$(1:2)="TC" and g(5)>0 then let extra(12)=1 ! trash taxable
02030   if rate$(1:2)="CN" then let g(3)=val(line$(227:234)): let gb(3)=val(line$(219:227))+g(3): let extra(12)=1: let a(3)=int(g(3)/15) ! previous balance of cannister plus current charge--set tax code to 1
...
02080   if rate$(1:2)="MR" then let g(9)=g(9)+val(line2$(1:9)): let a(6)=1 : let gb(9)+=val(line2$(1:9)) ! residential tax on gas
02090   if rate$(1:2)="MC" then let g(9)=g(9)+val(line2$(1:9)): let a(6)=2 : let gb(9)+=val(line2$(1:9)) ! commercial tax on gas
