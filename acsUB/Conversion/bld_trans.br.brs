...
def library fnub_cnv_build_transactions
		library 'S:\Core\Library': fnerror,fnTop,fnTos,fnAcs,fnCmdSet,fnLbl,fndate_mmddyy_to_ccyymmdd,fnChk,fnXit,fnpause,fngethandle,fnub_index_customer,fnStatus,fnindex_it
		delubtransvb$="True"
! removebaddates$="True" ! Gosub MENU1
...
def fn_ub_build_transactions
		...
		fnub_index_customer
		open #master=3: "Name=[Q]\UBmstr\Customer.h[cno],KFName=[Q]\UBmstr\ubIndex.h[cno],Shr",internal,input,keyed
...
! r: convert transactions from ubTrans
		...
		open #h_ubtrans=fngethandle: "Name=[Q]\UBmstr\ubTrans.h[cno]",internal,input
