...
00120 ! 
00130     if ~exists("[Q]\UBmstr\UBAdrBil.h[cno]") then ! move old files to "env$('temp')&"\temp."&session$&"orary file before creating new file with same name
00132       fnCopy("[Q]\UBmstr\UBAdrBil.h[cno]",env$('temp')&"\temp."&session$)
00134     end if 
00140     if exists("[Q]\UBmstr\UBAdrBil.h[cno]")=0 then goto BUILD_FILES
00142     open #3: "Name=[Q]\UBmstr\ubMaster.h[cno],KFName=[Q]\UBmstr\ubIndex.h[cno],Shr",internal,outIn,keyed ioerr OPN_CUST
00144     goto L160
00150 OPN_CUST: ! 
00152     open #3: "Name=[Q]\UBmstr\Customer.h[cno],KFName=[Q]\UBmstr\ubIndex.h[cno],Shr",internal,outIn,keyed 
00160 L160: ! 
...
00310     if ~fnindex_it("[Q]\UBmstr\UBAdrBil.h[cno]","[Q]\UBmstr\adrIndex.h[cno]","1 10") then goto XIT ! ,Replace,DupKeys -n" ioerr XIT
00320     execute "Free "&env$('temp')&"\temp."&session$
00325     close #3: ioerr ignore
00330     execute "Free [Q]\UBmstr\ubMaster.h[cno]" ioerr ignore
00340     goto XIT
00350 BUILD_FILES: ! build files if don't exist
00360     open #2: "Name=[Q]\UBmstr\UBAdrBil.h[cno],RecL=130,Replace",internal,outIn,relative 
00370     close #2: 
00380     fnindex_it("[Q]\UBmstr\UBAdrBil.h[cno]","[Q]\UBmstr\adrIndex.h[cno]","1 10") ! execute "Index [Q]\UBmstr\UBAdrBil.h[cno]"&' '&"[Q]\UBmstr\adrIndex.h[cno] 1,10,Replace,DupKeys -n"
00390     return 
00410 XIT: fnend 
