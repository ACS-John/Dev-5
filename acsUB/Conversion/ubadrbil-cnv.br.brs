...
! fnTop("S:\acsUB\conversion\ubadrbil-cnv",cap$="adrbil-cnv")
		fncno(cno)
! note!!!!   may have to change a$(3) to a$(4), etc and form on line 220
...
L210: !
		...
		goto L240
L230: read #1,using 'Form POS 11,4*C 30',rec=bra: mat a$ noRec L180
L240: if trim$(a$(1))="" and trim$(a$(2))="" and trim$(a$(3))="" and trim$(a$(4))="" then goto L180
...
END1: close #1:
		...
		if ~fnindex_it("[Q]\UBmstr\UBAdrBil.h[cno]","[Q]\UBmstr\adrIndex.h[cno]","1 10") then goto Xit ! ,Replace,DupKeys -n" ioerr Xit
...
BUILD_FILES: ! build files if don't exist
		...
		close #2:
		fnindex_it("[Q]\UBmstr\UBAdrBil.h[cno]","[Q]\UBmstr\adrIndex.h[cno]","1 10") ! execute "Index [Q]\UBmstr\UBAdrBil.h[cno]"&' '&"[Q]\UBmstr\adrIndex.h[cno] 1,10,Replace,DupKeys -n"
return
Xit: fnend
IGNORE: continue
