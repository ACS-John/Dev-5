...
00020 ! pr bills for Village of Divernon  (new 4 per page 10/24/06)
...
02090   if g(10)=0 then goto L2100 else !:
          pr #20: 'Call Print.AddText("IEPA",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')' !:
...
02160 L2160: pr #20: 'Call Print.MyFontSize(10)'
02170 ! ______________________________________________________________________
02180   if estimatedate=d1 then pr #20: 'Call Print.AddText("Bill estimated!",'&str$(xmargin+1)&','&str$(lyne*29+ymargin)&')'
02190   pr #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*25+1+ymargin)&',63,0)'
02200   pr #20: 'Call Print.AddText("   Pay By  '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+1)&','&str$(lyne*26+ymargin)&')'
02210   pr #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+42)&','&str$(lyne*26+ymargin)&')'
02220   pr #20: 'Call Print.AddText("Pay After  '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+1)&','&str$(lyne*27+ymargin)&')'
02230   if bal>0 then pr #20: 'Call Print.AddText("'&fnformnumb$(bal+10,2,9)&'",'&str$(xmargin+42)&','&str$(lyne*27+ymargin)&')' else pr #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+42)&','&str$(lyne*27+ymargin)&')'
02240   pr #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*28+1+ymargin)&',63,0)'
02250   pr #20: 'Call Print.AddText("  Office 217-628-3416",'&str$(xmargin+1)&','&str$(lyne*28.5+ymargin)&')'
02252   pr #20: 'Call Print.AddText("Address Correction Requested",'&str$(xmargin+1)&','&str$(lyne*29.9+ymargin)&')'
...
02290   pr #20: 'Call Print.MyFontSize(7)'
02300   pr #20: 'Call Print.AddLine('&str$(xmargin+97)&','&str$(ymargin+0)&',29,'&str$(lyne*5+2)&',TRUE)'
02310   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+0)&',7,0)'
02320   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+2.8)&',7,0)'
02330   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+5.6)&',7,0)'
02340   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+8.4)&',7,0)'
02350   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+11.2)&',7,0)'
02360   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+14)&',7,0)'
02370   pr #20: 'Call Print.AddLine('&str$(xmargin+90)&','&str$(ymargin+17)&',7,0)'
02380   pr #20: 'Call Print.AddText("   Pre-Sorted",'&str$(xmargin+100)&','&str$(lyne*1-1+ymargin)&')'
02390   pr #20: 'Call Print.AddText("First Class Mail",'&str$(xmargin+100)&','&str$(lyne*2-1+ymargin)&')'
02400   pr #20: 'Call Print.AddText("  U.S. Postage  ",'&str$(xmargin+100)&','&str$(lyne*3-1+ymargin)&')'
02410   pr #20: 'Call Print.AddText("      Paid",'&str$(xmargin+100)&','&str$(lyne*4-1+ymargin)&')'
02420   pr #20: 'Call Print.AddText("  Permit No 1",'&str$(xmargin+100)&','&str$(lyne*5-1+ymargin)&')'
02430   pr #20: 'Call Print.MyFontSize(9)'
02440 ! pr #20: 'Call Print.AddText("Address Service Requested",'&STR$(XMARGIN+68)&','&STR$(LYNE*7+YMARGIN-6)&')'
02450   pr #20: 'Call Print.AddText("Please return this",'&str$(xmargin+68)&','&str$(lyne*7+ymargin)&')'
02460   pr #20: 'Call Print.AddText("side with payment to:",'&str$(xmargin+68)&','&str$(lyne*8+ymargin)&')'
02470   pr #20: 'Call Print.AddText("'&env$('cnam')&'",'&str$(xmargin+68)&','&str$(lyne*9+ymargin)&')'
02480   pr #20: 'Call Print.MyFontSize(10)'
02490   pr #20: 'Call Print.AddText("Pay By '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68)&','&str$(lyne*11+ymargin)&')'
02500   pr #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+106)&','&str$(lyne*11+ymargin)&')'
02510   pr #20: 'Call Print.AddText("After  '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68)&','&str$(lyne*12+ymargin)&')'
02520   if bal>0 then pr #20: 'Call Print.AddText("'&fnformnumb$(bal+10,2,9)&'",'&str$(xmargin+106)&','&str$(lyne*12+ymargin)&')' else pr #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+106)&','&str$(lyne*12+ymargin)&')'
02530   pr #20: 'Call Print.MyFontSize(9)'
02540   addy=14
02550   pr #20: 'Call Print.AddText("'&mg$(1)&'",'&str$(xmargin+68)&','&str$((addy+=1)*lyne+ymargin)&')'
02560   pr #20: 'Call Print.AddText("'&mg$(2)&'",'&str$(xmargin+68)&','&str$((addy+=1)*lyne+ymargin)&')'
02570   pr #20: 'Call Print.AddText("'&mg$(3)&'",'&str$(xmargin+68)&','&str$((addy+=1)*lyne+ymargin)&')'
02580   addy+=1
02590   pr #20: 'Call Print.MyFontSize(10)'
02600   if df$="Y" then !:
...
02620   pr #20: 'Call Print.AddText("#'&trim$(z$)&' '&bulk$&'",'&str$(xmargin+68)&','&str$(lyne*(addy+=1)+ymargin)&')'
02630   if pe$(1)<>"" then !:
