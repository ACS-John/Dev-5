...
23800   fnopenprn
24000   open #1: "Name=[Q]\UBmstr\Customer.h[cno],Shr",internal,input,relative 
24200   open #2: "Name=[Q]\UBmstr\Customer.h[cno],KFName=[Q]\UBmstr\ubIndex.h[cno],Shr",internal,input,keyed 
24400   fn_header
24600   do 
