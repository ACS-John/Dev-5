00020 ! -- Calculate Bills    *** DO NOT FORGET TO PARALLEL CHANGES IN S:\acsUB\UBRECALK
...
00660 TOP: ! r:
00670   if r3=>lrec(h_work) then goto FINIS
...
00821     print_count_skip+=1
00822     fn_cuu_report_usage
00824     goto TOP
00826   else if f=d1 then ! else recalculation reduce balances
00830     for j=1 to 10
