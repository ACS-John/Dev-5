...
22060   dim z$*10,e$(4)*30,dat$*20,idx$(5)*40,resp$(10)*80
...
24040   fndat(dat$,1)
24060 ! 
24080   idx$(1)="[Q]\UBmstr\ubIndex.h[cno]"
24100   idx$(2)="[Q]\UBmstr\ubIndx2.h[cno]"
24120   idx$(3)="[Q]\UBmstr\ubIndx3.h[cno]"
24140   idx$(4)="[Q]\UBmstr\ubIndex.h[cno]"
24160   idx$(5)="[Q]\UBmstr\ubIndx5.h[cno]"
24180 ! 
...
24450 ! 
24460   open #3: "Name=[Q]\UBmstr\ubAdrBil.h[cno],KFName=[Q]\UBmstr\AdrIndex.h[cno],Shr",internal,outIn,keyed 
24480 ! /r
34000 ! MENU1: ! r:
...
42100     open #1: "Name=[Q]\UBmstr\Customer.h[cno],KFName="&idx$(1)&",Shr",internal,input,keyed 
42120   else 
42140     open #1: "Name=[Q]\UBmstr\Customer.h[cno],KFName="&idx$(q0)&",Shr",internal,input,keyed 
...
60020   open #1: "Name=[Q]\UBmstr\Customer.h[cno],KFName="&idx$(q0)&",Shr",internal,input,keyed 
