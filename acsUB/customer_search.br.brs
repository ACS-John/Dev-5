...
20240     let ch$(1)="Account"
20260     let ch$(2)="Status"
20280     let ch$(3)="Name"
20300     let ch$(4)="Address"
20320     let ch$(5)="Address"
20340     let ch$(6)="City, ST Zip"
20360     let ch$(7)="Meter Address"
20380     let ch$(8)="Route"
20400     let ch$(9)="Sequence"
20420     let ch$(10)="Phone"
20440     let ch$(11)="Meter"
20460     let ch$(12)="Alpha"
20480     mat cm$=("80") : let cm$(2)="61" : let cm$(8)="61": let cm$(9)="61"
...
20660 ! Print 'Record locked during Customer_Search flexgrid creation - skipped'
...
20960     print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
