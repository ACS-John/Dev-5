...
00020 ! print bills for Village of Grandview
00030 ! ______________________________________________________________________
00040   library 'S:\Core\Library': fnacs,fnlbl,fntxt,fnwait,fncmbrt2,fncombof,fnchk,fnerror,fnopt,fntos,fncmbact,fncno,fnd1,fnxit,fncmdset,fntop,fnformnumb$,fnpause,fnpa_finis,fnpa_txt,fnpa_newpage,fnpa_open
...
00170   let fntop("S:\acsUB\ubprtbl1",cap$="Bills-Laser (4 per page)")
...
01760   if checkcounter=2 then let xmargin=145 : let ymargin=0 ! xmargin=140
01770   if checkcounter=3 then let xmargin=0 : let ymargin=113 ! ymargin=108
01780   if checkcounter=4 then let xmargin=145 : let ymargin=113 ! xmargin=140 : ymargin=108
01782   if checkcounter=4 then let checkcounter=0
01790 ! ______________________________________________________________________
01800   print #20: 'Call Print.AddLine('&str$(xmargin+5)&','&str$(ymargin+2)&',55,'&str$(lyne*3+3)&',True)'
...
01840   let fnpa_txt(at$(1),xmargin+8,lyne*1-1+ymargin)
...
01880   let fnpa_txt(at$(2),xmargin+6,lyne*2+1+ymargin-.2)
01890   let fnpa_txt(at$(3),xmargin+6,lyne*3+1+ymargin)
01900   print #20: 'Call Print.AddText("#'&trim$(z$)&'  '&bulk$&'",'&str$(xmargin+4)&','&str$(lyne*5+ymargin)&')'
01910   let fnpa_txt(e$(1),xmargin+4,lyne*6+ymargin)
01920   print #20: 'Call Print.AddText("From: '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d2)&'  To: '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d3)&'",'&str$(xmargin)&','&str$(lyne*7+ymargin)&')'
...
01980   print #20: 'Call Print.AddText("Charge",'&str$(xmargin+48)&','&str$(lyne*13+ymargin)&')'
...
02030 L2030: if g(3)=0 then goto L2040 else !:
          print #20: 'Call Print.AddText("EL",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')' !:
          print #20: 'Call Print.AddText("'&fnformnumb$(d(5),0,9)&'",'&str$(xmargin+6)&','&str$(lyne*meter+ymargin)&')' !:
          print #20: 'Call Print.AddText("'&fnformnumb$(d(7),0,9)&'",'&str$(xmargin+23)&','&str$(lyne*meter+ymargin)&')' !:
          print #20: 'Call Print.AddText("'&fnformnumb$(g(3),2,9)&'",'&str$(xmargin+45)&','&str$(lyne*meter+ymargin)&')'
02040 L2040: if a4=1 then let gcode$="RSGS" else !:
...
02050   if g(4)=0 then goto L2060 else !:
          ...
          print #20: 'Call Print.AddText("'&fnformnumb$(d(11),0,9)&'",'&str$(xmargin+23)&','&str$(lyne*meter+ymargin)&')' !:
...
02060 L2060: if g(5)=0 then goto L2070 else !:
          print #20: 'Call Print.AddText("MET",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')' !:
...
02070 L2070: if g(6)=0 then goto L2080 else !:
          print #20: 'Call Print.AddText("SUR",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')' !:
...
02120 L2120: print #20: 'Call Print.MyFontSize(10)'
02130 ! ______________________________________________________________________
02140   print #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*23+1+ymargin)&',63,0)'
02150   print #20: 'Call Print.AddText("Pay By '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+1)&','&str$(lyne*24+ymargin)&')'
02160   print #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+40)&','&str$(lyne*24+ymargin)&')'
02170   print #20: 'Call Print.AddText("Pay After '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+1)&','&str$(lyne*25+ymargin)&')'
02180   print #20: 'Call Print.AddText("'&fnformnumb$(bal+g(10),2,9)&'",'&str$(xmargin+40)&','&str$(lyne*25+ymargin)&')'
02190   print #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*26+1+ymargin)&',63,0)'
02200   print #20: 'Call Print.AddText("Phone: 217-528-7624",'&str$(xmargin+1)&','&str$(lyne*27+ymargin)&')'
...
02240   print #20: 'Call Print.MyFontSize(7)'
02250   print #20: 'Call Print.AddCircle('&str$(xmargin+78+xmod_for_right)&','&str$(lyne*2+3+ymargin)&','&"9,0"&')'
02260   print #20: 'Call Print.AddText("Springfield",'&str$(xmargin+70+xmod_for_right)&','&str$(lyne*2-1+ymargin)&')'
02270   print #20: 'Call Print.AddText("     IL    ",'&str$(xmargin+70+xmod_for_right)&','&str$(lyne*3-1+ymargin)&')'
02280   print #20: 'Call Print.AddText("   62702   ",'&str$(xmargin+70+xmod_for_right)&','&str$(lyne*4-1+ymargin)&')'
02290   print #20: 'Call Print.AddLine('&str$(xmargin+97+xmod_for_right)&','&str$(ymargin+0)&',29,'&str$(lyne*5+2)&',TRUE)'
02300   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+0)&',7,0)'
02310   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+2.8)&',7,0)'
02320   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+5.6)&',7,0)'
02330   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+8.4)&',7,0)'
02340   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+11.2)&',7,0)'
02350   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+14)&',7,0)'
02360   print #20: 'Call Print.AddLine('&str$(xmargin+90+xmod_for_right)&','&str$(ymargin+17)&',7,0)'
02370   print #20: 'Call Print.AddText("   Pre-Sorted",'&str$(xmargin+100+xmod_for_right)&','&str$(lyne*1-1+ymargin)&')'
02380   print #20: 'Call Print.AddText("First Class Mail",'&str$(xmargin+100+xmod_for_right)&','&str$(lyne*2-1+ymargin)&')'
02390   print #20: 'Call Print.AddText("  U.S. Postage  ",'&str$(xmargin+100+xmod_for_right)&','&str$(lyne*3-1+ymargin)&')'
02400   print #20: 'Call Print.AddText("      Paid",'&str$(xmargin+100+xmod_for_right)&','&str$(lyne*4-1+ymargin)&')'
02410   print #20: 'Call Print.AddText("  Permit No 916",'&str$(xmargin+100+xmod_for_right)&','&str$(lyne*5-1+ymargin)&')'
02420   print #20: 'Call Print.MyFontSize(9)'
02430 ! Print #20: 'Call Print.AddText("Address Service Requested",'&STR$(XMARGIN+68)&','&STR$(LYNE*7+YMARGIN-6)&')'
02440   print #20: 'Call Print.AddText("Please return this",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*7+ymargin)&')'
02450   print #20: 'Call Print.AddText("side with payment to:",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*8+ymargin)&')'
02460   print #20: 'Call Print.AddText("'&cnam$&'",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*9+ymargin)&')'
02470   print #20: 'Call Print.MyFontSize(10)'
02480   print #20: 'Call Print.AddText("Pay By '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*11+ymargin)&')'
02490   print #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+104+xmod_for_right)&','&str$(lyne*11+ymargin)&')'
02500   print #20: 'Call Print.AddText("After '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*12+ymargin)&')'
02510   print #20: 'Call Print.AddText("'&fnformnumb$(bal+g(10),2,9)&'",'&str$(xmargin+104+xmod_for_right)&','&str$(lyne*12+ymargin)&')'
02520   print #20: 'Call Print.MyFontSize(9)'
02530   let addy=14
02540   let fnpa_txt(mg$(1),xmargin+68+xmod_for_right,(addy+=1)*lyne+ymargin)
02550   let fnpa_txt(mg$(2),xmargin+68+xmod_for_right,(addy+=1)*lyne+ymargin)
02560   let fnpa_txt(mg$(3),xmargin+68+xmod_for_right,(addy+=1)*lyne+ymargin)
02570   let addy+=1
02580   print #20: 'Call Print.MyFontSize(10)'
02590   if df$="Y" then !:
          print #20: 'Call Print.AddText("Drafted",'&str$(xmargin+1+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)
02600   if c4>0 then !:
          print #20: 'Call Print.AddText("Final Bill",'&str$(xmargin+1+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)
02610   if d(10)=1 then !:
          print #20: 'Call Print.AddText("Bill Estimated",'&str$(xmargin+1+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)
02620   print #20: 'Call Print.AddText("#'&trim$(z$)&' '&bulk$&'",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)&')'
02630   if pe$(1)<>"" then !:
          print #20: 'Call Print.AddText("'&trim$(pe$(1))&'",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)&')'
02640   if pe$(2)<>"" then !:
          print #20: 'Call Print.AddText("'&trim$(pe$(2))&'",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)&')'
02650   if pe$(3)<>"" then !:
          print #20: 'Call Print.AddText("'&trim$(pe$(3))&'",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)&')'
02660   if pe$(4)<>"" then !:
          print #20: 'Call Print.AddText("'&trim$(pe$(4))&'",'&str$(xmargin+68+xmod_for_right)&','&str$(lyne*(addy+=1)+ymargin)&')'
...
02710 ! let bc$=""
02720 ! if trim$(bc$)<>"" then print #20: 'Call Print.DisplayBarCode('&str$(checkx)&','&str$(checky)&',"'&bc$&'")'
...
02770   open #1: "Name="&env$('Q')&"\UBmstr\Customer.h"&str$(cno)&",KFName="&env$('Q')&"\UBmstr\ubIndex.H"&str$(cno)&",Shr",internal,input,keyed  ! open in Account order
