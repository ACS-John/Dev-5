...
01715     print #20: 'Call Print.AddLine('&str$(xmargin+5)&','&str$(ymargin+2)&',55,'&str$(lyne*3+3)&',True)'
01720     print #20: "Call Print.MyFontBold(True)"
01725     print #20: 'Call Print.MyFontSize(12)'
01730     print #20: 'Call Print.MyFont("Courier New")'
01735     print #20: 'Call Print.AddText("Village of Moweaqua",'&str$(xmargin+8)&','&str$(lyne*1-1+ymargin)&')'
01740     print #20: 'Call Print.MyFont("Lucida Console")'
01745     print #20: 'Call Print.MyFontSize(10)'
01750     print #20: 'Call Print.MyFontBold(False)'
01755     print #20: 'Call Print.AddText("    122 North Main  ",'&str$(xmargin+6)&','&str$(lyne*2+1+ymargin-.2)&')'
01760     print #20: 'Call Print.AddText("  Moweaqua, IL 62550    ",'&str$(xmargin+6)&','&str$(lyne*3+1+ymargin)&')'
01765     let fnpa_txt("#"&trim$(z$)&'  '&bulk$,xmargin+4,lyne*5+ymargin)
01770     let fnpa_txt(e$(1),xmargin+4,lyne*6+ymargin)
01775     print #20: 'Call Print.AddText("From: '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d2)&'  To: '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d3)&'",'&str$(xmargin+2)&','&str$(lyne*7+ymargin)&')'
01780     print #20: 'Call Print.AddText("Is due now and payable.",'&str$(xmargin+2)&','&str$(lyne*8+ymargin)&')'
01785     print #20: 'Call Print.AddText("Billing Date: '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d1)&'",'&str$(xmargin+2)&','&str$(lyne*11+ymargin)&')'
01790     print #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*12+1+ymargin)&',62,0)'
01795     print #20: 'Call Print.AddText("Reading",'&str$(xmargin+10)&','&str$(lyne*13+ymargin)&')'
01800     print #20: 'Call Print.AddText("Usage",'&str$(xmargin+33)&','&str$(lyne*13+ymargin)&')'
01805     print #20: 'Call Print.AddText("Charge",'&str$(xmargin+50)&','&str$(lyne*13+ymargin)&')'
01810 ! ______________________________________________________________________
01815 ! PRINTGRID:
01816     let meter=14
01820     print #20: 'Call Print.MyFontSize(8)'
01825     if g(1) then 
01830       print #20: 'Call Print.AddText("WTR",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')'
01835       print #20: 'Call Print.AddText("'&fnformnumb$(d(1),0,9)&'",'&str$(xmargin+6)&','&str$(lyne*meter+ymargin)&')'
01840       print #20: 'Call Print.AddText("'&fnformnumb$(d(3),0,9)&'",'&str$(xmargin+25)&','&str$(lyne*meter+ymargin)&')'
01845       print #20: 'Call Print.AddText("'&fnformnumb$(g(1),2,9)&'",'&str$(xmargin+45)&','&str$(lyne*meter+ymargin)&')'
01850     end if 
01855     if g(2) then 
01860       print #20: 'Call Print.AddText("SWR",'&str$(xmargin+1)&','&str$(lyne*(meter+=1)+ymargin)&')'
01865       print #20: 'Call Print.AddText("'&fnformnumb$(g(2),2,9)&'",'&str$(xmargin+45)&','&str$(lyne*meter+ymargin)&')'
01870     end if 
01875     if g(3) then 
01880       let fnpa_txt("Water Plant Improvements",xmargin+1,lyne*(meter+=1)+ymargin)
01895       print #20: 'Call Print.AddText("'&fnformnumb$(g(3),2,9)&'",'&str$(xmargin+45)&','&str$(lyne*meter+ymargin)&')'
01900     end if 
02020 ! L2020: !
02030     if a4=1 then 
...
02460     print #20: 'Call Print.AddText("'&fnformnumb$(bal,2,9)&'",'&str$(xmargin+42)&','&str$(lyne*24+ymargin)&')'
02470     print #20: 'Call Print.AddText("Pay After '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+1)&','&str$(lyne*25+ymargin)&')'
02480     print #20: 'Call Print.AddText("'&fnformnumb$(bal+g(10),2,9)&'",'&str$(xmargin+42)&','&str$(lyne*25+ymargin)&')'
02490     print #20: 'Call Print.AddLine('&str$(xmargin+1)&','&str$(lyne*26+1+ymargin)&',63,0)'
02500     print #20: 'Call Print.AddText("Phone: 217-768-3435",'&str$(xmargin+1)&','&str$(lyne*27+ymargin)&')'
...
02700     print #20: 'Call Print.AddText("Please return this",'&str$(xmargin+68)&','&str$(lyne*7+ymargin)&')'
02710     print #20: 'Call Print.AddText("side with payment to:",'&str$(xmargin+68)&','&str$(lyne*8+ymargin)&')'
02720     print #20: 'Call Print.AddText("Village of Moweaqua",'&str$(xmargin+68)&','&str$(lyne*9+ymargin)&')'
02730     print #20: 'Call Print.MyFontSize(10)'
02740     print #20: 'Call Print.AddText("Pay By '&cnvrt$("PIC(ZZ/ZZ/ZZ)",d4)&':",'&str$(xmargin+68)&','&str$(lyne*11+ymargin)&')'
...
02770     print #20: 'Call Print.AddText("'&fnformnumb$(bal+g(10),2,9)&'",'&str$(xmargin+106)&','&str$(lyne*12+ymargin)&')'
