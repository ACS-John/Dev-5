...
00560   let usage=0
00570   if srvc=1 then let usage=d(3): amount=g(1): let meter$=f$(1) ! water
00580   if srvc=2 then let usage=d(3): amount=g(2): let meter$="" ! sewer
00590   if srvc=3 then let usage=d(7): amount=g(3): let meter$=f$(2) ! electric
00600   if srvc=4 then let usage=d(11): amount=g(4): let meter$=f$(3) ! gas
