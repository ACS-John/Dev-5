...
01900   let txt$=trim$(z$) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(62)&','&str$(lyne+7)&')'
01910   let txt$=trim$(fb$(1)) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(95)&','&str$(lyne+7)&')'
01920   if pb<>0 then let de$="Prv" else let de$="   "
01930   let txt$=cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzz)",0)&" "&de$&cnvrt$("pic(-----.--)",pb) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(1)&','&str$(lyne+25)&')'
01940   if g(1)>0 then let de$="Wat" else let de$="   "
01950   let txt$=cnvrt$("pic(zzzzzzzz)",d(1))&cnvrt$("pic(zzzzzzzz)",d(2))&cnvrt$("pic(zzzzzz)",d(3))&" "&de$&cnvrt$("pic(-----.--)",g(1))&"     "&pe$(1)(1:22) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(1)&','&str$(lyne+30)&')'
01960   if g(2)>0 then let de$="Sew" else let de$="   "
01970   let txt$=cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzz)",0)&" "&de$&cnvrt$("pic(-----.##)",g(2))&"     "&pe$(2)(1:22) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(1)&','&str$(lyne+35)&')'
01980   if g(3)>0 then let de$="Fee" else let de$="   "
01990   let txt$=cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzz)",0)&" "&de$&cnvrt$("pic(-----.--)",g(3))& "     "&pe$(3)(1:22) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(1)&','&str$(lyne+40)&')'
02000   if g(5)>0 then let de$="P/T" else let de$="   "
02010   if g(5)>0 then let txt$=cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzzzz)",0)&cnvrt$("pic(zzzzzz)",0)&" "&de$&cnvrt$("pic(-----.##)",g(5))&"     "&pe$(4)(1:22) !:
...
02100   let txt$=cnvrt$("pic(zzbzzbbzz)",d3x)&" "&cnvrt$("pic(zzbzzbbzz)",d2x)&cnvrt$("pic(----.##)",g(12)+pb) &cnvrt$("pic(------.##)",g(11)+pb)&"    "&cnvrt$("pic(-----.##)",g(12)+pb)&"   "&cnvrt$("pic(zzbzzbzz)",d4)&cnvrt$("pic(-----.##)",g(11)+pb) !:
