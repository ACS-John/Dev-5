...
dim io2$(38),code$(4)
	...
	fndat(bdate)
	fnTop("S:\acsUB\ubanlyze","Analyze Charges")
MAIN: !
	fnTos
	mylen=20
	mypos=mylen+2
...
L620: if cde(k9)>0 then goto L640
		if cde(k9)=0 then goto L930
L640: if cde(k9)<1 or cde(k9)>20 then goto L510
		close #105: ioerr L660
L660: open #105: "SROW=2,SCOL=42,EROW=23,ECOL=77,BORDER=SR,CAPTION=<Print Analysis Report",display,outIn
		pr #105: newpage
