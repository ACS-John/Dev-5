...
00090   print newpage
00100   print fields "06,20,Cc 40,R,n": "POSITION BILLING FORMS IN THE PRINTER"
00110   print fields "08,23,c 26,N": " DATE OF BILLING (MMDDYY):"
00120   print fields "10,23,c 26,n": "DUE DATE OF BILL (MMDDYY):"
00130   print fields "12,23,c 26,n": " SERVICE FROM DATE (MMDD):"
00140   print fields "14,23,c 26,n": "   SERVICE TO DATE (MMDD):"
00150   print fields "16,20,Cc 40,R,N": "PRESS F5 TO STOP"
...
00530   print #255,using L540: d(2),d(1),int(d(3)/100),g(1),z$
00540 L540: form pos 9,n 8,n 8,n 7,n 9.2,pos 45,c 30,skip 1
00550   if g(2)=0 then print #255,using L560: e$(2) else print #255,using L570: "Sewer",g(2),e$(2)
00560 L560: form pos 45,c 30,skip 1
00570 L570: form pos 26,c 5,pos 32,n 9.2,pos 45,c 30,skip 1
00580   if g(5)=0 then print #255,using L560: e$(3) else print #255,using L570: "Sanit",g(5),e$(3)
00590   if g(8)=0 then print #255,using L560: e$(4) else print #255,using L570: "Other",g(8),e$(4)
00600   if pb=0 then print #255,using L610: csz$ else print #255,using L620: "Prew",pb,csz$
00610 L610: form pos 45,c 30,skip 1
00620 L620: form pos 26,c 5,pos 32,n 9.2,pos 45,c 30,skip 1
00630   print #255,using L640: g(9)
00640 L640: form skip 1,pos 32,n 9.2,skip 2
00650   print #255,using L660: bal+g(10)+g(7),z$,bal
00660 L660: form pos 8,n 10.2,x 3,c 10,pos 32,n 9.2,skip 5
00665   let count=count+1: if int(count/3)=count/3 then print #255: newpage
00670   return 
00680   goto L490
00690   rem NOKEY GO PRINT WITHOUT NAME
00700   mat e$=(" ")
00710   goto L430
00720 L720: print newpage
00730   print fields "12,14,c 40,N": "Starting Account (Blank for All):"
00740 L740: input fields "12,55,C 10,U,N": a$
00750   let numb=val(a$) conv L740
00760   if numb=0 then goto L840
00770   let a$=lpad$(str$(numb),10)
00780   let ppos=pos (a$,".",1)
00790   if ppos<1 or ppos>7 then goto L800 else goto L740
00800 L800: if ppos=8 then goto L830
00810   if ppos=9 then let a$=a$(2:10)&"0"
00820   if ppos=0 then let a$=a$(4:10)&".00"
00830 L830: read #1,using L360,key=a$: z$,mat e$,f$,a4,mat b,mat d,bal,f,mat g,bkno nokey L720
00840 L840: print newpage
00850   print fields "10,20,Cc 40,R,N": "Printing Utility Bills: Please wait..."
00860   print fields "12,20,Cc 40,R,N": "Press F5 to stop"
00870   return 
00880 L880: print newpage
00890   print fields "10,20,C 37,N": "Book Number to Print (Blank for All):"
00900 L900: input fields "10,58,Nz 2,U,N": prtbkno conv L900
00910   if prtbkno=0 then goto L330
00920   print newpage
00930   print fields "10,20,Cc 40,R,N": "Printing Utility Bills: Please wait..."
00940   print fields "12,20,Cc 40,R,N": "Press F5 to stop"
