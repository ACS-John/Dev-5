...
00200   open #1: "Name=[Q]\UBmstr\Customer.h[cno],KFName=[Q]\UBmstr\ubIndex.h[cno],Shr",internal,input,keyed  ! open in Account order
00210   open #2: "Name=[Q]\UBmstr\Customer.h[cno],KFName=[Q]\UBmstr\ubIndx5.h[cno],Shr",internal,input,keyed  ! open in route-sequence #
00220   open #ubtransvb=15: "Name=[Q]\UBmstr\UBTransVB.h[cno],KFName=[Q]\UBmstr\UBTrIndx.h[cno],Shr",internal,outIn,keyed 
00223   if exists("[Q]\UBmstr\message.h[cno]")=0 then goto L3250
00225 L225: open #16: "Name=[Q]\UBmstr\message.h[cno]",internal,outIn,relative 
00226   for j=1 to 13
...
03030   open #1: "Name=[Q]\UBmstr\Customer.h[cno],KFName=[Q]\UBmstr\ubIndex.h[cno],Shr",internal,input,keyed  ! open in Account order
...
03230   goto L3160
03240 L3240: return 
03250 L3250: open #16: "Name=[Q]\UBmstr\message.h[cno],RecL=132,replace",internal,outIn,relative 
03255   for j=1 to 10
