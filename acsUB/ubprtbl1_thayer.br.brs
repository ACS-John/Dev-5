...
! pr bills for Village of Thayer  (new 4 per page 10/24/06)
	...
	dim resp$(10)*40,txt$*45,mg$(3)*30,rw(22,13)
	dim z$*10,e$(4)*30,f$*12,g(12),xd(15),w$*31,y$*39,x$*70,b(11),extra1$*30
...
L550: !
	...
	read #1,using L610,key=z$: z$,mat e$,f$,a3,mat b,final,mat xd,bal,f,mat g,bra,mat gb,route,d3,d2,bulk$,extra1$,estimatedate,escrow nokey L560
...
! If TRIM$(A$)="" Then Goto 1030 Else Goto 1040 ! kj 7/12/05
	...
	read #1,using L610,key=a$: z$,mat e$,f$,a3,mat b,final,mat xd,bal,f,mat g,bra,mat gb,route,d3,d2,bulk$,extra1$,estimatedate,escrow nokey SCREEN3
goto READALTADR ! /r
...
PRINTGRID: !
		...
		if g(1)<>0 then
			...
			pr #20: 'Call Print.AddText("'&fnformnumb$(xd(1),0,9)&'",'&str$(xmargin+6)&','&str$(lyne*meter+ymargin)&')'
			pr #20: 'Call Print.AddText("'&fnformnumb$(xd(3),0,9)&'",'&str$(xmargin+25)&','&str$(lyne*meter+ymargin)&')'
		...
		if g(4)<>0 then
			...
			pr #20: 'Call Print.AddText("'&fnformnumb$(xd(9),0,9)&'",'&str$(xmargin+6)&','&str$(lyne*meter+ymargin)&')'
			pr #20: 'Call Print.AddText("'&fnformnumb$(xd(11),0,9)&'",'&str$(xmargin+25)&','&str$(lyne*meter+ymargin)&')'
