...
00045   dim txt$*200,tg(11),key$*19
00050   dim bt1(14,2),badr(2),resp$(5)*60
00055 !
00070   fntop(program$,"Reverse Calculation")
00075 !
...
01080   def fn_bud1
01082     bud1=0
01090     open #81: "Name=[Q]\UBmstr\BudMstr.h[cno],KFName=[Q]\UBmstr\BudIdx1.h[cno],Shr",internal,outIn,keyed ioerr L1120
01100     open #82: "Name=[Q]\UBmstr\BudTrans.h[cno],Shr",internal,outIn,relative 
01110     bud1=1
01120 L1120: ! 
01122   fnend 
01130 !
