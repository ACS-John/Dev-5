...
L1290: form pos 1,c 128
	write #9,using L1290: "File "&env$('Temp')&"\Temp."&wsid$&",,,"&env$('Temp')&"\Addr."&session$&",,,,,A,N"
...
L2760: close #1: ioerr ignore
		...
		execute "Index "&env$('Temp')&"\Temp."&wsid$&" "&env$('Temp')&"\Tempidx."&wsid$&" 1,19,Replace,DupKeys -n" ! ioerr L2800
