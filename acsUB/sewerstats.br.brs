...
def fn_showresults
	...
	open #(h_prn:=fnH): "Name=[Q]\UBmstr\Sewerstats"&wsid$&".txt,Replace,RecL=5000",d,o 
...
fnend 
def fn_openfiles
	open #(h_ubmstr:=fnH): "Name=[Q]\UBmstr\customer.h[cno],KFName=[Q]\UBmstr\UBIndex.h[cno]",i,i,k 
	CUSTFORM: form c 10
	open #(h_ubtrans:=fnH): "Name=[Q]\UBmstr\ubtransvb.h[cno],KFName=[Q]\UBmstr\ubtrindx.h[cno]",i,i,k 
