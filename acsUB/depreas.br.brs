...
! -- Reassign Deposit Change Addresses
	...
	dim msgline$(3)*60,cap$*128,ta(2),message$*40
	fncno(cno)
 
	fnTop(program$,cap$="Reassign Deposit Change Addresses")
 
MAIN: !
	msgline$(1)="No other users may be using the Deposit file" : _
	msgline$(2)="while this option is running.  Do you want to run" : _
	msgline$(3)="Reassign Deposit Change Addresses now?" : _
