...
fnend 
def fn_main_loop ! main
	dim cap$*80,billingdate$*10,msgtext$(1)*1000,readings(12),charges(12),breakdown(10),readingdates(2)
	fnTop(program$,cap$="Remove Excessive Balance")
	remove_total=2
	do 
