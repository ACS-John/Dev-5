! Replace S:\Client Billing\Legacy\CliLabel
! pr client labels
...
L710: !
	...
	labelcount=0
	if uprc$(rtrm$(prg$))='S:\Client Billing\Client Legacy' or uprc$(rtrm$(prg$))='S:\Client Billing\Client Legacy' then chain prg$ ! XXX
goto Xit
Xit: !
