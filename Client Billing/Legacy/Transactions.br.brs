...
! r: setup layout for hamster2
	...
	fnH2Init   !                                                        spos
	fnH2AddText("Client ID"					    	, 5,''  ,0  ,0              ,  1)
	fnH2AddText("Invoice"  					    	,12,''  ,0  ,0              ,  6)
	fnH2AddText("Date"     					    	, 6,'N' ,0  ,mask_mmddyy    , 18) ! 30 (mask_number) =no decimals, no commas
	! fnH2AddText("Origional Amount"      	,10,'PD',5.2,mask_pointtwo  , 24)
	fnH2AddText("Amount"                 	,10,'PD',5.2,mask_pointtwo  , 29)
	! fnH2AddText("Salesman Number"       	, 3,'PD',2  ,mask_pointtwo  , 34)
	itemTCode=fnH2AddText("Trans Code" 	, 1,'N' ,0  ,mask_number    , 36)
	...
	! fnH2AddText("Posting Code"          	, 1,'N' ,0  ,mask_number    , 37)
	fnH2AddText("Invoice Description"  	,20,'C' ,0  ,0              , 38)
	! fnH2AddText("Next Trans Addr"       	, 5,'PD',3  ,0              , 58)
