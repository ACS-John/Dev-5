...
def fn_getTrusts(mat trustPath$,mat trustName$; basePath$*512,___,path$*40,tName$*28,trustItem)
	...
	open #hFinSum:=fngethandle: 'name='&basePath$&'\common\trustact,shr',i,outi,r IOERR Xitfn_getTrusts
	! open #hFinSum:=fngethandle: "name=trustact/common/5,shr",i,outi,r IOERR Xitfn_getTrusts
