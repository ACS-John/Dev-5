00010 ! Replace R:\acsCL\TransactionHamster
00020 ! Check Book Transaction File
...
00150   open #open_file_count+=1: "Name=Q:\CLmstr\TrMstr.h"&str$(cno)&",Version=2,KFName=Q:\CLmstr\TrIdx1.h"&str$(cno)&",Use,RecL=78,KPs=1,KLn=11,Shr",internal,outin,keyed 
00160   open #open_file_count+=1: "Name=Q:\CLmstr\TrMstr.h"&str$(cno)&",Version=2,KFName=Q:\CLmstr\TrIdx2.h"&str$(cno)&",Use,RecL=78,KPs=28/1,KLn=8/11,Shr",internal,outin,keyed 
00170   open #open_file_count+=1: "Name=Q:\CLmstr\TrMstr.h"&str$(cno)&",Version=2,KFName=Q:\CLmstr\TrIdx3.h"&str$(cno)&",Use,RecL=78,KPs=16/12/4,KLn=2/4/8,Shr",internal,outin,keyed 
00180   return 
...
00450   let cl=1 : let c$(cl,1)='ComboF' !:
        ...
        let c$(cl,7)="Q:\CLmstr\BankIdx1.h"&str$(cno) !:
        let c$(cl,8)=limit_to_list$
00460   let cl=2 : let c$(cl,1)='ComboF' !:
        let c$(cl,2)="Q:\CLmstr\TransactionType.dat" !:
        let c$(cl,3)='1' : let c$(cl,4)='1' !:
        let c$(cl,5)='2' : let c$(cl,6)='25' !:
        let c$(cl,7)="Q:\CLmstr\TransactionType.idx" !:
        let c$(cl,8)=limit_to_list$
...
00480   let cl=9 : let c$(cl,1)='ComboF' !:
        ...
        let c$(cl,3)='1' : let c$(cl,4)='1' !:
        let c$(cl,5)='2' : let c$(cl,6)='25' !:
        let c$(cl,7)="R:\acsCL\PostingCode.idx" !:
        let c$(cl,8)=limit_to_list$
00490   let cl=11 : let c$(cl,1)='ComboF' !:
        let c$(cl,2)="Q:\CLmstr\SourceCode.dat" !:
        let c$(cl,3)='1' : let c$(cl,4)='1' !:
        let c$(cl,5)='2' : let c$(cl,6)='25' !:
        let c$(cl,7)="R:\acsCL\SourceCode.idx" !:
        let c$(cl,8)=limit_to_list$
00500   return 
