...
00150   open #open_file_count+=1: "Name=[Q]\CLmstr\TrMstr.h[cno],Version=2,KFName=[Q]\CLmstr\TrIdx1.h[cno],Use,RecL=78,KPs=1,KLn=11,Shr",internal,outIn,keyed 
00160   open #open_file_count+=1: "Name=[Q]\CLmstr\TrMstr.h[cno],Version=2,KFName=[Q]\CLmstr\TrIdx2.h[cno],Use,RecL=78,KPs=28/1,KLn=8/11,Shr",internal,outIn,keyed 
00170   open #open_file_count+=1: "Name=[Q]\CLmstr\TrMstr.h[cno],Version=2,KFName=[Q]\CLmstr\TrIdx3.h[cno],Use,RecL=78,KPs=16/12/4,KLn=2/4/8,Shr",internal,outIn,keyed 
00180   return 
