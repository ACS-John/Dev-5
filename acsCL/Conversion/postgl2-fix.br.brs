00010 ! REPLACE R:\acsCL\conversion\postgl2-fix
00020 ! 
...
00070   print newpage
00080   print fields "10,15,C 60": "ENTER COMPANY NUMBER TO FIX:"
00090   print fields "12,10,C 60": "ENTER THE LAST DATE POSTED THROUGH:"
00100   print fields "14,10,C 34,R,N": "PRESS F1 TO CONTINUE OR F5 TO STOP"
00110 L110: input fields mat io1$,attr "R": cno,dt1 conv CONV1
00120   if ce>0 then let io1$(ce)(ce1:ce2)="U": let ce=0
00130   if cmdkey>0 then goto L200 else let ce=curfld
00140 L140: let ce=ce+1: if ce>udim(io1$) then let ce=1
00150 L150: let io1$(ce)=rtrm$(uprc$(io1$(ce))) : let ce1=pos(io1$(ce),"U",1) : if ce1=0 then goto L140
00160   let ce2=ce1+1 : let io1$(ce)(ce1:ce1)="UC" : goto L110
00170 CONV1: if ce>0 then let io1$(ce)(ce1:ce2)="U"
00180   let ce=cnt+1
00190 ERR1: print fields "24,78,C 1": bell : goto L150
00200 L200: if cmdkey=5 then stop 
00210   print #255: dt1
00220 ! 
00230   open #1: "Name=Q:\CLmstr\TRMSTR.H"&str$(cno)&",KFName=Q:\CLmstr\TRIDX1.H"&str$(cno)&",Shr",internal,outin,keyed 
00240   open #3: "Name=Q:\CLmstr\TRALLOC.h"&str$(cno)&",Shr",internal,outin,relative 
...
00370 ! PRINT #255,USING 380: CK$,IVD,PD,AMT
00380   form pos 1,c 8,2*pic(zz/zz/zz),n 12.2
00390   if pcde=1 or pcde=3 then let pcde=pcde-1
00400 L400: let adr=nta : goto L310
