00010 ! Replace R:\acsCL\Conversion\PayAlloc-Cnv
...
00100   let fncno(cno)
00110   open #1: "Name=Q:\CLmstr\PayMstr.h"&str$(cno)&",KFName=Q:\CLmstr\PayIdx1.h"&str$(cno),internal,outin,keyed 
00120   open #2: "Name=Q:\CLmstr\X.H"&str$(cno)&",RecL=164,Replace",internal,outin,relative 
00130   open #3: "Name=Q:\CLmstr\PayAlloc.h"&str$(cno)&",SIZE=0,RecL=56,Replace",internal,outin,relative 
...
00200   execute "COPY Q:\CLmstr\X.H"&str$(cno)&" Q:\CLmstr\PayMstr.h"&str$(cno)
00210   execute "INDEX Q:\CLmstr\PayMstr.h"&str$(cno)&" Q:\CLmstr\PayIdx1.h"&str$(cno)&" 1 8 Replace DupKeys"
00220   execute "INDEX Q:\CLmstr\PayMstr.h"&str$(cno)&" Q:\CLmstr\PayIdx2.H"&str$(cno)&" 9 28 Replace DupKeys"
