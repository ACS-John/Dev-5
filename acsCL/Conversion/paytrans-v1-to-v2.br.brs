...
00230     let fncopy("Q:\CLmstr\PayTrans.h"&str$(cno),"Q:\CLmstr\PayTrans.h"&str$(cno),114)
00270     open #paytrans1=1: "Name=Q:\CLmstr\PayTrans.h"&str$(cno)&",KFName=Q:\CLmstr\UnPdIdx1.h"&str$(cno),internal,outin,keyed 
...
00340     let fnindex_it("Q:\CLmstr\PayTrans.H"&str$(cno),"Q:\CLmstr\UnPdIdx1.H"&str$(cno),"1 20")
00350     let fnindex_it("Q:\CLmstr\PayTrans.h"&str$(cno),"Q:\CLmstr\UnPdIdx2.h"&str$(cno),"31/27/1 2/4/26")
00360     goto XIT
00370 ! ______________________________________________________________________
00380 ! <Updateable Region: ERTN>
00390 ERTN: let fnerror(cap$,err,line,act$,"xit")
