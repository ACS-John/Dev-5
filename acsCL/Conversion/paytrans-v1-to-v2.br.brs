...
00340     fnindex_it(env$('Q')&"\CLmstr\PayTrans.H"&env$('cno'),env$('Q')&"\CLmstr\UnPdIdx1.H"&env$('cno'),"1 20")
00350     fnindex_it(env$('Q')&"\CLmstr\PayTrans.h"&env$('cno'),env$('Q')&"\CLmstr\UnPdIdx2.h"&env$('cno'),"31/27/1 2/4/26")
00360     goto XIT
