00010 ! REPLACE R:\acsCL\conversion\trckno-fix
00020   dim tr(2)
...
00080 ! 
00090   open #trmstr=1: "Name=Q:\CLmstr\TRMSTR.H"&str$(cno),internal,outin 
00100   open #2: "Name=Q:\CLmstr\TRALLOC.h"&str$(cno),internal,outin,relative 
...
00270   close #2: 
00280   execute "INDEX Q:\CLmstr\TRMSTR.H"&str$(cno)&" Q:\CLmstr\TRIDX1.H"&str$(cno)&" 1 11 REPLACE DupKeys"
00290   execute "INDEX Q:\CLmstr\TRMSTR.H"&str$(cno)&" Q:\CLmstr\TRIDX2.H"&str$(cno)&" 1/28/4 3/8/8 REPLACE DupKeys"
00300   stop 
