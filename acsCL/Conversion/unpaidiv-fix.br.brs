00010 ! REPLACE R:\acsCL\conversion\unpaidiv-fix
00020 ! check for posting codes in unpaid file
00030 ! 
00040   dim tr(2),up$(4),aa(2)
00050   print newpage
00060   print fields "10,15,C 60": "ENTER THE COMPANY NUMBER TO BE CHECKED: 1"
00070 L70: input fields "10,55,N 2,UE,N": cno conv L70
00080   def fncd(x)=(x-int(x*.01)*100)*10000+int(x*.01)
00090   if cno=0 then stop 
00100 ! 
00110   open #1: "Name=Q:\CLmstr\PayTrans.h"&str$(cno)&",Shr",internal,outin,relative 
