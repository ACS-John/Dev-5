...
00030   dim tr(2)
00050   print newpage
00060   print fields "10,15,C 60": "ENTER THE COMPANY NUMBER TO BE CHECKED: 2"
00070 L70: input fields "10,55,N 2,UE,N": cno conv L70
00080   if cno=0 then stop 
00090 ! 
00100   open #1: "Name="&env$('Q')&"\CLmstr\TRMSTR.H"&str$(cno),internal,outin 
00110   open #2: "Name="&env$('Q')&"\CLmstr\TRALLOC.h"&str$(cno),internal,outin,relative 
00120 L120: read #1,using L130: ck$,mat tr eof END1
00130 L130: form pos 4,c 8,pos 79,2*pd 3
00150   let v1=val(ck$) conv L120
00151   if v1>13070 then goto END1
00152   if v1<13042 or v1>13070 then goto L120
00160   let ck$=cnvrt$("N 8",v1+1)
