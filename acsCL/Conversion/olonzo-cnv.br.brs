00010 ! Replace R:\acsCL\Conversion\OLONZO-CNV
...
00190 ! 
00200   execute "COPY Q:\CLmstr\PayTrans.h"&str$(cno)&",X -D"
00210   execute "COPY X Q:\CLmstr\PayTrans.h"&str$(cno)&"  -112"
00220   open #1: "Name=Q:\CLmstr\PayTrans.h"&str$(cno),internal,outin,relative 
...
00270   next j
00280   close #1: 
00290   execute "INDEX Q:\CLmstr\PayTrans.h"&str$(cno)&",Q:\CLmstr\UnPdIdx1.h"&str$(cno)&",1,20,Replace,DupKeys"
00300   execute "COPY Q:\CLmstr\PayMstr.h"&str$(cno)&",X -D -164"
00310   execute "FREE Q:\CLmstr\PayMstr.h"&str$(cno)
00320   execute "RENAME X,Q:\CLmstr\PayMstr.h"&str$(cno)
00330   execute "INDEX Q:\CLmstr\PayMstr.h"&str$(cno)&",Q:\CLmstr\PayIndx1.H"&str$(cno)&",1,8,Replace,DupKeys"
00340   execute "INDEX Q:\CLmstr\PayMstr.h"&str$(cno)&",Q:\CLmstr\PayIndx2.H"&str$(cno)&",9,28,Replace,DupKeys"
