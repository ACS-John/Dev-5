...
00120   open #1: "Name="&env$('Q')&"\CLmstr\TRMSTR.H"&str$(cno)&",KFName="&env$('Q')&"\CLmstr\TRIDX1.H"&str$(cno)&",Shr",internal,outin,keyed 
00130   open #2: "Name="&env$('Q')&"\CLmstr\TRMSTR.H"&str$(cno)&",KFName="&env$('Q')&"\CLmstr\TRIDX2.H"&str$(cno)&",Shr",internal,outin,keyed 
