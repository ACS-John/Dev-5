00010 ! Replace R:\acsCL\Conversion\fundmstr-recL75
...
00100     let fncno(cno)
00110 ! 
00120     execute "COPY Q:\CLmstr\fundmstr.h"&str$(cno)&" X."&session$&" -75"
00130     execute "COPY X."&session$&" Q:\CLmstr\fundmstr.h"&str$(cno)&" -D"
00140     execute "Free X."&session$
00150     execute "Index Q:\CLmstr\fundmstr.h"&str$(cno)&",Q:\CLmstr\fundidx1.h"&str$(cno)&",1,3,Replace,DupKeys"
00160     goto XIT
