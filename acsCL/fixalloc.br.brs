...
!
	...
	do
		READ_TRMSTR: !
		holdck$=ck$
		L200: read #trmstr,using 'Form POS 1,n 2,n 1,C 8,N 6,PD 10.2,POS 28,C 8,C 30,POS 71,N 1,X 6,N 1': trbank_code,trtcde,ck$,pd,ca1,vn$,de$,pcde,scd eof Finis
		if ck$=holdck$ then delete #trmstr: : goto L200
		...
		do
			...
			if trbank_code=bank_code and tcde=trtcde and ck$=trck$ then goto L270 else goto L300
			L270: totalalloc+=amt
			if amt=ca1 then foundone=1
		loop
		L300: !
		if totalalloc<>ca1 and foundone=1 then ca1=totalalloc
		rewrite #trmstr,using 'Form POS 1,n 2,n 1,C 8,N 6,PD 10.2,POS 28,C 8,C 30,POS 71,N 1,X 6,N 1': trbank_code,trtcde,ck$,pd,ca1,vn$,de$,pcde,scd
		foundone=0
	loop
Finis: !
Xit: fnXit
