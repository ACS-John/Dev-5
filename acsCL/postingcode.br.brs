00010 ! Replace R:\acsCL\PostingCode
00020 ! Check Book PostingCode File
...
00110   let fntop(program$,cap$="Posting Code")
00120   let fncno(cno)
00130   let lbl$(1)="Posting Code" !:
...
00180   open #1: "Name=R:\acsCL\PostingCode.dat,Version=1,KFName=R:\acsCL\PostingCode.idx,Use,RecL=26,KPs=1,KLn=1,Shr",internal,outin,keyed 
00190   close #1: 
00200   open #1: "Name=R:\acsCL\PostingCode.dat,Version=1,KFName=R:\acsCL\PostingCode.idx,Use,RecL=26,KPs=1,KLn=1,Shr",internal,outin,keyed 
00210   let fnhamster("PostingCode",mat lbl$,mat tln,1,mat p$,mat fltyp$,mat sln,mat mask,mat sp,mat c$)
00220 XIT: let fnxit
