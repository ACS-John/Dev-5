00010 ! Replace R:\acsCL\RemovePaidInvoices
00020 ! Remove Paid Invoices
00030 ! ______________________________________________________________________
00040   library 'R:\Core\Library': fntop,fnxit, fncno,fnerror,fndate_mmddyy_to_ccyymmdd,fntos,fnlbl,fntxt,fnacs,fncmdset
...
00130   let fntos(sn$='RmvPdInv') !:
        let lc=0 : let mylen=13 : let mypos=mylen+2 !:
        let mywidth=42
00140   let fnlbl (lc+=1,1,"Removal Date:",mylen,right)
00150   let fntxt(lc,mypos,10,0,left,'1003') !:
        let resp$(1)=""
00160   let lc+=1
00170   let fnlbl(lc+=1,1,"All transactions with a date equal to",mywidth,center)
00180   let fnlbl(lc+=1,1,"or older than this date will be removed.",mywidth,center)
00190   let fncmdset(2)
00200   let fnacs(sn$,0,mat resp$,ckey)
00210   if ckey=5 or ckey=cancel then goto XIT else !:
          let rd1=val(resp$(1))
00220 ! fnwait
00230   open #ivpaid=1: "Name=Q:\CLmstr\IvPaid.H"&str$(cno)&",KFName=Q:\CLmstr\IVIndex.H"&str$(cno)&",Shr",internal,outin,keyed 
...
00320   close #ivpaid: 
00330   close #work: 
00340   execute "Free Q:\CLmstr\IvPaid.H"&str$(cno)&" -n"
00350   execute "Rename Q:\CLmstr\Work."&session$&" Q:\CLmstr\IvPaid.H"&str$(cno)&" -n"
00360   goto XIT
