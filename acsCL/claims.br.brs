...
00630   notused=1: open #11: "Name="&env$('Q')&"\CLmstr\dptmSTR.H"&str$(cno)&",KFName="&env$('Q')&"\CLmstr\dptidx1.H"&str$(cno),internal,input,keyed ioerr L640 : notused=0
...
02120   pd1=fndate_mmddyy_to_ccyymmdd(val(tr$(2))) conv READ_TRMSTR
...
02180 NEXT_IVNUM: ! 
02190   ivnum+=1 : ck1=ivnum
02200 RESTORE_TRALLOC: ! 
02210   key$=cnvrt$("Pic(zz)",bank_code)&str$(tcde)&tr$(1) !:
...
02270 L2270: if tcde=2 then paid$="Received" else !:
          if tcde=3 then paid$="Adjustment" !:
          else paid$="Paid"
02280 WRITE_CLWORK: ! 
...
02800   pos2=val(resp$(10))
02810   return 
02850 ! /r
02860 ! <Updateable Region: ERTN>
02870 ERTN: fnerror(program$,err,line,act$,"xit")
...
03000     dpt$=gl$(1:3)&cnvrt$("pic(zz)",val(gl$(pos1:pos2)))
...
03100   hp3=51-int(len(rtrm$(dp$))/2)
