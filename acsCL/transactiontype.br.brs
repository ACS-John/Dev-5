00010 ! Replace R:\acsCL\TransactionType
00020 ! Check Book TransactionType File
...
00110   let fntop(program$,cap$="Transaction Type")
00120   let fncno(cno)
00130   let lbl$(1)="Transaction Type" !:
...
00180   open #1: "Name=Q:\CLmstr\TransactionType.dat,Version=1,KFName=Q:\CLmstr\TransactionType.Idx,Use,RecL=26,KPs=1,KLn=1,Shr",internal,outin,keyed 
00190   close #1: 
00200   open #1: "Name=Q:\CLmstr\TransactionType.dat,Version=1,KFName=Q:\CLmstr\TransactionType.Idx,Use,RecL=26,KPs=1,KLn=1,Shr",internal,outin,keyed 
00210   let fnhamster("TransactionType",mat lbl$,mat tln,1,mat p$,mat fltyp$,mat sln,mat mask,mat sp,mat c$)
00220 XIT: let fnxit
