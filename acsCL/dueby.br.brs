...
00130   fndat(dat$)
00140   gosub ASK
00150   execute "Index [Q]\CLmstr\PayTrans.h[cno]"&' '&"[Q]\CLmstr\Unpdidx2.H[cno] 31/27/1 2/4/26 Replace DupKeys -n" ! index in year,monthday,reference
00160   open #paymstr:=13: "Name=[Q]\CLmstr\PayMstr.H[cno],KFName=[Q]\CLmstr\PayIdx1.H[cno],Shr",internal,input,keyed 
00170   open #paytrans:=4: "Name=[Q]\CLmstr\PayTrans.H[cno],KFName=[Q]\CLmstr\Unpdidx2.H[cno],Shr",internal,input,keyed 
00180   fnopenprn
00190   gosub HDR
00200   vn$=iv$=""
00210 READ_INVOICES: ! 
