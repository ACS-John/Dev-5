...
00130   open #20: "Name="&env$('Q')&"\CLmstr\Company.h"&env$('cno')&",Shr",internal,outIn,relative: read #20,using 'Form POS 152,N 2',rec=1,release: wbc : close #20: 
00140 ASK1: ! 
00150   fnTos(sn$='ChgBank') !:
        lc=0 : mylen=20 : mypos=mylen+2
00160   fnLbl(lc+=1,1,"Working Bank:",mylen,right)
00170   fncombof('bank',lc,mypos,33,env$('Q')&"\CLmstr\BankMstr.h"&env$('cno'),1,2,3,30,env$('Q')&"\CLmstr\BankIdx1.h"&env$('cno'),limit_to_list) !:
        resp$(1)=str$(wbc)
...
00210   open #20: "Name="&env$('Q')&"\CLmstr\Company.h"&env$('cno')&",Shr",internal,outIn,relative: rewrite #20,using 'Form POS 152,N 2',rec=1: wbc : close #20: 
00220   goto XIT
