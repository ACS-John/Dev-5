...
00300   open #1: "Name="&env$('Q')&"\CLmstr\GLmstr.H"&env$('cno')&",Size=0,RecL=62,Replace",internal,output 
00310 L310: read #2,using 'Form POS 1,C 12,C 50': gl$,de$ eof END1
00320   write #1,using 'Form POS 1,C 12,C 50': gl$,de$
00330   goto L310
00340 END1: close #1: 
00350   close #2: 
00355   execute "Index "&env$('Q')&"\CLmstr\GLmstr.H"&env$('cno')&' '&env$('Q')&"\CLmstr\GLINDEX.H"&env$('cno')&" 1 12 Replace DupKeys"
00360   goto XIT
00370 ! ______________________________________________________________________
00380   execute "Index "&env$('Q')&"\CLmstr\GLmstr.H"&env$('cno')&' '&env$('Q')&"\CLmstr\GLINDEX.H"&env$('cno')&" 1 12 Replace DupKeys"
00390   goto XIT
...
00500 L500: fnCopy(env$('Q')&"\CLmstr\GLmstr.H"&env$('cno'),env$('Temp')&"\WORK",0,"-D")
00510   fnFree(env$('Q')&"\CLmstr\GLmstr.h"&env$('cno'))
00520   fnRename(env$('Temp')&"\WORK",env$('Q')&"\CLmstr\GLmstr.h"&env$('cno'))
00530   fnIndex(env$('Q')&"\CLmstr\GLmstr.H"&env$('cno'),env$('Q')&"\CLmstr\GLINDEX.H"&env$('cno'),"1 12")
00540   goto L120
