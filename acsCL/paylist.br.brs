...
00150   open #1: "Name=[Q]\CLmstr\PAYMSTR.h[cno],KFName=[Q]\CLmstr\PAYIDX1.h[cno],Shr",internal,outIn,keyed 
00160   open #2: "Name=[Q]\CLmstr\PAYMSTR.h[cno],KFName=[Q]\CLmstr\PAYIDX2.h[cno],Shr",internal,outIn,keyed 
00170   open #trmstr2=31: "Name=[Q]\CLmstr\TRMSTR.h[cno],KFName=[Q]\CLmstr\TRIDX2.h[cno],Shr",internal,outIn,keyed 
00180   open #payeegl=3: "Name=[Q]\CLmstr\payeeGLBreakdown.h[cno],KFName=[Q]\CLmstr\Payeeglbkdidx.h[cno],Shr",internal,outIn,keyed 
00190   pr newpage
...
00360   fndat(dat$,2)
00370   if resp$(3)(1:1)="T" then printgl=1 else printgl=0 ! pr general ledger breakdowns
00380   if resp$(4)(1:1)="T" then printtotal=1 else printtotal=0 ! pr total payments
00390   begdate=val(resp$(5))
00400   enddate=val(resp$(6)) ! ending date for adding purchases for period of time
00410   namtab=66-int(len(rtrm$(cnam$))/2)
00420   dattab=66-int(len(rtrm$(dat$))/2)
00430   fnopenprn
00440   gosub L730
...
00480   transactionstotal=0
00490   key$=vn$&cnvrt$('pic(Z#)',0)&cnvrt$("pic(#)",1)&rpt$(chr$(0),8) !:
