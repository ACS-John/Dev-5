00010 ! Replace R:\acsCL\checkalloc
00020 ! GL Distribution Report     AND/OR     Post to General Ledger
00030 ! GLT: 1=Post  2=Print Only
00040 ! ______________________________________________________________________
00050   library 'R:\Core\Library': fntop,fnxit, fnopenprn,fncloseprn,fncno,fnerror,fnputcno,fntop,fnxit,fndate_mmddyy_to_ccyymmdd,fnpgnum,fnprocess,fnchain,fnconsole,fntos,fnlbl,fntxt,fncomboa,fnchk,fncmdset,fnacs,fndate_mmddyy_to_ccyymmdd
...
00150   let fnopenprn
00160   open #trmstr=1: "Name=Q:\CLmstr\TrMstr.H"&str$(cno)&",KFName=Q:\CLmstr\TrIdx1.H"&str$(cno)&",Shr",internal,outin,keyed 
00170   open #tralloc=3: "Name=Q:\CLmstr\TrAlloc.H"&str$(cno)&",KFName=Q:\CLmstr\tralloc-idx.h"&str$(cno)&",Shr",internal,outin,keyed 
00180   open #bankmstr=4: "Name=Q:\CLmstr\BankMstr.H"&str$(cno)&",KFName=Q:\CLmstr\BankIdx1.H"&str$(cno)&",Shr",internal,outin,keyed 
