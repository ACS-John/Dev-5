...
02400   right=1
02420   fncno(cno)
02440   open #20: "Name=Q:\CLmstr\PostDat.h"&str$(cno)&",Shr,Use,RecL=12",internal,outin,relative 
...
02560   close #20: 
02580 ! 
02600   open #20: "Name=Q:\CLmstr\Company.h"&str$(cno)&",Shr",internal,input,relative 
...
02880   open #bankmstr=fngethandle: "Name=Q:\CLmstr\BankMstr.H"&str$(cno)&",KFName=Q:\CLmstr\BankIdx1.H"&str$(cno)&",Shr",internal, outin, keyed 
02900   read #bankmstr,using 'Form POS 45,PD 6.2,PD 6.2',key=bc$,release: bal,upi nokey ignore
02920   close #bankmstr: 
02940   open #glmstr=fngethandle: "Name=Q:\CLmstr\GLmstr.H"&str$(cno)&",KFName=Q:\CLmstr\GLIndex.H"&str$(cno)&",Shr",internal,outin,keyed 
02960   open #paymstr1=13: "Name=Q:\CLmstr\PayMstr.H"&str$(cno)&",KFName=Q:\CLmstr\PayIdx1.H"&str$(cno)&",Shr",internal,outin,keyed 
02980   open #paymstr2=14: "Name=Q:\CLmstr\PayMstr.H"&str$(cno)&",KFName=Q:\CLmstr\PayIdx2.H"&str$(cno)&",Shr",internal,outin,keyed 
03000   open #payeegl=17: "Name=Q:\CLmstr\payeeGLBreakdown.h"&str$(cno)&",KFName=Q:\CLmstr\Payeeglbkdidx.h"&str$(cno)&",Shr",internal,outin,keyed 
03020   open #paytrans=4: "Name=Q:\CLmstr\PayTrans.H"&str$(cno)&",KFName=Q:\CLmstr\UnPdIdx1.H"&str$(cno)&",Shr",internal,outin,keyed 
03040   open #unpdaloc=5: "Name=Q:\CLmstr\UnPdAloc.H"&str$(cno)&",KFName=Q:\CLmstr\Uaidx2.H"&str$(cno)&",Shr",internal,outin,keyed 
...
16090   open #41: "Name=Q:\PRmstr\JCMSTR.H"&str$(cno)&",KFName=Q:\PRmstr\JCIndx.H"&str$(cno)&",Shr",internal,outin,keyed ioerr JCBLD_FINIS
16100   open #category:=2: "Name=Q:\PRmstr\JCCAT.H"&str$(cno)&", KFName=Q:\PRmstr\CATIndx.H"&str$(cno)&",Shr", internal,outin,keyed 
16110   open #43: "Name=Q:\PRmstr\SCMSTR.H"&str$(cno)&",KFName=Q:\PRmstr\SCIndex.H"&str$(cno)&",Shr",internal,outin,keyed 
16120   open #45: "Name=Q:\PRmstr\JCTrans.H"&str$(cno)&",Shr",internal,outin,relative 
16130   if not exists("Q:\CLmstr\JCBreakdownS"&wsid$&".h"&str$(cno)) then gosub MAKE_JCB
16140   open #jcbreakdown=46: "Name=Q:\CLmstr\JCBreakdownS"&wsid$&".h"&str$(cno)&",KFName=Q:\CLmstr\JcBrkidx"&wsid$&".h"&str$(cno)&",Version=1,Shr",internal,outin,keyed ioerr MAKE_JCB
16150 JCBLD_FINIS: ! 
16160   return  ! /r
...
21130   open #paytrans=4: "Name=Q:\CLmstr\PayTrans.H"&str$(cno)&",KFName=Q:\CLmstr\UnPdIdx1.H"&str$(cno)&",Shr",internal,outin,keyed 
...
31070 execute "Drop Q:\CLmstr\jcbreakdowns"&wsid$&".h"&str$(cno)
31080 L6930: ! 
31090 return  ! /r
31500 MAKE_JCB: ! r: create Q:\CLmstr\JCBreakdownS"&wsid$&".h"&str$(cno)
31520 open #jcbreakdown=46: "Name=Q:\CLmstr\JCBreakdownS"&wsid$&".h"&str$(cno)&",Version=1,replace,RecL=79",internal,outin,relative 
31540 close #jcbreakdown: 
31560 execute "INDEX Q:\CLmstr\JCBreakdownS"&wsid$&".h"&str$(cno)&",Q:\CLmstr\jcbrkidx"&wsid$&".H"&str$(cno)&",48,20,Replace,DupKeys -n"
31580 return  ! /r
...
35180   open #ivpaid:=fngethandle: "Name=Q:\CLmstr\IvPaid.h"&str$(cno)&",KFName=Q:\CLmstr\IvIndex.h"&str$(cno),internal,outin,keyed 
...
35320   open #testpaytrans:=fngethandle: "Name=Q:\CLmstr\PayTrans.h"&str$(cno)&",KFName=Q:\CLmstr\UnPdIdx1.h"&str$(cno)&",SHR",internal,outin,keyed 
...
46180   fncombof("Paymstr",lc,mypos,0,"Q:\CLmstr\paymstr.h"&str$(cno),1,8,9,30,"Q:\CLmstr\Payidx1.h"&str$(cno),1,0, "Enter the payee number (Use the 'Add Payee' option to add a new vendor record",frame)
46200   resp$(1)=vn$
...
46920   fncombof("bankmstr",lc,mypos,23,"Q:\CLmstr\bankmstr.h"&str$(cno),1,2,3,20,"Q:\CLmstr\bankidx1.h"&str$(cno),0,0, "",frame)
