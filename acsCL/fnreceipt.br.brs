...
def library fnaddreceipt
	...
	open #receipt:=fngethandle: "Name=[Q]\CLmstr\recmstr.h[cno],Version=1,KFName=[Q]\CLmstr\recidx1.h[cno],Shr",internal,outIn,keyed 
	open #receiptgl:=fngethandle: "Name=[Q]\CLmstr\ReceiptGLBreakdown.h[cno],Version=1,KFName=[Q]\CLmstr\Receiptglbkdidx.h[cno],Use,RecL=56,KPs=1,KLn=8,Shr",internal,outIn,keyed 
...
fnend 
CREATERECEIPTFILE: ! r:
	open #receipt:=fngethandle: "Name=[Q]\CLmstr\recmstr.h[cno],Version=1,KFName=[Q]\CLmstr\recidx1.h[cno],REPLACE,RecL=38,KPS=1,KLN=8",internal,outIn,keyed 
	close #receipt: 
