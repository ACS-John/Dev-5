00010 ! Replace R:\acsCL\fnReceipt
00020 ! Standard Receipt file
00030   def library fnaddreceipt
00040     library 'R:\Core\Library': fncno,fndat,fnerror,fntos,fnlbl,fntxt,fncmdset,fnacs,fnmsgbox,fnwait,fnfra,fnbutton,fnflexinit1,fnflexadd1,fncmdkey,fndate_mmddyy_to_ccyymmdd,fngethandle,fnqgl,fnagl$,fnrgl$
...
00150     let fncno(cno)
00155     execute "Index Q:\CLmstr\Recmstr.h"&str$(cno)&" Q:\CLmstr\Recidx1.h"&str$(cno)&" 1 8 Replace DupKeys,Shr" ioerr ignore
...
00180     if exists("Q:\CLmstr\RECmstr.H"&str$(cno))=0 then gosub CREATERECEIPTFILE
00190     open #receipt:=fngethandle: "Name=Q:\CLmstr\recmstr.h"&str$(cno)&",Version=1,KFName=Q:\CLmstr\recidx1.h"&str$(cno)&",Shr",internal,outin,keyed 
00200     open #receiptgl:=fngethandle: "Name=Q:\CLmstr\ReceiptGLBreakdown.h"&str$(cno)&",Version=1,KFName=Q:\CLmstr\Receiptglbkdidx.h"&str$(cno)&",Use,RecL=56,KPs=1,KLn=8,Shr",internal,outin,keyed 
...
50240   if ck=2 then 
50260     let percent=gldistrec=0: let receiptkey$=gldesc$=receiptgl$=""
...
58060   open #trans:=fngethandle: "Name=Q:\CLmstr\TrMstr.h"&str$(cno)&",KFName=Q:\CLmstr\TrIdx2.h"&str$(cno)&",Shr",internal,outin,keyed 
...
58480   open #paytrans:=fngethandle: "Name=Q:\CLmstr\Paytrans.h"&str$(cno)&",KFName=Q:\CLmstr\UnPdIdx1.h"&str$(cno)&",Shr",internal,outin,keyed 
...
58700   open #unpdaloc:=fngethandle: "Name=Q:\CLmstr\UnPdAloc.h"&str$(cno)&",KFName=Q:\CLmstr\UAIdx2.h"&str$(cno)&",Shr",internal,outin,keyed 
...
62020 ERTN: let fnerror(cap$,err,line,act$,"xit")
...
64360   let percent=val(resp$(2)) ! percent
...
68020 open #receipt:=fngethandle: "Name=Q:\CLmstr\recmstr.h"&str$(cno)&",Version=1,KFName=Q:\CLmstr\recidx1.h"&str$(cno)&",REPLACE,RecL=38,KPS=1,KLN=8",internal,outin,keyed 
68040 close #receipt: 
68060 execute "Index Q:\CLmstr\Recmstr.h"&str$(cno)&" Q:\CLmstr\Recidx1.h"&str$(cno)&" 1 8 Replace DupKeys,Shr"
68080 execute "Index Q:\CLmstr\Receiptglbreakdown.h"&str$(cno)&" Q:\CLmstr\receiptglbkdidx.h"&str$(cno)&" 1 8 Replace DupKeys,Shr"
68100 return  ! /r
