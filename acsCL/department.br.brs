00010 ! Replace R:\acsCL\Department
00020 ! __Departmental breakdown file for monticello and others for claims report
00030   library 'R:\Core\Library': fntop,fnxit, fncno,fnerror,fnhamster
...
00150   open #1: "Name=Q:\CLmstr\dptmstr.h"&str$(cno)&",KFName=Q:\CLmstr\dptidx1.h"&str$(cno)&",Use,RecL=35,KPs=1,KLn=5,Shr",internal,outin,keyed 
00160   close #1: 
00170   open #1: "Name=Q:\CLmstr\dptmstr.h"&str$(cno)&",KFName=Q:\CLmstr\dptidx1.h"&str$(cno)&",Use,RecL=35,KPs=1,KLn=5,Shr",internal,outin,keyed 
00180   let fnhamster("Bank",mat lbl$,mat tln,1,mat p$,mat fltyp$,mat sln,mat mask,mat sp,mat c$)
00190   close #1: 
00200   execute "INDEX Q:\CLmstr\DPTMSTR.h"&str$(cno)&" Q:\CLmstr\DPTIDX1.h"&str$(cno)&" 1 5 Replace DupKeys -n"
00210 XIT: let fnxit
00220 ! ______________________________________________________________________
00230 ! <Updateable Region: ERTN>
00240 ERTN: let fnerror(cap$,err,line,act$,"xit")
00250   if uprc$(act$)<>"PAUSE" then goto ERTN_EXEC_ACT
00260   execute "List -"&str$(line) : pause : goto ERTN_EXEC_ACT
00270   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
