...
00136   execute "Index [Q]\CLmstr\GLmstr.H[cno]"&' '&"[Q]\GLmstr\glindex.h[cno]1 12,replace,DupKeys" ioerr L140
00140 L140: goto XIT
00150 !
00160 OPEN_FILE: ! !:
        open_file_count=0 ! this value is used in the close_file sub routine
00170   open #open_file_count+=1: "Name=[Q]\CLmstr\GLmstr.H[cno],Version=0,KFName=[Q]\CLmstr\GLIndex.h[cno],Use,RecL=62,KPs=1,KLn=12,Shr",internal,outIn,keyed 
00180   return 
00190 !
