00010 ! Replace R:\acsCL\SourceCode
00020 ! Check Book SourceCode File
...
00110   let fntop(program$,cap$="Source Code")
00120   let fncno(cno)
00130   let lbl$(1)="Source Code" !:
...
00180   open #1: "Name=Q:\CLmstr\SourceCode.dat,Version=1,KFName=R:\acsCL\SourceCode.idx,Use,RecL=26,KPs=1,KLn=1,Shr",internal,outin,keyed 
00190   close #1: 
00200   open #1: "Name=Q:\CLmstr\SourceCode.dat,Version=1,KFName=R:\acsCL\SourceCode.idx,Use,RecL=26,KPs=1,KLn=1,Shr",internal,outin,keyed 
00210   let fnhamster("SourceCode",mat lbl$,mat tln,1,mat p$,mat fltyp$,mat sln,mat mask,mat sp,mat c$)
00220 XIT: let fnxit
