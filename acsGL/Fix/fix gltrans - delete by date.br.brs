...
open #hTrans=fnH: 'Name=[Q]\GLmstr\GLTrans.h[cno],kfname=[Q]\GLmstr\glTrans-IdxAcct.h[cno],Shr',i,outIn,k
do
	dim tr(7)
	dim tr$*12
	dim td$*30
	read #hTrans,using 'form pos 1,N 3,N 6,N 3,N 6,PD 6.2,2*N 2,C 12,C 30,N 2': mat tr,tr$,td$ eof EO_hTrans
	! bad from "Remove Entries Posted by Mistake.br.brs" read #hTrans,using 'form pos 1,C 12,N 6,PD 6.2,N 2,N 2,C 12,C 30': acct$,_s,_k,mat n,l$,p$ eof EO_hTrans
