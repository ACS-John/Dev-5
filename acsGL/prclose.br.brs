...
00090 ! empty the General Ledger Payroll Checks File !:
        open #20: "Name="&env$('Q')&"\GLmstr\ACPRCKS.H"&env$('cno')&",Size=0,RecL=110,Replace",internal,output: close #20: 
00100   open #prmstr=1: "Name="&env$('Q')&"\GLmstr\PRmstr.h"&env$('cno')&",KFName="&env$('Q')&"\GLmstr\PRINDEX.h"&env$('cno')&",NoShr",internal,outin,keyed 
00110 READ_PRMSTR: ! 
