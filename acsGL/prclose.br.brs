...
00100   open #prmstr=1: "Name="&env$('Q')&"\GLmstr\PRmstr.h"&str$(cno)&",KFName="&env$('Q')&"\GLmstr\PRINDEX.h"&str$(cno)&",NoShr",internal,outin,keyed 
00110 READ_PRMSTR: ! 
...
00230 ERTN: let fnerror(program$,err,line,act$,"NO")
00240   if lwrc$(act$)<>"pause" then goto ERTN_EXEC_ACT
00250   execute "List -"&str$(line) : pause : goto ERTN_EXEC_ACT
00260   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
