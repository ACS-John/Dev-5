...
00230   let pors=1
00240   if fnps=2 then let fl1$="Name="&env$('Q')&"\GLmstr\ACGLFNSJ.h"&str$(cno)&",KFName="&env$('Q')&"\GLmstr\FNSJINDX.h"&str$(cno)&",Shr" : let mp1=72 else !:
...
01760   let pt1+=1
01770   print #255: "\qc  {\f181 \fs24 \b "&env$('cnam')&"}"
