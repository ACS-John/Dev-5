00010 ! Replace R:\acsGL\AcGlIncB6
...
00360   if fnprocess=1 or fngl_number_use_dept=0 then goto L450
...
02200   let pt1+=1
02210   print #255: "\qc  {\f181 \fs24 \b "&trim$(cnam$)&"}"
