...
00050   let fntop(program$,cap$="Add Company")
00060   on error goto ERTN
00070 ! ______________________________________________________________________
00080   dim zer(57),resp$(10)*80
00090 ! ___________________________
00100   let right=1
00120   let fncno(to_cno)
00130 ! ___________________________
00140 MENU1: ! 
00150   let fntos(sn$="GLAddCNo") !:
        let mylen=37 : let mypos=mylen+2
00160   let fnlbl(1,1,"Copy Chart of Accounts from Company:",mylen,right)
00170   let fncmbcno(1,mypos)
00180   let fncmdset(2)
...
00230   let fnCopy(env$('Q')&"\GLmstr\*.h"&str$(fro_cno),env$('Q')&"\GLmstr\*.h"&str$(to_cno))
