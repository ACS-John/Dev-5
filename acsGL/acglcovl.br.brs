00010 ! Replace R:\acsGL\AcGlCovl
00020 ! -- Edit/Print Cover Letter
00030 ! ______________________________________________________________________
00040   library 'R:\Core\Library': fntop,fnxit, fnxit,fntop, fnopenprn,fncloseprn,fnerror,fncno,fndat,fnprocess,fnpedat$,fnactpd$,fnchain
...
00130   let fndat(dat$)
00140   open #1: "Name=Q:\GLmstr\Company.h"&str$(cno)&",Shr",internal,input,relative  !:
...
00370 L370: execute "SY -s NotePad "&os_filename$("Q:\GLmstr\ACGLCovF.h"&str$(cno))
00380   goto MENU1
00390 L390: open #1: "Name=Q:\GLmstr\ACGLCovF.h"&str$(cno)&",Shr",display,input ioerr MENU1
00400   print newpage !:
...
00570 XIT: let fnchain("R:\acsGL\acglAuto")
