...
00150   if exists("[Q]\GLmstr\Schedule"&str$(schedule)&".h[cno]")=0 then goto L190
00160   if exists("[Q]\GLmstr\schedule"&str$(schedule)&"-idx.h[cno]")=0 then gosub INDEX
00170   open #open_file_count: "Name=[Q]\GLmstr\schedule"&str$(schedule)&".H[cno],KFName=[Q]\GLmstr\schedule"&str$(schedule)&"-idx.H[cno],Version=1,Shr",internal,outIn,keyed 
00180   goto L220
00190 L190: open #open_file_count: "Name=[Q]\GLmstr\schedule"&str$(schedule)&".h[cno],Version=1,Replace,RecL=12",internal,outIn 
00200   gosub CLOSE_FILE
00210   gosub INDEX
00220 L220: return 
00230 ! ______________________________________________________________________
00240 INDEX: ! 
00250   execute "Index [Q]\GLmstr\schedule"&str$(schedule)&".H[cno]"&' '&"[Q]\GLmstr\schedule"&str$(schedule)&"-idx.h[cno]" &" 1 12 Replace,DupKeys"
00260   return 
