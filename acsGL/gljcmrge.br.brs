...
00150   open #2: "Name=[Q]\PRmstr\JCCAT.H[cno],KFName=[Q]\PRmstr\CatIndx.h[cno],Shr",internal,outIn,keyed 
00160   open #3: "Name=[Q]\GLmstr\GL_Work_"&env$('acsUserId')&".h[cno]",internal,input 
