...
! GL Payroll File Menu
	...
	dim l4$(4)*25,l5$(4)*11,mp(4,36),dat$*20,cnam$*40,pr$(21),td$*25
...
L1340: open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],SIZE=0,RecL=280,Replace",internal,output
	close #2: ioerr L1360
L1360: fnFree("[Q]\GLmstr\PRIndex.h[cno]")
...
HDR: !
	pr #255,using L1990: date$('mm/dd/yy'),cnam$
...
MSGBOX4: !
	mat ml$(4) : _
	ml$(1)="Gross pay ("&trim$(cnvrt$("pic(zzzz,zzz.##)",prd(3)))&") less withholding " : _
