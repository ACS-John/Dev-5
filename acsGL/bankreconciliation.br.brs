...
00150   if exists("[Q]\GLmstr\bankrec.H[cno]")=0 then goto L190
00160   if exists("[Q]\GLmstr\glstdidx.h[cno]")=0 then gosub INDEX
00170   open #open_file_count: "Name=[Q]\GLmstr\bankrec.H[cno],KFName=[Q]\GLmstr\bankrec-idx.H[cno],Version=1,Shr",internal,outIn,keyed 
00180   goto L220
00190 L190: open #open_file_count: "Name=[Q]\GLmstr\bankrec.h[cno],Version=1,Replace,RecL=91",internal,outIn 
00200   gosub CLOSE_FILE
00210   gosub INDEX
00220 L220: return 
00230 ! ______________________________________________________________________
00240 INDEX: ! 
00250   execute "Index [Q]\GLmstr\bankrec.H[cno]"&' '&"[Q]\GLmstr\bankrec-idx.h[cno]" &" 79/3/4 12/1/8 Replace,DupKeys"
00260   return 
