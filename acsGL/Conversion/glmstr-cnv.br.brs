...
00110 ! 
00120   execute "Copy "&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')&" Work."&session$&" -416" ioerr L220
00130   execute "COPY  Work."&session$&' '&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')
00140   open #1: "Name="&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')&",KFName="&env$('Q')&"\GLmstr\GLIndex.h"&env$('cno'),internal,outin,keyed 
...
00190   goto L150
00200 END1: close #1: 
00210   execute "Index "&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')&' '&env$('Q')&"\GLmstr\GLIndex.h"&env$('cno')&" 1 12 REPLACE DupKeys"
00220 L220: ! Goto 30
