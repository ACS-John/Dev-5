...
00190   pr newpage
00200   pr f "10,5,C 60": "CONVERSION FOR COMPANY #[cno] IN PROCESS"
00210 ! 
00220   fnputcno(cno)
00230   open #2: "Name=[Q]\GLmstr\GLmstr.h[cno],KFName=[Q]\GLmstr\GLIndex.h[cno]",internal,outIn,keyed 
00240   open #1: "Name=[Q]\GLmstr\GLmstr.h[cno],Replace,RecL=338",internal,output 
...
00310   open #2: "Name=[Q]\GLmstr\ACGLTRAN.h[cno]",internal,input,relative 
00320   open #1: "Name=[Q]\GLmstr\GLTrans.h[cno],Replace,RecL=73",internal,outIn,relative 
...
00400   open #1: "Name=[Q]\GLmstr\ACGLPGMN.h[cno],Replace,RecL=58",internal,outIn,relative 
00410   for j=1 to 20
00420     write #1,using L430,rec=j: "","",0,0,0
00430 L430: form pos 1,c 20,c 35,3*n 1
00440   next j
00450   close #1: 
00460   open #2: "Name=[Q]\GLmstr\PRmstr.h[cno]",internal,outIn,relative ioerr L550
00470   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],Replace,RecL=190",internal,output 
...
00560   open #1: "Name=[Q]\GLmstr\Company.h[cno]",internal,outIn,relative 
...
00590   close #1,free: 
00600   open #1: "Name=[Q]\GLmstr\Company.h[cno],SIZE=0,RecL=512",internal,outIn,relative 
00610   open #2: "Name=[Q]\GLmstr\PRGLNUMB.h[cno]",internal,input ioerr L650
00620   read #2,using L630: mat prgl
00630 L630: form pos 1,21*pd 4
00640   close #2,free: 
00650 L650: open #2: "Name=[Q]\GLmstr\GLREC.h[cno]",internal,input ioerr L690
00660   read #2,using L670: reccode
00670 L670: form pos 1,n 1
00680   close #2,free: 
00690 L690: open #2: "Name=S:\acsGL\ACGLCODE.H[cno]",internal,input ioerr L730
00700   read #2,using L710: c1,c2
00710 L710: form pos 1,n 1,n 2
00720   close #2,free: 
00730 L730: open #2: "Name=[Q]\GLmstr\ACGLDATE.h[cno]",internal,input 
...
00790   close #1: 
00800   open #1: "Name=[Q]\GLmstr\GLBREC.h[cno],NoShr",internal,input ioerr L820
00810   close #1,free: 
00820 L820: open #1: "Name=[Q]\GLmstr\GLBREC.h[cno],size=0,RecL=68,Shru",internal,outIn,relative 
00830   close #1: 
00840   gosub L920 ! CONVERT VENDOR FILES
00850   execute "Index [Q]\GLmstr\GLmstr.h[cno]"&' '&"[Q]\GLmstr\GLIndex.h[cno] 1 12 Replace DupKeys -n"
00860   execute "Index [Q]\GLmstr\GL1099.h[cno]"&' '&"[Q]\GLmstr\GL109IDX.h[cno] 1 8 Replace DupKeys -n"
00870   fnindex_it("[Q]\GLmstr\GLBREC.h[cno]","[Q]\GLmstr\GLRecIdx.h[cno]","1 24")
...
00940   close #2,free: 
00950 L950: open #2: "Name=[Q]\GLmstr\GLTR1099.H[cno],SIZE=0,RecL=64,NoShr",internal,outIn,relative 
00960   write #2,using L1000,rec=1: "",0,0,"","",1
00970   open #1: "Name=[Q]\GLmstr\GL1099N.H[cno],KFName=[Q]\GLmstr\GL109IDX.h[cno]",internal,outIn,keyed ioerr L990
00980   close #1,free: 
00990 L990: open #1: "Name=[Q]\GLmstr\GL1099N.H[cno],size=0,RecL=127,NoShr",internal,outIn,relative 
...
01360   close #1: 
01370   close #2: 
01380   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],KFName=[Q]\GLmstr\PRIndex.h[cno]",internal,outIn,keyed ioerr L1580
01390   open #2: "Name=[Q]\GLmstr\ACPRCKS.h[cno]",internal,outIn,relative ioerr L1580
01400   pr newpage
...
01570   close #2: 
01580 L1580: ! 
01590   open #1: "Name=[Q]\GLmstr\AcTrans.h[cno]",internal,input,relative ioerr L1740
...
01690   close #1,free: 
01700   close #2: 
01710   execute "Rename X [Q]\GLmstr\AcTrans.h[cno]"
01720   execute "Index [Q]\GLmstr\AcTrans.h[cno]"&' '&"[Q]\GLmstr\AcTrIdx.h[cno] 1/71/17/13 12/2/2/4 Replace DupKeys"
...
01760   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],KFName=[Q]\GLmstr\PRIndex.h[cno]",internal,outIn,keyed ioerr L1940
...
01900   execute "Index [Q]\GLmstr\PRmstr.h[cno],[Q]\GLmstr\PRIndex.h[cno],1,4,Replace,DupKeys"
01910   fnputcno(cno)
01920   open #1: "Name=[Q]\GLmstr\ACPRCKS.h[cno],RecL=110,Replace",internal,output 
01930   close #1: 
01940 L1940: open #1: "Name=[Q]\GLmstr\Company.h[cno]",internal,outIn,relative ioerr L1990
...
02070   for j=1 to 6
02080     execute "Copy [Q]\GLmstr\"&fil$(j)&".h[cno] "&env$('Temp')&"\Work."&session$&" -83" ioerr L2360
02090     execute "COPY  "&env$('Temp')&"\Work."&session$&' '&"[Q]\GLmstr\"&fil$(j)&".h[cno]"
02100     if j=2 or j=5 then goto L2110 else goto L2360
02110 L2110: open #1: "Name=[Q]\GLmstr\"&fil$(j)&".h[cno],KFName=[Q]\GLmstr\"&idx$(j)&".h[cno]",internal,outIn,keyed 
