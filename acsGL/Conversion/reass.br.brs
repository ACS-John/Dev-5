...
00280 END1: close #1: 
00290   close #2: 
00300   execute "COPY "&env$('Temp')&"\Work."&session$&", "&env$('Q')&"\GLmstr\PRmstr.h"&env$('cno')&"/ -n"
00310   execute "Index "&env$('Q')&"\GLmstr\PRmstr.h"&env$('cno')&","&env$('Q')&"\GLmstr\PRIndex.h"&env$('cno')&",1,4,Replace,DupKeys -n"
00320   fnputcno(cno)
