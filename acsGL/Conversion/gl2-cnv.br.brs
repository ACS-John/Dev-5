...
00150   pr newpage
00160   pr f "10,5,C 60": "CONVERSION FOR COMPANY #[cno] IN PROCESS"
00170 ! 
00180   rewrite #1,using L190,rec=1: cno
00190 L190: form pos 1,n 2
00200   close #1: 
00210   open #2: "Name=[Q]\GLmstr\GLmstr.h[cno],KFName=[Q]\GLmstr\GLIndex.h[cno]",internal,outIn,keyed 
00220   open #1: "Name=[Q]\GLmstr\GLmstr.h[cno],REPLACE,RecL=338",internal,output 
...
00290   open #2: "Name=[Q]\GLmstr\ACGLTRAN.h[cno]",internal,input,relative 
00300   open #1: "Name=[Q]\GLmstr\GLTrans.h[cno],REPLACE,RecL=73",internal,outIn,relative 
...
00380   open #1: "Name=[Q]\GLmstr\ACGLPGMN.h[cno],REPLACE,RecL=58",internal,outIn,relative 
00390   for j=1 to 20
00400     write #1,using L410,rec=j: "","",0,0,0
00410 L410: form pos 1,c 20,c 35,3*n 1
00420   next j
00430   close #1: 
00440   open #2: "Name=[Q]\GLmstr\PRmstr.h[cno]",internal,outIn,relative ioerr L530
00450   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],REPLACE,RecL=190",internal,output 
...
00540   open #1: "Name=[Q]\GLmstr\Company.h[cno]",internal,outIn,relative 
...
00570   close #1,free: 
00580   open #1: "Name=[Q]\GLmstr\Company.h[cno],SIZE=0,RecL=512",internal,outIn,relative 
00590   open #2: "Name=[Q]\GLmstr\PRGLNUMB.h[cno]",internal,input ioerr L630
00600   read #2,using L610: mat prgl
00610 L610: form pos 1,21*pd 4
00620   close #2,free: 
00630 L630: open #2: "Name=[Q]\GLmstr\GLREC.h[cno]",internal,input ioerr L670
00640   read #2,using L650: reccode
00650 L650: form pos 1,n 1
00660   close #2,free: 
00670 L670: open #2: "Name=S:\acsGL\ACGLCODE.H[cno]",internal,input ioerr L710
00680   read #2,using L690: c1,c2
00690 L690: form pos 1,n 1,n 2
00700   close #2,free: 
00710 L710: open #2: "Name=[Q]\GLmstr\ACGLDATE.h[cno]",internal,input 
...
00770   close #1: 
00780   open #1: "Name=[Q]\GLmstr\GLBREC.h[cno],NoShr",internal,input ioerr L800
00790   close #1,free: 
00800 L800: open #1: "Name=[Q]\GLmstr\GLBREC.h[cno],size=0,RecL=68,Shru",internal,outIn,relative 
00810   close #1: 
00820   gosub L890 ! CONVERT VENDOR FILES
00830   execute "Index [Q]\GLmstr\GLmstr.h[cno]"&' '&"[Q]\GLmstr\GLIndex.h[cno] 1 12 REPLACE DupKeys"
00840   execute "Index [Q]\GLmstr\GL1099.h[cno]"&' '&"[Q]\GLmstr\GL109IDX.h[cno] 1 8 REPLACE DupKeys"
00850   fnindex_it("[Q]\GLmstr\GLBREC.h[cno]","[Q]\GLmstr\GLRecIdx.h[cno]","1 24")
00860   execute "Index [Q]\GLmstr\PRmstr.h[cno]"&' '&"[Q]\GLmstr\PRIndex.h[cno] 1 4 REPLACE DupKeys" ioerr L870
00870 L870: execute "Index [Q]\GLmstr\GL1099.h[cno]"&' '&"[Q]\GLmstr\GL109IDX.h[cno] 1 8 REPLACE DupKeys"
00880   goto L1130
00890 L890: open #3: "Name=[Q]\GLmstr\GL1099.h[cno],KFName=[Q]\GLmstr\GL109IDX.h[cno]",internal,outIn,keyed 
00900   open #2: "Name=[Q]\GLmstr\GLTR1099.H[cno]",internal,outIn,relative ioerr L920
00910   close #2,free: 
00920 L920: open #2: "Name=[Q]\GLmstr\GLTR1099.H[cno],SIZE=0,RecL=64,NoShr",internal,outIn,relative 
00930   write #2,using L970,rec=1: "",0,0,"","",1
00940   open #1: "Name=[Q]\GLmstr\GL1099N.H[cno],KFName=[Q]\GLmstr\GL109IDX.h[cno]",internal,outIn,keyed ioerr L960
00950   close #1,free: 
00960 L960: open #1: "Name=[Q]\GLmstr\GL1099N.H[cno],size=0,RecL=127,NoShr",internal,outIn,relative 
...
01100 L1100: execute "Copy [Q]\GLmstr\GL1099N.H[cno]"&' '&"[Q]\GLmstr\GL1099.h[cno]"
01110   fnFree("[Q]\GLmstr\GL1099N.H[cno]")
01120   return 
01130 L1130: ! REASS.CNV
01140   open #1: "Name=[Q]\GLmstr\GLmstr.h[cno],KFName=[Q]\GLmstr\GLIndex.h[cno]",internal,outIn,keyed 
01150   open #2: "Name=[Q]\GLmstr\GLTrans.h[cno]",internal,outIn,relative 
01160   pr newpage
...
01320   close #1: 
01330   close #2: 
01340   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],KFName=[Q]\GLmstr\PRIndex.h[cno]",internal,outIn,keyed ioerr L1540
01350   open #2: "Name=[Q]\GLmstr\ACPRCKS.h[cno]",internal,outIn,relative ioerr L1540
01360   pr newpage
...
01530   close #2: 
01540 L1540: ! 
01550   open #1: "Name=[Q]\GLmstr\AcTrans.h[cno]",internal,input,relative ioerr L1690
...
01650   close #1,free: 
01660   close #2: 
01670   execute "Rename X [Q]\GLmstr\AcTrans.h[cno]"
01680   execute "Index [Q]\GLmstr\AcTrans.h[cno]"&' '&"[Q]\GLmstr\AcTrIdx.h[cno] 1/71/17/13 12/2/2/4 REPLACE DupKeys"
01690 L1690: ! S:\acsGL\PRmstr.CNV
01700   dim pr1$*90,pr1(18),pr2(36)
01710   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],KFName=[Q]\GLmstr\PRIndex.h[cno]",internal,outIn,keyed ioerr L1910
...
01810 END1: close #1: 
01820   close #2: 
01830   execute "COPY "&env$('Temp')&"\Work."&session$&", [Q]\GLmstr\PRmstr.h[cno]"
01840   execute "Index [Q]\GLmstr\PRmstr.h[cno],[Q]\GLmstr\PRIndex.h[cno],1,4,REPLACE,DupKeys"
01850   open #1: "Name=CNO.H"&wsid$,internal,outIn,relative 
01860   rewrite #1,using L1870,rec=1: cno
01870 L1870: form pos 1,n 2
01880   close #1: 
01890   open #1: "Name=[Q]\GLmstr\ACPRCKS.h[cno],RecL=110,REPLACE",internal,output 
01900   close #1: 
01910 L1910: open #1: "Name=[Q]\GLmstr\Company.h[cno]",internal,outIn,relative ioerr L1960
...
02040   for j=1 to 6
02050     execute "Copy [Q]\GLmstr\"&fil$(j)&".h[cno] "&env$('Temp')&"\Work."&session$&" -83" ioerr L2300
02060     execute "COPY  "&env$('Temp')&"\Work."&session$&' '&"[Q]\GLmstr\"&fil$(j)&".h[cno]"
02070     if j=2 or j=5 then goto L2080 else goto L2300
02080 L2080: open #1: "Name=[Q]\GLmstr\"&fil$(j)&".h[cno],KFName=[Q]\GLmstr\"&idx$(j)&".h[cno]",internal,outIn,keyed 
