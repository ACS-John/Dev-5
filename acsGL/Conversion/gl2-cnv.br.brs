...
00150   pr newpage
00160   pr f "10,5,C 60": "CONVERSION FOR COMPANY #"&env$('cno')&" IN PROCESS"
00170 ! 
...
00620   close #2,free: 
00630 L630: open #2: "Name="&env$('Q')&"\GLmstr\GLREC.h"&env$('cno')&"",internal,input ioerr L670
00640   read #2,using L650: reccode
00650 L650: form pos 1,n 1
00660   close #2,free: 
00670 L670: open #2: "Name=S:\acsGL\ACGLCODE.H"&env$('cno')&"",internal,input ioerr L710
00680   read #2,using L690: c1,c2
00690 L690: form pos 1,n 1,n 2
00700   close #2,free: 
00710 L710: open #2: "Name="&env$('Q')&"\GLmstr\ACGLDATE.h"&env$('cno')&"",internal,input 
...
00840   execute "Index "&env$('Q')&"\GLmstr\GL1099.h"&env$('cno')&' '&env$('Q')&"\GLmstr\GL109IDX.h"&env$('cno')&" 1 8 REPLACE DupKeys"
...
01100 L1100: execute "Copy "&env$('Q')&"\GLmstr\GL1099N.H"&env$('cno')&' '&env$('Q')&"\GLmstr\GL1099.h"&env$('cno')
...
01530   close #2: 
01540 L1540: ! 
01550   open #1: "Name="&env$('Q')&"\GLmstr\AcTrans.h"&env$('cno'),internal,input,relative ioerr L1690
...
01650   close #1,free: 
01660   close #2: 
01670   execute "Rename X "&env$('Q')&"\GLmstr\AcTrans.h"&env$('cno')
