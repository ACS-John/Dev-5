00010 ! Replace R:\acsGL\Conversion\GLmstr-338-416
00011 ! convert Q:\GLmstr from RECL 338 to RECL 416 Format
10000   def library fnglmstr_338_416
10020     library 'R:\Core\Library': fntop, fnerror,fncno,fnacglblds,fnstatus,fncopy,fnindex_it
...
10420 ! 
10440     let fncopy("Q:\GLmstr\GLmstr.h"&str$(cno),"Q:\GLmstr\GLmstr.h"&str$(cno),416) ! &" -416 -n"
10460     let stopable$="NO"
10520     open #1: "Name=Q:\GLmstr\GLmstr.h"&str$(cno)&",KFName=Q:\GLmstr\GLIndex.h"&str$(cno),internal,outin,keyed 
10540     do 
...
10660 DONE: ! 
10680     close #1: 
10700     let fnindex_it("Q:\GLmstr\GLmstr.h"&str$(cno),"Q:\GLmstr\glIndex.h"&str$(cno),"1 12")
...
10800 ERTN: let fnerror(cap$,err,line,act$,stopable$)
10820     if uprc$(act$)<>"PAUSE" then goto ERTN_EXEC_ACT
10840     execute "List -"&str$(line) : pause : goto ERTN_EXEC_ACT
10860     print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
