...
00230     open #1: "Name="&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')&",Size=0,RecL=416,Replace",internal,output 
00240     close #1: 
00250     open #1: "Name="&env$('Q')&"\GLmstr\glTrans.h"&env$('cno')&",Size=0,RecL=73,Replace",internal,output 
...
00320     for j=1 to 20 !:
          ...
          next j
00330     close #1: 
00340     open #1: "Name="&env$('Q')&"\GLmstr\gl1099.h"&env$('cno'),internal,output ioerr L370
00350     close #1: 
00360     goto L390
00370 L370: open #1: "Name="&env$('Q')&"\GLmstr\gl1099.h"&env$('cno')&",Size=0,RecL=127",internal,output 
00380     close #1: 
00390 L390: open #1: "Name="&env$('Q')&"\GLmstr\glTr1099.h"&env$('cno'),internal,output ioerr L420
00400     close #1: 
00410     goto L460
00420 L420: open #1: "Name="&env$('Q')&"\GLmstr\glTr1099.h"&env$('cno')&",Size=0,RecL=64",internal,output,relative 
00430     write #1,using L440,rec=1: "",0,0,"","",1
00440 L440: form pos 1,c 8,n 6,pd 5.2,c 12,c 30,pd 3
00450     close #1: 
00460 L460: open #1: "Name="&env$('Q')&"\GLmstr\glBRec.h"&env$('cno'),internal,output ioerr L490
00470     close #1: 
00480     goto L510
00490 L490: open #1: "Name="&env$('Q')&"\GLmstr\glBRec.h"&env$('cno')&",Size=0,RecL=68",internal,output 
00500     close #1: 
00510 L510: open #1: "Name="&env$('Q')&"\GLmstr\PRmstr.h"&env$('cno'),internal,output ioerr L530
00520     goto L540
00530 L530: open #1: "Name="&env$('Q')&"\GLmstr\PRmstr.h"&env$('cno')&",Size=0,RecL=280",internal,output 
00540 L540: close #1: 
00550     open #1: "Name="&env$('Q')&"\GLmstr\acPrCks.h"&env$('cno'),internal,output ioerr L570
00560     goto L580
00570 L570: open #1: "Name="&env$('Q')&"\GLmstr\acPrCks.h"&env$('cno')&",Size=0,RecL=110",internal,output,relative 
00580 L580: close #1: 
00590     execute "Index "&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')&' '&env$('Q')&"\GLmstr\GLIndex.h"&env$('cno')&" 1 12 Replace DupKeys -n"
00600     execute "Index "&env$('Q')&"\GLmstr\GLmstr.h"&env$('cno')&' '&env$('Q')&"\GLmstr\glIndx2.h"&env$('cno')&" 13 30 Replace DupKeys -n"
00610     execute "Index "&env$('Q')&"\GLmstr\gl1099.h"&env$('cno')&' '&env$('Q')&"\GLmstr\gl109Idx.h"&env$('cno')&" 1 8 Replace DupKeys -n"
00620     fnindex_it(env$('Q')&"\GLmstr\GLBREC.h"&env$('cno'),env$('Q')&"\GLmstr\GLRecIdx.h"&env$('cno'),"1 24")
00630     execute "Index "&env$('Q')&"\GLmstr\PRmstr.h"&env$('cno')&' '&env$('Q')&"\GLmstr\PRINDEX.h"&env$('cno')&" 1 4 Replace DupKeys -n"
00640     execute "Index "&env$('Q')&"\GLmstr\AcTrans.h"&env$('cno')&' '&env$('Q')&"\GLmstr\AcTrIdx.h"&env$('cno')&" 1/71/17/13 12/2/2/4 Replace DupKeys -n"
