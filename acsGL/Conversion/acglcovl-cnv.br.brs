...
00100   open #1: "Name="&env$('Q')&"\GLmstr\ACGLCovF.h"&str$(cno)&",Shr",internal,outin,relative 
...
00140   print #2,using L130: mat ln$
00150   goto L120
00160 L160: close #1: : close #2: 
00170   execute "copy test "&env$('Q')&"\GLmstr\ACGLCovF.h"&str$(cno)
00180 L180: let fnxit
00190   goto L240
00200   print newpage
00210   if err=4148 then print fields "23,1,C 80,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L230
00220   goto L240
00230 L230: print fields "23,1,C 80,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00240 L240: print fields "24,1,C 80,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00250   input fields "24,60,C 1,N": quitcode$
00260   if rtrm$(uprc$(quitcode$))="Q" then goto L300
00270   print fields "23,1,C 80,N": ""
00280   print fields "24,1,C 80,N": ""
00290   retry 
