...
00140   if ce>0 then io1$(ce)(ce1:ce2)="U": ce=0
00150   if cmdkey>0 then goto L220 else ce=curfld
00160 L160: ce=ce+1: if ce>udim(io1$) then ce=1
00170 L170: io1$(ce)=rtrm$(uprc$(io1$(ce))) : ce1=pos(io1$(ce),"U",1) : if ce1=0 then goto L160
00180   ce2=ce1+1 : io1$(ce)(ce1:ce1)="UC" : goto L130
00190 CONV1: if ce>0 then io1$(ce)(ce1:ce2)="U"
00200   ce=cnt+1
