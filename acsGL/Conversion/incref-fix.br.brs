...
00100   print fields "11,11,C 40": "ENTER THE COMPANY # WITH GOOD NUMBERS:"
00110   print fields "12,11,C 40": "ENTER THE COMPANY # TO BE CHANGED:"
00120   print fields "14,13,C 34,R,N": "PRESS F1 TO CONTINUE OR F5 TO STOP"
00130 L130: input fields mat io1$,attr "R": cn1,cn2 conv CONV1
00140   if ce>0 then let io1$(ce)(ce1:ce2)="U": let ce=0
00150   if cmdkey>0 then goto L220 else let ce=curfld
00160 L160: let ce=ce+1: if ce>udim(io1$) then let ce=1
00170 L170: let io1$(ce)=rtrm$(uprc$(io1$(ce))) : let ce1=pos(io1$(ce),"U",1) : if ce1=0 then goto L160
00180   let ce2=ce1+1 : let io1$(ce)(ce1:ce1)="UC" : goto L130
00190 CONV1: if ce>0 then let io1$(ce)(ce1:ce2)="U"
00200   let ce=cnt+1
00210 ERR1: print fields "24,78,C 1": bell : goto L170
