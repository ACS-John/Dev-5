...
00150   close #2,free: 
00160 L160: open #2: "Name="&env$('Q')&"\GLmstr\GLmstr.h"&str$(cno)&",SIZE=0,RecL=416",internal,output 
...
00230 END1: close #1: 
00240   close #2: 
00250   execute "Index "&env$('Q')&"\GLmstr\GLmstr.h"&str$(cno)&' '&env$('Q')&"\GLmstr\GLIndex.h"&str$(cno)&" 1 12 Replace DupKeys -n"
00260   goto XIT
