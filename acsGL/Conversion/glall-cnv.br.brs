...
00120 ! 
00130   open #1: "Name=[Q]\GLmstr\AcTrans.h[cno]",internal,input ioerr L260
...
00280   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],KFName=[Q]\GLmstr\PRIndex.h[cno]",internal,outIn,keyed ioerr L480
...
00380 END3: close #1: 
00390   close #2: 
00400   execute "COPY "&env$('Temp')&"\Work."&session$&", [Q]\GLmstr\PRmstr.h[cno]"
00410   execute "Index [Q]\GLmstr\PRmstr.h[cno],[Q]\GLmstr\PRIndex.h[cno],1,4,REPLACE,DupKeys"
00420   open #1: "Name=CNO.H"&wsid$,internal,outIn,relative 
00430   rewrite #1,using L440,rec=1: cno
00440 L440: form pos 1,n 2
00450   close #1: 
00460   open #1: "Name=[Q]\GLmstr\ACPRCKS.h[cno],SIZE=0,RecL=110,REPLACE",internal,output 
00470   close #1: 
00480 L480: close #1: ioerr L490
00490 L490: open #1: "Name=[Q]\GLmstr\Company.h[cno]",internal,outIn,relative ioerr L560
...
00580   id$(1)=" 1 = BALANCE SHEET FILE": fil$(1)="ACGLFNSB": idx$(1)="FNSBINDX"
00590   id$(2)=" 2 = INCOME STATEMENT FILE": fil$(2)="ACGLFNSI": idx$(2)="FNSIINDX"
00600   id$(3)=" 3 = FUND STMT / CASH FLOW FILE": fil$(3)="ACGLFNSF": idx$(3)="FNSFINDX"
00610   id$(4)=" 4 = SECONDARY BALANCE SHEET FILE": fil$(4)="ACGLFNSC": idx$(4)="FNSCINDX"
00620   id$(5)=" 5 = SECONDARY INCOME STATEMENT FILE": fil$(5)="ACGLFNSJ": idx$(5)="FNSJINDX"
00630   id$(6)=" 6 = SECONDARY FUND / CASH FLOW FILE": fil$(6)="ACGLFNSG": idx$(6)="FNSGINDX"
00640   pr newpage
00650   for j=1 to 6
00660     execute "Copy [Q]\GLmstr\"&fil$(j)&".h[cno] "&env$('Temp')&"\Work."&session$&" -83" ioerr L950
00670     execute "COPY  "&env$('Temp')&"\Work."&session$&' '&"[Q]\GLmstr\"&fil$(j)&".h[cno]"
00680     if j=2 or j=5 then goto L690 else goto L950
00690 L690: open #1: "Name=[Q]\GLmstr\"&fil$(j)&".h[cno],KFName=[Q]\GLmstr\"&idx$(j)&".h[cno]",internal,outIn,keyed 
