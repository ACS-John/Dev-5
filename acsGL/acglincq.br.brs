...
00740 L740: if ir=val(r$) then total=total+(cb-bb) else goto L780
00750   total2=total2+cb
00760   k$=cnvrt$("N 5",pcr)
00770   goto L640
00780 L780: if ir<val(r$) then goto L640
00790   if ir>val(r$) then goto L810
00800 L800: notrans=1
...
00850 L850: next j
00860   if rs=1 then total=-total else goto L880
00870   total2=-total2
...
01060   if ds=1 then dollar$="$" else dollar$=" "
01070   sp2=49-sp-1
...
01120   goto L470
01130 L1130: if te$="R" then report$=d$
...
01340   goto L1440
01350 L1350: fnpglen(pglen)
01360 ! If PGLEN<>42 Then pGLEN=58
...
01990   pc3=round(((total-pc2)/total)*100,0)
02000   if pc3<-999 or pc3>9999 then pc3=0
