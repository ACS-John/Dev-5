...
00310 L310: print newpage
00320   close #2: ioerr L330 ! close any reference file that is opened
00330 L330: let win=101
00340   let cap$='Create Type "D" Records' ! use correct name above for printing
00350   let fnwin3b(win,cap$,14,75,0,2,5,2)
00360   print #win: newpage
00370 L370: print #win,fields "2,1,Cc 75,R,N": 'Create "D" records for a range of general ledger numbers'
00380   print #win,fields "4,32,Cc 14,N": "From"
00390   print #win,fields "4,50,Cc 14,N": "To"
00400   print #win,fields "5,2,Cr 28,N": "Range of General Ledger #s:"
00410   print #win,fields "7,1,Cc 75,R,N": "Type of G/L Accounts Being Selected (Only one type at a time!)"
00420   print #win,fields "8,2,Cr 65,N": "A (Asset),L (Liability),Q (Equity),I (Income), E (Expense:"
00430   print #win,fields "10,2,Cr 46,N": "Starting Financial Statement Reference Number:"
00440   print #win,fields "10,1,Cc 75,r,N": "Type of Financial Statement Being Designed"
00450   print #win,fields "11,2,Cr 70,N": "1=Balance Sheet, 2=2nd B/S, 3=I/C, 4=2nd I/C, 5=Fund, 6=2nd Fund:"
00460   print #win,fields "13,2,Cr 46,N": "Starting Financial Statement Reference Number:"
...
00530   goto L520
00540 L540: print #win,fields io1$(9): rno+20
00550 L550: if cmdkey>0 then goto L620 else let ce=curfld+1
00560   if ce>udim(io1$) then let ce=1
00570 L570: let io1$(ce)=rtrm$(uprc$(io1$(ce))) : let ce1=pos(io1$(ce),"U",9)
00580   let ce2=ce1+1 : let io1$(ce)(ce1:ce1)="UC" : goto L370
...
00650   if gln(1,2)=0 then let ce=1: goto ERR1
00660   if gln(2,2)=0 then let ce=4: goto ERR1
...
00690   if gl1=0 then let ce=1: goto ERR1
00700   if gl2=0 then let ce=4: goto ERR1
00710   let gf=gl3-gl1
00720   let glk$=lpad$(str$(gln(1,1)),3)&lpad$(str$(gln(1,2)),6)&lpad$(str$(gln(1,3)),3)
00730   if fin=0 then let ce=8: goto ERR1
00740   if uprc$(type$)="A" or uprc$(type$)="L" or uprc$(type$)="Q" or uprc$(type$)="I" or uprc$(type$)="E" then goto L750 else let ce=7: goto ERR1
00750 L750: if fs<1 or fs>5 then let ce=9: goto ERR1
00760 ! ______________________________________________________________________
00770   print #101: newpage
00780   print #win,fields "5,1,Cc 75,N": "Please wait..."
00790   let ff=20 ! incrument reference numbers
00800   let te$="D" ! all detail records
00810   let ac(1)=3 ! indent all d records to position 3
00820   let rno=fin
...
00900   if type$="A" or type$="E" then let ac(5)=0 else let ac(5)=1 !:
