...
autoLibrary
fnTop(program$,'Financial Statement')
on error goto Ertn
! r: initialize stuff
...
Screen1: ! r:
	...
	L330: !
	fnwin3b(win=101,'Create Type "D" Records',14,75,0,2,5,2)
	pr #win: newpage
	L370: !
	pr #win,fields '2,1,Cc 75,R,N': 'Create "D" records for a range of general ledger numbers'
	...
	open #2: 'Name=[Q]\GLmstr\'&fil$(fs)&'.h[cno],KFName=[Q]\GLmstr\'&idx$(fs)&'.h[cno],Shr',i,outIn,k
	do
		read #2,using L920: rno eof L540
	loop
	L540: !
	pr #win,fields io1$(9): rno+20
	L550: !
	if cmdkey>0 then goto L620 else ce=curfld+1
	if ce>udim(io1$) then ce=1
	L570: !
	io1$(ce)=rtrm$(uprc$(io1$(ce))) : ce1=pos(io1$(ce),'U',9)
	ce2=ce1+1 : io1$(ce)(ce1:ce1)='UC' : goto L370
	CONV1: !
	if ce>0 then io1$(ce)(ce1:ce2)='U'
	ce=cnt+1
	ERR1: !
	pr f '24,78,C 1': bell : goto L570
	L620: !
	...
	L750: !
	if fs<1 or fs>5 then ce=9: goto ERR1
goto Process ! /r
Process: ! r:
	pr #101: newpage
...
Xit: !
fnChain('General Ledger\Financial Statement Design')
include: ertn
