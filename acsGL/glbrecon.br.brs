...
00200   let sc2$(4)="4. Enter Cleared Checks"
00210   let sc2$(5)="5. Print Bank Reconciliation"
00220   let sc2$(6)="6. Listing of Checks"
00230   let sc2$(7)="7. Change Bank Account Number"
00240   let fl2$(3)="6,2,C 38,C,N"
00250   let flo2$(1)="5,31,C 3,UT,N"
00260   let flo2$(2)="5,35,C 6,UT,N"
00270   let flo2$(3)="5,42,C 3,UT,N"
00280   let sc$(1)="5,21,G 3,UT,N"
00290   let sc$(2)="5,25,G 6,UT,N"
00300   let sc$(3)="5,32,G 3,UT,N"
00310   let sc$(4)="6,23,c 12,UT,N"
00320   let sc$(5)="7,16,C 30,UT,N"
00330   let sc$(6)="8,22,C 2,UT,N"
00340   let sc$(7)="9,22,N 6,UT,N"
00350   let sc$(8)="10,22,N 10.2,UT,N"
00360   let sc$(9)="11,31,N 1,UT,N"
00370   for j=1 to 7: let sd$(j)=str$(j+4)&",9,C 20" : next j
00380   let se$(1)="G/L Number:"
00390   let se$(2)="Check Number:"
00400   let se$(3)="Payee:"
00410   let se$(4)="Source:"
00420   let se$(5)="Date:"
00430   let se$(6)="Amount:"
00440   let se$(7)="Cleared Bank (1=YES)"
00450 OPEN_FILES: ! 
...
00510   print #101,fields "1,1,Cc 40,R,N": cnam$
00520   print #101,fields "2,1,Cc 40,R,N": "Company Number "&str$(cno)
00530   print fields "14,35,C 09,B,5": "Exit (F5)"
00540   rinput #101,select mat fl2$,attr "H": mat sc2$
00550   let scode=curfld
...
00620   print #101,fields "1,1,Cc 40,R,N": cnam$
00630   print #101,fields "2,1,Cc 40,R,N": "Company Number "&str$(cno)
00640   print #101,fields "4,1,Cc 40,R,N": "* * *   WARNING   * * *"
00650   print #101,fields "5,1,Cc 40,N": "This selection will destroy all"
00660   print #101,fields "6,1,Cc 40,N": "existing Bank Reconciliation records"
00670   print fields "16,34,C 11,B,5": "Cancel (F5)"
00680   print #101,fields "8,2,C 24,N": "Enter ERASE to continue:"
...
00810 L810: let sf$(1)="11,10,N 3,UT,N"
00820   let sf$(2)="11,14,N 6,UT,N"
00830   let sf$(3)="11,21,N 3,UT,N"
00840   let sf$(4)="11,30,C 12,CUE,N"
00850   print newpage
...
00880   print #101: newpage
00890   print fields mat sf$: val(currgl$(1:3)),val(currgl$(4:9)),val(currgl$(10:12)),""
00900   print fields "10,10,C 14,R,N": "Bank GL Number"
00910   print fields "10,30,C 12,R,N": "Check Number"
00920   print fields "13,35,C 09,B,5": "Stop (F5)"
00930 L930: input fields mat sf$: gl1,gl2,gl3,c$ conv L930
00940   if cmdkey=5 then goto L480
00950   let c$=lpad$(rtrm$(c$),12)
...
01030   print #101: newpage
01040   print fields "3,10,Cc 38,R,N": "Enter Check Number as 0 to Delete"
01050   print fields mat sd$: mat se$
01060   print fields "13,30,C 09,B,1": "Next (F1)"
01070   print fields "13,41,C 09,B,5": "Stop (F5)"
01080   if scode=2 then goto L1110
01090   print fields mat sc$: gl$(1:3),gl$(4:9),gl$(10:12),c$,p$,s$,mat a
01100   let ce=5: goto L1170
01110 L1110: print fields mat sc$: currgl$(1:3),currgl$(4:9),currgl$(10:12)
01120   let ce=4: goto L1170
01130 L1130: input fields mat sc$: gl1,gl2,gl3,c$,p$,s$,mat a conv L1130
01140   if ce>0 then let sc$(ce)(ce1:ce2)="U": let ce=0
01150   if cmdkey>0 then goto L1220 else let ce=curfld+1
01160   if ce>udim(sc$) then let ce=1
01170 L1170: let sc$(ce)=rtrm$(uprc$(sc$(ce))) : let ce1=pos(sc$(ce),"U",1)
01180   let ce2=ce1+1 : let sc$(ce)(ce1:ce1)="UC" : goto L1130
01190 CONVC: if ce>0 then let sc$(ce)(ce1:ce2)="U"
01200   let ce=cnt+1
01210 ERRC: print fields "24,78,C 1": bell : goto L1170
01220 L1220: if scode=2 and (ltrm$(c$)="" or ltrm$(c$)="0") then goto L480
01230   let c$=lpad$(rtrm$(c$),12)
01240   if a(1)<10100 or a(1)>123199 then let ce=7: goto ERRC
01250   if a(3)<0 or a(3)>1 then let ce=9: goto ERRC
01260   if scode=2 then goto L1380
01270   if ltrm$(c$)="" or ltrm$(c$)="0" then goto L1280 else goto L1350
01280 L1280: print fields "18,10,C 40,R,N": hex$("07")&" ENTER 1 TO DELETE; ENTER 2 TO RE-ENTER"
01290 L1290: input fields "18,51,N 1,UE,N": dcode conv L1290
01300   on dcode goto L1330,L1310 none L1290
01310 L1310: let c$=holdgc$(13:24)
01320   goto L1000
...
01450   goto L570
01460 L1460: let sa$(1)="10,43,C 12,UT,N"
01470   let sa$(2)="12,43,N 12.2,UT,N"
01480 L1480: print newpage
...
01510   print fields "8,24,C 32,R,N": "      Bank #: "&currgl$
01520   print fields "10,25,C 25": "  Check Number:"
01530   print fields "12,25,C 25": "Amount to Verify:"
01540   print fields "14,35,C 09,B,5": "Stop (F5)"
01550 L1550: input fields mat sa$: c$,amt conv L1550
01560   if cmdkey=5 then goto L480
01570   let c$=lpad$(rtrm$(c$),12)
01580   print fields "15,5,C 70,N": ""
01590   print fields "16,5,C 70,N": ""
...
01630   if a3=1 then print fields "16,10,C 54,R,N": hex$("07")&" Check Number "&c$&" has been coded as cleared" else goto L1650
01640   goto L1550
01650 L1650: if amt=0 then goto L1710
01660   if amt=a2 then goto L1710
01670   print fields "16,5,C 75,R,N": hex$("07")&" Amount entered does not equal amount on file!"
01680   print fields "17,5,C 70,R,N": " Enter 1 to code as cleared or 2 to bypass"
...
01730   goto L1480
01740 L1740: print fields "16,10,C 69,R,N": hex$("07")&" Check Number "&rtrm$(c$)&" in Bank Number "&ltrm$(currgl$)&" is not on file"
01750   goto L1550
01760 L1760: let fnchain("S:\acsGL\glCkRec")
01770 L1770: print newpage
01780   let sb$(1)="2,23,C 20,UT,N"
01790   let sb$(2)="3,37,Nz 6,UT,N"
01800   let sb$(3)="4,37,Nz 6,UT,N"
...
01830   print #101: newpage
01840   print #101,fields "2,2,C 20,N": "Report Heading Date:"
01850   print #101,fields "3,2,Cr 34,N": "Starting Date to appear on report:"
01860   print #101,fields "4,2,Cr 34,N": "Ending Date to appear on report:"
01870   print fields "16,30,C 09,B,1": "Next (F1)"
01880   print fields "16,41,C 09,B,5": "Stop (F5)"
01890 L1890: rinput #101,fields mat sb$: dat$,begdat,enddat conv L1890
01900   if ce>0 then let sb$(ce)(ce1:ce2)="U": let ce=0
01910   if cmdkey>0 then goto L1980 else let ce=curfld+1
01920   if ce>udim(sb$) then let ce=1
01930 L1930: let sb$(ce)=rtrm$(uprc$(sb$(ce))) : let ce1=pos(sb$(ce),"U",1)
01940   let ce2=ce1+1 : let sb$(ce)(ce1:ce1)="UC" : goto L1890
01950 CONVB: if ce>0 then let sb$(ce)(ce1:ce2)="U"
01960   let ce=cnt+1
01970 ERRB: print fields "24,78,C 1": bell : goto L1930
...
02050   print #101: newpage
02060   print #101,fields "1,1,Cc 41,R,N": cnam$
02070   print #101,fields "2,1,Cc 41,R,N": "Company Number "&str$(cno)
02080   print #101,fields "4,1,Cc 41,N": "Printing..."
02090   print fields "13,34,C 11,B,5": "Cancel (F5)"
...
02170   if a(3)=1 then print #255,using L2180: c$,p$,a(2),a(1),s$,"Yes" pageoflow L2210 else print #255,using L2180: c$,p$,a(2),a(1),s$,"No" pageoflow L2210
...
02250 L2250: print #255,using L2260: "------------",tot,"============"
...
02290 L2290: print #255,using L2300: cnam$,"Report of Checks Written",currgl$(1:3),currgl$(4:9),currgl$(10:12),dat$
02300 L2300: form pos namtab,c 40,skip 1,pos 54,c 24,skip 1,pos 59,c 3,x 1,c 6,x 1,c 3,skip 1,pos dattab,c 20,skip 2
02310   print #255,using L2320: "Check Number","Payee","Amount","Date","Source","Cleared"
...
02380   goto L480
02390 L2390: print newpage
02400   let sb$(1)="2,31,N 3,UT,N"
02410   let sb$(2)="2,35,N 6,UT,N"
02420   let sb$(3)="2,42,N 3,UT,N"
...
02450   print #101: newpage
02460   print fields "12,30,C 09,B,1": "Next (F1)"
02470   print fields "12,41,C 09,B,5": "Exit (F5)"
02480   print #101,fields "2,2,C 28,N": "Working Bank Account Number:"
02490 L2490: input #101,fields mat sb$: gl1,gl2,gl3 conv L2490
02500   if ce>0 then let sb$(ce)(ce1:ce2)="U": let ce=0
02510   if cmdkey>0 then goto L2580 else let ce=curfld+1
02520   if ce>udim(sb$) then let ce=1
02530 L2530: let sb$(ce)=rtrm$(uprc$(sb$(ce))) : let ce1=pos(sb$(ce),"U",1)
02540   let ce2=ce1+1 : let sb$(ce)(ce1:ce1)="UC" : goto L2490
02550 CONV1: if ce>0 then let sb$(ce)(ce1:ce2)="U"
02560   let ce=cnt+1
02570 ERR1: print fields "24,78,C 1": bell : goto L2530
02580 L2580: if cmdkey=5 then goto XIT
02590   let currgl$=lpad$(str$(gl1),3)&lpad$(str$(gl2),6)&lpad$(str$(gl3),3)
02600   goto L480
...
02740   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
