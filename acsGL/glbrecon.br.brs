...
00210   let sc2$(5)="5. pr Bank Reconciliation"
...
00530   pr fields "14,35,C 09,B,5": "Exit (F5)"
...
00670   pr fields "16,34,C 11,B,5": "Cancel (F5)"
...
00890   pr fields mat sf$: val(currgl$(1:3)),val(currgl$(4:9)),val(currgl$(10:12)),""
00900   pr fields "10,10,C 14,R,N": "Bank GL Number"
00910   pr fields "10,30,C 12,R,N": "Check Number"
00920   pr fields "13,35,C 09,B,5": "Stop (F5)"
...
01040   pr fields "3,10,Cc 38,R,N": "Enter Check Number as 0 to Delete"
01050   pr fields mat sd$: mat se$
01060   pr fields "13,30,C 09,B,1": "Next (F1)"
01070   pr fields "13,41,C 09,B,5": "Stop (F5)"
01080   if scode=2 then goto L1110
01090   pr fields mat sc$: gl$(1:3),gl$(4:9),gl$(10:12),c$,p$,s$,mat a
01100   ce=5: goto L1170
01110 L1110: pr fields mat sc$: currgl$(1:3),currgl$(4:9),currgl$(10:12)
01120   ce=4: goto L1170
01130 L1130: input fields mat sc$: gl1,gl2,gl3,c$,p$,s$,mat a conv L1130
01140   if ce>0 then let sc$(ce)(ce1:ce2)="U": ce=0
01150   if cmdkey>0 then goto L1220 else ce=curfld+1
01160   if ce>udim(sc$) then ce=1
01170 L1170: let sc$(ce)=rtrm$(uprc$(sc$(ce))) : ce1=pos(sc$(ce),"U",1)
01180   ce2=ce1+1 : let sc$(ce)(ce1:ce1)="UC" : goto L1130
01190 CONVC: if ce>0 then let sc$(ce)(ce1:ce2)="U"
01200   ce=cnt+1
01210 ERRC: pr fields "24,78,C 1": bell : goto L1170
...
01280 L1280: pr fields "18,10,C 40,R,N": hex$("07")&" ENTER 1 TO DELETE; ENTER 2 TO RE-ENTER"
...
01510   pr fields "8,24,C 32,R,N": "      Bank #: "&currgl$
01520   pr fields "10,25,C 25": "  Check Number:"
01530   pr fields "12,25,C 25": "Amount to Verify:"
01540   pr fields "14,35,C 09,B,5": "Stop (F5)"
01550 L1550: input fields mat sa$: c$,amt conv L1550
01560   if cmdkey=5 then goto L480
01570   c$=lpad$(rtrm$(c$),12)
01580   pr fields "15,5,C 70,N": ""
01590   pr fields "16,5,C 70,N": ""
...
01630   if a3=1 then pr fields "16,10,C 54,R,N": hex$("07")&" Check Number "&c$&" has been coded as cleared" else goto L1650
01640   goto L1550
01650 L1650: if amt=0 then goto L1710
01660   if amt=a2 then goto L1710
01670   pr fields "16,5,C 75,R,N": hex$("07")&" Amount entered does not equal amount on file!"
01680   pr fields "17,5,C 70,R,N": " Enter 1 to code as cleared or 2 to bypass"
...
01730   goto L1480
01740 L1740: pr fields "16,10,C 69,R,N": hex$("07")&" Check Number "&rtrm$(c$)&" in Bank Number "&ltrm$(currgl$)&" is not on file"
01750   goto L1550
...
01870   pr fields "16,30,C 09,B,1": "Next (F1)"
01880   pr fields "16,41,C 09,B,5": "Stop (F5)"
01890 L1890: rinput #101,fields mat sb$: dat$,begdat,enddat conv L1890
01900   if ce>0 then let sb$(ce)(ce1:ce2)="U": ce=0
01910   if cmdkey>0 then goto L1980 else ce=curfld+1
01920   if ce>udim(sb$) then ce=1
01930 L1930: let sb$(ce)=rtrm$(uprc$(sb$(ce))) : ce1=pos(sb$(ce),"U",1)
01940   ce2=ce1+1 : let sb$(ce)(ce1:ce1)="UC" : goto L1890
01950 CONVB: if ce>0 then let sb$(ce)(ce1:ce2)="U"
01960   ce=cnt+1
01970 ERRB: pr fields "24,78,C 1": bell : goto L1930
...
02460   pr fields "12,30,C 09,B,1": "Next (F1)"
02470   pr fields "12,41,C 09,B,5": "Exit (F5)"
02480   pr #101,fields "2,2,C 28,N": "Working Bank Account Number:"
02490 L2490: input #101,fields mat sb$: gl1,gl2,gl3 conv L2490
02500   if ce>0 then let sb$(ce)(ce1:ce2)="U": ce=0
02510   if cmdkey>0 then goto L2580 else ce=curfld+1
02520   if ce>udim(sb$) then ce=1
02530 L2530: let sb$(ce)=rtrm$(uprc$(sb$(ce))) : ce1=pos(sb$(ce),"U",1)
02540   ce2=ce1+1 : let sb$(ce)(ce1:ce1)="UC" : goto L2490
02550 CONV1: if ce>0 then let sb$(ce)(ce1:ce2)="U"
02560   ce=cnt+1
02570 ERR1: pr fields "24,78,C 1": bell : goto L2530
