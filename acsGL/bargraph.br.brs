...
00770   if maximumdepth<1000 then let bottom=-1000 : goto L800
00780   if maximumdepth<10000 then let bottom=-10000 : goto L800
00790   if maximumdepth<100000 then let bottom=-100000 : goto L800
00800 L800: let spacing=10 : let lyne=10
00810   let cnam=(len(trim$(env$('cnam')))/2)+50
00820   print #20: 'Call Print.MyFontsize(14)'
00830   print #20: 'Call Print.AddText("'&env$('cnam')&'",'&str$(cnam)&','&str$(1)&')'
00840   print #20: 'Call Print.MyFontsize(12)'
00850   let txt$="Earnings By Month " !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(80)&','&str$(5)&')'
00860   let txt$="For the Year "&str$(year) !:
        print #20: 'Call Print.AddText("'&txt$&'",'&str$(80)&','&str$(10)&')'
00870   print #20: 'Call Print.MyFontsize(9)'
00877 ! Print #20: 'Call Print.AddText("'&month$(1)&'",'&STR$(10)&','&STR$(11)&')'
00880   for j=1 to 12
00890     let txt$=trim$(month$(j))(1:3) !:
          let indent=8+(10*j) !:
          print #20: 'Call Print.AddText("'&txt$&'",'&str$(indent)&','&str$(15)&')'
00900   next j
00910   let txt$=cnvrt$("pic(--------)",top) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
00920   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
00930   for j=1 to 9
00940     let txt$=cnvrt$("pic(--------)",top-((.10*j)*top)) !:
          print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
00950     print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
00960   next j
00970   goto L1140
00980   let txt$=cnvrt$("pic(--------)",top*.80) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
00990   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01000   let txt$=cnvrt$("pic(--------)",top*.70) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01010   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01020   let txt$=cnvrt$("pic(--------)",top*.60) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01030   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01040   let txt$=cnvrt$("pic(--------)",top*.50) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01050   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01060   let txt$=cnvrt$("pic(--------)",top*.40) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01070   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01080   let txt$=cnvrt$("pic(--------)",top*.30) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01090   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01100   let txt$=cnvrt$("pic(--------)",top*.20) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01110   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01120   let txt$=cnvrt$("pic(--------)",top*.10) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01130   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01140 L1140: ! zero line starts right here
01142   for j=1 to 12
01143     let txt$=trim$(month$(j))(1:3) !:
          let indent=8+(10*j) !:
          print #20: 'Call Print.AddText("'&txt$&'",'&str$(indent)&','&str$(120)&')'
01144   next j
01150   let txt$=cnvrt$("pic(-------#)",0) !:
        print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01160   print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01170   for j=1 to 10
01180     let txt$=cnvrt$("pic(-------#)",-top*(.10*j)) !:
          print #20: 'Call Print.AddText('&txt$&','&str$(1)&','&str$(lyne+=spacing)&')'
01190     print #20: 'Call Print.AddLine('&str$(15)&','&str$(lyne)&',200,0)' ! left,up/down,lenght of top line on chart
01200   next j
01210   let linezero=(spacing*10)+20
01220   let column=18 ! spacing sideways
01230   print #20: 'Call Print.MyFontBold(1)'
01240   for j=1 to 12
...
01330     print #20: 'Call Print.AddLine('&str$(column-1)&','&str$(homedot)&','&str$(7)&','&str$(linezero-homedot)&',1)'
01340     for q=1 to 6
01350       print #20: 'Call Print.AddLine('&str$(column-1+q)&','&str$(homedot)&','&str$(7-q)&','&str$(linezero-homedot)&',1)'
01360     next q
01370     print #20: 'Call Print.MyFontsize(6)'
01380     if profit(j)<0 then let txt$=cnvrt$("pic(--------#)",-round(profit(j),0)): print #20: 'Call Print.AddText('&txt$&','&str$(column)&','&str$(homedot-3)&')'
01390     if profit(j)>0 then let txt$=cnvrt$("pic(--------#)",-round(profit(j),0)): print #20: 'Call Print.AddText('&txt$&','&str$(column)&','&str$(homedot+2)&')'
01400     print #20: 'Call Print.MyFontsize(9)'
01410     let column+=10
01420   next j
01421   for j=1 to nap
01422     let txt$=trim$(month$(j))(1:3) !:
          let indent=8+(10*j) !:
          print #20: 'Call Print.AddText("'&txt$&'",'&str$(indent)&','&str$(230)&')'
01423   next j
...
01540   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
...
01610     print #20: 'Call Print.MyOrientation("Portrait")'
01620     let lyne=margin ! starting of 1st line
01630     let column1=16 !:
          let column2=103 !:
          let column3=153
01640   end if 
01650   return 
