...
18060     execute "Index [Q]\GLmstr\GLTrans.h[cno] "&env$('Temp')&"\fsindex.H[cno]"& " 25/29/1 2/12/12 Replace DupKeys -N,Shr"
18080     open #3: "Name=[Q]\GLmstr\GLtrans.h[cno],KFName="&env$('Temp')&"\fsindex.h[cno],Shr",internal,input,keyed 
18100   else if cur_prior=2 then ! index current file
18120     execute "Index [Q]\GLmstr\AcTrans.h[cno] "&env$('Temp')&"\fsindex.H[cno]"& " 25/29/1 2/12/12 Replace DupKeys -N" ! index current file
18140     open #3: "Name=[Q]\GLmstr\ACtrans.h[cno],KFName="&env$('Temp')&"\fsindex.h[cno],Shr",internal,input,keyed 
18160   end if 
20000 PJ_READ_1: ! 
