...
11400   fntop("S:\acsGL\financialstatement",cap$="Financial Statement Design")
11500   fncno(cno,cnam$)
11600   fndat(dat$)
...
17000   item$(8)=str$(ul) : item$(9)=str$(rs) : item$(10)=str$(bc)
17100   item$(11)=str$(ap) : item$(12)=str$(ac(1)) : item$(13)=str$(ac(2))
17200   item$(14)=str$(ac(3)) : item$(15)=str$(ac(4)) : item$(16)=str$(ac(5))
17300   item$(17)=str$(ac(6)) : item$(18)=str$(ac(7)) : item$(19)=str$(ac(8))
17400   item$(20)=str$(ac(9)) : item$(21)=str$(rnp) : item$(22)=str$(fc)
17500   item$(23)=d$(1:10)
...
28500 MSGBOX1: ! 
28600   mat ml$(3)
28700   ml$(1)="You are changing reference # "&holdrno$&" to "
28800   ml$(2)="reference # "&rno$&".  Click OK to continue, else"
28900   ml$(3)="Cancel to prevent changing the #."
29000   fnmsgbox(mat ml$,resp$,cap$,49)
...
30200   mat ml$(3)
30300   ml$(1)="You are attempting to delete reference # "&rno$&"."
30400   ml$(2)="Click OK to continue, "
30500   ml$(3)="else Cancel to prevent deleting the reference #."
30600   fnmsgbox(mat ml$,resp$,cap$,49)
...
31300 EDIT_CHECKS: ! 
31400   rno$=lpad$(rtrm$(rno$),5)
31500   te$=uprc$(te$)
31600   if add=1 and ltrm$(rtrm$(rno$))="" then goto L1640
31700   if add=1 and ltrm$(rtrm$(rno$))="0" then goto L1640
31800   goto L1660
31900 L1640: mat ml$(2)
32000   ml$(1)="You must have a valid reference number in order to add a new line."
32100   ml$(2)="Click OK to fix."
32200   fnmsgbox(mat ml$,resp$,cap$,49)
...
33000   fnmsgbox(mat ml$,resp$,cap$,49)
33100   goto ADD_EDIT_FIN_STMTS
33200 L1690: if ds>=0 and ds<=1 then goto L1720
33300   mat ml$(3)
33400   ml$(1)="The Dollar Sign codes must be 0 or 1.  0 is no dollar"
33500   ml$(2)="sign.  1 will pr a dollar sign beside the entry."
33600   ml$(3)="Click OK to fix."
33700   fnmsgbox(mat ml$,resp$,cap$,49)
33800   goto ADD_EDIT_FIN_STMTS
33900 L1720: if ul>=0 and ul<=2 then goto L1750
34000   mat ml$(3)
34100   ml$(1)="The Underline Codes must be 0,1 or 2.  0 is no underline."
34200   ml$(2)="1 will pr 1 underline. 2 will pr 2 underlines."
34300   ml$(3)="Click OK to fix."
34400   fnmsgbox(mat ml$,resp$,cap$,49)
34500   goto ADD_EDIT_FIN_STMTS
34600 L1750: if rs>=0 and rs<=1 then goto L1780
34700   mat ml$(3)
34800   ml$(1)="The Reverse Sign code is simply 1 to reverse the sign."
34900   ml$(2)="0 will default to no action. All other codes are invalid."
35000   ml$(3)="Click OK to fix."
35100   fnmsgbox(mat ml$,resp$,cap$,49)
35200   goto ADD_EDIT_FIN_STMTS
35300 L1780: if bc>=0 and bc<=3 then goto L1810
35400   mat ml$(3)
35500   ml$(1)="The Balance Sheet Column is only applicable in a balance"
35600   ml$(2)="sheet design.  The codes are 0,1,2,3. 0 will default to 1."
...
36500   fnmsgbox(mat ml$,resp$,cap$,49)
36600   goto ADD_EDIT_FIN_STMTS
36700 L1840: if ap>=0 and ap<=9 then goto L1870
36800   mat ml$(3)
36900   ml$(1)="The Accumulator to pr must be no less than 0 or "
37000   ml$(2)="or no greater than 9. All other codes are invalid, "
37100   ml$(3)="Click OK to fix."
37200   fnmsgbox(mat ml$,resp$,cap$,49)
37300   goto ADD_EDIT_FIN_STMTS
37400 L1870: for j=1 to 9
37500     if ac(j)=0 or ac(j)=1 or ac(j)=9 then goto L1910
37600     mat ml$(3)
37700     ml$(1)="Accumulator to clear must be a 0,1, or 9."
37800     ml$(2)="All other codes are invalid, "
37900     ml$(3)="Click OK to fix."
38000     fnmsgbox(mat ml$,resp$,cap$,49)
...
41500 ERTN: fnerror(program$,err,line,act$,"xit")
...
43400     ic=0 ! temporary Item Counter
