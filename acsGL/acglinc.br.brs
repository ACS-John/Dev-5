00010 ! Replace R:\acsGL\acglinc
00020 ! -- Print Income Statement !:
        ! FOR 8 1/2 * 11 PAPER WITHOUT PERCENTAGES
00030 ! ______________________________________________________________________
00040   library 'R:\Core\Library': fntop,fnxit, fnopenprn,fncloseprn,fnpglen,fnerror,fnprocess,fncno,fnchain,fngl_number_use_dept,fnpedat$,fnps,fnpriorcd,fnfscode,fnactpd$,fncch$,fnglfs,fntos,fnlbl,fntxt,fncmdkey,fnacs,fnactpd
...
00147   let fscode=fnfscode
00148   let priorcd=fnpriorcd
...
00202     let mp1=mp1+3
00204     let mp2=78
00206     let fl1$="Name=Q:\GLmstr\ACGLFNSJ.h"&str$(cno)&",KFName=Q:\GLmstr\FNSJINDX.h"&str$(cno)&",Shr"
00208   else 
00210     let mp2=75
00212     let fl1$="Name=Q:\GLmstr\ACGLFNSI.h"&str$(cno)&",KFName=Q:\GLmstr\FNSIINDX.h"&str$(cno)&",Shr"
00214   end if 
00216   open #h_acglfns:=1: fl1$,internal,input,keyed 
...
00332     execute "Index Q:\GLmstr\GLmstr.h"&str$(cno)&" "&env$('temp')&"\fsindex.H"&str$(cno)&" 72 3 Replace DupKeys -N"
00334   else 
00336     execute "Index Q:\GLmstr\GLmstr.h"&str$(cno)&" "&env$('temp')&"\fsindex.H"&str$(cno)&" 69 3 Replace DupKeys -N"
00338   end if 
00370   open #h_glmstr:=3: "Name=Q:\GLmstr\GLmstr.h"&str$(cno)&",KFName="&env$('temp')&"\fsindex.h"&str$(cno)&",Shr",internal,input,keyed 
...
00400 READ_ACGLFNS: ! 
00402   read #h_acglfns,using 'form pos 1,c 5,c 50,c 1,2*n 2,5*n 1,9*n 1,n 1,n 3': r$,d$,te$,sp,ls,ds,ul,rs,bc,ap,mat ac,ic,fc eof L1650
