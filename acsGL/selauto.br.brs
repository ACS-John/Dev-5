...
00160   fncno(cno)
00170   open #1: "Name=[Q]\GLmstr\acGLPGMN.h[cno],Use,RecL=76",internal,outIn,relative ioerr L190
00180   goto L210
00190 L190: if exists("[Q]\GLmstr\acGLPGMN.h[cno]") >0 then let fnFree("[Q]\GLmstr\acGLPGMN.h[cno]")
00200   open #1: "Name=[Q]\GLmstr\acGLPGMN.h[cno],Use,RecL=76",internal,outIn,relative ioerr MAIN
...
01640 L1640: execute "drop [Q]\GLmstr\acGLPGMN.h[cno]"
01650   close #1: ioerr ignore
01660   open #1: "Name=[Q]\GLmstr\acGLPGMN.h[cno],Use,RecL=76",internal,outIn,relative 
