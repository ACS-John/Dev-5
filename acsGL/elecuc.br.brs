...
02200   let win=101
02210   let win_height=13: let win_width=75: let display_cnam=1: let button_option=2: gosub L2650
02220   print #win,fields "04,2,Cr 31,N": "Personal ID Number:" !:
        ...
        print #win,fields "12,2,Cr 66,N": "Is Medicare W/H a seperate field in the employee record (Y/N):" !:
...
02980   if button_option=7 then !:
          let fkey$(1)="Save" !:
          let fkey$(4)="Delete"
02990   let scrline=er+1: gosub L3660
03000 ! 
...
03440   print #win,fields "1,1,Cc 40,R,N": env$('cnam')
03450   print #win,fields "2,1,Cc 40,R,N": "Company Number "&env$('cno')
...
03610   print #win,fields "1,1,Cc "&str$(win_width)&",R,N": env$('cnam')(1:min(40,win_width))
03620   print #win,fields "2,1,Cc "&str$(win_width)&",R,N": "Company Number "&env$('cno')(1:min(40,win_width))
03630 ! 
03640 ! 
03650   return  ! Fnend
