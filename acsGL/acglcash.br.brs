...
L360: if fnps=2 then goto L390 ! secondary
	close #3: ioerr L370
L370: execute "Index [Q]\GLmstr\GLmstr.h[cno] "&env$('Temp')&"\fsindex.H[cno] 75 3 Replace DupKeys -N"
	goto L400
L390: execute "Index [Q]\GLmstr\GLmstr.h[cno] "&env$('Temp')&"\fsindex.H[cno] 78 3 Replace DupKeys -N"
L400: open #3: "Name=[Q]\GLmstr\GLmstr.h[cno],KFName="&env$('Temp')&"\fsindex.h[cno],Shr",internal,input,keyed
	fnopenprn : _
