00010 ! Replace S:\acsGL\fnacprScr
00020 ! job cost screens???
00030   def library fnacprscr
00040     library 'S:\Core\Library': fntop,fnxit, fncno,fnerror,fnacglblds
00050 ! ______________________________________________________________________
00060     let fntop(program$,"CHANGE_ME")
...
00520     read mat b$
00530     for j=1 to 5
00540       let floa$(j)=str$(j+3)&",10,C 20,N"
...
00610       let x=x+1
00620       let floa$(j)=str$(x+3)&",3,C 20,N"
00630       let floa$(j+1)=str$(x+3)&",41,C 20,N"
00640       let io1$(j)=str$(x+3)&",23,N 11.2,UT,N"
00650       let io1$(j+1)=str$(x+3)&",62,N 11.2,UT,N"
00660     next j
00670     for j=1 to 14
00680       let flob$(j)=str$(j+3)&",2,C 20,N"
...
00750     close #1,free: 
00760 L760: open #1: "Name="&env$('Q')&"\GLmstr\ACPRSCF.h"&str$(cno)&",SIZE=0,RecL=1288,NoShr",internal,output 
