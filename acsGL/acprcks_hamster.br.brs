...
! another Hamster
	...
	fnTop(program$,cap$='AcPrCks Hamster')
	fn_setup_hamster
	fn_open_file
...
def fn_open_file
		...
		open #open_file_count+=1: "Name=[Q]\GLmstr\AcPrCks.h[cno],Shr",internal,outIn,relative
fnend
def fn_close_file
...
! fn_add_rec(label$*38,textbox_len,field_type$*2; storage_length,ar_mask,storage_position)
		...
		for x=1 to 19
			fn_add_rec("D("&str$(x+3)&")",12,'PD',5.2,mask_pointtwo)
		next x
