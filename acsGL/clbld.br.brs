...
00340   open #2: "Name="&dv$&"GLmstr.h[cno],SIZE=0,RecL=62,Replace",internal,output 
...
00420 L420: open #2: "Name="&dv$&"PAYMSTR.h[cno],SIZE=0,RecL=276,Replace",internal,output 
00430   open #payeegl:=fngethandle: "Name=[Q]\CLmstr\PayeeGLBreakdown.h[cno],Version=1,KFName=[Q]\CLmstr\Payeeglbkdidx.h[cno],Use,RecL=56,KPs=1,KLn=8,Shr",internal,outIn,keyed 
00440   open #1: "Name=[Q]\GLmstr\paymstr.h[cno],KFName=[Q]\GLmstr\payidx1.h[cno],Shr",internal,input,keyed  ! Ioerr 580
00450 READ_GL1099: ! 
...
00500 EOF_GL1099: ! 
00510   close #1: 
00520   open #1: "Name=[Q]\GLmstr\PRmstr.h[cno],KFName=[Q]\GLmstr\PRIndex.h[cno],Shr",internal,input,keyed ioerr L410
00530   vn$(3)=""
...
00580 L580: close #1: 
00590   close #2: 
00600   execute "Copy [Q]\GLmstr\PayeeGLBreakdown.h[cno] a:"
00610   goto XIT
