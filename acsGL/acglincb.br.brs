...
! -- INCOME STATEMENT WITH BUDGET
	...
	fnTop(program$,cap$="Income Statement with Budget")
...
L1190: sp2=26-sp-1
	if ul=1 then pr #255,using L1211: d$(1:sp2),dollar$,"{\UL ",annualb,"}",dollar$,"{\UL ",total,"}",dollar$,"{\UL ",monthb,"}",dollar$,"{\UL ",total2,"}",dollar$,"{\UL ",ytdb,"}",dollar$,"{\UL ",overundr,"}",dollar$,"{\UL ",unexpend,"}" pageoflow L1890 : goto L1210
	pr #255,using L1210: d$(1:sp2),dollar$,annualb,dollar$,total,dollar$,monthb,dollar$,total2,dollar$,ytdb,dollar$,overundr,dollar$,unexpend pageoflow L1890
...
L1330: if ap=0 then ap=1
	...
	sp2=26-sp-1
	if ul=1 then pr #255,using L1211: d$(1:sp2),dollar$,"{\UL ",accum3,"}",dollar$,"{\UL ",accum1,"}",dollar$,"{\UL ",accum4,"}",dollar$,"{\UL ",accum2,"}",dollar$,"{\UL ",accum5,"}",dollar$,"{\UL ",accum6,"}",dollar$,"{\UL ",accum7,"}" pageoflow L1890 : goto L1440
	pr #255,using L1210: d$(1:sp2),dollar$,accum3,dollar$,accum1,dollar$,accum4,dollar$,accum2,dollar$,accum5,dollar$,accum6,dollar$,accum7 pageoflow L1890
L1440: ft1=0
	gosub L1600
...
L1970: pr #255,using L1980: underlin$,underlin$(1:12),underlin$(1:12),underlin$,underlin$,underlin$,underlin$
L1980: form pos 26,c 15,2*c 13,4*c 15,skip redir
L1990: if redir=0 then pr #255,using L2000: " " pageoflow L1890
L2000: form skip 1,c 1,skip 0
return
