...
00120   let fntop(program$,cap$="Income Statement with Budget")
...
01000     let accum(j,2)=accum(j,2)+total2
01010     let accum(j,3)=accum(j,3)+annualb
01020     let accum(j,4)=accum(j,4)+monthb
01030     let accum(j,5)=accum(j,5)+ytdb
01040     let accum(j,6)=accum(j,6)+overundr
01050     let accum(j,7)=accum(j,7)+unexpend
01060 L1060: next j
...
01195   if ul=1 then print #255,using L1211: d$(1:sp2),dollar$,"{\UL ",annualb,"}",dollar$,"{\UL ",total,"}",dollar$,"{\UL ",monthb,"}",dollar$,"{\UL ",total2,"}",dollar$,"{\UL ",ytdb,"}",dollar$,"{\UL ",overundr,"}",dollar$,"{\UL ",unexpend,"}" pageoflow L1890 : goto L1210
01200   print #255,using L1210: d$(1:sp2),dollar$,annualb,dollar$,total,dollar$,monthb,dollar$,total2,dollar$,ytdb,dollar$,overundr,dollar$,unexpend pageoflow L1890
...
01400   if rs=1 then let accum7=accum(ap,7) else let accum7=accum(ap,7)
01410   if ds=1 then let dollar$="$" else let dollar$=" "
01420   let sp2=26-sp-1
01425   if ul=1 then print #255,using L1211: d$(1:sp2),dollar$,"{\UL ",accum3,"}",dollar$,"{\UL ",accum1,"}",dollar$,"{\UL ",accum4,"}",dollar$,"{\UL ",accum2,"}",dollar$,"{\UL ",accum5,"}",dollar$,"{\UL ",accum6,"}",dollar$,"{\UL ",accum7,"}" pageoflow L1890 : goto L1440
01430   print #255,using L1210: d$(1:sp2),dollar$,accum3,dollar$,accum1,dollar$,accum4,dollar$,accum2,dollar$,accum5,dollar$,accum6,dollar$,accum7 pageoflow L1890
...
01970 L1970: print #255,using L1980: underlin$,underlin$(1:12),underlin$(1:12),underlin$,underlin$,underlin$,underlin$
