...
00150   fncno(cno,cnam$) !:
        fndat(dat$)
00160   open #payee=1: "Name=[Q]\GLmstr\paymstr.h[cno],KFName=[Q]\GLmstr\PayIdx2.h[cno],Shr",internal,outIn,keyed 
00170   open #payee2=11: "Name=[Q]\GLmstr\paymstr.h[cno],KFName=[Q]\GLmstr\payidx2.h[cno],Shr",internal,outIn,keyed 
00180   open #trans=2: "Name=[Q]\GLmstr\GLTR1099.H[cno],KFName=[Q]\GLmstr\gltridx1.h[cno],Shr",internal,outIn,keyed 
...
00480   if trim$(trvn$) <> trim$(vn$) then nomore=1: goto L590
...
00660   p1=66-int((len(rtrm$(dat$))+6)/2)
