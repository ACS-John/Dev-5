...
00510   if am<-2000000 then let am=0
00520 L520: form pos 1,c 8,n 6,pd 5.2,c 12,c 30
00530   let tot=tot+am
00540   if fst=0 then print #255,using L550: vn$,nam$,dt,rn$,de$,am,tot,ec$ pageoflow L580 else print #255,using L560: dt,rn$,de$,am,tot,ec$ pageoflow L580
...
00600   if nomore=1 then print #255,using "form pos 50,c 20,n 10.2": "Total Transactions",tot: let nomore=0 else goto L470
00610   goto L400
00620 L620: print #255: newpage
00630 L630: let p2=p2+1
00640   print #255,using L650: date$('mm/dd/yy'),cnam$,time$,"Vendor Transaction Listing"
00650 L650: form skip 1,pos 1,c 8,pos 40,cc 40,skip 1,pos 1,c 8,pos 40,cc 40,skip 1
00660   let p1=66-int((len(rtrm$(dat$))+6)/2)
00670   print #255,using L680: rtrm$("As of "&dat$),"Page",p2
00680 L680: form pos 40,cc 40,pos 110,c 4,n 5,skip 1
00690   print #255,using "form pos 118,c 5": "Total"
00700   print #255,using L710: "Vendor #","Vendor Name","Date","Reference #","Description","Amount","    Purchases"
