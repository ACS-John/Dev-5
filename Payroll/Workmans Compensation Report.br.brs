...
MENU1: !
  ...
  open #hDepartment:=2: 'Name=[Q]\PRmstr\Department.h[cno],KFName=[Q]\PRmstr\DeptIdx4.h[cno],Shr',i,i,k  ! open in workmans comp code sequence
  open #h_payrollchecks:=4: 'Name=[Q]\PRmstr\PayrollChecks.h[cno],KFName=[Q]\PRmstr\CheckIdx.h[cno],Shr',i,i,k
  fnOpenPrn
  fn_hdr
  do ! r:
    read #hDepartment,using 'form pos 1,n 8,n 3,pos 50,n 2': teno,tdept,workman_comp eof EO_DEPARTMENT
		! pr #255: '     *Read hDepartment: teno='&str$(teno)&', workman_comp='&str$(workman_comp)
