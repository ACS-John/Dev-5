...
34000   let fntos(sn$="Calculation-1") 
34020   let rc=cf=0: let mylen=42: let mypos=45: let frameno=1
34040   let fnfra(1,1,4,66,"Payroll Date","Enter the payroll date.")
34060   let fnlbl(1,1,"Payroll Period Ending Date:",mylen,1,0,frameno)
34080   let fntxt(1,mypos,10,0,1,"3",0,"Enter the date which you want used for your earnings records. ",frameno) 
34100   let resp$(rc+=1)=str$(d1)
34120   let fnlbl(2,1,"Report Heading Date:",mylen,1,0,frameno)
34140   let fntxt(2,mypos,20,0,0," ",0,"Enter the date in alpha format for use in report headings, etc." ,frameno) 
34160   let resp$(rc+=1)= d1$
34180   let fnfra(7,25,6,42,"Date Range","In order to Identify earnings and deductions, these answers must be correct.") 
34200   let frameno=2 : let mylen=26 : let mypos=mylen+2
34220   let fnlbl(1,1,"Starting Date:",mylen,1,0,frameno)
34240   let fntxt(1,mypos,10,0,1,"3",0,"Enter the beginning date of your payrll year.",frameno) 
34260   let resp$(rc+=1)=str$(beg_date)
34280   let fnlbl(2,1,"Ending Date:",mylen,1,0,frameno)
34300   let fntxt(2,mypos,10,0,1,"3",0,"Enter the last payroll date of the year",frameno) 
34320   let resp$(rc+=1)=str$(end_date)
34340   let fnlbl(3,1,"1st Day of 1st quarter:",mylen,1,0,frameno)
34360   let fntxt(3,mypos,10,0,1,"3",0,"Enter the first day of the first quarter. Could be something other than January 1st if your last payroll of the previous year should be included in this year",frameno) 
34380   let resp$(rc+=1)=str$(qtr1)
34400   let fnlbl(4,1,"1st Day of 2nd quarter:",mylen,1,0,frameno)
34420   let fntxt(4,mypos,10,0,1,"3",0,"Normally would be April 1st, but could be different if your payroll dates and check dates are not the same.",frameno) 
34440   let resp$(rc+=1)=str$(qtr2)
34460   let fnlbl(5,1,"1st Day of 3rd quarter:",mylen,1,0,frameno)
34480   let fntxt(5,mypos,10,0,1,"3",0,"Normally would be July 1st",frameno) 
34500   let resp$(rc+=1)=str$(qtr3)
34520   let fnlbl(6,1,"1st Day of 4th quarter:",mylen,1,0,frameno)
34540   let fntxt(6,mypos,10,0,1,"3",0,"Normally would be October 1st.",frameno) 
34560   let resp$(rc+=1)=str$(qtr4)
34580   let fncmdkey("Next",1,1,0,"Save and Continue")
34600   let fncmdkey("Cancel",5,0,1,"Close without Saving")
34620   let fnacs(sn$,0,mat resp$,ckey)
