...
for empItem=1 to emplRecordCount
	...
	tcp7 =emplList_FOOD(empItem)           			! ,GARN standard deduction 3   
...
def fn_readEmplIntoArrays ! it is all local 
	...
	do
		...
		emplList_FOOD            	(emplRecordCount)	=val(item$(empl_FOOD            	))
...
def fn_mat_emplList(newArraySize)
	...
	mat emplList_FOOD          	(newArraySize)
