...
fncreg_read(cap$&'.emplRegisterFile$',emplRegisterFile$, 'D:\ACS\(Client_Files)\Payroll Done Right\mr j.txt')
fnTos
...
for empItem=1 to emplRecordCount
	...
	tcp9 =emplList_TRANSIT(empItem)				! ,standard deduction 5       
	...
	tcp13=0 ! deptList_TrimetTax(deptIndex)				! ,standard deduction 9      
