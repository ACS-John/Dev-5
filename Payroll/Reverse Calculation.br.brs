...
! Reverse Calculation
	...
	library 'S:\Core\Library': fnTos,fnLbl,fnTxt,fnCmdKey,fnAcs,fncombof
...
POSTGL1: ! r:
	...
	fnAcs(sn$,0,mat resp$,ckey) ! posting date
	if ckey<>5 then 
		dat1=val(resp$(1))
...
! return ! /r
CREATE_LIST: ! r:
	open #13: "Name="&env$('temp')&"\prreverse"&session$&",size=0,RecL=128,replace",internal,outIn 
	L4000: !
