...
16300   mat ml$(2)
16320   ml$(1)="A record with this number already exists!"
16340   ml$(2)="Select a different employee number."
16360   fnmsgbox(mat ml$,resp$,'',48)
16380   goto ADDREC ! /r
18000 L1020: ! r:
18020   mat em$=("")
18040   ph$=ss$=""
...
22000 L1120: ! r:
22020   mat ml$(2)
22040   ml$(1)="A record with this number does not exist!"
22060   ml$(2)="Select a different employee number."
...
29080   em$(3)=resp$(4)
29100   ss$=resp$(5)
29120   rs(1)=val(resp$(6)(1:1))
29140   rs(2)=val(resp$(7)(1:1)) ! sex
...
29660       mat ml$(1) : ml$(1)='Pay Code is required.'
29680       fnmsgbox(mat ml$,resp$)
...
32180   tli=val(resp$(7)) ! last increase amount
32200   tdt(4)=val(resp$(8)) ! last payroll date
32220   for j=1 to 10
32240     if uprc$(trim$(resp$(9)(1:2)))=uprc$(trim$(state_option$(j)(1:2))) then tcd(1)=j ! state code
32260   next j
32280   tcd(2)=val(resp$(10)) ! w/c code
32300   tcd(3)=val(resp$(11)) ! union code
32320   tdet(1)=val(resp$(12)) ! salary
32340   tdet(2)=val(resp$(13)) ! hourly rate
32360   tdet(3)=val(resp$(14)) ! overtime rate
32380   for j=4 to 23
32400     tdet(j)=val(resp$(14+j-3)) ! standard deductions
32420   next j
32440   if tdn=0 then 
32460     mat ml$(2)
32480     ml$(1)="The department # can not be 0 (zero)."
32500     ml$(2)="Enter a valid department number!"
32520     fnmsgbox(mat ml$,resp$)
...
42020   mat ml$(2)
42040   ml$(1)="Employee Number "&ltrm$(ent$)&" will be Deleted."
42060   ml$(2)="Do you wish to continue?"
42080   fnmsgbox(mat ml$,resp$,'',52)
...
44020   msgline$(1)="Employee Number "&ltrm$(ent$)&" will be changed "
44040   msgline$(1)=msgline$(1)&"to "&str$(eno)&"."
44060   msgline$(2)="Do you wish to continue?"
44080   fnoldmsgbox(mat response$,'',mat msgline$,2)
...
46000 CHGENO: ! r:
46020   mat ml$(3)
46040   ml$(1)="You have chosen to change the employee number"
46060   ml$(2)="from "&str$(holdeno)&" to "&str$(eno)&"."
46080   ml$(3)="Do you wish to continue?"
46100   fnmsgbox(mat ml$,resp$,'',52)
46120   if resp$<>"Yes" then 
46180     goto CHGENO_XIT
46200   end if 
46240   read #1,using 'form pos 1,n 8',key=lpad$(str$(eno),8): teno nokey L3790
46260   mat ml$(2)
46280   ml$(1)="Employee Number "&ltrm$(ent$)&" already exists."
46300   ml$(2)="You cannot change to this number."
46320   fnmsgbox(mat ml$,resp$)
...
48280   race_option$(1)="0 - Unknown"
48300   race_option$(2)="1 - Caucasian"
48320   race_option$(3)="2 - Hispanic"
48340   race_option$(4)="3 - Black"
48360   race_option$(5)="4 - Oriental"
48380   race_option$(6)="5 - AmIndian"
...
48780   payperiod_option$(2)="2 - Semi-monthly"
48800   payperiod_option$(3)="3 - Bi-weekly"
48820   payperiod_option$(4)="4 - Weekly"
48840   ! 
...
49400       dednames$(j)=trim$(dednames$(j))&":"
49420     end if 
49440   next j
49460 fnend 
...
63060 L4670: ! 
63080   mat ml$(2)
63100   ml$(1)="You must have valid answers in the routing #, account"
63120   ml$(2)="type, and bank account before you can answer yes."
63140   fnmsgbox(mat ml$,resp$)
63160   goto ASKDD
63180 L4680: ! 
63200   if ckey=1 or ckey=4 then goto SAVEDD
63220   goto ASKDD ! /r
64000 SAVEDD: ! r:
64020   key$=rpad$(str$(eno),10)
