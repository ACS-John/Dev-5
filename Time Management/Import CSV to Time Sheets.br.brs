! r: setup
	library 'S:\Core\Library': fnAcs,fnCmdSet,fnLbl,fnTxt,fnerror,fnTos,fnxit,fntop,fnpause,fngethandle,fnopenprn,fncloseprn
	on error goto ERTN
...
! /r
	...
	label$(2)='Ending Date'
	fn_askDatesAndFile(mat label$,mat filter_date)
...
def fn_askDatesAndFile(mat label$,mat filter_date)
