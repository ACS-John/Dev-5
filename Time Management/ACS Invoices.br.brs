...
20710   print newpage
20720   print fields "10,10,Cc 60": "Printing Invoices..."
...
22260     let client_id=val(client_id$)
...
22360       let cln=val(cln$)
22380       !     if client_id=918 then print 'cln=';cln;'client_id=';client_id ! pause
...
22460         !        print "An";int(b4*.01);'=';int(sup_exp_date*.01);' !  bill annual if it expires this month'
...
22840           if trim$(sys_name$(scode))='' then print ' sending blank system name  scode='&str$(scode) : pause 
22860         end if 
...
26000   ASK_MERGE: ! r:
26010   print newpage
26020   print fields "10,2,c 70": "All invoices have been printed.  Enter 1 to merge, or 2 to Stop"
...
32020   if inv_line=30 then let fn_print_inv ! print invoice if more than 20 entries
...
36120     if b8=20 then let b8=19 ! ALL PRINTING SUPPORT IS COVERED BY CORE
...
38040   print #22: "Clnt   Name           Date      Prev Bal    New Amt     Total Due   Inv No  "
38060   print #22: "_____ ______________  ________  __________  __________  __________  __________"
38080   SI_ADD: if (pbal+b3)<1 then let piv$="" else let piv$=iv$ ! if less than a dollar than don't charge it
38100   if piv$<>'' then 
38120     print #22,using L1420: client_id$,client_addr$(1)(1:14),inv_date,pbal,b3,pbal+b3,piv$
38140   end if  ! piv$<>''
...
40120       print #255: skln$
40140     loop 
40160     SP_FINIS: ! 
40180     print #255: 
40200     print #255: "Total of Invoices Printed:  ";cnvrt$("N 12.2",tb3)
40220     print #255: "Total of Previous Balances: ";cnvrt$("N 12.2",tb4)
40240     close #22,free: 
40260 SP_XIT: ! 
40280   fnend 
42000   def fn_print_inv ! PRINT INVOICE
...
42400     print #255: newpage ! mat inv_item$=("")
