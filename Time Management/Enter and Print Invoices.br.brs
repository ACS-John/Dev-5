...
! /r
	...
	pr f "10,5,c 70": "Enter 1 for regular or 2 if Reprinting previously entered invoices:"
	pr f "12,32,Cc 16,B,5": "Cancel (F5)"
	if f1=0 then f1=1
L820: rinput fields "10,73,N 1,UE,N": f1 conv L820
