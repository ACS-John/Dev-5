...
00065 ! -------------------------------------------------------------------
00066   let fnfra(1,1,3,12,ttt$,sn$)
00067   let fnfra(5,5,3,12,ttt$,sn$)
00068   let fnfra(1,1,1,6,ttt$,sn$,2)
00069   let fnfra(10,5,3,12,ttt$,sn$)
00070   let mymask$ = "1001"
00071   let ttt$ = "data\R.jpg"
00072   let fntxt(1,1,8,0,0,mymask$,0,ttt$,1,0)
