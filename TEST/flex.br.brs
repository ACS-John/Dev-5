...
73410   let cmask$(5)=''
73900   let fnflexinit1('TrAlloc-tran2',17,1,4,90,mat chdr$,mat cmask$,1)
...
75400   let fncmdkey('Ok',1,1,0)
75500   let fncmdkey('Cancel',99,0,1)
75600   let fnacs("S-Flex",0,mat resp$,ck)
75700   print "returned response is "&resp$(1)
75800   print "Press Enter to continue"
