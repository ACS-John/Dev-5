...
00168   print fields '#185,7,24,28/combo 128,+,select': mat opt$
00170 ! 
00172 !  let curfld(4)
00174 ! 
00180   let ace_io$(01)="#186,1,17,10/C 10,P[textboxes],300"
00200   let ace_io$(02)="#186,2,17,30/C 30,P[textboxes],300"
00220   let ace_io$(03)="#186,3,17,10/C 10,P[textboxes],300"
00240   let ace_io$(04)="#185,2,14,10/#PIC(---,---,---),T[textboxes],300"
00260   let ace_io$(05)="#185,2,26,10/#PIC(--,---.--),T[textboxes],300"
00280   let ace_io$(06)="#185,2,38,10/#PIC(---,---,---),T[textboxes],300"
00300   let ace_io$(07)="#185,3,26,10/#PIC(--,---.--),P[textboxes],300"
00320   let ace_io$(08)="#185,4,38,10/#PIC(---,---,---),T[textboxes],300"
00340   let ace_io$(09)="#185,5,26,10/#PIC(--,---.--),T[textboxes],300"
00360   let ace_io$(10)="#185,7,24,28/combo 128,Select[textboxes]"
