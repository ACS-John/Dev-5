...
!
			open #hold:=fngethandle: 'name='&filenameold$(fileitem),display,input
			open #hnew:=fngethandle: 'name='&filenamenew$(fileitem),display,input
			do
...
DIFFFINIS: !
		...
		open #hdiff:=fngethandle: 'name=C:\Users\John\Desktop\pbjFix\Loc'&location$&'_Q4_Missed_Terms_Update.xml,recl=2048,replace',display,output
