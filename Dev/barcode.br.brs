...
00020   let bc$="123456789012"
00025   let label_pos=1 : let lyne=16
00030   if trim$(bc$)<>"" then print #20: 'Call Print.DisplayBarCode('&str$(label_pos)&','&str$(lyne+ymargin)&',"'&bc$&'")'
...
00090     print #20: 'Call Print.MyOrientation("Portrait")'
00100     let lyne=4
00110   end if 
00120   return 
