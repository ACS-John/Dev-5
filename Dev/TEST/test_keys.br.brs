...
open #1: "Name=xxx,KFName=xxx.ky1,replace,RecL=80,kps=1,kln=4",i,outIn,k 
open #2: "Name=xxx,KFName=xxx.ky2,replace,RecL=80,kps=11,kln=4",i,outIn,k 
...
open #1: "Name=xxx,KFName=xxx.ky1",i,outIn,k 
open #2: "Name=xxx,KFName=xxx.ky2",i,outIn,k 
