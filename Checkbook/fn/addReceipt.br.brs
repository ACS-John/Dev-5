...
def library fnaddreceipt
	...
	open #receipt=fnH: 'Name=[Q]\CLmstr\recmstr.h[cno],Version=1,KFName=[Q]\CLmstr\recidx1.h[cno],Shr',i,outIn,k 
	open #receiptgl=fnH: 'Name=[Q]\CLmstr\ReceiptGLBreakdown.h[cno],Version=1,KFName=[Q]\CLmstr\Receiptglbkdidx.h[cno],Use,RecL=56,KPs=1,KLn=8,Shr',i,outIn,k 
