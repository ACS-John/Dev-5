...
00430   goto READ_2
00440 L440: mat ml$(2) 
00442   ml$(1)='There are no transactions for' 
00444   ml$(2)="the date entered.  Check the date." 
...
00490   if tcde=2 or tcde=3 then p1=68 else p1=56
...
00590   pf2=46-int(len(rtrm$(bn$))/2)
...
00640   if p1=0 then 
00642     d1$=cnvrt$("pic(####/##/##)",d1) 
00644     d3=val(d1$(6:7))*10000+val(d1$(9:10))*100+val(d1$(3:4)) 
