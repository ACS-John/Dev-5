...
! ______________________________________________________________________
	if fnps=2 then 
		mp1=72 
		open #hAcGlFnsX:=fngethandle:"Name=[Q]\GLmstr\ACGLFNSJ.h[cno],KFName=[Q]\GLmstr\FNSJINDX.h[cno],Shr" ,internal,input,keyed 
	else 
		mp1=69 
		open #hAcGlFnsX:=fngethandle:"Name=[Q]\GLmstr\ACGLFNSI.h[cno],KFName=[Q]\GLmstr\FNSIINDX.h[cno],Shr",internal,input,keyed 
	end if
	fnindex_it("[Q]\GLmstr\GLmstr.h[cno]",env$('temp')&"\fsindex.H[cno]",str$(mp1)&" 3")
	fnopenprn
