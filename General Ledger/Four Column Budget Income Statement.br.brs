...
!
	if fnps=2 then
		mp1=72
		open #hAcGlFnsX:=fngethandle:"Name=[Q]\GLmstr\ACGLFNSJ.h[cno],KFName=[Q]\GLmstr\agfsidx2.h[cno],Shr" ,internal,input,keyed
	else
		mp1=69
		open #hAcGlFnsX:=fngethandle:"Name=[Q]\GLmstr\ACGLFNSI.h[cno],KFName=[Q]\GLmstr\agfsidx3.h[cno],Shr",internal,input,keyed
	end if
