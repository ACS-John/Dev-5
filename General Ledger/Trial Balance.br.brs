...
00153   close #20: 
00160   let a$(1)="C/D" : let a$(2)="C/R" : let a$(3)="ADJ" 
00162   let a$(4)="A/P" : let a$(5)="PR" : let a$(6)="A/R" 
00164   let a$(7)="S/J" : let a$(8)="P/J" : let a$(9)=" "
...
00750   if subt=1 and olddno>0 and olddno<>dno then print #255,using L760: "FUND "&str$(olddno)&" TOTALS",fundt1,fundt2,fundt3 else goto L780
...
00780   L780: let ano=val(n$(4:9))
00790   let sno=val(n$(10:12))
00800   let begbal=begbal+bb
00810   let curbal=curbal+cb
...
00950 L950: print #255: 
00960   if subt=1 then 
00962     print #255,using L760: "Fund "&str$(olddno)&" Totals",fundt1,fundt2,fundt3
00964   end if
00970   print #255: ,"Trial Balance Proof Totals";
00980   print #255,using L990: begbal,trtotal,curbal
...
01060 HDR2: ! r:
01070   print #255,using L1090: date$('mm/dd/yy'),env$('cnam')
01080   print #255,using L1090: time$,cap$
01090   L1090: form pos 1,c 8,pos 15,cc 50
01100   print #255,using L1110: fnpedat$,"Page ",p1+=1
01110   L1110: form pos 15,cc 50,pos 115,c 5,n 4,skip 2
01120   print #255,using L1130: "Account","Reference","Beginning","Current","Ending"
01130   L1130: form pos 6,c 7,pos 70,c 9,pos 84,c 9,pos 99,c 7,pos 116,c 6,skip 1
01140   print #255,using L1150: "Number","Account Name/Transaction Description","Date  Source","Number","Balance","Activity","Balance"
01150   L1150: form pos 6,c 6,pos 17,c 36,pos 54,c 13,pos 71,c 6,pos 85,c 7,pos 99,c 8,pos 116,c 7
01160   print #255,using L1170: "__________","____________________________________","____","______","___________","_________","__________","_________"
...
01204     if pt=0 then 
01206       print #255,using L1220: dno,ano,sno,d$,bb,cb pageoflow PGOF
01208       L1220: form pos 1,pic(---),x 1,pic(------),x 1,pic(---),x 2,c 50,pos 80,pic(zz,zzz,zzz.## cr),pos 111,pic(zz,zzz,zzz.## cr),skip 2
01210     end if
01212   else 
01214     if pt=0 then 
01216       print #255,using L1250: dno,ano,sno,d$,bb pageoflow PGOF
...
01370   L1400: !
01372   if pt=0 then 
01374     print #255,using L1410: td$,tr(4),x$,ltrm$(tr$),tr(5),cb pageoflow PGOF
01376   end if
...
01380   ! Print #255,Using 'form pos 40,2*c 35,skip 2': "Total Debits: "&LTRM$(CNVRT$("PIC(ZZZZ,ZZZ,ZZZ,ZZ#.##)",TDR1)),"Total Credits: "&LTRM$(CNVRT$("PIC(ZZZZ,ZZZ,ZZZ,ZZ#.##)",ABS(TCR1)))
01382   let tdr1=tcr1=0
01384   goto L1480
01386   L1460: !
01388   if pt=0 then 
01390     print #255,using L1470: td$,tr(4),x$,ltrm$(tr$),tr(5) pageoflow PGOF
01392   end if
...
01540   if pt=0 then print #255,using L1550: "Summary Transaction",u0,cb pageoflow PGOF
01550   L1550: form pos 21,c 30,pos 95,pic(zz,zzz,zzz.## cr),pos 111,pic(zz,zzz,zzz.## cr),skip 2
01560   let u0=0
01570   L1570:  !
01580 return ! /r
01590 PGOF: ! r:
01592   print #255: newpage
01600   gosub HDR2
01610 continue ! /r
01670 XIT: let fnxit
