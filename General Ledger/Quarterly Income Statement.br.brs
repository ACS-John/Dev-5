...
dim b$*3,a$(8)*30,oldtrans$*16,g(8),accum(9,2),by(13)
...
L1530: ! r:
	...
	L1560: !
	if redir=0 then pr #255,using L1570: ' '
...
BLDPCT1: ! r:
	open #10: 'Name=[Temp]\Work.[Session],KFName=[Temp]\Addr.[Session],Replace,RecL=17,KPS=1,KLN=5',i,outIn,k
	for j=1 to lrec(3)
		...
		goto L1900
		L1890: !
		write #10,using L1840: pc1,cb-bb,cb
		L1900: !
	next j
	pc0=1
return ! /r
