...
00100   dim l4$(4)*25,l5$(4)*11,mp(4,36),dat$*20,pr$(21),td$*25
...
00160   let fntop(program$,cap$="Employee")
...
00420 ! Let FNCOMBOF("PRmstr",1,MYPOS,27,env$('Q')&"\GLmstr\PRmstr.h"&env$('cno'),1,4,5,30,'',0,PAS, "Choose from the list of employees.  Click Add Employee to add a new employee not shown on list.",0) !:
        let resp$(1)=str$(eno)
00430   let fncmdkey("E&dit",1,1,0,"")
...
00872   let fncmdkey("W-2 Suplimental",2,0,0,"W-2 Suplimental Information")
...
02670 MSGBOX4: ! 
02680   mat ml$(4) !:
        let ml$(1)="Gross pay ("&trim$(cnvrt$("pic(----,---.##)",prd(3)))&") less withholding " !:
        let ml$(2)="("&trim$(cnvrt$("pic(----,---.##)",wh))&") does not equal" !:
        let ml$(3)="the net check ("&trim$(cnvrt$("pic(----,---.##)",prd(21)))&")" !:
