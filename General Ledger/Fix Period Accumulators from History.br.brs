...
26560         let respc+=1
26580         fncreg_read("last retained earnings account - fund "&str$(fund_list(fund_item)),resp$(respc)) : let resp$(respc)=fnrgl$(resp$(respc))
...
26680       let respc+=1
26700       fncreg_read("last retained earnings account - no fund ",resp$(respc)) : let resp$(respc)=fnrgl$(resp$(respc))
26720     end if 
26740     fncmdset(2)
