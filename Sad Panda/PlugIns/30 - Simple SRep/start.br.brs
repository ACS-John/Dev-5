...
fn
def fn_srepExcludeStringLiterals$*1024(in$*1024,srepFrom$,srepTo$; ___,return$*1024,x,map$*1024,posI,posX,inLen,inQuoteS,inQuoteD,closeingQuoteD,closeingQuoteS,holdin$*1024)
	do until in$=holdin$
		holdin$=in$
		inLen=len(in$)
		map$=rpt$(' ',inLen)
