...
10030       open #h_company:=fngethandle: "Name=[Q]\PRmstr\Company.h[cno]",internal,input 
...
10130       open #h_company:=fngethandle: "Name=[Q]\PRmstr\Company.h[cno]",internal,input 
