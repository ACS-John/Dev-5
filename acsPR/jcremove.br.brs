...
00420   restore #1: 
00430   open #2: "Name=JCCAT.X,KFName=[Q]\PRmstr\CatIndx.h[cno]",internal,input,keyed 
00440   open #3: "Name=JCTRANS.X",internal,input,relative 
00450   open #11: "Name=[Q]\PRmstr\JCMSTR.h[cno]",internal,output 
00460   close #11,free: 
00470   open #11: "Name=[Q]\PRmstr\JCMSTR.h[cno],SIZE=0,RecL=300",internal,output 
00480   open #12: "Name=[Q]\PRmstr\JCCAT.H[cno]",internal,output 
00490   close #12,free: 
00500   open #12: "Name=[Q]\PRmstr\JCCAT.H[cno],SIZE=0,RecL=123",internal,output 
00510   open #13: "Name=[Q]\PRmstr\JCTRANS.h[cno]",internal,output 
00520   close #13,free: 
00530   open #13: "Name=[Q]\PRmstr\JCTRANS.h[cno],SIZE=0,RecL=88",internal,outIn,relative 
00540   ot4=1
