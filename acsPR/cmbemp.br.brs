...
def library fncmbemp(myline,mypos; addall,container)
	...
	fncombof(fen$,myline,mypos,43,"[Q]\PRmstr\rpmstr.h[cno]",1,8,9,30,'[Q]\PRmstr\rpindex.h[cno]',1+addall,0,"Select from the list of employees. To add an employee, go to the Employee File.",container)
fnend
