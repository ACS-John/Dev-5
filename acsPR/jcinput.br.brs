...
00170   for j=1 to 20 : iosc$(j)=str$(j+1)&",10,C 40,UT,N" : next j
00180   label2$(1)="Employee Number:"
00190   label2$(2)="Method of Payment:"
00200   label2$(3)="Date (mmddyy):"
00210   label2$(4)="Payroll Department Number:"
00220   label2$(5)="Regular Hours:"
00230   label2$(6)="O.T. Hours:"
00240   label2$(7)="Job Number:"
00250   label2$(8)="Category:"
00260   label2$(9)="Sub-Category Code:"
00270   label2$(10)="Amount:"
00280   label2$(11)="Deduction/Addition Code:"
00290   label2$(12)="Units:"
00300 ! ___________________________
00310   io2$(1)="6,28,G 8,UT,N"
00320   io2$(2)="7,28,n 1,UT,N"
00330   io2$(3)="8,28,n 6,UT,N"
00340   io2$(4)="9,28,n 3,UT,N"
00350   io2$(5)="10,28,n 8.2,UT,N"
00360   io2$(6)="11,28,n 8.2,UT,N"
00370   io2$(7)="12,28,c 6,UT,N"
00380   io2$(8)="13,28,n 5,UT,N"
00390   io2$(9)="14,28,n 2,UT,N"
00400   io2$(10)="15,28,n 10.2,UT,N"
00410   io2$(11)="16,28,n 2,UT,N"
00420   io2$(12)="17,28,n 8.2,UT,N"
00430 ! ___________________________
00440   for j=1 to 12 : iolabel2$(j)=str$(j+3)&",2,Cr 26,N" : next j
00450 ! ______________________________________________________________________
00460   open #1: "Name=[Q]\PRmstr\RPMSTR.h[cno],KFName=[Q]\PRmstr\RPINDEX.h[cno],Shr",internal,input,keyed 
00470   open #5: "Name=[Q]\PRmstr\RPMSTR.h[cno],KFName=[Q]\PRmstr\RPINDX2.h[cno],Shr",internal,input,keyed 
00480   open #2: "Name=[Q]\PRmstr\RPTRAIL.h[cno],Shr",internal,input,relative 
00490   open #3: "Name="&env$('temp')&"\Work."&session$&",SIZE=0,RecL=84,Replace",internal,outIn,relative 
00500   open #11: "Name=[Q]\PRmstr\JCMSTR.h[cno],KFName=[Q]\PRmstr\JCIndx.h[cno],Shr",internal,input,keyed 
00510   open #14: "Name=[Q]\PRmstr\JCMSTR.h[cno],KFName=[Q]\PRmstr\JCINDX2.H[cno],Shr",internal,input,keyed 
00520   open #12: "Name=[Q]\PRmstr\JCCAT.H[cno],KFName=[Q]\PRmstr\CatIndx.h[cno],Shr",internal,input,keyed 
00530   open #13: "Name=[Q]\PRmstr\SCMSTR.h[cno],KFName=[Q]\PRmstr\SCIndex.h[cno],Shr",internal,input,keyed 
...
00680   shoption=1 ! john did this to remove some other stuff
00690 SCREENFORINPUT2: ! 
00700   pr newpage
00710   fnopenwin(win=102,5,4,20,75,cap$)
00720   io2$(01)="04,29,G 8,UT,N"
00730   io2$(02)="05,29,N 1,UT,N"
00740   io2$(03)="06,29,N 6,UT,N"
00750   io2$(04)="07,29,N 3,UT,N"
00760   io2$(05)="08,29,N 8.2,UT,N"
00770   io2$(06)="09,29,N 8.2,UT,N"
00780   io2$(07)="10,29,C 6,UT,N"
00790   io2$(08)="11,29,N 5,UT,N"
00800   io2$(09)="12,29,N 2,UT,N"
00810   io2$(10)="13,29,N 10.2,UT,N"
00820   io2$(11)="14,29,N 2,UT,N"
00830   io2$(12)="15,29,N 8.2,UT,N"
...
00870   if shoption=1 then pr f "21,25,C 09,B,1": "Next (F1)"
00880   if shoption=1 then pr f "21,35,C 09,B,5": "Stop (F5)"
00890   if shoption=1 then pr f "21,45,C 09,B,6": "Help (F6)"
00900   if shoption=2 then pr f "21,19,C 09,B,1": "Next (F1)"
00910   if shoption=2 then pr f "21,29,C 11,B,2": "Delete (F2)"
00920   if shoption=2 then pr f "21,41,C 09,B,5": "Stop (F5)"
00930   if shoption=2 then pr f "21,51,C 09,B,6": "Help (F6)"
00940   if c1=2 or jcsrch=1 then pr #win,fields mat io2$: mat ji1,jn$,mat ji2
00950   jcsrch=0
00960   if ji1(1)=0 then io2$(4)="7,29,N 3,UT,N" : goto L1000
00970 L970: pr #win,fields mat io2$: ji1(1),ji1(2),ji1(3)
00980 ! io2$(4)="7,29,N 3,CUT,N"
...
01010   ck1=cmdkey
01020   ji1(1)=val(en$) conv L1040
01030   goto L1070
01040 L1040: ck1=6
01050   ce4=1 : nam$=uprc$(rtrm$(en$))
01060   goto L2870
01070 L1070: if ce>0 then io2$(ce)(ce1:ce2)="U": ce=0
01080   ce4=curfld
01090   if ck1>0 then goto L1230 else ce=curfld
01100   if ce<>1 then goto L1130
01110 L1110: en$=lpad$(str$(ji1(1)),8)
...
01180 L1180: io2$(ce)=rtrm$(uprc$(io2$(ce))) !:
        ce1=pos(io2$(ce),"U",1) !:
        if ce1=0 then goto L1130
01190   ce2=ce1+1 !:
        io2$(ce)(ce1:ce1)="UC" !:
        goto L1000
01200 CONV1: if ce>0 then io2$(ce)(ce1:ce2)="U"
01210   ce=cnt+1
01220 ERR1: pr f "24,78,C 1": bell : goto L1180
01230 L1230: if ck1=5 then goto WHATNOWSCREEN
01240   io2$(8)="11,29,N 5,UT,N"
...
01440   ta1=nta
01450   goto L1400
01460 L1460: if ji2(3)=0 then ji2(3)=hr(1)*ji1(5)+hr(2)*ji1(6)
...
01620   if ji2(4)<1 or ji2(4)>10 then pt=ptp/100*ji2(3) else pt=0
01630   if c1=2 then goto L1740
01640 L1640: rw=lrec(3)+1
...
02010   next j
02020   pr f "16,27,C 25,B,5": "Exit Without Posting (F5)"
...
02100   pr newpage
02110   message$="Printing Input Proof List..."
02120   fnwait(message$,1)
...
02680 ERTN: fnerror(program$,err,line,act$,"xit")
...
02870 L2870: l1=max(1,len(rtrm$(nam$)))
02880   if rtrm$(nam$)="" then prtall=1
...
03290   io2b$(1)="4,29,Cu 1,UT,N"
03300   io2b$(2)="5,29,Nz 6,UT,N"
03310   pr f "16,30,C 09,B,1": "Next (F1)"
03320   pr f "16,41,C 11,B,5": "Cancel (F5)"
03330   dv$="A"
03340 L3340: rinput #win,fields mat io2b$: dv$,td1 conv CONV2
03350   if ce>0 then io2b$(ce)(ce1:ce2)="U": ce=0
03360   if cmdkey>0 then goto L3430 else ce=curfld
03370 L3370: ce=ce+1: if ce>udim(io2b$) then ce=1
03380 L3380: io2b$(ce)=rtrm$(io2b$(ce)) !:
        ce1=pos(io2b$(ce),"U",9) !:
        if ce1=0 then goto L3370
03390   ce2=ce1+1 : io2b$(ce)(ce1:ce1)="UC" : goto L3340
03400 CONV2: if ce>0 then io2b$(ce)(ce1:ce2)="U"
03410   ce=cnt+1
03420 ERR2: pr f "24,78,C 1": bell : goto L3380
...
03510 R1: j1=val(ln$(1:8)) conv L3470
03520   if j1>0 then goto L3540
03530   goto L3470
03540 L3540: if j1=ji1(1) then goto L3470 ! TOTAL RECORD
03550   mat ji1=(0)
03560   mat ji2=(0)
03570   ji1(1)=j1 ! EMPLOYEE #
03580   ji1(2)=2 ! HOURLY
03590   ji2(1)=1 ! Category - LABOR
03600   goto L3470
03610 R2: ji2(2)=ji1(4)=val(ln$(1:10))
03620   ji1(3)=td1
03630   goto L3470
03640 R3: jn$=rtrm$(ltrm$(ln$(11:18)))
03650   for j=1 to len(jn$)
03660     if jn$(j:j)<"0" or jn$(j:j)>"9" then jn$(j:j)=""
03670   next j
03680   jn$=cnvrt$("N 6",val(jn$)) conv L3470
03690   ji1(5)=val(ln$(72:82)) ! REG HRS
03700   ji1(6)=val(ln$(83:90)) ! OVT HRS
03710   empnam$=""
03720   en$=cnvrt$("N 8",ji1(1))
...
03790   ta1=nta : goto L3750
03800 L3800: ji2(3)=hr(1)*ji1(5)+hr(2)*ji1(6)
03810   if ji2(4)<1 or ji2(4)>10 then pt=ptp/100*ji2(3) else pt=0
03820 L3820: rw=lrec(3)+1
03830 L3830: write #3,using L1660,rec=rw: mat ji1,jn$,mat ji2, pt, empnam$, sal duprec L3820
03840   goto L3470
03850 L3850: close #9: 
03860   sh$(1)="   JOB COST INPUT TIME FROM DISKETTE"
...
04080   pr f "11,32,C 16,R,N": "PRESS F5 TO STOP"
04090 L4090: input fields "7,34,C "&str$(skl(seq))&",UT,N": nam$
04100   if cmdkey=5 then goto SRCHEND
04110   if seq=1 then nam$=lpad$(rtrm$(nam$),skl(1))
04120   if seq=2 then nam$=rpad$(ltrm$(nam$),skl(2))
04130   restore #14,search>=nam$: nokey L4090
04140   close #101: ioerr L4150
04150 L4150: pr newpage
04160   pr f "1,2,C 6,R,N": "JOB #:"
04170   pr f "1,9,C 40,R,N": "JOB NAME"
04180   pr f "1,50,C 8,R,N": "EST.Date"
04190   pr f "1,59,C 10,R,N": "EST.Date"
04200   pr f "1,59,C 10,R,N": " CT.AMOUNT"
04210   pr f "1,70,C 10,R,N": "BLD.AMOUNT"
04220   cde=0
04230   for j=1 to 20
04240     read #14,using L4250: jn$,n$,mat a$,mat b eof SREND
04250 L4250: form pos 1,c 6,c 40,3*c 30,n 6,2*pd 7.2,n 2
04260     cde=1
04270     pr f str$(j+1)&",2,C 6,UT,N": jn$
04280     pr f str$(j+1)&",9,C 40,UT,N": n$
04290     pr f str$(j+1)&",50,PIC(ZZ/ZZ/ZZ),UT,N": b(1)
04300     pr f str$(j+1)&",59,N 10.2,UT,N": b(2)
04310     pr f str$(j+1)&",70,N 10.2,UT,N": b(3)
04320     if j>1 then goto L4360
04330     bk=bk+1
04340     if bk>20 then bk=1
04350     bk$(bk)=bl$(2)(1:28)
04360 L4360: next j
04370 SREND: if j>1 then j=j-1
04380   mat in2$(j)
04390   pr f "24,02,C 67,R,N": "ENTER TO CONTINUE; F2 TO BACKUP; F5 TO STOP; Select ACCOUNT Number:"
...
04480   bk=bk-1
04490 L4490: selclp=1
04500   goto L4150
04510 L4510: selclp=0
04520   goto L4020
04530 SRCHEND: if rtrm$(k$)="" or len(rtrm$(k$))>6 then alp=0: goto L4580
04540   jn$=lpad$(rtrm$(k$),6)
04550   read #11,using L4250,key=jn$: hjn$,n$,mat a$,mat b nokey L4400
04560   ti=alp=3 : jcsrch=1: io2$(8)="11,29,N 5,UC,N": restore #11: : goto SCREENFORINPUT2
