...
00820   namcde$=resp$(9)
00830   topmargin=val(resp$(10))
00840   bottom=val(resp$(11))
00850   posx=val(resp$(12))
00860   med$="Y"
00870   gosub L5540
...
01060   gosub L5770
01070   kz$=lpad$(rtrm$(str$(eno)),8)
01080   px$=""
01090   mat desc$=(" ")
01100   mat amt=(0)
01110   mat miscded=(0)
01120   tdedret=0 ! REMOVE EXPLANATION  FROM LINE 905 TO LIST RETIREMENT IN BOX 13
...
01230 L1230: if tcd<1 or tcd>10 then tcd=1
...
01280   stcode$=e$(tcd)
01290 L1290: dedfica=0
01300   dedret=0
01310   for j=1 to 20
01320     if newdedfed(j)>=1 and newdedcode(j)=1 then dedret=dedret+tcp(j+4)
01330     if dedfica(j)=1 and newdedcode(j)=1 then dedfica=dedfica+tcp(j+4)
...
01690 L1690: desc$(j)=lpad$("G "&cnvrt$("Nz 10.2",tdedret),15)
01700     goto L1720
01710 L1710: next j
...
01760 L1760: desc$(j2)=lpad$(dedcode$(j)&" "&cnvrt$("Nz 10.2",miscded(j)),15): totalbox12(j)=totalbox12(j)+miscded(j)
01770       goto L1790
01780 L1780: next j2
01790 L1790: next j
...
02180     desc$(misc)=lpad$("  "&cnvrt$("Nz 10.2", totalbox12(j)),15)
02190     misc=misc+1
...
02600   if ckey=5 then totalcode=1 : goto L2130
02610   restore #1: 
02620   numb=val(resp$(1)(1:8))
...
03130   txt$= trim$(first$)&" "&trim$(mid$)(1:1)
...
03630   txt$=box2b$&"  "&cnvrt$("pic(zz,zzz,zzz.##",box2)
...
03700 L3700: txt$=desc$(4)
03710   pr #20: 'Call Print.AddText("'&txt$&'",'&str$(column4)&','&str$(lyne)&')'
03720   txt$=box3c$&"  "&cnvrt$("pic(zz,zzz,zzz.##",box3)
...
03760   txt$=box4d$&"  "&cnvrt$("pic(zz,zzz,zzz.##",box4)
...
06180   if totalcode=0 then heading$="Enter Information from Incorrect W-2" else heading$="Total Screen for Corrected W-2s"
...
06300   fntxt(lc,mypos,10,0,0,"10") !:
        resp$(rc+=1)=str$(w(9))
06310   mypos+=37: fnlbl(lc=1,38,"Federal Wh:",mylen,1)
