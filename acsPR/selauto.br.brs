...
00930   if wk(l1)=1 then tmpyn$="Y" else tmpyn$="N"
00940   pr #win,fields str$(l1+1)&",50,C 1,N": tmpyn$
00950   if mo(l1)=1 then tmpyn$="Y" else tmpyn$="N"
00960   pr #win,fields str$(l1+1)&",61,C 1,N": tmpyn$
00970   if qt(l1)=1 then tmpyn$="Y" else tmpyn$="N"
...
01070     pgm(j1+=1)=j : sf$(j1)=str$(j1+1)&",2,C 35,N"
...
01380   if qt(l1)=1 then temp_qt$="Y" else temp_qt$="N"
01390   temp_desc$=nxtdesc$(l1)
01400   if rtrm$(temp_desc$)="" then goto CHANGE_PROGRAM
01410 L1410: rinput #win,fields mat io3$: temp_desc$,temp_wk$,temp_mo$,temp_qt$
01420   if ce>0 then io3$(ce)(ce1:ce2)="U": ce=0
01430   if cmdkey>0 then goto L1500 else ce=curfld
01440 L1440: ce=ce+1: if ce>udim(io3$) then ce=1
01450 L1450: io3$(ce)=rtrm$(io3$(ce)) : ce1=pos(io3$(ce),"U",9) !:
        if ce1=0 then goto L1440
01460   ce2=ce1+1 : io3$(ce)(ce1:ce1)="UC" : goto L1410
01470 CONV3: if ce>0 then io3$(ce)(ce1:ce2)="U"
01480   ce=cnt+1
