...
19863   c(6)=c(6)+x16
19865   c(7)=c(7)+x23
19867   c(8)=c(8)+max(x16/x23*100-x16,(x13-x16))
19869   c(9)=c(9)+x12
19871   c(10)=c(10)+x15
19873   c(11)=c(11)+x15/x12*100
19875   c(12)=c(12)+max((x12-x15),(x15/(x23/100))-x15)
19895   x6=0
19896   x7=0
19897   x8=0
19898   x9=0
19899   if sd = 1 then goto L19833
19900 L19900: pr #255, using L19910: jn$(1:6),n$(1:40),cn$(7:11),k$(1:25),c(5),c(6),c(7),c(8),c(9),c(10),c(11),c(12) pageoflow PGOF
...
20000 L20000: pr #255,using L20020: "_________","_________","_________","_________","_________","_________"
20020 L20020: form skip 0,pos 40,c 9,pos 50,c 9,pos 71,c 9,pos 88,c 9,pos 98,c 9,pos 117,c 9,skip 0
20025   pr #255, using L20026: s(5),s(6),s(8),s(9),s(10),s(12)
...
20120   gosub HDR
20140   pr #255, using L20150: t(5),t(6),t(8),t(9),t(10),t(12)
