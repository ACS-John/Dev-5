...
L19834: cn=val(cn$(7:11))
	...
	c(6)=c(6)+x16
	c(7)=c(7)+x23
	c(8)=c(8)+max(x16/x23*100-x16,(x13-x16))
	c(9)=c(9)+x12
	c(10)=c(10)+x15
	c(11)=c(11)+x15/x12*100
	c(12)=c(12)+max((x12-x15),(x15/(x23/100))-x15)
	x6=0
	x7=0
	x8=0
	x9=0
	if sd = 1 then goto L19833
L19900: pr #255, using L19910: jn$(1:6),n$(1:40),cn$(7:11),k$(1:25),c(5),c(6),c(7),c(8),c(9),c(10),c(11),c(12) pageoflow PgOf
L19910: form skip 1,pos 1,c 6,pos 10,c 40,skip 1,pos 3,c 11,pos 15,c 25,pos 40,n 9.2,pos 50,n 9.2,pos 65,n 3,pos 71,n 9.2,pos 88,n 9.2,pos 98,n 9.2,pos 113,n 3,pos 117,n 9.2,skip 0
...
L20000: pr #255,using L20020: "_________","_________","_________","_________","_________","_________"
L20020: form skip 0,pos 40,c 9,pos 50,c 9,pos 71,c 9,pos 88,c 9,pos 98,c 9,pos 117,c 9,skip 0
	pr #255, using L20026: s(5),s(6),s(8),s(9),s(10),s(12)
L20026: form skip 1,"Job Totals",pos 40,n 9.2,pos 50,n 9.2,pos 71,n 9.2,pos 88,n 9.2,pos 98,n 9.2,pos 117,n 9.2,skip 1
	mat s=(0)
	goto PRTRPT
SND: !
	pr #255: newpage
	gosub HDR
	pr #255, using L20150: t(5),t(6),t(8),t(9),t(10),t(12)
