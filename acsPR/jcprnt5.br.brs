...
19861   let c(5)=c(5)+x13
19863   let c(6)=c(6)+x16
19865   let c(7)=c(7)+x23
19867   let c(8)=c(8)+max(x16/x23*100-x16,(x13-x16))
19869   let c(9)=c(9)+x12
19871   let c(10)=c(10)+x15
19873   let c(11)=c(11)+x15/x12*100
19875   let c(12)=c(12)+max((x12-x15),(x15/(x23/100))-x15)
19895   let x6=0
19896   let x7=0
19897   let x8=0
19898   let x9=0
19899   if sd = 1 then goto L19833
19900 L19900: print #255, using L19910: jn$(1:6),n$(1:40),cn$(7:11),k$(1:25),c(5),c(6),c(7),c(8),c(9),c(10),c(11),c(12) pageoflow PGOF
19910 L19910: form skip 1,pos 1,c 6,pos 10,c 40,skip 1,pos 3,c 11,pos 15,c 25,pos 40,n 9.2,pos 50,n 9.2,pos 65,n 3,pos 71,n 9.2,pos 88,n 9.2,pos 98,n 9.2,pos 113,n 3,pos 117,n 9.2,skip 0
...
20000 L20000: print #255,using L20020: "_________","_________","_________","_________","_________","_________"
20020 L20020: form skip 0,pos 40,c 9,pos 50,c 9,pos 71,c 9,pos 88,c 9,pos 98,c 9,pos 117,c 9,skip 0
20025   print #255, using L20026: s(5),s(6),s(8),s(9),s(10),s(12)
20026 L20026: form skip 1,"Job Totals",pos 40,n 9.2,pos 50,n 9.2,pos 71,n 9.2,pos 88,n 9.2,pos 98,n 9.2,pos 117,n 9.2,skip 1
20030   mat s=(0)
20040   goto PRTRPT
20100 SND: ! 
20110   print #255: newpage
20120   gosub HDR
20140   print #255, using L20150: t(5),t(6),t(8),t(9),t(10),t(12)
20150 L20150: form skip 2,"Grand Totals",pos 40,n 9.2,pos 50,n 9.2,pos 71,n 9.2,pos 88,n 9.2,pos 98,n 9.2,pos 117,n 9.2,skip 1
20160   goto EOF1
