! Replace S:\acsPR\PullLayDept! only use for payroll (need to send out S:\acsPR\Layouts\chechhistory.lay and department.lay for any one trying to use this
! ______________________________________________________________________
	library 'S:\Core\Library': fnerror,fnsetmonth,fnxit,fnDedNames,fnbooktitle$
...
! 
	...
	outputfile$="[Q]\acsPR\grid\departments\department.fil"
	ev$="S:\acsPR\Layouts\department.LAY"
...
XIT: fnxit ! pr f "24,1,C 7,UT,N": "Done..."
	stop 
! ______________________________________________________________________
MOVEITTOTEXT: ! 
