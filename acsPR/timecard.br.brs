...
00350   pr fields "16,35,C 09,B,5": "Exit (F5)"
...
00410   pr fields mat fl1$: mat sc1$
00420   pr fields "24,11,C 09,B,1": "Next (F1)"
00430   pr fields "24,21,C 10,B,2": "Print (F2)"
00440   pr fields "24,32,C 26,B,3": "Skip to Next Employee (F3)"
00450   pr fields "24,59,C 09,B,5": "Stop (F5)"
...
00520   pr fields "1,35,C 30,R,N": em$
00530   goto L550
...
00760   pr fields str$(ln)&",55,N 6.2,H,N": hrs(ln-3)
00770   ce=ln*5-12
...
00820   if ln<23 then pr fields str$(ln+1)&",15,N 6,UT,N": dt
00830   pr fields "2,55,N 6.2,R,N": sum(hrs)
00840   goto L460
