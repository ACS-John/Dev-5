...
00430   for j=1 to 20
00440     let ab$(j)=lpad$(rtrm$(ab$(j)),8)
00450   next j
00460   gosub L1000
...
00510   let checkkey$=cnvrt$("pic(ZZZZZZZ#)",eno)&"         "
...
00582 !  print #255: 'employee number: '&str$(heno)&' employee record: '&str$(rec(h_employee))&' check number: '&str$(ckno)&' check history record number: '&str$(rec(h_checks))
00590   print #255,using L650: prd,cp(31),cp(2)+cp(3),cp(1),cp(4),cp(5),cp(6),cp(7),cp(8),cp(9),cp(10),cp(11),cp(12),cp(13),cp(14),cp(32),cp(2)+cp(3) pageoflow PGOF
00600   if cp(15)+cp(16)+cp(17)+cp(18)+cp(19)+cp(20)+cp(21)+cp(22)+cp(23)+cp(24) =0 then goto L640
00610   print #255,using L620: ab$(11),ab$(12),ab$(13),ab$(14),ab$(15),ab$(16),ab$(17),ab$(18),ab$(19),ab$(20)
00620 L620: form pos 61,10*c 10
00630   print #255,using L640: cp(15),cp(16),cp(17),cp(18),cp(19),cp(20),cp(21),cp(22),cp(23),cp(24) pageoflow PGOF
...
00710 PGOF: ! 
00720   print #255: newpage
00730   gosub L1000
00740   continue 
00750 ! ______________________________________________________________________
00760 TOTAL_THAT: ! 
00770   print #255,using L780: "Total",t(31),t(2)+t(3),t(1),t(4),t(5),t(6),t(7),t(8), t(9),t(10),t(11),t(12),t(13),t(14),t(32),t(2)+t(3) pageoflow PGOF
...
00800   print #255,using L640: t(15),t(16),t(17),t(18),t(19),t(20),t(21),t(22),t(23),t(24) pageoflow PGOF
00810 L810: print #255,using L820: "Calculated Tax Deposit:" ,"Medicare W/H",t(3),"SS Withholding",t(2),"Federal Withholding",t(1),"Employer's FICA Match",round(t(2)/ssr1*ssr2,2)+t(3),"Less EIC",-t(25),"Total Deposit",t(3)+t(2)+t(1)+round(t(2)/ssr1*ssr2,2)+t(3)-t(25) ! 2013
...
01000 L1000: ! 
01002   print #255,using "form pos 1,c 25": "Page "&str$(pgno+=1)&" "&date$
01010   print #255: "\qc  {\f221 \fs22 \b "&env$('cnam')&"}"
01020   print #255: "\qc  {\f201 \fs20 \b "&env$('program_caption')&"}"
01030   print #255: "\qc  {\f181 \fs16 \b From: "&cnvrt$("pic(zzzz/zz/zz)",beg_date)&"  To: "&cnvrt$("pic(zzzz/zz/zz)",end_date)&"}"
01040   print #255: "\ql   "
01050 ! Print #255,Using 1060: TIME$,"From ",BEGD," To ",ENDD
01070   print #255,using L1080: "Date","     Gross","   FICA/ME","   Federal","     State",ab$(1),ab$(2),ab$(3),ab$(4),ab$(5),ab$(6),ab$(7),ab$(8),ab$(9),ab$(10),"   Net","  Emp FICA"
...
01170   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
