...
00290   let beg_date=val(resp$(1)) ! beginning of year
...
00355   let ficamaxw=ficamaxw*10
...
00420 ! 
00430 ! 
00440   for j=1 to 20: let abbrevname$(j)=lpad$(rtrm$(abbrevname$(j)),6) : next j
00450   gosub HDR
...
00490   let checkkey$=cnvrt$("pic(zzzzzzz#)",eno)&cnvrt$("pic(zz#)",0)&cnvrt$("pd 6",0) ! index employee#,department# and payroll date
...
00600   next j
00610   print #255,using L660: eno,em$(1:18),t1(1),t1(2),t1(3),t1(4),t1(5),t1(6),t1(7),t1(8),t1(9),t1(10) pageoflow NEWPGE
00620   for j=1 to 10
...
00670 L670: print #255,using L680: t1(11),t1(12),t1(13),t1(14),t1(15),t1(16),t1(17),t1(18),t1(19),t1(20) pageoflow NEWPGE
...
00720 EOJ: ! 
00730   print #255,using L740: rpt$("  ________",10)
00740 L740: form pos 29,c 100,skip 1
00750   print #255,using L660: "","Totals",t2(1),t2(2),t2(3),t2(4),t2(5),t2(6),t2(7),t2(8),t2(9),t2(10)
00760   for j=1 to 10
00770     if trim$(abbrevname$(j+10))<>"" then goto L800 ! have more than 10 deductions
00780   next j
00790   goto L810
00800 L800: print #255,using L680: t2(11),t2(12),t2(13),t2(14),t2(15),t2(16),t2(17),t2(18),t2(19),t2(20)
...
00880 NEWPGE: print #255: newpage : gosub HDR : continue 
00890 ! ______________________________________________________________________
00900 HDR: ! 
00910   print #255,using "form pos 1,c 25": "Page "&str$(pgno+=1)&" "&date$
00920   print #255: "\qc  {\f221 \fs22 \b "&env$('cnam')&"}"
00930   print #255: "\qc  {\f201 \fs20 \b "&env$('program_caption')&"}"
00940   print #255: "\qc  {\f181 \fs16 \b From: "&cnvrt$("pic(zzzz/zz/zz)",beg_date)&" To: "&cnvrt$("pic(zzzz/zz/zz)",end_date)&"}"
00950   print #255: "\qc  {\f181 \fs16 \b "&trim$(dat$)&"}"
00960   print #255: "\ql   "
00970   print #255,using L980: "Emp-Numb  Employee Name",abbrevname$(1),abbrevname$(2),abbrevname$(3),abbrevname$(4),abbrevname$(5),abbrevname$(6),abbrevname$(7),abbrevname$(8),abbrevname$(9),abbrevname$(10)
00980 L980: form pos 1,c 32,9*c 10,c 6
00990   print #255: "________  __________________";rpt$("  ________",10)
01000   for j=1 to 10
01010     if trim$(abbrevname$(j+10))<>"" then goto L1040 ! have more than 10 deductions
01020   next j
01030   goto L1070
01040 L1040: print #255,using L1050: abbrevname$(11),abbrevname$(12),abbrevname$(13),abbrevname$(14),abbrevname$(15),abbrevname$(16),abbrevname$(17),abbrevname$(18),abbrevname$(19),abbrevname$(20)
01050 L1050: form pos 38,10*c 10
01060   print #255: "                                 ";rpt$("  ________",10)
01070 L1070: return 
01080 XIT: let fnxit
