...
19861   let c(5)=c(5)+x12+x14
19863   let c(6)=c(6)+x18+x20
19865   let c(7)=c(7)+x15+x17
19867   let c(8)=c(5)-c(7)
19895   let x6=0
19896   let x7=0
19897   let x8=0
19898   let x9=0
19899   if sd = 1 then goto L19833
19900 L19900: print #255, using L19910: jn$(1:6),n$(1:40),cn$(7:11),k$(1:25),c(5),c(6),c(7),c(8) pageoflow PGOF
...
20000 L20000: print #255,using L20020: "_________","_________","_________","_________"
20020 L20020: form skip 0,pos 53,c 9,pos 72,c 9,pos 84,c 9,pos 102,c 9,skip 0
20025   print #255, using L20026: s(5),s(6),s(7),s(8)
...
20120   gosub HDR
20140   print #255, using L20150: t(5),t(6),t(7),t(8)
