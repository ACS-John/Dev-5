...
00160   fncno(cno)
00170   open #1: "Name=[Q]\PRmstr\NewPrPgmn.h[cno],Use,RecL=61",internal,outIn,relative ioerr MAIN
...
00620   if ckey=4 then mat nxtdesc$=(""): !:
          ...
          mat mo=(0) !:
          mat qt=(0) !:
          execute "drop [Q]\PRmstr\NewPrPgmn.h[cno] -n" !:
          goto MAIN
...
00760   execute "drop [Q]\PRmstr\NewPrPgmn.h[cno] -n"
00770   close #1: ioerr L780
00780 L780: open #1: "Name=[Q]\PRmstr\NewPRPgmn.h[cno],Use,RecL=61",internal,outIn,relative 
