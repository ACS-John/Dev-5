...
15800   let beg_date=val(resp$(1)) ! beginning of year
...
18300 ! print #255: '     *Read h_department: teno='&str$(teno)&', workman_comp='&str$(workman_comp)
...
18800     let checkkey$=cnvrt$("pic(zzzzzzz#)",teno)&cnvrt$("pic(zz#)",tdept)&cnvrt$("pd 6",beg_date) ! index employee#,department# and payroll date
18810 ! let checkkey$=cnvrt$("pic(zzzzzzz#)",teno)&cnvrt$("pic(zz#)",0)&cnvrt$("pd 6",0) ! index employee#,department# and payroll date
19000     restore #h_payrollchecks,key>=checkkey$: nokey NEXT_DEPARTMENT
19020 ! print #255: '     *restore h_payrollchecks: '&checkkey$
19100     do 
...
20520 !         print #255: ' *(c) read h_payrollchecks: heno='&str$(heno)&',tdn='&str$(tdn)&',prd='&str$(prd)&',ckno='&str$(ckno)
20600             let fn_add_wages
20800 !       else 
20900 !         pr #255: '(B)'
21000 !         let fn_print_accumulated ! goto NEXT_DEPARTMENT ! same employee and same code else print it
21200           end if 
21400         else 
21600           let is_first=0
21800           let prev_comp=workman_comp
22000           let holdeno=teno
22020 !        print #255: ' *(d) read h_payrollchecks: heno='&str$(heno)&',tdn='&str$(tdn)&',prd='&str$(prd)&',ckno='&str$(ckno)
...
28200 PA_CONTINUE: ! 
28220     print #255,using L620: ename$,tdept,prev_comp,totwage,wcwage pageoflow PGOFLOW
...
30400     print #255,using F_TOTAL: "Subtotal",subtot(1),subtot(2)
30600 F_TOTAL: form pos 6,c 8,pos 37,pic(---,---,---.##),pos 51,pic(---,---,---.##),skip 2
30800     mat tottot=tottot+subtot
31000     mat subtot=(0)
31200   fnend 
31400   def fn_hdr
31600     print #255,using "form pos 1,c 25": "Page "&str$(pgno+=1)&" "&date$
31800     print #255: "\qc  {\f221 \fs22 \b "&env$('cnam')&"}"
32000     print #255: "\qc  {\f201 \fs20 \b "&env$('program_caption')&"}"
32200     print #255: "\qc  {\f181 \fs16 \b From: "&cnvrt$("pic(zzzz/zz/zz)",beg_date)&" To: "&cnvrt$("pic(zzzz/zz/zz)",end_date)&"}"
32400     print #255: "\qc  {\f181 \fs16 \b "&trim$(dat$)&"}"
32600     print #255: "\ql   "
32800     print #255,using L1040: "Workmans                Workmans"
33000 L1040: form pos 33,c 32
33200     print #255,using L1060: "Comp       Total        Comp"
33400 L1060: form pos 35,c 28
33600     print #255,using L1080: "Employee Name","Dept","Code","Wages","Wages"
...
81190   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
