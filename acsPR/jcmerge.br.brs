...
00260   let ji2(6)=ji2(3)
00270   let ji2(3)=0
00280 L280: let jn$=lpad$(rtrm$(jn$),6)
...
00320   let h(6)=sal
00330   let dt2=fndate_mmddyy_to_ccyymmdd(ji1(3))
...
00380   let h(2)=ji1(2)
00390   let h(3)=ji1(4)
00400 L400: let h(4)=h(4)+ji1(5)
00410   let h(5)=h(5)+ji1(6)
00420   if ji2(4)<1 or ji2(4)>10 then let h(6)=ji2(3) else let h(6)=ji2(6)
00430   let h(7)=ji2(4)
00440   if ltrm$(jn$)="" or rtrm$(ltrm$(jn$))="0" then goto L220
00450   let cn$=jn$&lpad$(str$(ji2(1)),5)
...
00720 L720: let dt2=fndate_mmddyy_to_ccyymmdd(ji1(3))
