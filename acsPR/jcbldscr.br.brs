...
00180     let io1$(j)=str$(j+2)&",23,C 30,UT,N" : goto L240
00190 L190: if j>6 then goto L210
00200     let io1$(j)=str$(j+2)&",23,N 6,UT,N" : goto L240
00210 L210: if j>8 then goto L230
00220     let io1$(j)=str$(j+2)&",23,N 14.2,UT,N" : goto L240
...
00300     let io2$(j)=str$(j+2)&",23,C 25,UT,N" : goto L340
...
00490   read mat sc3$
00500   let io3$(1)="4,34,C 12,UT,N"
00510   let io3$(2)="5,34,C 6,UT,N"
00520   let io3$(3)="6,34,N 5,UT,N"
00530   let io3$(4)="7,34,N 2,UT,N"
00540   let io3$(5)="8,34,N 3,UT,N"
00550   let io3$(6)="9,34,N 6,UT,N"
00560   for j=7 to 10
00570     let io3$(j)=str$(j+3)&",34,N 8.2,UT,N"
00580   next j
00590   let io3$(11)="14,34,N 10.2,UT,N"
00600   let io3$(12)="15,34,C 30,UT,N"
