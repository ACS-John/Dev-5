...
00110 ! 
00120   open #4: "Name="&env$('Q')&"\PRmstr\PRCkHist.h"&str$(cno)&",RecL=150,USE",internal,output 
00130   close #4: 
00140   execute "Index "&env$('Q')&"\PRmstr\PRCkHist.h"&str$(cno)&' '&env$('Q')&"\PRmstr\PRCKINDX.h"&str$(cno)&" 1 14 Replace DupKeys -n"
