...
00150 ! 
00160   execute "Copy [Q]\PRmstr\JCMSTR.h[cno],X -D -n"
00170   open #2: "Name=X",internal,outIn,relative 
00180   open #1: "Name=[Q]\PRmstr\JCMSTR.h[cno],RecL=300,Replace",internal,outIn,relative 
...
00260   close #1: 
00270   close #2: 
00280   execute "Index [Q]\PRmstr\JCMSTR.h[cno],[Q]\PRmstr\JCIndx.h[cno],1,6,Replace,DupKeys -n"
00290   execute "Copy [Q]\PRmstr\JCCAT.H[cno],X -D -n"
00300   open #2: "Name=X",internal,outIn,relative 
00310   open #1: "Name=[Q]\PRmstr\JCCAT.H[cno],RecL=123,Replace",internal,outIn,relative 
...
00380   close #1: 
00390   close #2: 
00400   execute "Index [Q]\PRmstr\JCCAT.H[cno],[Q]\PRmstr\CatIndx.h[cno],1,11,Replace,DupKeys"
00410   pr f "12,5,C 60": "COMPLETED CONVERTING JOB FILE FOR COMPANY #: [cno]"
