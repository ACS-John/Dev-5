...
00210   open #4: "Name="&env$('Q')&"\PRmstr\PRCkHist.h"&str$(cno)&",RecL=150,USE",internal,outin 
...
00350 L350: close #4: 
00360   execute "Index "&env$('Q')&"\PRmstr\PRCkHist.h"&str$(cno)&' '&env$('Q')&"\PRmstr\PRCKINDX.h"&str$(cno)&" 1 14 Replace DupKeys -n"
