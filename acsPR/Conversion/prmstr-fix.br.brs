...
00420   close #12,free: 
00430   close #13: 
00440   execute "RENAME RPMSTR.X "&env$('Q')&"\PRmstr\RPMSTR.h"&str$(cno)&" -n"
00450   execute "RENAME RPTRAIL.X "&env$('Q')&"\PRmstr\RPTRAIL.h"&str$(cno)&" -n"
00460   execute "Index "&env$('Q')&"\PRmstr\RPMSTR.h"&str$(cno)&' '&env$('Q')&"\PRmstr\RPINDEX.h"&str$(cno)&" 1 8 Replace DupKeys -n"
00470   execute "Index "&env$('Q')&"\PRmstr\RPMSTR.h"&str$(cno)&' '&env$('Q')&"\PRmstr\RPINDX2.h"&str$(cno)&" 9 30 Replace DupKeys -n"
00480 XIT: stop 
