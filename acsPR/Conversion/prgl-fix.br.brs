...
! CREATE GL ENTRIEX
	...
	open #2: "Name=[Q]\PRmstr\RPMstr.h[cno],KFName=[Q]\PRmstr\RPIndex.h[cno],Shr",i,outIn,k
	open #3: "Name=[Q]\PRmstr\RPTRAIL.h[cno],Shr",i,outi,r
	open #4: "Name=[Q]\PRmstr\PRCkHist.h[cno],KFName=[Q]\PRmstr\PRCKINDX.h[cno],Shr",i,outIn,k
	open #5: "Name=[Temp]\Work.[Session],KFName=[Temp]\Addr.[Session],RecL=30,KPS=1,KLN=12,Replace",i,outIn,k
	io5$(1)="11,55,N 6,U,N"
	io5$(2)="12,55,N 6,U,N"
	pr newpage
