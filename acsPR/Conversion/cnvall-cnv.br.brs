...
00280 L280: close #1: 
00290   close #2: 
00300   execute "Copy "&env$('Q')&"\CLmstr\PayTrans.h"&env$('cno')&",X -D -n"
00310   execute "Copy X "&env$('Q')&"\CLmstr\PayTrans.h"&env$('cno')&"  -95 -n"
00320   execute "Index "&env$('Q')&"\CLmstr\PayTrans.h"&env$('cno')&","&env$('Q')&"\CLmstr\UnPdIdx1.h"&env$('cno')&",1,20,Replace,DupKeys -n"
00330   open #1: "Name="&env$('Q')&"\CLmstr\PayTrans.h"&env$('cno')&",KFName="&env$('Q')&"\CLmstr\UnPdIdx1.h"&env$('cno'),internal,outIn,keyed 
00340   open #2: "Name="&env$('Q')&"\CLmstr\UnPdAloc.h"&env$('cno')&",SIZE=0,RecL=70,Replace",internal,outIn,relative 
...
00460 L460: close #1: 
00470   close #2: 
00480   open #1: "Name="&env$('Q')&"\CLmstr\FUNDMSTR.h"&env$('cno')&",KFName="&env$('Q')&"\CLmstr\FundIdx1.h"&env$('cno'),internal,outIn,keyed ioerr NF1
...
00560 L560: close #1: 
00570 L570: close #2: 
00580   execute "COPY X,"&env$('Q')&"\CLmstr\FUNDMSTR.h"&env$('cno')&" -n"
00590   execute "Index "&env$('Q')&"\CLmstr\FUNDMSTR.h"&env$('cno')&","&env$('Q')&"\CLmstr\FundIdx1.h"&env$('cno')&",1,3,Replace,DupKeys -n"
00600   execute "Index "&env$('Q')&"\CLmstr\FUNDMSTR.h"&env$('cno')&","&env$('Q')&"\CLmstr\FundIdx2.h"&env$('cno')&",4,28,Replace,DupKeys -n"
00610   goto L730
00620 ! ______________________________________________________________________
00630 L630: pr newpage
00640   pr f "12,5,C 60": "COMPLETED CONVERTING FILES FOR COMPANY #: "&env$('cno')
...
00740   execute "Copy "&env$('Q')&"\CLmstr\TRALLOC.h"&env$('cno')&" X -79 -n"
00750   fnFree(env$('Q')&"\CLmstr\TRALLOC.h"&env$('cno'))
00760   execute "Rename X "&env$('Q')&"\CLmstr\TRALLOC.h"&env$('cno')&" -n"
00770   goto L630
