...
00280 L280: close #1: 
00290   close #2: 
00300   execute "Copy [Q]\CLmstr\PayTrans.h[cno],X -D -n"
00310   execute "Copy X [Q]\CLmstr\PayTrans.h[cno]  -95 -n"
00320   execute "Index [Q]\CLmstr\PayTrans.h[cno],[Q]\CLmstr\UnPdIdx1.h[cno],1,20,Replace,DupKeys -n"
00330   open #1: "Name=[Q]\CLmstr\PayTrans.h[cno],KFName=[Q]\CLmstr\UnPdIdx1.h[cno]",internal,outIn,keyed 
00340   open #2: "Name=[Q]\CLmstr\UnPdAloc.h[cno],SIZE=0,RecL=70,Replace",internal,outIn,relative 
