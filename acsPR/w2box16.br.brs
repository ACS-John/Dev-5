...
00190   io1$(3)="7,46,G 1,UT,N"
00200   io1$(4)="7,52,G 1,UT,N"
00210   io1$(5)="7,58,G 1,UT,N"
00220   for j=1 to 5
00230     io1$(j+05)="08"&io1$(j)(2:18)
00240     io1$(j+10)="10"&io1$(j)(2:18)
00250     io1$(j+15)="11"&io1$(j)(2:18)
00260     io1$(j+20)="12"&io1$(j)(2:18)
00270     io1$(j+25)="13"&io1$(j)(2:18)
00280   next j
...
00310   hd$(1)="    Add W-2 Special Info"
00320   hd$(2)=" Maintaining W-2 Special Info"
...
00840   if ce>0 then io1$(ce)(ce1:ce2)="U" : ce=0
...
00890   ce2=ce1+1 : io1$(ce)(ce1:ce1)="UC" : goto L830
00900 CONV1: if ce>0 then io1$(ce)(ce1:ce2)="U"
00910   ce=cnt+1
00920 ERR1: pr f "24,78,C 1": bell : goto L880
00930 L930: if cmdkey=2 then t$="" : goto L1040
00940   if cmdkey=5 then goto MENU1
00950   for j=1 to 6
00960     ce=j*5-3
00970     in1$(ce)=cnvrt$("N 10.2",val(in1$(ce))) conv ERR1
00980     for j1=1 to 3
00990       ce=j*5-3+j1
01000       in1$(ce)=str$(val(in1$(ce))) conv ERR1
...
01160 L1160: mtype=2
01170   msgline$(1)="Delete this record (Y/N)"
01180   fnoldmsgbox(mat response$,cap$,mat msgline$,mtype)
01190   if uprc$(response$(1))="Y" then d1=1 else d1=0
01200   goto L1280
...
03590 ERTN: fnerror(program$,err,line,act$,"xit")
