...
00460   let wrd1$(4)="4. Print Proof List"
00470   let wrd1$(5)="5. Reorganize"
00480   print fields "15,35,C 09,B,5": "Exit (F5)"
...
00620   print fields "3,10,C 20": "Employee #:"
...
00700 L700: print fields "16,20,C 45": "Effect on wages (0=None, 1=Add, 2=Subtract)"
00710   print fields "6,20,C 45": "Description     Amount   Fed  Fica  State"
00720   print fields "7,11,Cr 8,N": "Box 11:"
00730   print fields "8,11,Cr 8,N": "Unused:"
00740   print fields "10,11,Cr 8,N": "Box 12a:"
00750   print fields "11,11,Cr 8,N": "Box 12b:"
00760   print fields "12,11,Cr 8,N": "Box 12c:"
00770   print fields "13,11,Cr 8,N": "Box 12d:"
00780   print fields "18,20,C 9,B,1": "Next (F1)"
00790   print fields "18,31,C 11,B,2": "Delete (F2)"
00800   print fields "18,44,C 9,B,5": "Exit (F5)"
00810   if ti=2 then goto L830
00820 L820: print fields mat io1$: mat in1$
00830 L830: input fields mat io1$: mat in1$ conv CONV1
00840   if ce>0 then let io1$(ce)(ce1:ce2)="U" : let ce=0
00850   goto L930 ! IF CMDKEY>0 THEN GOTO 619 ELSE LET CE=CURFLD+1
...
00890   let ce2=ce1+1 : let io1$(ce)(ce1:ce1)="UC" : goto L830
...
01230   goto L590
01240 L1240: if ltrm$(k$)<>"0" then print fields "24,2,C 50,R,N": " ENTER 1 TO CHANGE EMPLOYEE # OR 0 TO CORRECT: "
01250   print fields "24,2,C 1": bell
01260 L1260: input fields "24,60,N 1,UET,N": d1 conv L1260
01270   print fields "24,1,C 80,N": ""
...
01500   print fields "5,13,Cc 52,R,N": cnam$
01510   print fields "6,13,Cc 52,R,N": "COMPANY NUMBER "&str$(cno)
01520   print fields "8,13,C 52,R,N": " ******************   WARNING   ******************"
01530   print fields "10,13,C 52,N": "  This selection will destroy all existing records"
01540   print fields "11,13,C 52,N": "  in the W-2 Box 12 File."
01550   print fields "16,33,C 11,B,5": "Cancel (F5)"
01560   print fields "13,15,C 47,R,N": " Enter ERASE to destroy all records in"
01570   print fields "14,15,C 47,R,N": " the W-2 Box 12 file:"
01580   input fields "14,40,Cu 5,UT,N": pas$
01590   if cmdkey=5 then goto MENU1
01600   if uprc$(pas$)="ERASE" then let cont=1 else let cont=2
...
01720 L1720: print #99: "CLEAR"
01730   print #99: "PROCERR RETURN"
01740   print #99: "Index "&env$('Q')&"\PRmstr\W2Box16.h"&str$(cno)&","&env$('Q')&"\PRmstr\W2Index.h"&str$(cno)&",1,8,Replace,DupKeys"
01750   if cont=1 then print #99: "LOAD S:\acsPR\W2Box16" else print #99: "LOAD menu"
01760   print #99: "RUN"
01770   close #99: 
...
01830   print fields "10,12,C 50": "Employee # to Start With (blank for all):"
01840   print fields "12,28,c 9,B,1": "Next (F1)"
01850   print fields "12,39,c 11,B,5": "Cancel (F5)"
...
02000   print #255: 
02010   print #255: "EMPLOYEE #: ";t$
02020   print #255,using L2080: "Box 11",in1$(1),val(in1$(2)),val(in1$(3)),val(in1$(4)),val(in1$(5))
02030   print #255,using L2080: "Unused",in1$(6),val(in1$(7)),val(in1$(8)),val(in1$(9)),val(in1$(10))
02040   print #255,using L2080: "Box 12a",in1$(11),val(in1$(12)),val(in1$(13)),val(in1$(14)),val(in1$(15))
02050   print #255,using L2080: "Box 12b",in1$(16),val(in1$(17)),val(in1$(18)),val(in1$(19)),val(in1$(20))
02060   print #255,using L2080: "Box 12c",in1$(21),val(in1$(22)),val(in1$(23)),val(in1$(24)),val(in1$(25))
02070   print #255,using L2080: "Box 12d",in1$(26),val(in1$(27)),val(in1$(28)),val(in1$(29)),val(in1$(30))
...
03150 PRNBELL: ! print bell
03160   print fields "24,1,C 7,N": bell$
03170   return 
...
03410   print #win: newpage
03420   print #win,fields "1,1,Cc "&str$(win_width)&",R,N": cnam$(1:min(40,win_width))
03430   print #win,fields "2,1,Cc "&str$(win_width)&",R,N": "Company Number "&str$(cno)(1:min(40,win_width))
03440   return 
...
03620   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
