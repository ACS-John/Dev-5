...
00350 ADD_EDIT_REC: ! 
00360   let deptname$="": read #9,using "form pos 4,c 20",key=rpad$(ltrm$(dp$),3): deptname$ nokey L370
00370 L370: if addrec=1 then let dp$="": mat mgl$=(""): goto L400
00380   let k$=dp$=lpad$(uprc$(rtrm$(dp$)),3)
...
00570   let mgl$(1)=fnagl$(resp$(2)) ! fica
00580   let x=2
00590   for j=1 to 20
00600     if dedcode(j)=3 then goto L610 else goto L620
00610 L610: let mgl$(j+1)=fnagl$(resp$(x+=1))
00620 L620: next j
