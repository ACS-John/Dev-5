...
00190     print #255,using "form pos 1,c 25": "Page "&str$(pgno+=1)&" "&date$
00200     print #255: "\qc  {\f221 \fs22 \b "&env$('cnam')&"}"
00210     print #255: "\qc  {\f201 \fs20 \b "&env$('program_caption')&"}"
00220     print #255: "\qc  {\f181 \fs16 \b "&trim$(dat$)&"}"
00230     print #255: "\ql   "
00240 ! form skip 2,pos 1,c 8,pos nametab,c 40,skip 1,pos 1,c 8,pos 51,c 30,skip 2
00250     print #255,using 'form pos 1,c 13,pos 20,pic(zz)': "Report Number",rn
00270     print #255,using 'form pos 1,c 12,pos 20,c 78': "Report Title",rt$
00290     print #255,using 'form pos 1,c 15,skip 2,c 132': "Column Headings",ch$(1)
00310     print #255,using 'form pos 1,c 132': ch$(2)
00312     print #255: ''
00330     print #255,using 'form pos 1,c 25,pos 30,pic(zz#)': "Item Number for Print Sel",ips
00350     print #255,using 'form pos 1,c 26,pos 32,pic(#)': "Summarize Departments",sd
00370 ! Print #255,Using 360: "Use Condensed Print",CP
00380     for j=1 to 100
00390       if psc(j)=0 then goto L490
00400       if j><48 then goto L450
00410       print #255: newpage
00412       print #255: ''
00414       print #255: ''
00420       print #255,using L460: "Print Selection Criteria",psc(j)
00440       goto L470
00450 L450: ! 
00452       print #255,using L460: "PRINT SELECTION CRITERIA",psc(j)
...
00510       print #255,using 'form pos 1,c 20,pos 25,pic(zzz),pos 35,c 14,pos 49,pic(zzz),pos 65,c 15,pos 85,pic(#)': "Item Number to Print",inp(j), "Print Position",pp(j), "Total this Item",ti(j)
00530     next j
00540 L540: ! 
00542     print #255: newpage
00550   loop 
00560 L560: ! 
