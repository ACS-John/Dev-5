...
00170   open #1: "Name=[Q]\PRmstr\RPNAMES.H[cno],Shr",internal,input 
...
00220   gosub SORTIT
00230   open #1: "Name=[Q]\PRmstr\RPMSTR.h[cno],KFName=[Q]\PRmstr\RPINDEX.h[cno],Shr",internal,outIn,keyed 
00240   open #2: "Name=[Q]\PRmstr\RPTRAIL.h[cno],Shr",internal,outIn,relative 
00250   open #3: "Name=[Q]\PRmstr\rpwork"&wsid$&".h[cno],SIZE=0,RecL=117,Replace",internal,output 
00260   open #4: "Name="&env$('Temp')&"\Addr."&session$,internal,input 
00270   open #5: "Name=[Q]\PRmstr\JCPRH1.H[cno]",internal,input,relative 
...
01810   close #3: 
01820   open #3: "Name=[Q]\PRmstr\rpwork"&wsid$&".h[cno]",internal,outIn,relative 
01830   label1$(20)=" "
01840   label1$(21)=" "
...
02740   r=0
02750   close #3: 
02760   open #3: "Name=[Q]\PRmstr\rpwork"&wsid$&".h[cno]",internal,output 
02770   s9=0
...
02850   close #4: 
02860   close #5: 
02870   open #5: "Name=[Q]\PRmstr\JCPRH1.H[cno]",internal,output ioerr L2890
02880   close #5,free: 
02890 L2890: open #5: "Name=[Q]\PRmstr\JCPRH1.H[cno],SIZE=0,RecL=40",internal,output 
02900   close #5: 
...
02970   open #2: "Name=[Q]\PRmstr\JCPRH1.H[cno]",internal,input 
02980   write #1,using L3030: "! SORT FOR TRANSFER JC TO PR IN PROCESS"
02990   write #1,using L3030: "FILE [Q]\PRmstr\JCPRH1.H[cno],,,"&env$('Temp')&"\Addr."&session$&",,,acsPR,,A,N"
03000   write #1,using L3030: "MASK 1,8,N,A,10,2,PD,A"
03010   write #1,using L3030: "FILE [Q]\PRmstr\JCPRH1.H[cno],,,ADDR2."&wsid$&",,,acsPR,,A,N"
