...
19857   let c(3)=c(3)+x12+x14
19859   let c(4)=c(4)+((x12*x23)+(x14*x24))/100
19861   let c(5)=(c(4)/c(3))*100
19863   let c(6)=c(6)+x12+x14
19865   let c(7)=c(7)+x12*(x23/100)+x14*(x24/100)
19867   let c(8)=c(8)+x15+x17
19869   let c(9)=c(9)+max((x15/(x23/100))-x15,(x12-x15))
19871   let c(10)=c(10)+max((x17/(x24/100))-x17,(x14-x17))
19873   let c(11)=c(9)+c(10)
19875   let c(12)=c(12)+x7
19877   let c(13)=c(13)+x8
19879   let c(14)=c(14)+x7-x8
19881   let c(15)=c(12)-(c(8)+c(11))
19895   let x6=0
19896   let x7=0
19897   let x8=0
19898   let x9=0
19899   if sd = 1 then goto L19833
19900 L19900: print #255, using L19910: jn$(1:6),n$(1:25),c(5),c(6),c(7),c(8),c(11),c(12),c(13),c(14),c(15) pageoflow PGOF
19910 L19910: form skip 1,pos 1,c 6,pos 10,c 25,pos 35,n 4,pos 40,n 10.2,pos 50,n 10.2,pos 60,n 10.2,pos 70,n 10.2,pos 80,n 10.2,pos 90,n 10.2,pos 100,n 10.2,pos 110,n 10.2,skip 0
...
20000 L20000: print #255,using L20020: "__________","__________","__________","__________","__________","__________","__________","__________"
20020 L20020: form skip 0,pos 40,c 10,pos 50,c 10,pos 60,c 10,pos 70,c 10,pos 80,c 10,pos 90,c 10,pos 100,c 10,pos 110,c 10,skip 0
20025   print #255, using L20026: s(6),s(7),s(8),s(11),s(12),s(13),s(14),s(15)
20026 L20026: form skip 1,"Job Totals",pos 40,n 10.2,pos 50,n 10.2,pos 60,n 10.2,pos 70,n 10.2,pos 80,n 10.2,pos 90,n 10.2,pos 100,n 10.2,pos 110,n 10.2,skip 1
20030   mat s=(0)
20040   goto PRTRPT
20100 SND: ! 
20110   print #255: newpage
20120   gosub HDR
20140   print #255, using L20150: t(6),t(7),t(8),t(11),t(12),t(13),t(14),t(15)
20150 L20150: form skip 2,"Grand Totals",pos 40,n 10.2,pos 50,n 10.2,pos 60,n 10.2,pos 70,n 10.2,pos 80,n 10.2,pos 90,n 10.2,pos 100,n 10.2,pos 110,n 10.2,skip 1
20160   goto EOF1
