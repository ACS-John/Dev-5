...
00330   print #win,fields "4,1,Cc 40,R,N": "* * * Warning * * *"
00340   print #win,fields "5,1,Cc 40,N": "This selection will erase all records"
00350   print #win,fields "6,1,Cc 40,N": "in the Sub-Category Description File."
00360   print #win,fields "8,2,C 24,N": "Enter ERASE to continue:"
00370   print fields "17,34,C 11,B,5": "Cancel (F5)"
...
00530 L530: print #1: "CLEAR"
00540   print #1: "PROCERR RETURN"
00550   print #1: "Index "&env$('Q')&"\PRmstr\SCMSTR.h"&str$(cno)&","&env$('Q')&"\PRmstr\SCIndex.h"&str$(cno)&",1,3,Replace,DupKeys"
00560   if cont=1 then !:
          print #1: "CHAIN 'S:\acsPR\JCSCMINT'" else print #1: "Chain 'menu'"
00570   close #1: 
...
00640   print #win,fields "4,2,C 17,N": "Description Code:"
00650   print fields "15,34,C 11,B,5": "Cancel (F5)"
00660   if ti=4 then let cde$=lpad$(rtrm$(k$),3) : goto L720
00670 L670: input #win,fields "4,20,Nz 2,UT,N": cde conv L670
00680   if cmdkey=5 or cde=0 then goto MENU1
00690   let cde$=uprc$(lpad$(rtrm$(str$(cde)),3))
00700   let des$=""
00710   let da=0
...
00780   print #win,fields "3,1,Cc 40,R,N": "Modifying"
00790   goto L810
00800 L800: print #win,fields "3,1,Cc 40,R,N": "Adding"
00810 L810: print fields "15,22,C 12,B,1": "Save (Enter)"
00820   print fields "15,35,C 11,B,4": "Delete (F4)"
00830   print fields "15,47,C 11,B,5": "Cancel (F5)"
00840   print #win,fields "5,2,Cr 12,N": "Code:"
00850   print #win,fields "6,2,Cr 12,N": "Description:"
00860   print #win,fields "5,15,C 3,N": ltrm$(cde$)
...
01020   print #255,using L1030: cde$,des$ pageoflow L1050
01030 L1030: form pos 16,c 5,c 30,skip 1
01040   goto L1010
01050 L1050: print #255: newpage
01060   gosub L1130
01070   continue 
...
01130 L1130: print #255,using L1140: date$,cnam$
01140 L1140: form pos 1,c 8,cc 52
01150   print #255,using L1160: time$,"Sub-Category File Proof Listing"
01160 L1160: form pos 1,c 8,pos 11,cc 50,skip 2
01170   print #255: tab(15);"Code  Description"
01180   print #255: tab(15);"____  ______________________________"
01190   return 
...
01370 L1370: print #win: newpage
01380   print fields "2,47,C 33,R,N": " "&n$(1:31)
01390   let ln=0
01400 L1400: read #1,using L1410: cde$,des$ eof L1460
01410 L1410: form pos 1,c 3,c 25
01420   let ln=ln+1
01430   print fields str$(ln+2)&",49,C 3,N": cde$
01440   print fields str$(ln+2)&",54,C 25,N": des$
01450   if ln<20 then goto L1400
01460 L1460: print fields "23,47,C 33,R,N": " Press Enter to continue" ! asdf
01470   print fields "24,47,C 33,R,N": " or enter category Number:"
