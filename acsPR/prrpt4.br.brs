...
autoLibrary
on error goto Ertn
fnTop(program$,'Report File - Proof List')
...
do
	read #1,using L220: rn,rt$,mat ch$,ips,sd,cp,mat psc,mat inp,mat pp,mat ti eof L560
	L220: form pos 1,n 2,c 78,2*c 132,n 3,2*n 1,100*pd 6.3,40*pd 2,20*n 1
	pr #255,using L240: date$,env$('cnam'),time$,'Payroll Report File Proof List'
