...
10400   let fntop("S:\acsPR\adjustpaydate","Adjust Historical Pay Date")
10500   on error goto ERTN
10600   let fn_adjustpaydate
...
11200       open #(h_prchecks:=fngethandle): "Name=PRmstr\Payrollchecks.h"&str$(cno)&",KFName=PRmstr\checkidx3.h"&str$(cno),internal,outin,keyed 
...
12600     let fntos(sn$="getpradjustdates")
12700     let mylen=42 : let mypos=45
12800     let fnlbl(1,1,"Payroll Date to Adjust:",mylen)
12900     let fntxt(1,mypos,10,0,1,"3",0,"Enter the payroll date you want to change.")
13000     let prdate$(1)=""
13100     let fnlbl(2,1,"New Payroll Date:",mylen)
13200     let fntxt(2,mypos,10,0,1,"3",0,"To reset checks on the above date to a new payroll date, enter it here.")
13300     let prdate$(2)=""
13400     let fncmdkey("Next",1,1,0,"Proceed with date adjustment.")
13500     let fncmdkey("Cancel",5,0,1,"Return to menu without changing the payroll date as indicated.")
13600     let fnacs(sn$,0,mat prdate$,ckey)
13700     if ckey=5 then 
13800       let fn_getdates=0
13900     else 
...
14700   print "PROGRAM PAUSE: Type GO and press [Enter] to continue." : print "" : pause : goto ERTN_EXEC_ACT
