...
00210   print #win,fields "4,2,Cr 29,N": "Report Heading Date:"
00220   print #win,fields "5,2,Cr 29,N": "Print All Jobs (Y/N):"
00230   print #win,fields "6,2,Cr 29,N": "Print One Job Per Page (Y/N):"
00240   let io1$(1)="4,32,C 20,UT,N"
00250   let io1$(2)="5,32,Cu 1,UT,N"
00260   let io1$(3)="6,32,Cu 1,UT,N"
00270   print fields "16,30,C 09,B,1": "Next (F1)"
00280   print fields "16,41,C 09,B,5": "Exit (F5)"
00290   let prtjob$="Y"
00300   let perpag$="Y"
00310 L310: rinput #win,fields mat io1$: dat$,prtjob$,perpag$ conv CONV1
00320   if ce>0 then let io1$(ce)(ce1:ce2)="U": let ce=0
00330   if cmdkey>0 then goto L400 else let ce=curfld
00340 L340: let ce=ce+1: if ce>udim(io1$) then let ce=1
00350 L350: let io1$(ce)=rtrm$(io1$(ce)) : let ce1=pos(io1$(ce),"U",1) : if ce1=0 then goto L340
00360   let ce2=ce1+1 : let io1$(ce)(ce1:ce1)="UC" : goto L310
00370 CONV1: if ce>0 then let io1$(ce)(ce1:ce2)="U"
00380   let ce=cnt+1
00390 ERR1: print fields "24,78,C 1": bell : goto L350
...
00620     print #win,fields "4,2,Cr 20,n": "Job Number to print:"
00630     if j>1 then print #win,fields "6,1,Cc 40,R,N": "Last Job Number entered was "&ltrm$(prtj$(j-1))
00640     print fields "14,34,C 11,B,2": "Print (F2)"
...
00900   gosub L1170
00910   let cnt$=lpad$(rtrm$(str$(val(cn$(7:11))+1)),5)
00920   goto L870
...
00990 HDR: ! 
01000   print #255,using L1010: "Job Status Worksheet",dat$
01010 L1010: form pos 56,c 20,skip 1,pos 1,cc 132,skip 2
01020   print #255,using L1030: "Job       Job Name  ","Category   Description","Old %    Percent     Units"
01030 L1030: form pos 2,c 20,pos 47,c 22,pos 88,c 26,skip 1
01040   print #255,using L1050: "Number","Number","Complete Complete   Complete"
...
01130 L1130: print #255,using L1140: jn$,n$
...
01170 L1170: print #255,using L1210: cn$(7:11),k$,"LABOR",l12,"%","___%","_____.__" pageoflow L1190
01180   goto L1220
01190 L1190: print #255: newpage
01200   gosub HDR
01210 L1210: form pos 49,c 5,pos 55,c 25,pos 81,c 5,pos 89,n 3,c 1,pos 97,c 4,pos 107,c 8,skip 1
01220 L1220: print #255,using L1210: " "," ","OTHER",l13,"%","___%","        " pageoflow L1250
01230   print #255: pageoflow L1250
01240   goto L1270
01250 L1250: print #255: newpage
01260   gosub HDR
01270 L1270: return 
