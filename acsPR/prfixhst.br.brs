...
00330   for j=1 to 15 : let tqm(j)=t1(j) : next j
00340   let tqm(16)=t1(21)
00350 L350: if ytd$="N" then goto L370
00360   for j=1 to 21 : let ty(j)=ty1(j) : next j ! ( asdf )
00370 L370: rewrite #2,using 'Form POS 168,38*PD 5.2',rec=tadr: mat ty,mat tqm
00380   mat t1=(0) : mat ty1=(0) : let tadr=nta
00390   goto L300
00400 L400: mat t1=(0) : mat ty1=(0) : let heno=0
00410   return 
...
00490 L490: let heno=eno
00500 ! LET PRD=fndate_mmddyy_to_ccyymmdd(PRD) ! IF IN MMDDYY FORMAT
