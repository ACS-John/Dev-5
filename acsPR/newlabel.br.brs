...
! Payroll Labels
! r: setup
	library 'S:\Core\Library': fntop,fnxit,fnwait,fnerror,fnaddlabel,fnlabel,fncomboa,fnTos,fnLbl,fnChk,fncombof,fnCmdSet,fnAcs,fnTxt,fndate_mmddyy_to_ccyymmdd,fnCmdKey,fnGetPayrollDates
	on error goto ERTN
