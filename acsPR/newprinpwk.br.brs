...
00270   if teno<>eno then print #255: pageoflow NEWPGE: goto READ_EMPLOYEE
00280   if fsttrl=1 then goto L320
00290   print #255,using L300: tdn,tdet(2),rpt$("  __________",3) pageoflow NEWPGE
00300 L300: form pos 44,n 3,n 10.2,c 36,skip 1
00310   goto L350
00320 L320: print #255,using L330: eno,em$,tdn,tdet(2),rpt$("  __________",3) pageoflow NEWPGE
...
00370 NEWPGE: print #255: newpage : gosub HDR : continue 
00380 ! ______________________________________________________________________
00390 DONE: close #1: ioerr ignore
00400   close #2: ioerr L430
00410   print #255,using L420: "Totals",rpt$("  ==========",3)
...
00490   print #255: "\qc  {\f201 \fs20 \b "&env$('program_caption')&"}"
00500   print #255: "\qc  {\f181 \fs16 \b "&trim$(dat$)&"}"
00510   print #255: "\ql   "
00520   print #255: "Employee                                  Dept    Hourly  <----------- Hours -------------->"
00530   print #255: " Number   Employee Name                   Numb      Rate   Regluar     Overtime      Other"
00540   print #255: "________  ______________________________  ____    ______  __________  __________  __________"
00550   return 
