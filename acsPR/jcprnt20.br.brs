...
19861   let c(5)=c(5)+x22
19863   let c(6)=c(6)+x21
19865   let c(7)=c(7)+x12+x14
19867   let c(8)=c(8)+x15+x17
19869   let c(9)=c(9)+(x12+x14)/x22
19871   let c(10)=c(10)+(x15+x17)/x21
19873   let c(11)=c(11)+(x12+x14)*x23/100
19875   let c(12)=c(12)+(x21/x22)*((x12+x14)*x23/100)
19877   let c(13)=c(11)-c(7)
19879   let c(14)=c(12)-c(8)
19881   let c(15)=(c(12)/c(8))*100
19895   let x6=0
19896   let x7=0
19897   let x8=0
19898   let x9=0
19899   if sd = 1 then goto L19833
19900 L19900: print #255, using L19910: jn$(1:6),n$(1:23),cn$(7:11),k$(1:16),c(5),c(6),c(7),c(8),c(9),c(10),c(11),c(12),c(13),c(14),c(15) pageoflow PGOF
...
20000 L20000: print #255,using L20020: "________","________","______","________","________","________","________"
20020 L20020: form skip 0,pos 55,c 8,pos 65,c 8,pos 74,c 6,pos 90,c 8,pos 100,c 8,pos 110,c 8,pos 120,c 8,skip 0
20025   print #255, using L20026: s(7),s(8),s(9),s(11),s(12),s(13),s(14)
...
20120   gosub HDR
20140   print #255, using L20150: t(7),t(8),t(9),t(11),t(12),t(13),t(14)
