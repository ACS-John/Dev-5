...
L19834: cn=val(cn$(7:11))
	...
	c(8)=c(8)+x15+x17
	c(9)=c(9)+(x12+x14)/x22
	c(10)=c(10)+(x15+x17)/x21
	c(11)=c(11)+(x12+x14)*x23/100
	c(12)=c(12)+(x21/x22)*((x12+x14)*x23/100)
	c(13)=c(11)-c(7)
	c(14)=c(12)-c(8)
	c(15)=(c(12)/c(8))*100
	x6=0
...
L20000: pr #255,using L20020: "________","________","______","________","________","________","________"
L20020: form skip 0,pos 55,c 8,pos 65,c 8,pos 74,c 6,pos 90,c 8,pos 100,c 8,pos 110,c 8,pos 120,c 8,skip 0
	pr #255, using L20026: s(7),s(8),s(9),s(11),s(12),s(13),s(14)
L20026: form skip 1,"Job Totals",pos 55,n 8.2,pos 65,n 8.2,pos 74,n 6.2,pos 90,n 8.2,pos 100,n 8.2,pos 110,n 8.2,pos 120,n 8.2,skip 1
	mat s=(0)
	goto PRTRPT
SND: !
	pr #255: newpage
	gosub HDR
	pr #255, using L20150: t(7),t(8),t(9),t(11),t(12),t(13),t(14)
L20150: form skip 2,"Grand Totals",pos 55,n 8.2,pos 65,n 8.2,pos 74,n 6.2,pos 90,n 8.2,pos 100,n 8.2,pos 110,n 8.2,pos 120,n 8.2,skip 1
	goto EOF1
L25000: continue
