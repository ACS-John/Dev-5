...
00440   let cap$="Create Job Cost Report Program"
...
00580   print #11: "Clear"
00590   print #11: "ProcErr Return"
00600   print #11: "Load S:\acsPR\JCRpt-Mod"
00610   print #11: "00010 ! Replace S:\acsPR\JCPrnt";str$(rn) !:
        ! this program is dynamicaly created by S:\acsPR\jcRptS1 and !:
        ! uses S:\acsPR\JCRpt-Mod as a base"
00620   print #11: '00051 RN$="';rn$;'"'
00630   let pf$="19900 PRINT #255, USING 19910: "
00640   let af$="19910 FORM SKIP 1"
00650   let gpf$="20140 PRINT #255, USING 20150: "
00660   let gaf$="20150 FORM SKIP 2,""Grand Totals"""
00670   let jpf$="20025 PRINT #255, USING 20026: "
00680   let jaf$="20026 FORM SKIP 1,""Job Totals"""
00690   let upf$="20000 print #255,using 20020: "
00700   let uaf$="20020 form skip 0"
00710   print #11: "19850 on zdiv goto 25000"
00720   print #11: "19851 on uflow goto 25000"
00730   print #11: "19852 on oflow goto 25000"
00740   print #11: "25000 continue"
00750   print #11: "25001 ! ______________________________________________________________________"
00760   print #11: "25010 jn=0"
00770   print #11: "25020 cn=0"
00780   print #11: "25030 Continue"
00790   print #11: "25031 ! ______________________________________________________________________"
00800   print #11: '25050 cn$=""'
00810   print #11: "25060 Continue"
00820   print #11: "25061 ! ______________________________________________________________________"
00830   for j=1 to 20
...
00870     next j2
00880     print #11: str$(19850+j*2+1);" c(";str$(j);")=c(";str$(j);")+";f$(j)
00890     goto L910
00900 L900: print #11: str$(19850+j*2+1);" c("&str$(j);")=";f$(j)
00910 L910: let j1=j1+1
00920 L920: next j
00930   print #11: "19895 x6=0"
00940   print #11: "19896 x7=0"
00950   print #11: "19897 x8=0"
00960   print #11: "19898 x9=0"
00970   print #11: "19899 if sd = 1 then 19833"
00980   for j=1 to 20
...
01290     let af$=rtrm$(af$)&"."&str$(dp(j)) ! Add Decimal Points
...
01380   print #11: pf$
01390   let af$(11:11)=" "
01400   let af$=rtrm$(af$)&",skip 0"
01410   print #11: af$
01420   print #11: '19911 IF FILE$(255)(1:4)<>"PRN:" THEN PRINT #255:'
01430   print #11: "19920 mat t=t+c"
01440   print #11: "19930 mat s=s+c"
01450   print #11: "19940 mat c=(0)"
01460   print #11: "19941 jn$="""""
01470   print #11: "19942 n$="""""
01480   print #11: "19945 if sd><0 then 19800"
01490   print #11: "19950 IF CN$(1:6)=JN1$ and sd=0 then 19833"
...
01540   print #11: gaf$
01550   goto L1570
01560 L1560: print #11: "20105 goto 390"
...
01660   print #11: uaf$
01670   print #11: "20030 mat s=(0)"
01680   print #11: "20040 goto 19800"
01690   goto L1710
01700 L1700: print #11: "20000 goto 19800"
01710 L1710: print #11: "20100 snd: !"
01720   print #11: "20110 print #255: newpage"
01730   print #11: "20120 gosub hdr"
01740   print #11: "20160 goto 390"
...
01790 L1790: print #11: "19814 if ";ty$(ips);">=psc(1) then 19820 else 19800"
01800   goto L2130
01810 ! ______________________________________________________________________
01820 L1820: print #11: "19814 if ";ty$(ips);"<=psc(1) then 19820 else 19800"
01830   goto L2130
01840 ! ______________________________________________________________________
01850 L1850: print #11: "19814 if ";ty$(ips);">=psc(1) and ";ty$(ips);"<=psc(2) then 19820 else 19800"
01860   goto L2130
01870 ! ______________________________________________________________________
01880 L1880: print #11: "19811 for j=1 to 100"
01890   print #11: "19814   IF "&ty$(ips)&"= PSC(J) then 19820"
01900   print #11: "19813   IF PSC(J)=0 then 19800"
01910   print #11: "19815 next j"
01920   print #11: "19816 goto 19800"
01930   goto L2130
...
01970 L1970: print #11: "19837 if ";ty$(ips);">=psc(1) then 19850 else 19833"
01980   goto L2130
01990 ! ______________________________________________________________________
02000 L2000: print #11: "19837 if ";ty$(ips);"<=psc(1) then 19850 else 19833"
02010   goto L2130
02020 ! ______________________________________________________________________
02030 L2030: print #11: "19837 if ";ty$(ips);">=psc(1) and ";ty$(ips);"<=psc(2) then 19850 else 19833"
02040   goto L2130
02050 ! ______________________________________________________________________
02060 L2060: print #11: "19837 for j=1 to 100"
02070   print #11: "19839   IF ";ty$(ips);"= PSC(J) then 19850"
02080   print #11: "19838   IF PSC(J)=0 then 19833"
02090   print #11: "19840 next j"
02100   print #11: "19841 goto 19833"
02110   goto L2130
02120 ! ______________________________________________________________________
02130 L2130: print #11: "Free S:\acsPR\jcPrnt"&str$(rn)&".br -n"
02140   print #11: "Save S:\acsPR\jcPrnt"&str$(rn)
02150   print #11: "run Menu"
02160   close #11: 
