...
00610   open #2: "Name=[Q]\PRmstr\Employee.h[cno],KFName=[Q]\PRmstr\EmployeeIdx-no.h[cno],Shr",internal,input,keyed 
00620   gosub HDR
...
00760   if em5=1 then pedate=begdate+19: box1+=1 ! monthly pay period
00770   if em5=2 then pedate=begdate+15 : box1+=1 ! semi-monthly
00780   if em5=3 then pedate=begdate+14 : box1+=1 ! bi-weekly
00790   if em5=4 then pedate=begdate+7: box1+=1 ! weekly
00800 ! deptkey$=cnvrt$("pic(zzzzzzz#)",eno)&cnvrt$("pic(zz#)",tdn)
...
00940   for j=1 to 20
00950     if deduc(j)=1 and dedcode(j)=1 then dedytdfeduc+=ytdtotal(j+4) : dedqtrfeduc+=qtr(j+4) ! TOTAL DEDUCTIONS FOR federal u/c FOR QUARTER
00960   next j
00970   m2=m2+ytdtotal(31)-dedytdfeduc ! TOTAL WAGES less deductions FOR THIS EMPLOYEE FOR YEAR
00980   m1=m1+qtr(31)-dedqtrfeduc ! TOTAL WAGES less deductions FOR QURATER
...
01400   h2=feducmax-(m2-m1)
01410   goto L1450
01420 L1420: h2=0
01430   goto L1450
01440 L1440: h2=m1
01450 L1450: h3=m1-h2
...
01720 ERTN: pause : fnerror(program$,err,line,act$,"xit")
