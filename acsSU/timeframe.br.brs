...
00150   open #open_file_count+=1: "Name="&env$('Q')&"\TMmstr\TimeFrame.h"&env$('cno')&",Version=1,KFName="&env$('Q')&"\TMmstr\TimeFrame-Idx.h"&env$('cno')&",Use,RecL=52,KPs=1,KLn=2,Shr",internal,outin,keyed 
00160   return 
