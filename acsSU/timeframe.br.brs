...
00150   open #open_file_count+=1: "Name=[Q]\TMmstr\TimeFrame.h[cno],Version=1,KFName=[Q]\TMmstr\TimeFrame-Idx.h[cno],Use,RecL=52,KPs=1,KLn=2,Shr",internal,outIn,keyed 
00160   return 
