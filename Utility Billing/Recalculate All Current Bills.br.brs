! -- RECalculate All Current Bills    *** DO NOT FORGET TO PARALLEL CHANGES FROM S:\Utility Billing\Calculate Bills
! ______________________________________________________________________
	...
	library 'S:\Core\Library': fnget_services,fnapply_default_rates,fnAutomatedSavePoint
...
! /r
	...
	if env$('client')="Edinburg" or env$('client')="French Settlement" then btu_factor_enabled=1 else btu_factor_enabled=btu=0
...
! ______________________________________________________________________
TOP: ! r:
	if r3=>lrec(h_customer) then goto FINIS
! read #h_work,using F_WORK,rec=r3+=1: x$,mat x eof FINIS,noRec TOP
	read #h_customer,using F_CUSTOMER_W_ACCT,rec=r3+=1: x$,meteradr$,custname$,mat a,mat b,mat c,mat d, bal,f,mat g,mat gb,mat extra noRec TOP eof FINIS
...
LX770: ! 
	...
	if g(11)>99999 or g(12)>99999 then goto BILL_TOO_LARGE
	if g(11)<99999 and g(11)>-99999 then goto LX1230
BILL_TOO_LARGE: ! r:
	pr #255: ""
...
def fn_ask_billing_date
	...
	ASK_BILLING_DATE: ! 
	fnTos(sn$='ubCalk_'&str$(btu_factor_enabled)&'_'&env$('client')(1:1))
...
! fnLbl(1,1,"",34,1)
	...
	if btu_factor_enabled=1 then ! ask BTU question on Edinburg and French Settlement
...
! /r
	...
	if ck<>5 then 
		...
		if btu_factor_enabled then btu=val(resp$(resp_btu_factor)) ! Edinburg requires a monthly BTU factor for calculating taxes
