...
26040     !
28000     print #255: "\qc {\f181 {\fs32 {\b Utility Work Order}"
28020     print #255: "{\fs24 "&env$('cnam')&"}}}"
28040     print #255: "\qc {\fs20 "&trim$(i$(1))&"}"
28060     print #255: "\ql "
28080     print #255: "{\b                 Name: }{\ul "&e$(2)&"}{\b    Account: }{\ul "&z$&"}"
28100     print #255: ""
28120     print #255: "{\b      Service Address: }{\ul "&e$(1)&"}"
28140     print #255: ""
28160     if fn_not_blank(i$(6)) then
28180       print #255: "{\b                Phone: }"&i$(6)
28200       print #255: ""
28220     end if
28240     if fn_not_blank(i$(5)) then
28260       print #255: "{\b      Request made by: }"&i$(5)
28280       print #255: ""
28300     end if
28320     if fn_not_blank(i$(2)) then
28340       print #255: "{\b             Taken by: }"&i$(2)
28360       print #255: ""
28380     end if
28400     if fn_not_blank(i$(7)) then
28420       print #255: "{\b              Name In: }"&i$(7)
28440       print #255: ""
28460     end if
28480     if fn_not_blank(i$(3)) then
28500       print #255: "{\b    Date Last Reading: }"&i$(3)
28520       print #255: ""
28540     end if
28560     if fn_not_blank(i$(4)) then
28580       print #255: "{\b Date to be Completed: }"&i$(4)
28600       print #255: ""
28620     end if
28640     if fn_not_blank(i$(8)) then
28660       print #255: "{\b              Turn On: }{\ul "&date$(days(fn_clean_ul$(i$(8),1008),'mmddyy'),'mm/dd/ccyy')&'}'
28680       print #255: ""
28700     end if
28720     if fn_not_blank(i$(9)) then
28740       print #255: "{\b             Turn Off: }{\ul "&date$(days(fn_clean_ul$(i$(9),1008),'mmddyy'),'mm/dd/ccyy')&'}'
28760       print #255: ""
28780     end if
28800     if fn_not_blank(i$(10)) then
28820       print #255: "{\b             Leave On: }"&i$(10)
28840       print #255: ""
28860     end if
28880     if fn_not_blank(i$(11)&i$(12)) then
28900       print #255: "{\b   Forwarding Address: }"&i$(11)&"  "&i$(12)
28920       print #255: ""
28940     end if
...
32080     print #255: '<--------------------------------Comments-------------------------------->'
32120     print #255: ""
32160     for j=1 to 5
32180       if trim$(line$(j))<>"" then 
32200         print #255: line$(j)
32220       else 
32240         print #255: rpt$("_",74)
32260       end if 
32280       print #255: ""
32300     next j
32320     for j=1 to 2
32340       print #255: rpt$("_",74)
32360       print #255: ""
32380     next j
32400     print #255: ""
32420     print #255,using 'form pos 32,c 51': "{\b Date Order Completed: _____________________}"
32440     print #255: ""
32460     print #255,using 'form pos 32,c 51': "{\b By: _______________________________________}"
...
40060       print #255: "{\b <"&rpt$('-',dash_len)&trim$(service_name$)&rpt$('-',dash_len)&">}"
40080       print #255:   "{\b             Code: }{\ul "&str$(rate_code)&'}'
40100       print #255:   "{\b          Deposit: }{\ul "&trim$(cnvrt$('N 8.2',deposit_amt))&"}"
40120       if trim$(serial_number$)<>'' then 
40140         print #255: "{\b    Serial Number: }{\ul "&trim$(serial_number$)&"}"
40160       end if 
40180       if ~is_not_metered then ! if not not metered than it is metered
40200         if trim$(meter_number$)<>'' then 
40220           print #255: "{\b     Meter Number: }{\ul "&trim$(meter_number$)&"}"
40240         end if 
40260         if reading_prior>0 then 
40280           print #255: "{\b Previous Reading: }{\ul "&str$(reading_prior)&"}     {\b  Current Reading: }____________________"
40300           print #255: ""
40320         else
40340           print #255:   "                              {\b  Current Reading: }____________________"
40360           print #255: ""
40380         end if 
40400       end if 
40420     end if 
