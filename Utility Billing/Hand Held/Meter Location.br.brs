...
def fn_setup
  if ~setup then
    ...
    library 'S:\Core\Library': fnmsgbox,fnOpenFile,fnCloseFile
    ...
    library 'S:\Core\Library': fnCustomerData$,fnLastBillingDate
...
def library fnCustomerMeterLocationSelect(account$*10,serviceCode$*2) ! cmls
  ...
  fnflexinit1('locationSelect',4,1,20,20,mat ch$) : cmlsFlexCount=0
  do
