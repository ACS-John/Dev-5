...
00020   library 'S:\Core\Library': fntop,fnxit, fnerror,fnmsgbox,fnhand_held_device$,fnHamsterFio ! fnHamster,fnH2Init,fnH2AddText,fnHamster2AddCombo,fnH2AddComboF,fnH2AddComboA,fnH2AddComboF,fnHamster2
00030   on error goto ERTN
00040 ! ______________________________________________________________________
00070   fntop(program$)
00120   if fnhand_held_device$<>'Itron FC300' and fnhand_held_device$(1:6)<>'[Ask]' and fnhand_held_device$(1:6)<>'Aclara'  and fnhand_held_device$<>'Badger Beacon' then 
...
00212   fnHamsterFio("U4 Meter Type")
00220   ! fn_close_file
00230   goto XIT
