...
34040   gosub NewWay
34060 goto DONE ! /r
38000 NEWPGE: pr #255: newpage : gosub HDR : continue 
42000 HDR: ! r:
42020   pg=pg+1
42040   pr #255: "\qc  {\f181 \fs22 \b "&env$('cnam')&"}"
42060   pr #255: "\qc  {\f181 \fs28 \b "&env$('program_caption')&"}"
42080   pr #255: "\qc  {\f181 \fs18 \b From: "&cnvrt$("PIC(####/##/##)",bd1)&"   Thru: "&cnvrt$("pic(####/##/##)",ed1)&"}"
42100   pr #255,using 'form pos 1,c 12,pos 75,c 10': "\ql "&date$,"Page "&str$(pg)
42120   pr #255: ""
42140   pr #255: "{\ul Account No}  {\ul    Date   }  {\ul Description                     }  {\ul  Before }  {\ul   After }"
42160 return ! /r
44000 DONE: ! r:
44020   pr #255: "" 
...
52020 ERTN: fnerror(program$,err,line,act$,"xit")
52040   if uprc$(act$)<>"PAUSE" then goto ERTN_EXEC_ACT
52060   execute "List -"&str$(line) : pause : goto ERTN_EXEC_ACT
52080   pr "PROGRAM PAUSE: Type GO and press [Enter] to continue." : pr "" : pause : goto ERTN_EXEC_ACT
...
56180 !       pr #255,using 'form pos 1,c 12,pic(####/##/##bb),c 32,2*n 10.2': k32$,dt1,dp$,dp1,dp2 pageoflow NEWPGE
56220 !       t1=t1+dp2-dp1
56240 !     end if
56260 !   end if
56280 !   r32=n32
...
57100       pr #255,using 'form pos 1,c 12,pic(####/##/##bb),c 32,2*n 10.2': k32$,dt1,dp$,dp1,dp2 pageoflow NEWPGE
57140       t1=t1+dp2-dp1
57160     end if
57180   end if
57200   loop
