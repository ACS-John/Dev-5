...
! Penalty Calculation
	...
	library 'S:\Core\Library': fnAcs,fnLbl,fnTxt,fnerror,fnTos,fnopenprn,fncloseprn,fnmsgbox,fnxit,fndate_mmddyy_to_ccyymmdd,fndat,fnLastBillingDate,fnCmdSet,fntop,fnChk,fnFra,fnOpt,fnget_services,fnAutomatedSavePoint
	on error goto Ertn
