...
fn_setup
fnTop(program$)
open #hRate1=fnH: "Name=[Q]\UBmstr\ubData\RateMst.h[cno],KFName=[Q]\UBmstr\ubData\RateIdx1.h[cno],Use,RecL=374,KPs=1,KLn=4,Shr",i,outIn,k
open #hRate2=fnH: "Name=[Q]\UBmstr\ubData\RateMst.h[cno],KFName=[Q]\UBmstr\ubData\RateIdx2.h[cno],Use,RecL=374,KPs=5,KLn=25,Shr",i,outIn,k
...
def fn_setup(; ___,index,optionCount)
	if ~setup then
		setup=1
		autoLibrary
