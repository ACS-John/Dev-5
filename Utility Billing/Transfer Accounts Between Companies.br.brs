...
30000 MENU1: ! 
30020   let fntos(sn$="CoTr-1")
30040   let mylen=5 : let mypos=mylen+2
30060   let fnlbl(1,1,"From:",mylen,1)
30080   let fntxt(1,mypos+.4,50, 0,0,'',1) ! let fncmbcno(1,mypos)
30100   let resp$(1)=env$('cnam')&' ('&str$(cno)&')'
30120   let fnlbl(2,1,"To:",mylen,1)
30140   let fncmbcno(2,mypos)
30160   let resp$(2)=''
30180   let fnlbl(4,10,"(Both companies must be set up in advance)",49,0)
...
34060   let fnlbl(1,1,"Customer to Transfer:",28,1)
34080   let fncmbact(1,30)
34100   let resp$(1)=""
34120   let fncmdset(2)
34140   let fnacs(sn$,0,mat resp$,ck)
...
36100   let fnlbl(3,1,"New Account:",mylen,1)
36120   let fntxt(3,30,10)
36140   let resp$(1)=z2$
36180   let fnlbl(1,1,"Account "&z2$&" already exists!",0,2)
36200   let fncmdset(2)
36220   let fnacs(sn$,0,mat resp$,ck)
