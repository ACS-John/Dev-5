	...
	library 'S:\Core\Library': fnerror,fnwait,fnopenprn,fncloseprn,fnAcs
	library 'S:\Core\Library': fnflexadd1,fnflexinit1,fnTos,fncustomer_search
	library 'S:\Core\Library': fnLbl,fnTxt,fnOpt,fnmsgbox,fncomboa,fnButton,fnpic
	library 'S:\Core\Library': fnFra,fnChk,fndat,fncmbact,fncombof,fncmbrt2,fnxit
