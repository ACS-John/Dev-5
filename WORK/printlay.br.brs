...
00130   print #101: newpage
00140   print fields "10,5,C 60": "Enter 0 for Printer only, 1 for Screen only, or 2 for Both:"
00150   print fields "12,5,C 60": "Enter Ext/VolId to print all or blank to select:"
...
00280   print #101: newpage
00290   if f1>0 then print fields "2,5,C 60,H,N": "LAST FILE NAME ENTER WAS "&fil$(f1)
00300   print fields "4,5,C 60": "Enter File Name/VolId to print or Blank to stop"
...
00480   print newpage
00490   print fields "1,1,C 40,R,N": " FIELD DESCRIPTIONS: "&filename$(1:p1)&"/"&volid$
00500   print fields "1,43,C 8,R,N": " NAME"
00510   print fields "1,53,C 8,R,N": " FORMAT"
00520   print fields "1,63,C 5,R,N": " FROM"
00530   print fields "1,70,C 5,R,N": "  TO"
00540   let sln=1
00550 L550: if pp=0 or j3=0 then goto L660
00560   if sln=0 then goto L460
00570   if sln<23 then let sln=sln+1: goto L610
00580   print fields "24,5,C 60,R,N": "  SCREEN FULL  PRESS ENTER TO CONTINUE:"
00590   input fields "24,50,C 1,RE,N": pause$
00600   goto L460
00610 L610: print fields str$(sln)&",1,C 40,UT,N": a$(j3,1)
00620   print fields str$(sln)&",43,C 8,UT,N": a$(j3,2)(1:10)
00630   print fields str$(sln)&",53,C 8,UT,N": a$(j3,3)(1:8)
00640   print fields str$(sln)&",63,PIC(ZZZZZ),UT,N": a(j3,5)
00650   print fields str$(sln)&",70,PIC(ZZZZZ),UT,N": a(j3,6)
...
00940   let a$(j3,1)=ln$(p1:p2-1)
00950   let a$(j3,2)=ln$(p2+1:p3-1)
00960   let a$(j3,3)=ln$(p3+1:p4)
...
01060   if uprc$(a$(j3,3)(1:p1-2))="PD" then let al=l*2-1 else let al=l !   ACTUAL FIELD LENGTH
01070   let l=l*m1 ! TOTAL STORAGE LENGTH
01080   let b=a+l
01090   let a=a+1
01100   let ino=ino+1
01110   let a(j3,1)=ino
01120   let a(j3,2)=al
01130   let a(j3,3)=dp
01140   let a(j3,4)=l
01150   let a(j3,5)=a
...
01280     print #255,using L1290: a$(j,1) pageoflow NEWPGE
01290 L1290: form pos 13,c 43,skip 2
01300     goto L1340
01310 L1310: if rtrm$(a$(j,1))="" then goto L1340
01320     print #255,using L1330: a(j,1),a$(j,1),a$(j,2),a(j,2),a(j,3),a$(j,3),a(j,4),a(j,5),a(j,6) pageoflow NEWPGE
01330 L1330: form pos 5,n 5,x 3,c 43,c 11,n 7,n 10,x 5,c 11,n 7,2*n 9,skip 2
01340 L1340: next j
01350   print #255: newpage
01360   print #255,using L970: hex$("1B40")
01365   let fncloseprn
01370 L1370: close #1: 
01380   if f2<f1 then goto L360
01390 L1390: close #2: ioerr L1400
01400 L1400: print fields "24,1,C 7,UT,N": "Done..."
01410   stop 
...
01460 HDR: ! 
01470   print #255,using L970: hex$("2B0205000A1042")
01480   print #255,using L970: hex$("1B471B2D00")
01490   let pg=pg+1
01500   print #255,using L970: hex$("1B5701")
01510   print #255,using L1520: h1$
01520 L1520: form pos 3,c 46,skip 2
01530   print #255,using L970: hex$("1B57001B53000F")
01540   print #255,using L1550: prg$,dat$,pg,pgo
01550 L1550: form pos 51,c 40,c 20,"PAGE:",n 3,"  OF:",n 3,skip 1
01560   print #255,using L970: hex$("1B54")
01570   print #255,using L970: hex$("2B0205000A0000")
01580   print #255: tab(30);"----------------- REMARKS -------------------"
01590   print #255,using L1600: str$(rl),rm$(1)
01600 L1600: form pos 5,"RECORD LENGTH: ",c 5,pos 30,c 45,skip 1
01610   print #255,using L1620: rm$(2)
01620 L1620: form pos 30,c 45,skip 1
01630   print #255,using L1640: rm$(3)
01640 L1640: form pos 30,c 45,skip 1
01650   print #255,using L1660: filetype$,rm$(4)
01660 L1660: form pos 5,"FILE TYPE: ",c 10,pos 30,c 45,skip 2
01670   print #255,using L1680: filename$,volid$
01680 L1680: form pos 5,"FILE NAME: ",c 20,"VOLID: ",c 10,skip 2
01690   print #255,using L970: hex$("1B0F")
01700   print #255: "   ITEM #   FIELD DESCRIPTION                           NAME       LENGTH    DECIMALS    FORMAT    STORAGE     FROM      TO  "
01710   print #255: "   ------   ----------------------------------------   --------    ------    --------   -------    -------    -----    -----"
01720   print #255,using L970: hex$("1B2D01")
01730   return 
