...
06400       let msgbox("Invalid month")
06500     else 
06600       let month=usermonth
06700     end if 
06800     if useryear < 1900 or useryear > 2100 then 
06900       let msgbox("Invalid year")
07000     else 
...
11100     next index_
11200     let headers$(1) ="Sun"
11300     let headers$(2) ="Mon"
11400     let headers$(3) ="Tue"
11500     let headers$(4) ="Wed"
11600     let headers$(5) ="Thu"
11700     let headers$(6) ="Fri"
