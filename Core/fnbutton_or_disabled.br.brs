...
20120     fnbutton_or_disabled=fn_button_or_disabled(enable,lyne,ps,txt$,comkey, tt$,width,container,tabcon,default,cancel)
20140   fnend 
...
20200       fnbutton(lyne,ps,txt$,comkey, tt$,1,width,container,tabcon,default,cancel)
20220     else 
20240       fnlbl(lyne,ps,txt$, width,2,font_mod,container,tabcon,'The "'&txt$&'" button is currently disabled.'&chr$(10)&tt$)
20260     end if 
20280   fnend 
