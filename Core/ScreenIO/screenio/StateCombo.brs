...
05014        let fnListviewComboValFld=1
05015     end if
05016  fnend
05017 !
...
85016          let fnCheckStringFunction = 0
85017       else if Function$ = "{defaults\enter}" then
85018          let fnCheckStringFunction = 0
85019       else if Function$ = "{defaults\mainloop}" then
85020          let fnCheckStringFunction = 0
