...
13000   execute 'Sy -w '&os_filename$('R:\core\ACS_PrAce_Support_Install_ocx.exe')
13020   execute 'Sy '&os_filename$('R:\core\ACS_PrAce_Reg.cmd')&' /s'
60000 XIT: let fnxit
70000   def fn_setup
70020     if ~setup then 
70040       let setup=1
70080       library 'R:\Core\Library': fntop,fnxit,fnerror
