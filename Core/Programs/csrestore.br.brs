00010 ! Replace R:\Core\Programs\CsRestore
00020 ! Restore for Current System
00030 ! ______________________________________________________________________
00040   library 'R:\Core\Library': fnbackup,fnxit,fncursys$,fnerror,fntop
00050   on error goto ERTN
00060 ! ______________________________________________________________________
00070   let fntop("R:\Core\Programs\csRestore",uprc$(fncursys$)&" Restore")
00080   let backup=1 !:
        let restore=2
00090   let fnbackup(restore)
00100 XIT: let fnxit
