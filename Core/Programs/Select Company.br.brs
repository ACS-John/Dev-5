...
16000 let fncno(cno)
20000 MENU1: ! r:
20020   let fntos(sn$:=env$('cursys')&"Companies")
...
44000 COMPANY_ADD: ! r:
44020   let fntos(sn$='selcno-'&env$('cursys')&'-2')
...
45340       end if
45360     end if  ! /r
45380     let fnchain("S:\acs"&env$('cursys')&"\Company")
...
45480   else 
45500     let fnchain(txt$="S:\acs"&env$('cursys')&"\AddCNo")
45520   end if 
45540 ! /r
46000 XIT: let fnxit
