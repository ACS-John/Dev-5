...
def fn_getFileInfo(name$*512,kfname$*512,mat tmpkps,mat tmpkln,&tmpversion,&tmprln,&tmpfile$; ___,returnN,hTmp)
	if kfname$='' then
		open #hTmp:=fngethandle: 'Name='&name$&',Shr',internal,outIn,relative error GetFileInfoFail
	else
		open #hTmp:=fngethandle: 'Name='&name$&',KFName='&kfname$&',Shr',internal,outIn,keyed error GetFileInfoFail
	end if
