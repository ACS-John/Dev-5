00010 ! Replace R:\Core\Xit.br
00020 ! ______________________________________________________________________
00030   def library fnxit(;cursys$)
00040     library 'R:\Core\Library': fnchain,fnerror,fncursys$,fnprocess
00050     on error goto ERTN
00060 ! ______________________________________________________________________
20000     if fncursys$="GL" and fnprocess=1 then let fnchain("R:\acsGL\acglAuto")
20200     if fncursys$="PR" and fnprocess=1 then let fnchain("R:\acsPR\newprAuto")
