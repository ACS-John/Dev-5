...
00270     for j=1 to 6
00280       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! wide line
00290     next j
...
00480     for j=1 to 6
00490       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
00500     next j
00510     goto L210
00520 TWO: ! 
...
00550     for j=1 to 2
00560       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! narrow
00570     next j
00580 ! second line  (wide line)
00590     let w+=double*2 ! blank space
00600     for j=1 to 6
00610       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
00620     next j
...
00760     for j=1 to 6
00770       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
00780     next j
00790     goto L210
00800 THREE: ! 
...
00830     for j=1 to 6
00840       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! wide
00850     next j
00860 ! second line  (wide line)
00870     let w+=double*2 ! blank space
00880     for j=1 to 6
00890       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
00900     next j
...
01230     for j=1 to 6
01240       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! contains the blank space before  and a blank line
01250     next j
...
01340     for j=1 to 6
01350       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
01360     next j
01370     goto L210
01380 FIVE: ! 
...
01410     for j=1 to 6
01420       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
01430     next j
...
01520     for j=1 to 6
01530       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! contains the blank space before  and a blank line
01540     next j
...
01740     for j=1 to 6
01750       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
01760     next j
...
01800     for j=1 to 6
01810       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! contains the blank space before  and a blank line
01820     next j
...
02160     for j=1 to 6
02170       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
02180 ! 
02190     next j
02200 ! fifth line (wide)
02210     let w+=double*2 ! blank space
02220     for j=1 to 6
02230       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
02240     next j
02250     goto L210
02260 EIGHT: ! 
...
02290     for j=1 to 6
02300       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
02310     next j
...
02450     for j=1 to 6
02460       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
02470 ! 
02480     next j
...
02640     for j=1 to 6
02650       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
02660 ! 
02670     next j
...
02760     for j=1 to 6
02770       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
02780 ! 
02790     next j
...
03000     for j=1 to 6
03010       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! contains the blank space before  and a blank line
03020     next j
03030 ! fourth line  (wide)
03040     let w+=double*2 ! blank space
03050     for j=1 to 6
03060       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
03070 ! 
03080     next j
...
03290     for j=1 to 6
03300       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! wide line
03310     next j
03320 ! 4th line, quiet zone (wide line)
03330     let w+=double*2 ! blank line
03340     for j=1 to 6
03350       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! wide   line
03360     next j
...
03460 ! 
03470     for j=1 to 6
03480       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! narrow
03490     next j
03500     let w+=double*blankline ! extra blank line
03510 ! second line  (narrow)
03520     let w+=double*2 ! blank space
03530     for j=1 to 2
03540       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
03550     next j
03560 ! third line (narrow) (has a blank line in front of it)
03570     let w+=double*2 ! blank space
03580     for j=1 to 2
03590       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")" ! contains the blank space before  and a blank line
03600     next j
03610 ! fourth line  (wide)
03620     let w+=double*2 ! blank space
03630     for j=1 to 6
03640       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
03650     next j
03660 ! fifth line (narrow)
03670     let w+=double*2 ! blank space
03680     for j=1 to 2
03690       print #20: 'Call Print.AddLine('&str$(w+=double)&','&str$(x)&','&str$(0)&','&str$(z)&")"
03700     next j
03710     goto L210
03720 XIT: fnend 
