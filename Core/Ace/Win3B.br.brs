...
! pr_newpg = 1=Yes; 2=No; 0=Whatever, I don't know
		...
		if pr_newpg=2 then goto L240
		if pr_newpg=0 and exists(":C:\ACS\Local\Settings\No_Print_Newpage.txt") then goto L240 else pr newpage
		if pr_newpg=1 then pr newpage
L240: screen_width=80
		screen_height=24
...
L610: if button_option=0 then goto Xit
		mat fkey$=("") : em$="" : es=0
...
L270: close #tfn: ioerr L280
L280: pr f str$(scrline)&","&str$(startpos)&",C "&str$(totallen)&",N": rpt$("Ä",totallen)
