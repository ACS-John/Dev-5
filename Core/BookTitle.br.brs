...
24160     a=pos(x$," ",olda)
24180     if a<>0 then 
24200       a+=1 : let x$(a:a)=uprc$(x$(a:a)) : let olda=a
24220       goto L1240
24240     end if 
24260     a=olda=0
24280 L1260: ! 
24300     a=pos(x$,"-",olda)
24320     if a<>0 then 
24340       a+=1 : let x$(a:a)=uprc$(x$(a:a)) : let olda=a
24360       goto L1260
24380     end if 
24400     a=olda=0
24420 L1280: ! 
24440     a=pos(x$,"/",olda)
24460     if a<>0 then 
24480       a+=1 : let x$(a:a)=uprc$(x$(a:a)) : let olda=a
24500       goto L1280
24520     end if 
24540     a=olda=0
24560 L1300: ! 
24580     a=pos(x$,"\",olda)
24600     if a<>0 then 
24620       a+=1 : let x$(a:a)=uprc$(x$(a:a)) : let olda=a
24640       goto L1300
24660     end if 
24680     a=olda=0
24700 L1320: ! 
