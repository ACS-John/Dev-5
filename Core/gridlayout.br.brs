...
00060   let fntop(program$,"Grid Layout")
00070 ! ______________________________________________________________________
00080 L80: let fntos(sn$="file_layout")
00090   let lablen=15
00100   let text$="File Name:"
00102   let fnlbl(1,1,text$,lablen,1)
00110   let fntxt(1,lablen+2,60,0,0,"")
00112   let resp$(1)="programfolder\grid\data_base_name\filename"
00120   let fncmdset(2)
00130   let fnacs(sn$,0,mat resp$,ckey)
