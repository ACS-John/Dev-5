...
00060   def library fnH2AddText(label$*38,textbox_len; field_type$*2,storage_length,ar_mask,storage_position)
...
00252     fnH2AddText=add_rec_item
00260   fnend  ! fn_hamster_field_add
00270   def library fnH2AddComboF(hac_screen_item,hac_data_file$*256,hac_key_pos,hac_key_len,hac_desc_pos,hac_desc_len,hac_index_file$*256,hac_limit_to_list)
00280     c$(hac_screen_item,1)='ComboF'
00290     c$(hac_screen_item,2)=hac_data_file$
00300     c$(hac_screen_item,3)=str$(hac_key_pos)
00310     c$(hac_screen_item,4)=str$(hac_key_len) ! Key
00320     c$(hac_screen_item,5)=str$(hac_desc_pos)
00330     c$(hac_screen_item,6)=str$(hac_desc_len) ! Description
00340     c$(hac_screen_item,7)=hac_index_file$
00350     c$(hac_screen_item,8)=str$(hac_limit_to_list)
00360   fnend 
00370   def library fnH2AddComboA(hac_screen_item,mat hac_option$)
00380     c_y=1
00390     c$(hac_screen_item,c_y)='ComboA'
...
00420       c$(hac_screen_item,c_y+=1)=hac_option$(hac_item)
00430     next hac_item
00440   fnend 
00450   def library fnHamster2(h2_name$*20; h2_file)
