...
00120 fnreg_read(cap$&'.'&cursys$&'.[cno].company_file',company_file$)
00130 fnreg_read(cap$&'.'&cursys$&'.[cno].destination_company_number',destination_company_number$) : destination_company_number=val(destination_company_number$) conv ignore
00140 ! /r
00170 SCREEN1: ! r:
...
00500 fnreg_write(cap$&'.'&cursys$&'.[cno].company_file',company_file$)
00520 fnreg_write(cap$&'.'&cursys$&'.[cno].destination_company_number',destination_company_number$)
00522 ! /r
...
12020   ! exe 'dir [Q]\ubmstr\ubmaster.h700' : pause
...
16060       fn_ubmaster2customer_frenchset('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number),'[Q]\UBmstr\Customer.h'&str$(destination_company_number))
16080     else if cnv_ub_merriam_woods then 
16090       fn_ubmaster2customer_merriam('[Q]\UBmstr\Customer.h'&str$(destination_company_number),'[Q]\UBmstr\Customer.h'&str$(destination_company_number))
16092     else if cnv_exeter then 
16094       fnCopy('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number),'[Q]\UBmstr\Customer.h'&str$(destination_company_number),2067)
16096       fnFree('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number))
16100     else if ~exists('[Q]\UBmstr\Customer.h'&str$(destination_company_number)) and exists('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number)) then 
16110       fnCopy('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number),'[Q]\UBmstr\Customer.h'&str$(destination_company_number))
16120       fnFree('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number))
16140     end if 
...
19020       if ~exists("[Q]\PRmstr\dednames.h"&str$(cno)) then 
...
20060   fnFree('[Q]\'&cursys$&'mstr\*.h'&str$(destination_company_number))
20062   fnStatus('Existing files ('&os_filename$('[Q]\'&cursys$&'mstr\*.h'&str$(destination_company_number))&') have been removed.')
20080   fnCopy(env$('at')&company_import_path$&'*'&company_import_extension$,'[Q]\'&cursys$&'mstr\*.h'&str$(destination_company_number))
...
25020     open #h_tmp:=fngethandle: 'Name=[Q]\ubmstr\ubcoinfo.h'&str$(destination_company_number),internal,input 
25030     read #h_tmp,using 'form pos 121,N 6': d1
25040     close #h_tmp: 
25050   ! else if cursys$='PR' then 
25060   ! 
25070   !   open #h_tmp:=fngethandle: "Name=[Q]\PRmstr\PRCOINFO.h"&str$(destination_company_number),internal,input IOERR PRCoInfoOldVersionFinis
...
25410   if ~exists('[Q]\'&cursys$&'mstr\Company.h'&str$(destination_company_number)) then 
25420     if exists('[Q]\'&cursys$&'mstr\'&cursys$&'coinfo.h'&str$(destination_company_number)) then 
25440       fnCopy('[Q]\'&cursys$&'mstr\'&cursys$&'coinfo.h'&str$(destination_company_number),'[Q]\'&cursys$&'mstr\Company.h'&str$(destination_company_number))
25460       fnFree('[Q]\'&cursys$&'mstr\'&cursys$&'coinfo.h'&str$(destination_company_number))
26000     end if 
26020     if exists('[Q]\'&cursys$&'mstr\prcoinfo.h'&str$(destination_company_number)) then 
26040       fnCopy('[Q]\'&cursys$&'mstr\prcoinfo.h'&str$(destination_company_number),'[Q]\'&cursys$&'mstr\Company.h'&str$(destination_company_number))
26060       fnFree('[Q]\'&cursys$&'mstr\prcoinfo.h'&str$(destination_company_number))
26080     end if 
26100     if exists('[Q]\'&cursys$&'mstr\coinfo.h'&str$(destination_company_number)) then 
26120       fnCopy('[Q]\'&cursys$&'mstr\coinfo.h'&str$(destination_company_number),'[Q]\'&cursys$&'mstr\Company.h'&str$(destination_company_number))
26140       fnFree('[Q]\'&cursys$&'mstr\coinfo.h'&str$(destination_company_number))
26160     end if 
26180   end if 
...
30030     if exists('[Q]\UBmstr\ubdata\*.h'&str$(destination_company_number)) then 
30040       fnFree('[Q]\UBmstr\ubdata\*.h'&str$(destination_company_number))
30050     end if  ! exists('[Q]\UBmstr\ubdata\*.h'&str$(destination_company_number))
30060     fnCopy(env$('at')&company_import_path$&'ubdata\*'&company_import_extension$,'[Q]\UBmstr\ubdata\*.h'&str$(destination_company_number))
...
30100     fnCopy(env$('at')&company_import_path$&'..\acsub\ratemst'&company_import_extension$,'[Q]\UBmstr\ubdata\RateMst.h'&str$(destination_company_number))
30110     fnCopy(env$('at')&company_import_path$&'..\acsub\RateIdx1'&company_import_extension$,'[Q]\UBmstr\ubdata\RateIdx1.h'&str$(destination_company_number))
30120     fnCopy(env$('at')&company_import_path$&'..\acsub\RateIdx2'&company_import_extension$,'[Q]\UBmstr\ubdata\RateIdx2.h'&str$(destination_company_number))
30130   else 
...
32120       fnCopy(env$('at')&import_install_path$&'S:\acsUB\ratemst'&company_import_extension$,'[Q]\'&cursys$&'mstr\ubdata\*.h'&str$(destination_company_number))
32140     end if 
32160   end if 
32180   ! /r
32200   ! r: import notes folder
32220   if exists(company_import_path$&'UBmstr\notes'&company_import_extension$) then 
32240     fnFree('[Q]\'&cursys$&'mstr\notes.h'&str$(destination_company_number))
...
32280   end if  ! exists [import path][Q]\UBmstr\notes.h[company_import_extension]
32300   ! /r
32320   ! r: rename ubmaster to customer
32340   if ~cnv_ub and ~exists('[Q]\UBmstr\Customer.h'&str$(destination_company_number)) and exists('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number)) then ! and ~cnv_ub_capbell and ~cnv_ub_french_settlement then
32360     fnCopy('[Q]\UBmstr\UBMaster.h'&str$(destination_company_number),'[Q]\UBmstr\Customer.h'&str$(destination_company_number))
32380     fnFree('[Q]\'&cursys$&'mstr\UBMaster.h'&str$(destination_company_number))
32400   end if  ! exists [import path][Q]\UBmstr\notes.h[company_import_extension]
32420   ! /r
32450 fnend 
...
41060   to$=uprc$(to$)
41064   open #1: "Name=[Q]\UBmstr\ubData\RateMst.h[cno],KFName=[Q]\UBmstr\ubData\RateIdx1.h[cno],Use,RecL=374,KPs=1,KLn=4,Shr",internal,outIn,keyed 
41065   open #2: "Name=[Q]\UBmstr\ubData\RateMst.h[cno],KFName=[Q]\UBmstr\ubData\RateIdx2.h[cno],Use,RecL=374,KPs=5,KLn=25,Shr",internal,outIn,keyed 
41100   do 
...
54020   open #h_customer:=fngethandle: "Name=[Q]\UBmstr\Customer.h"&str$(cno)&",Shr",internal,outIn,relative 
54040   do 
...
56060   open #h_customer:=fngethandle: "Name=[Q]\UBmstr\Customer.h"&str$(destination_company_number)&",Shr",internal,outIn,relative 
56080   do 
...
56360   dim tg(11)
56380   open #h_customer:=fngethandle: "Name=[Q]\UBmstr\UBTransVB.h"&str$(destination_company_number)&",Shr",internal,outIn,relative 
56400   do 
