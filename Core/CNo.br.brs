...
34000   CNAM_XIT: ! 
34020   ! /r
34040   let cnam$=cnam_read$ soflow ignore
...
38060   let company_count=filename_item=0
...
38160       let company_count+=1
38180       let cno_list(company_count)=tmp_cno
38200     end if 
38210   ACNO_CONV: ! 
...
56120   if as2n_abbr$='' then let as2n_abbr$=env$('CurSys')
56140   let as2n_abbr$=lwrc$(as2n_abbr$)
56160   !   if as2n_abbr$='aa' then
56180   !     let as2n_return$='ACS Programmer'
56200   if as2n_abbr$='ar' then 
56220     let as2n_return$='Accounts Receivable'
56240   else if as2n_abbr$='bl' then 
56260     let as2n_return$='Business License'
56280   else if as2n_abbr$='cl' then 
56300     let as2n_return$='Checkbook'
56320   else if as2n_abbr$='co' then 
56340     let as2n_return$='ACS Core'
56360   else if as2n_abbr$='cr' then 
56380     let as2n_return$='Cash Register'
56400   else if as2n_abbr$='ea' then 
56420     let as2n_return$='Home Energy Assistance'
56440   else if as2n_abbr$='fa' then 
56460     let as2n_return$='Fixed Asset'
56480   else if as2n_abbr$='gl' or as2n_abbr$='g1' then 
56500     let as2n_return$='General Ledger'
56520   else if as2n_abbr$='g2' then 
56540     let as2n_return$='General Ledger - Accountants Add-On'
56560   else if as2n_abbr$='hh' then 
56580     let as2n_return$='LapTop Meter Reading'
56600   else if as2n_abbr$='mc' then 
56620     let as2n_return$='Municipal Court'
56640   else if as2n_abbr$='po' then 
56660     let as2n_return$='Purchase Order'
56680   !   else if as2n_abbr$='p1' then
56700   !     let as2n_return$='Payroll (Legacy)'
56720   else if as2n_abbr$='p2' then 
56740     let as2n_return$='Payroll - Job Cost Add-On'
56760   else if as2n_abbr$='pr' or as2n_abbr$='p4' then 
56780     let as2n_return$='Payroll'
56800   else if as2n_abbr$='su' then 
56820     let as2n_return$='Support Tracking'
56840   else if as2n_abbr$='ub' then 
56860     let as2n_return$='Utility Billing'
56880   else if as2n_abbr$='u4' then 
56900     let as2n_return$='Utility Billing - Hand Held Add-On'
56920   else if as2n_abbr$='tm' then 
56940     let as2n_return$='Time Management'
56960   else if as2n_abbr$='oe' then 
56980     let as2n_return$='BR Order Entry'
57000   end if 
...
58060     let cursys_cache$=uprc$(cursys_set$)
58080     let fnreg_write(session$&'.CurSys',cursys_cache$)
58100   else 
58120     let cursys_cache$=uprc$(env$('CurSys'))
58140   end if 
58160   ! 
...
58280         let cursys_cache$=trim$(system_abbr_list$(1)(1:len(system_abbr_list$(1))-4))
58300       end if 
58320       if cursys_cache$="" then 
58340         let cursys_cache$="CO"
58360       end if 
58380     end if 
58400   end if 
58420   ! 
58440   if uprc$(cursys_cache$)="P1" then let cursys_cache$="PR" ! Payroll
58460   if uprc$(cursys_cache$)="P2" then let cursys_cache$="PR" ! Job Cost Payroll
58480   if uprc$(cursys_cache$)="P4" then let cursys_cache$="PR" ! version 4 Payroll
58500   if uprc$(cursys_cache$)="G1" then let cursys_cache$="GL" ! General Ledger
58520   if uprc$(cursys_cache$)="G2" then let cursys_cache$="GL" ! Accountant's GL
58540   if uprc$(cursys_cache$)="G3" then let cursys_cache$="GL" ! Budget Management
