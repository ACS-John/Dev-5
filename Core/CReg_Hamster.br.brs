	...
	fnTop(program$,cap$='CReg Hamster for '&env$('CurSys')&' Company [cno]')
	fncno(cno)
	fn_setup_hamster
...
def fn_open_file
		...
		open #open_file_count+=1: 'Name=[Q]\'&env$('CurSys')&'mstr\reg-'&env$('CurSys')&'.h[cno],Version=1,KFName=[Q]\'&env$('CurSys')&'mstr\reg-'&env$('CurSys')&'-idx.h[cno],Use,RecL=384,KPs=1,KLn=128,Shr',internal,outIn,keyed
