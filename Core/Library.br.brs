...
63424     library 'S:\Core\Reg.br': fnmcreg_read
63426     fnmcreg_read=fnmcreg_read(reg_field_name$,reg_field_value$, reg_field_default$)
63428   fnend
63432   def library fnmcreg_write(reg_field_name$*128,reg_field_value$*256)
63434     library 'S:\Core\Reg.br': fnmcreg_write
63436     fnmcreg_write=fnmcreg_write(reg_field_name$,reg_field_value$)
63438   fnend
63990 ! /r
64000 ! r: array stuff
