...
00360 ! 
00410   let fl1$(5)="1,10,c 60,h,n"
00420   let fl1$(6)="2,10,c 60,h,n"
00430   let fl1$(7)="9,1,c 80,h,n"
00440   let fl1$(8)="24,2,c 60,h,n"
00450   let fl2$(5)="2,10,c 60,h,n"
00460   let fl2$(6)="14,10,c 60,h,n"
00470   let fl2$(7)="15,10,c 60,h,n"
00480   let fl2$(8)="24,2,c 60,h,n"
...
00590   next j
00600   for j=1 to 4
00610     let fl1$(j)=str$(j+3)&",8,c 20"
00620     let ot2$(j)=str$(j+3)&",25,n 10.2,ut,n"
00630     let fl2$(j)=fl1$(j)
00640   next j
00642   dim scr1$(4)
00650   let scr1$(1)="CLIENT #"
00660   let scr1$(2)="BILLING CODE"
00670   let scr1$(3)="DATE"
...
00920   let scrid$(2)="Enter CLIENT # as 0 when completed."
00930   let scrid$(3)="-Code- ---------Invoice Descriptions-------------------------  --Amount-- CT SC"
00940   let scrid$(4)="  Press F1 when completed with this screen"
00950 L950: ! 
...
02472   let scrid$(1)="TIme Management Input Correction Screen"
02480   let scrid$(2)="Enter client # as 0 to delete this entry"
02490   let scrid$(3)="  Desc/Code   Invoice Descriptions"
02500   let scrid$(4)="  Press F1 when completed with this screen"
