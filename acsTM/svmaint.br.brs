...
00250   goto L260
00260 L260: print newpage
00270   print fields "3,9,c 55,N": "SERVICE CODE MASTER FILE"
00280   print fields "4,6,C 72,N": "COMPANY NUMBER "&str$(cno)&"  "&ltrm$(cnam$)
00290   print fields "6,9,c 55,n": "1 = INITIAL FILE PREPARATION"
00300   print fields "7,9,c 55,n": "2 = ADD NEW RECORDS"
00310   print fields "8,9,c 55,n": "3 = FILE MAINTENANCE / INQUIRY"
00320   print fields "9,9,c 55,n": "4 = PRINT PROOF LIST"
00330   print fields "10,9,c 55,n": "5 = PRINT SERVICE CODE LISTING"
00340   print fields "12,9,c 55,n": "0 = COMPLETED (RETURN TO T/M MENU)"
00350   print fields "14,9,c 55,n": "ENTER SELECTION #:"
...
00420   let center=42-int(len(rtrm$(cnam$))/2)
00430   print fields "5,"&str$(center)&",C 50,N": cnam$
00440   print fields "8,25,c 50,h,n": "***********   WARNING   ***********"
00450   print fields "10,20,c 52,n": "THIS SELECTION WILL DESTROY ALL EXISTING SERVICE"
00460   print fields "11,20,c 60,n": "CODE RECORDS THAT ARE CURRENTLY SET UP ON THIS COMPANY."
00470   print fields "12,20,c 50,n": "ENTER PASSWORD TO CONTINUE; ELSE PRESS ENTER TO"
00480   print fields "13,20,c 23,n": "RETURN TO THE SUB-MENU."
...
00600   print fields "2,15,c 40,n": "*** ADD SERVICE CODE RECORDS ***"
00610   print fields "3,10,c 60,n": "ENTER SERVICE CODE NUMBER AS BLANK WHEN COMPLETED"
00620 L620: print fields mat sd$: mat se$
...
00690   let ti=3
00700   let holdsc$=sc$
00710 L710: if ti=3 or convc>0 then print fields mat sb$: sc$,ds$,th,sf
00720   print fields "23,5,C 60,H,N": "F6=HELP"
...
00790   let convc=cnt+1
00800   let cp1=len(rtrm$(sb$(convc)))-4
00810   let cp2=cp1+2
...
00890   print fields "5,35,c 30,h,n": "DUPLICATE SERVICE CODE NUMBER"
00900   goto L730
00910 L910: write #1,using L570: sc$,ds$,th,sf
00920   goto L390
00930 L930: print newpage ! *****  FILE MAINT   *****
00940   print fields "10,15,c 50,n": "ENTER SERVICE CODE NUMBER, ENTER 0 WHEN COMPLETED"
...
01010   print fields "2,13,c 45,n": "*** REVIEW SERVICE CODE RECORDS ***"
01020   print fields "3,10,c 60,n": "ENTER SERVICE CODE NUMBER AS BLANK TO DELETE"
01030   goto L620
01040 L1040: if ltrm$(sc$)="" or rtrm$(ltrm$(sc$))="0" then goto L1050 else goto L1160
01050 L1050: print newpage
01060   print fields "10,10,c 60,n": "SERVICE CODE NUMBER "&holdsc$&" WILL BE DELETED"
01070   print fields "12,10,c 40,n": "ENTER 1 TO DELETE; ENTER 2 TO RE-ENTER"
...
01240   let oldti=0
01250   goto L390
01260 L1260: print newpage
01270   if process=1 then goto L1340
01280   print fields "8,10,c 50,n": "POSITION PAPER FOR SERVICE CODE PROOF LIST"
01290   print fields "12,10,c 25,n": "ENTER DATE FOR PROOF LIST"
...
01330   print newpage
01340 L1340: print fields "10,10,c 50,n": "PRINT SERVICE CODE PROOF LIST IN PROCESS"
01350   print fields "23,2,C 30,N": "Press F5 to stop"
...
01490   print #255,using L1500: date$,cnam$,time$,"SERVICE CODE PROOF LIST",dat$
...
01520     print #255,using L1530: se$(i),pl$(i,1),pl$(i,2),pl$(i,3)
...
01850   return 
01860 L1860: print newpage
01870   let convc=currow-4
01880   if convc<1 or convc>8 then let convc=0: goto L1950
01890   let cp1=pos(uprc$(sb$(convc)),"U",1)
01900   let cp2=cp1+2
...
01940   print fields mat flh$: mat hlp$,se$(convc),"ENTER 0 TO CONTINUE OR 1 TO UPDATE HELP SCREEN:"
...
02010 L2010: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L2030
02020   goto L2070
02030 L2030: print newpage
02040   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2060
02050   goto L2070
02060 L2060: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
02070 L2070: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
02080   input fields "24,60,C 1,N": quitcode$
02090   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
02100   print fields "23,3,C 78,N": ""
02110   print fields "24,3,C 78,N": ""
02120   retry 
02130 XIT: let fnxit
