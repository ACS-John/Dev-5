...
00330   open #1: "Name=S:\Core\Data\acsllc\TMCat.h[cno],Shr",internal,input,relative ioerr L2080
00340   read #1,using L350,rec=1: mat cat$ ioerr L2080
00350 L350: form pos 1,30*c 30
00360   close #1: 
00370   gosub L1020
00380   open #1: "Name=S:\Core\Data\acsllc\CLmstr.h[cno],KFName=S:\Core\Data\acsllc\CLIndex.h[cno],Shr",internal,input,keyed ioerr L2080
00390   open #2: "Name=S:\Core\Data\acsllc\TMTRAddr.h[cno],Shr",internal,input,relative ioerr L2080
00400   open #3: "Name=S:\Core\Data\acsllc\TMTRANS.H[cno],Shr",internal,input,relative ioerr L2080
00410   open #4: "Name=S:\Core\Data\acsllc\EMmstr.H[cno],KFName=S:\Core\Data\acsllc\EMIndex.h[cno],Shr",internal,input,keyed ioerr L2080
00420   goto L480
...
01060   pr #255,using L1070: "CLIENT NAME","CATEGORY  HOURS","AT","BILLING","GAIN OR     % PARTIAL TYPE OF SERVICE","PARTNER IN CHARGE      INVOICE"
01070 L1070: form pos 6,c 11,pos 25,c 15,pos 46,c 2,pos 53,c 7,pos 62,c 37,pos 102,c 30,skip 1
01080   pr #255,using L1090: "BILLED   STANDARD","LOSS","BILL ","NUMBER"
01090 L1090: form pos 34,c 17,pos 64,c 4,pos 77,c 5,pos 126,c 6,skip 2
01100   return 
01110 L1110: if std=0 then goto L1180
01120   pr #255,using L1130: cliname$(1:26),b(5)," -",b(8),hrs,std,bil,bil-std,(bil-std)/std*100,"%",ast$,cat$(j1)(1:17),enam$(1:17),iv$ pageoflow L1150
...
01260     goto L1280
01270 L1270: c$(y)="UNASSIGNED"
01280 L1280: if e(y)=0 then goto L1320
01290     pr #255,using L1300: c$(y),d(y),e(y),f(y),f(y)-e(y),(f(y)-e(y))/e(y)*100,"%"
...
01400   goto L1420
01410 L1410: pr #255,using L1390: "  FINAL TOTALS",w,x,z,z-x,0," "
01420 L1420: return 
01430 L1430: if m1=0 then goto L1470
01440   pr #255,using L1450: "  FINAL TOTALS",l1,m1,n1,n1-m1,(n1-m1)/m1*100,"%"
01450 L1450: form skip 2,pos 1,c 14,pos 31,n 9.2,pos 41,n 10.2,pos 51,n 9.2,n 9.2,n 6,c 1,skip 1 ! 2/17/88
01460   goto L1480
01470 L1470: pr #255,using L1450: "  FINAL TOTALS",l1,m1,n1,n1,0," "
01480 L1480: return 
01490 L1490: pr #255: newpage
01500   pr #255,using L1510: cnam$,"BILLING ANALYSIS BY PARTNER"
01510 L1510: form skip 3,pos namtab2,c 40,skip 1,pos 29,c 28,skip 1
01520   pr #255,using L1530: dat$
01530 L1530: form pos dattab2,c 20,skip 2
01540   pr #255,using L1550: "PARTNER NAME","HOURS","AT","BILLING","GAIN OR     %"
01550 L1550: form pos 7,c 12,pos 31,c 5,pos 43,c 2,pos 53,c 7,pos 64,c 13,skip 1
01560   pr #255,using L1570: "BILLED    STANDARD","LOSS"
...
01850   pr #255,using L1530: dat$
01860   pr #255,using L1870: "CATEGORY NAME","HOURS","AT","BILLING","GAIN OR     %"
01870 L1870: form pos 6,c 13,pos 31,c 5,pos 43,c 2,pos 53,c 7,pos 64,c 13,skip 1
01880   pr #255,using L1890: "BILLED    STANDARD","LOSS"
