...
! 
  on error goto Ertn
  library 'S:\Core\Library': fntop,fnxit, fnopenprn,fncloseprn,fnpedat$,fnconsole,fndat,fnRead30Categories
...
! 
  ...
  dim hlp$(20)*78,flh$(22)*18,hhd$*60,dat$*20,a$*5
  open #1: "Name=S:\acsTM\TMSCRN.EM,Shr",internal,input
...
L440: on ti goto L2220,L470,L520,L1720,L450,L460 none L300
L450: chain "S:\acsTM\TMSTAFDR"
L460: chain "S:\acsTM\EMREMTER"
L470: !
	scrid3$(1)="* TIME MANAGEMENT ADD EMPLOYEE RECORDS * SCREEN 1 * "&date$&" * "&time$
  ...
  goto L630
L520: !
	scrid3$(1)="* TIME MANAGEMENT MAINTAIN EMPLOYEES * SCREEN 1 * "&date$&" * "&time$
...
L1760: input fields "10,52,c 20,eu,n": dat$ conv L1760
  ...
  restore #1,key>="         ": nokey L2150
L1830: read #1,using L1840: eno$,e$,mat d,mat e,mat r eof L2150
...
L2260: input fields "15,10,C 5,IE,N": a$ conv L2260
  if uprc$(a$)="THINK" then goto L2280 else goto L300
L2280: pr newpage
L2290: close #1: ioerr L2300
L2300: open #1: "Name=S:\Core\Data\acsllc\EMmstr.H[cno]",internal,outIn ioerr L2320
  close #1,free: 
L2320: open #1: "Name=S:\Core\Data\acsllc\EMmstr.H[cno],SIZE=0,RecL=610",internal,output
  close #1: 
L2340: execute "Index S:\Core\Data\acsllc\EMmstr.H[cno],S:\Core\Data\acsllc\EMIndex.h[cno],1,9,REPLACE,DupKeys"
  if ti<2 then chain 'S:\acsTM\EMAINT' else goto XIT
  goto XIT
L2370: if err=4152 then goto L2290
XIT: fnxit
include: ertn