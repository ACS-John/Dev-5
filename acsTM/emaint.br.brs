...
00320   print fields "3,9,C 60": "Employee Master File"
00330   print fields "4,6,C 72": "Company Number "&str$(cno)&"  "&ltrm$(cnam$)
00340   print fields "6,9,C 60": "1 = Initial File Preparation"
00350   print fields "7,9,C 60": "2 = Add New Records"
00360   print fields "8,9,C 60": "3 = File Maintenance / Inquiry"
00370   print fields "9,9,C 60": "4 = Print Proof Listing"
00380   print fields "10,9,C 60": "5 = Staff Directory Report"
00390   print fields "11,9,C 60": "6 = Remove Terminated Employees"
00400   print fields "13,9,C 60": "0 = Completed (Return To T/M Menu)"
00410   print fields "15,9,C 18": "Enter Selection #:"
...
00470 L470: let scrid3$(1)="* TIME MANAGEMENT ADD EMPLOYEE RECORDS * SCREEN 1 * "&date$&" * "&time$
00480   let scrid3$(2)="  ENTER EMPLOYEE # AS 0 WHEN COMPLETED"
00490   mat d=(0): mat s=(0): mat w=(0): mat t=(0): mat x=(0): mat u=(0): mat y=(0): mat v=(0): mat z=(0): mat r=(0)
00500   let eno$=" ": let e$=" "
00510   goto L630
00520 L520: let scrid3$(1)="* TIME MANAGEMENT MAINTAIN EMPLOYEES * SCREEN 1 * "&date$&" * "&time$
00530   let scrid3$(2)="  ENTER EMPLOYEE # AS 0 TO DELETE"
00540 L540: print newpage
00550   print fields "10,10,c 53,n": "ENTER EMPLOYEE NUMBER, ENTER 0 WHEN COMPLETE"
00560 L560: input fields "10,60,N 9,UE,N": eno conv L560
00570   if eno=0 then goto L300
00580   let eno$=lpad$(str$(eno),9)
...
00610   let eno=val(eno$)
00620   let holdeno$=eno$
00630 L630: print newpage
00640   print fields mat fl3$: mat scr3$,mat scrid3$
00650   print fields mat ot3$: eno$,e$,mat d,mat r
00660   print fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
00670 L670: input fields mat in3$: x1,e$,mat d,mat r conv L1400
00680   if cv>0 then let in3$(cv)(cv1:cv2)="U": let cv=0
00690   if ti=2 and x1=0 then goto L300
00700   let eno$=lpad$(str$(x1),9)
00710   if x1=eno or ti>2 then goto L880
00720   if x1=0 then goto L790
00730   let eno$=lpad$(str$(x1),9)
00740   read #1,using L600,key=eno$: eno$ nokey L880 ioerr L2380
00750   print fields "4,38,c 38,r,n": "DUPLICATE EMPLOYEE; ENTER to continue."
00760   input fields "4,78,c 1,ae,n": pause$
00770   print fields "4,38,c 38,h,n": " "
00780   goto L1260
00790 L790: print newpage
00800   print fields "10,10,c 45,n": "EMPLOYEE NUMBER "&holdeno$&" WILL BE DELETED"
00810   print fields "11,10,c 45,n": "ENTER 1 TO DELETE, ENTER 2 TO RE-ENTER"
...
00890 L890: let scrid4$(1)="EMPLOYEE:"&ltrm$(eno$)&" * "&rtrm$(e$)&" * SCREEN 2 * "&date$&" * "&time$
00900   let scrid4$(2)="                        CURRENT CHARGEABLE HOURS     YTD CHARGEABLE HOURS"
00910   let scrid4$(3)="                       CURRENT CHARGEABLE AMOUNT     YTD CHARGEABLE AMOUNT"
00920   print newpage
00930   print fields mat fl4$: mat ccat$,mat ccat$,mat scrid4$
00940   print fields mat ot4$: mat s,mat t,mat u,mat v
00950   print fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
00960 L960: input fields mat in4$: mat s,mat t,mat u,mat v conv L1480
00970   if cv>0 then let in4$(cv)(cv1:cv2)="U": let cv=0
00980   on cmdkey goto L630,L890,L990,L1080,L1170 none L990
00990 L990: let scrid5$(1)="EMPLOYEE:"&ltrm$(eno$)&" * "&rtrm$(e$)&" * SCREEN 3 * "&date$&" * "&time$
01000   let scrid5$(2)="           NON-CHARGEABLE HOURS - CURRENT           NON-CHARGEABLE HOURS- YTD"
01010   print newpage
01020   print fields mat fl5$: mat nccat$,mat scrid5$
01030   print fields mat ot5$: mat w,mat x
01040   print fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
01050 L1050: input fields mat in5$: mat w,mat x conv L1560
01060   if cv>0 then let in5$(cv)(cv1:cv2)="U": let cv=0
01070   on cmdkey goto L630,L890,L990,L1080,L1170 none L1080
01080 L1080: let scrid6$(1)="EMPLOYEE:"&ltrm$(eno$)&" * "&rtrm$(e$)&" * SCREEN 4 * "&date$&" * "&time$
01090   let scrid6$(2)="         NON-CHARGEABLE AMOUNT - CURRENT           NON-CHARGEABLE AMOUNT - YTD"
01100   print newpage
01110   print fields mat fl6$: mat nccat$,mat scrid6$
01120   print fields mat ot6$: mat y,mat z
01130   print fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
01140 L1140: input fields mat in6$: mat y,mat z conv L1640
01150   if cv>0 then let in6$(cv)(cv1:cv2)="U": let cv=0
...
01270 L1270: let scr3$(1)="EMPLOYEE NUMBER"
01280   let scr3$(2)="EMPLOYEE NAME"
01290   let scr3$(3)="PRIMARY DEPARTMENT #"
01300   let scr3$(4)="EMPLOYEE STATUS"
01310   for j=1 to 10
01320     if rtrm$(ccat$(j))="" then goto L1360
01330     let tcat$=rtrm$(ccat$(j)(1:20))
01340     let scr3$(j+4)=tcat$&" RATE"
01350     goto L1370
01360 L1360: let scr3$(j+4)=" "
01370 L1370: next j
01380   let scr3$(15)="NON - CHARGEABLE RATE"
01390   return 
01400 L1400: if cv>0 then let in3$(cv)(cv1:cv2)="U"
01410   let cv=cnt+1
01420   print fields "24,78,C 1": bell
01430   let in3$(cv)=rtrm$(in3$(cv))
01440   let cv1=pos(uprc$(in3$(cv)),"U",1)
01450   let cv2=cv1+1
01460   let in3$(cv)(cv1:cv1)="CR"
01470   goto L670
01480 L1480: if cv>0 then let in4$(cv)(cv1:cv2)="U"
01490   let cv=cnt+1
01500   print fields "24,78,C 1": bell
01510   let in4$(cv)=rtrm$(in4$(cv))
01520   let cv1=pos(uprc$(in4$(cv)),"U",1)
01530   let cv2=cv1+1
01540   let in4$(cv)(cv1:cv1)="RC"
01550   goto L960
01560 L1560: if cv>0 then let in5$(cv)(cv1:cv2)="U"
01570   let cv=cnt+1
01580   print fields "24,78,C 1": bell
01590   let in5$(cv)=rtrm$(in5$(cv))
01600   let cv1=pos(uprc$(in5$(cv)),"U",1)
01610   let cv2=cv1+1
01620   let in5$(cv)(cv1:cv1)="RC"
01630   goto L1050
01640 L1640: if cv>0 then let in6$(cv)(cv1:cv2)="U"
01650   let cv=cnt+1
01660   print fields "24,78,C 1": bell
01670   let in6$(cv)=rtrm$(in6$(cv))
01680   let cv1=pos(uprc$(in6$(cv)),"U",1)
01690   let cv2=cv1+1
01700   let in6$(cv)(cv1:cv1)="RC"
01710   goto L1140
01720 L1720: print newpage
01725   let fnopenprn
01730   print fields "7,15,c 50,h,n": "POSITION PAPER FOR EMPLOYEE PROOF LISTING"
01740   print fields "10,10,c 40,n": "ENTER AS OF DATE FOR EMPLOYEE PROOF LIST"
01750   print fields "10,52,c 20,n": dat$
01760 L1760: input fields "10,52,c 20,eu,n": dat$ conv L1760
01770   let dattab=66-int(len(rtrm$(dat$))/2)
01780   print newpage
01790   on fkey 5 goto L2140
01800   print fields "10,20,c 50,h,n": "EMPLOYEE PROOF LIST IN PROCESS"
01810   print fields "23,2,C 60": "Press F5 to STOP"
...
01850   gosub L2160
01860   print #255,using L1870: "EMPLOYEE NUMBER",eno$
01870 L1870: form pos 1,c 20,pos 25,c 9,skip 1
01880   print #255,using L1890: "EMPLOYEE NAME",e$
01890 L1890: form pos 1,c 20,pos 25,c 25,skip 1
01900   print #255,using L1910: "PRIMARY DEPARTMENT #",d(1)
01910 L1910: form pos 1,c 20,pos 25,n 4,skip 1
01920   print #255,using L1930: "EMPLOYEE STATUS",d(2)
01930 L1930: form pos 1,c 20,pos 25,n 1,skip 1
01940   print #255,using L1950: "NON-CHARGEABLE RATE",r(11)
01950 L1950: form pos 1,c 20,pos 25,n 6.2,skip 5
01960   print #255,using L1970: "CHARGEABLE HOURS","CHARGEABLE AMOUNT"
01970 L1970: form pos 39,c 16,pos 76,c 17,skip 1
01980   print #255,using L1990: "CURRENT            YTD","CURRENT            YTD","RATES"
01990 L1990: form pos 36,c 25,pos 73,c 25,pos 100,c 5,skip 2
02000   for j=1 to 10
02010     print #255,using L2020: ccat$(j),e(1,j),e(2,j),e(3,j),e(4,j),r(j)
02020 L2020: form pos 1,c 30,pos 35,n 8.2,pos 50,n 8.2,pos 70,n 10.2,pos 85,n 10.2,pos 99,n 6.2,skip 1
02030   next j
02040   print #255,using L2050: "NON-CHARGEABLE HOURS","NON-CHARGEABLE AMOUNT"
02050 L2050: form skip 3,pos 37,c 20,pos 73,c 21,skip 1
02060   print #255,using L2070: "CURRENT            YTD","CURRENT            YTD"
02070 L2070: form pos 36,c 25,pos 73,c 25,skip 2
02080   for j=1 to 20
02090     print #255,using L2100: nccat$(j),e(1,j+10),e(2,j+10),e(3,j+10),e(4,j+10)
02100 L2100: form pos 1,c 30,pos 35,n 8.2,pos 50,n 8.2,pos 70,n 10.2,pos 85,n 10.2,skip 1
02110   next j
02120   print #255: newpage
02130   goto L1830
02140 L2140: print #255: newpage
02150 L2150: let fncloseprn
02152   goto L300
02160 L2160: print #255,using L2161: cnam$
02161 L2161: form pos 47,cc 40,skip 1
02162   print #255,using L2170: "EMPLOYEE PROOF LISTING",dat$
...
02230   print fields "8,22,c 31,r,n": "  ********  WARNING  ********"
02240   print fields "11,10,c 70": "THIS SELECTION ERASES ALL EMPLOYEE RECORDS ON THIS FILE."
02250   print fields "13,5,c 72": "ENTER PASSWORD TO CONTINUE; ELSE PRESS ENTER TO RETURN TO EMPLOYEE MENU."
02260 L2260: input fields "15,10,C 5,IE,N": a$ conv L2260
02270   if uprc$(a$)="THINK" then goto L2280 else goto L300
02280 L2280: print newpage
...
02380 L2380: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L2400
02390   goto L2440
02400 L2400: print newpage
02410   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2430
02420   goto L2440
02430 L2430: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
02440 L2440: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
02450   input fields "24,60,C 1,N": quitcode$
02460   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
02470   print fields "23,3,C 78,N": ""
02480   print fields "24,3,C 78,N": ""
02490   retry 
02500 XIT: let fnxit
