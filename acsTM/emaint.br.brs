...
00320   pr fields "3,9,C 60": "Employee Master File"
00330   pr fields "4,6,C 72": "Company Number "&str$(cno)&"  "&ltrm$(cnam$)
00340   pr fields "6,9,C 60": "1 = Initial File Preparation"
00350   pr fields "7,9,C 60": "2 = Add New Records"
00360   pr fields "8,9,C 60": "3 = File Maintenance / Inquiry"
00370   pr fields "9,9,C 60": "4 = pr Proof Listing"
00380   pr fields "10,9,C 60": "5 = Staff Directory Report"
00390   pr fields "11,9,C 60": "6 = Remove Terminated Employees"
00400   pr fields "13,9,C 60": "0 = Completed (Return To T/M Menu)"
00410   pr fields "15,9,C 18": "Enter Selection #:"
...
00550   pr fields "10,10,c 53,n": "ENTER EMPLOYEE NUMBER, ENTER 0 WHEN COMPLETE"
...
00640   pr fields mat fl3$: mat scr3$,mat scrid3$
00650   pr fields mat ot3$: eno$,e$,mat d,mat r
00660   pr fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
...
00750   pr fields "4,38,c 38,r,n": "DUPLICATE EMPLOYEE; ENTER to continue."
00760   input fields "4,78,c 1,ae,n": pause$
00770   pr fields "4,38,c 38,h,n": " "
00780   goto L1260
00790 L790: pr newpage
00800   pr fields "10,10,c 45,n": "EMPLOYEE NUMBER "&holdeno$&" WILL BE DELETED"
00810   pr fields "11,10,c 45,n": "ENTER 1 TO DELETE, ENTER 2 TO RE-ENTER"
...
00920   pr newpage
00930   pr fields mat fl4$: mat ccat$,mat ccat$,mat scrid4$
00940   pr fields mat ot4$: mat s,mat t,mat u,mat v
00950   pr fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
...
01010   pr newpage
01020   pr fields mat fl5$: mat nccat$,mat scrid5$
01030   pr fields mat ot5$: mat w,mat x
01040   pr fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
...
01100   pr newpage
01110   pr fields mat fl6$: mat nccat$,mat scrid6$
01120   pr fields mat ot6$: mat y,mat z
01130   pr fields "24,1,C 80,H,N": "F1=SCREEN 1, F2=SCREEN 2, F3=SCREEN 3, F4=SCREEN 4, F5=COMPLETED"
...
01410   cv=cnt+1
01420   pr fields "24,78,C 1": bell
...
01490   cv=cnt+1
01500   pr fields "24,78,C 1": bell
...
01570   cv=cnt+1
01580   pr fields "24,78,C 1": bell
...
01650   cv=cnt+1
01660   pr fields "24,78,C 1": bell
...
01800   pr fields "10,20,c 50,h,n": "EMPLOYEE PROOF LIST IN PROCESS"
01810   pr fields "23,2,C 60": "Press F5 to STOP"
...
02230   pr fields "8,22,c 31,r,n": "  ********  WARNING  ********"
02240   pr fields "11,10,c 70": "THIS SELECTION ERASES ALL EMPLOYEE RECORDS ON THIS FILE."
02250   pr fields "13,5,c 72": "ENTER PASSWORD TO CONTINUE; ELSE PRESS ENTER TO RETURN TO EMPLOYEE MENU."
...
02380 L2380: if err=61 then pr fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L2400
02390   goto L2440
02400 L2400: pr newpage
02410   if err=4148 then pr fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2430
02420   goto L2440
02430 L2430: pr fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
02440 L2440: pr fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
02450   input fields "24,60,C 1,N": quitcode$
02460   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
02470   pr fields "23,3,C 78,N": ""
02480   pr fields "24,3,C 78,N": ""
02490   retry 
02500 XIT: let fnxit
