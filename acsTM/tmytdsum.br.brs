...
00110   print newpage
00120   print fields "10,10,c 35,n": "ENTER YTD BILLING SUMMARY DATE"
00130   print fields "10,48,c 20,n": dat$
00140   print fields "14,30,c 20,n": "Press F5 to stop"
...
00200   print fields "10,25,c 40,n": "YTD BILLING SUMMARY IN PROCESS"
00210   print fields "23,2,c 30,n": "Press F5 to stop"
00220   let fnopenprn
...
00820 XIT: let fnxit
00830 L830: print #255,using L840: date$,cnam$,time$,"YTD BILLING SUMMARY"
00840 L840: form skip 3,pos 1,c 8,pos namtab,c 40,skip 1,pos 1,c 8,pos 57,c 23,skip 1
00850   print #255,using L860: dat$
00860 L860: form pos dattab,c 20,skip 2
00870   print #255,using L880: "CLIENT NAME","CATEGORY   HOURS","AT","BILLING","GAIN OR     %   DATE   TYPE OF SERVICE","PARTNER IN CHARGE"
00880 L880: form pos 6,c 11,pos 25,c 16,pos 46,c 2,pos 54,c 7,pos 64,c 38,pos 112,c 20,skip 1
00890   print #255,using L900: "BILLED  STANDARD","LOSS","BILLED"
00900 L900: form pos 35,c 17,pos 66,c 4,pos 79,c 6,skip 2
00910   return 
00920 L920: if y(6)=0 then goto L990
00930   print #255,using L940: cliname$(1:26),y(3),"-",y(2),y(5),y(6),y(7),y(7)-y(6),(y(7)-y(6))/y(6)*100,"%",y(1),cat$(y(3))(1:22),enam$(1:22) pageoflow L960
...
00950   goto L1010
00960 L960: print #255: newpage
00970   gosub L830
00980   goto L1010
00990 L990: if y(3)= 0 then let y(3)=1
01000   print #255,using L940: cliname$(1:26),y(3),"-",y(2),y(5),y(6),y(7),y(7),0," ",y(1),cat$(y(3))(1:22),enam$(1:22) pageoflow L960
...
01080     goto L1100
01090 L1090: let c$(y3)="UNASSIGNED"
01100 L1100: if e(y3)=0 then goto L1140
01110     print #255,using L1120: c$(y3),d(y3),e(y3),f(y3),f(y3)-e(y3),(f(y3)-e(y3))/e(y3)*100,"%"
01120 L1120: form pos 1,c 25,pos 28,n 8.2,pos 38,n 10.2,pos 50,n 10.2,pos 61,n 10.2,pos 72,n 5,pos 77,c 1,skip 1 ! 2/5/88
01130     goto L1150
01140 L1140: print #255,using L1120: c$(y3),d(y3),e(y3),f(y3),f(y3),0,"%"
01150 L1150: let w=w+d(y3)
01160     let x=x+e(y3)
01170     let z=z+f(y3)
01180   next y3
01190 L1190: if x=0 then goto L1230
01200   print #255,using L1210: "  FINAL TOTALS",w,x,z,z-x,(z-x)/x*100,"%"
...
01220   goto L1240
01230 L1230: print #255,using L1210: "  FINAL TOTALS",w,x,z,z-x,0," "
01240 L1240: return 
01250 L1250: if m1=0 then goto L1290
01260   print #255,using L1270: "  FINAL TOTALS",l1,m1,n1,n1-m1,(n1-m1)/m1*100,"%"
01270 L1270: form skip 2,pos 1,c 14,pos 33,n 8.2,n 10.2,n 10.2,n 10.2,n 6,c 1,skip 1 ! 2/5/88
01280   goto L1300
01290 L1290: print #255,using L1270: "  FINAL TOTALS",l1,m1,n1,n1,0," "
01300 L1300: return 
01310 L1310: print #255: newpage
01320   print #255,using L1330: cnam$,"BILLING ANALYSIS BY PARTNER"
01330 L1330: form skip 3,pos namtab2,c 40,skip 1,pos 29,c 28,skip 1
01340   print #255,using L1350: dat$
01350 L1350: form pos dattab2,c 20,skip 2
01360   print #255,using L1370: "PARTNER NAME","HOURS","AT","BILLING","GAIN OR     %"
01370 L1370: form pos 7,c 12,pos 31,c 5,pos 43,c 2,pos 53,c 7,pos 64,c 13,skip 1
01380   print #255,using L1390: "BILLED    STANDARD","LOSS"
...
01640 L1640: return 
01650 L1650: print #255: newpage
01660   print #255,using L1330: cnam$,"BILLING ANALYSIS BY CATEGORY"
01670   print #255,using L1350: dat$
01680   print #255,using L1690: "CATEGORY NAME","HOURS","AT","BILLING","GAIN OR     %"
01690 L1690: form pos 6,c 13,pos 31,c 5,pos 43,c 2,pos 53,c 7,pos 64,c 13,skip 1
01700   print #255,using L1710: "BILLED    STANDARD","LOSS"
...
01780     print #255,using L1120: x$(x7)(1:25),h(x7),i(x7),g(x7),g(x7),0,"%"
01790     goto L1810
01800 L1800: print #255,using L1120: x$(x7)(1:25),h(x7),i(x7),g(x7),g(x7)-i(x7),(g(x7)-i(x7))/i(x7)*100,"%"
01810 L1810: let w1=w1+g(x7)
01820     let x1=x1+h(x7)
01830     let y1=y1+i(x7)
01840   next x7
01850 L1850: if y1=0 then goto L1880
01860   print #255,using L1210: "   FINAL TOTALS",x1,y1,w1,w1-y1,(w1-y1)/y1*100,"%"
01870   goto L1890
01880 L1880: print #255,using L1210: "   FINAL TOTALS",x1,y1,w1,w1-y1,0," "
01890 L1890: return 
01900 L1900: print #255,using L1910: "---------","---------",tbil,tgy
01910 L1910: form pos 52,c 9,pos 62,c 9,skip 1,pos 51,2*n 10.2,skip 2
01920   let tbil=0
01930   let tgy=0
01940   return 
01950 L1950: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L1970
01960   goto L2010
01970 L1970: print newpage
01980   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2000
01990   goto L2010
02000 L2000: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
02010 L2010: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
02020   input fields "24,60,C 1,N": quitcode$
02030   if rtrm$(uprc$(quitcode$))="Q" then goto L2070
02040   print fields "23,3,C 78,N": ""
02050   print fields "24,3,C 78,N": ""
02060   retry 
