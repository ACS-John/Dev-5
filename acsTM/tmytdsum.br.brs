...
00280   open #1: "Name="&env$('Q')&"\TMmstr\TMCat.h"&env$('cno')&",Shr",internal,input,relative ioerr L1950
00290   read #1,using L300,rec=1: mat cat$ ioerr L1950
00300 L300: form pos 1,30*c 30
00310   close #1: 
00320   gosub L830
00330   open #1: "Name="&env$('Q')&"\TMmstr\CLmstr.h"&env$('cno')&",KFName="&env$('Q')&"\TMmstr\CLIndex.h"&env$('cno')&",Shr",internal,input,keyed ioerr L1950
00340   goto L400
...
00380 L380: cliname$=" "
00390 L390: return 
00400 L400: open #2: "Name="&env$('Q')&"\TMmstr\TMYTDTrn.h"&env$('cno')&",Shr",internal,input,relative ioerr L1950
00410   open #3: "Name="&env$('Q')&"\TMmstr\EMmstr.H"&env$('cno')&",KFName="&env$('Q')&"\TMmstr\EMIndex.h"&env$('cno')&",Shr",internal,input,keyed ioerr L1950
...
02100   write #9,using L2090: "FILE tmytdtrn.H"&env$('cno')&","&env$('Q')&"\TMmstr,,"&env$('Temp')&"\Addr."&session$&",,,ACSTM,,A,N"
