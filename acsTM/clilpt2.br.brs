...
00085   do 
00090     print newpage
00100     print fields "10,10,C 50": "Account Number to Print (Blank to Stop):"
00108 ASK: ! 
...
00160     print #255,using "form pos 1,c 40": mat a$
00180     print #255,using "form c 1,skip 17": ""
00200     if ln=4 then print #255: : let ln=0 else let ln=ln+1
00210   loop 
