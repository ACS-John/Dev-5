...
00140   print fields "7,10,c 60,n": "POSITION PAPER IN PRINTER FOR SERVICE CODE LISTING"
00150   print fields "10,10,c 52,n": "ENTER DATE FOR SERVICE CODE LISTING IN MMDDYY FORMAT"
00160   print fields "10,66,n 6,n": dat
00170 L170: input fields "10,66,n 6,eu,n": dat conv L170
00180   if dat<10100 or dat>123199 then goto L130
00200   print newpage
00210   print fields "10,25,c 48,n": "SERVICE CODE LISTING IN PROCESS"
00220   print fields "23,2,c 20,n": "Press F5 to stop"
00230   let fnopenprn
00250   gosub L410
00260 L260: read #1,using L270: sc$,ds$ eof L520 ioerr L550
00270 L270: form pos 1,c 4,c 30
00280   let sc=int(val(sc$)/100)
...
00330   print #255: 
00340   let holdsc=sc
00350 L350: print #255,using L360: sc$,ds$ pageoflow L380
00360 L360: form pos 1,c 4,pos 9,c 30,skip 1
00370   goto L260
00380 L380: print #255: newpage
00390   gosub L410
00400   goto L260
00410 L410: let p1=p1+1
00420   print #255,using L430: cnam$,"PAGE",p1
00430 L430: form skip 3,pos namtab,c 40,pos 76,c 5,n 4,skip 1
00440   print #255,using L450: "SERVICE CODE LISTING"
00450 L450: form pos 33,c 22,skip 1
00460   print #255,using L470: dat
00470 L470: form pos 38,pic(zz/zz/zz),skip 3
00480   print #255,using L490: "CODE","DESCRIPTION"
...
00540   goto XIT
00550 L550: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L570
00560   goto L610
00570 L570: print newpage
00580   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L600
00590   goto L610
00600 L600: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00610 L610: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00620   input fields "24,60,C 1,N": quitcode$
00630   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
00640   print fields "23,3,C 78,N": ""
00650   print fields "24,3,C 78,N": ""
00660   retry 
00670 XIT: let fnxit
