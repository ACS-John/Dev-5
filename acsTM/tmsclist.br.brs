...
00140   pr fields "7,10,c 60,n": "POSITION PAPER IN PRINTER FOR SERVICE CODE LISTING"
00150   pr fields "10,10,c 52,n": "ENTER DATE FOR SERVICE CODE LISTING IN MMDDYY FORMAT"
00160   pr fields "10,66,n 6,n": dat
...
00540   goto XIT
00550 L550: if err=61 then pr fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L570
00560   goto L610
00570 L570: pr newpage
00580   if err=4148 then pr fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L600
00590   goto L610
00600 L600: pr fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00610 L610: pr fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00620   input fields "24,60,C 1,N": quitcode$
00630   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
00640   pr fields "23,3,C 78,N": ""
00650   pr fields "24,3,C 78,N": ""
00660   retry 
00670 XIT: let fnxit
