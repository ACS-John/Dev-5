...
00160   open #1: "Name=[Q]\TMmstr\CLmstr.h[cno]",internal,input ioerr L180
00170   close #1,free: 
00180 L180: open #1: "Name=[Q]\TMmstr\CLmstr.h[cno],SIZE=0,RecL=534",internal,output 
00190   close #1: 
00200   open #2: "Name=[Q]\TMmstr\TMTrans.h[cno]",internal,output ioerr L220
00210   close #2,free: 
00220 L220: open #2: "Name=[Q]\TMmstr\TMTrans.h[cno],SIZE=0,RecL=86",internal,output 
...
00250   close #2: 
00260   open #3: "Name=[Q]\TMmstr\TMTRAddr.h[cno]",internal,output ioerr L280
00270   close #3,free: 
00280 L280: open #3: "Name=[Q]\TMmstr\TMTRAddr.h[cno],SIZE=0,RecL=175",internal,output 
00290   ta(1,1)=1
00300   write #3,using L310: mat ta,mat fb
00310 L310: form pos 1,50*pd 3,25*n 1
00320   close #3: 
00330   open #4: "Name=[Q]\TMmstr\TMYTDTrn.h[cno]",internal,output ioerr L350
00340   close #4,free: 
00350 L350: open #4: "Name=[Q]\TMmstr\TMYTDTrn.h[cno],SIZE=0,RecL=56",internal,output 
00360   close #4: 
00370   open #5: "Name=[Q]\TMmstr\TMINVREG.h[cno]",internal,output ioerr L390
00380   close #5,free: 
00390 L390: open #5: "Name=[Q]\TMmstr\TMINVREG.h[cno],SIZE=0,RecL=45",internal,output 
00400   close #5: 
00410   open #6: "Name=[Q]\TMmstr\ARTrans.h[cno]",internal,output ioerr L430
00420   close #6,free: 
00430 L430: open #6: "Name=[Q]\TMmstr\ARTrans.h[cno],SIZE=0,RecL=60",internal,output 
00440   write #6,using L450: "",mat tr,"",1
00450 L450: form pos 1,c 17,n 6,2*pd 5.2,pd 2,2*n 1,c 20,pd 3
00460   close #6: 
00470 !   open #7: "Name=[Q]\TMmstr\ARMoTran.h[cno]",internal,output ioerr L490
00480 !   close #7,free: 
00490 ! L490: open #7: "Name=[Q]\TMmstr\ARMoTran.h[cno],SIZE=0,RecL=239",internal,output 
00500 !   close #7: 
00510   open #99: "Name=PROC."&wsid$,display,output 
00520   restore #99: 
00530   pr #99: "CLEAR"
00540   pr #99: "PROCERR RETURN"
00550   pr #99: "Index [Q]\TMmstr\CLmstr.h[cno]"&' '&"[Q]\TMmstr\CLIndex.h[cno] 1 5 REPLACE DupKeys"
00560   pr #99: "Index [Q]\TMmstr\CLmstr.h[cno]"&' '&"[Q]\TMmstr\CLIndx2.h[cno] 6 28 REPLACE DupKeys"
