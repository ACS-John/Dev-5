...
15100 ! pr f mat fl1$: mat sc1$,"A/R Input Selection Menu","Selection:"
15200 L630: ! 
15300 ! 
...
15900   if transaction_type=4 or transaction_type=3 then sc2$(7)="G/L # to Credit" else sc2$(7)="G/L # to Debit"
16000   if transaction_type=3 then sc2$(6)="Discount Amount" else sc2$(6)=""
16100   if gx=0 then sc2$(7)=" "
...
16800 L760: ! 
16900   pr f mat ot1$: p$,iv$,tr(1),tr(3),id$,tr(2)
17000   goto L790
17100 L780: ! 
17200   pr f mat ot1$: p$,iv$,tr(1),tr(3),id$,tr(2),mat pgl,mat gl
17300 L790: ! 
17400   pr f "5,30,pic(zzzzzz)": tr(1)
17500   pr f "24,20,C 50,N": "F1 Continue   F2 verify name    F4 Search"
...
18300   goto L1280
18400 L870: ! 
18500   if ce>0 then fli1$(ce)=srep$(fli1$(ce),1,"RC","U")
18600   ce=cnt+1
18700   fli1$(ce)=srep$(uprc$(rtrm$(fli1$(ce))),1,"U","RC")
18800   goto L820
18900 L910: ! 
...
20600   goto L920
20700 L1050: ! 
20800   pr f "3,40,C 25,N": name$
20900 L1060: ! 
21000   fli1$(4)="6,30,n 11.2,ut,n"
21100   if r1>0 then goto L1180
21200   if transaction_type=3 then fli1$(4)="6,30,n 11.2,ue,n"
...
22800   goto L1280
22900 L1240: ! 
23000   if ce>0 then fli1$(ce)=srep$(fli1$(ce),1,"RC","U")
23100   ce=cnt+1
23200   fli1$(ce)=srep$(uprc$(rtrm$(fli1$(ce))),1,"U","RC")
...
24400   pr f "6,48,c 20": "NO AMOUNT ENTERED"
24500   goto L790
24600 L1370: ! 
...
28800   pr newpage
28900   pr f mat fl1$: mat sc3$,"A/R Input Proof Totals",""
29000   pr f "11,5,C 20": "Total Cash Sales"
29100   pr f "12,5,C 22": "Total Discounts Taken"
29200   pr f mat flo3$: mat pt
29300   pr f "12,26,n 11.2": tdt
29400   pr f "18,1,C 70,H,N": "1=Merge; 2=Corrections; 3=Proof List: 5=Stop Without Posting"
29500 L1790: ! 
...
31000     pr f "10,20,C 40,N": "Input Edit Listing In Process"
31100     pr f "23,2,C 30,N": "Press F5 To Stop"
...
35600   fnxit
35700 ERR_FILE: ! r:
35800   if err=61 then pr f "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L2310
35900   goto L2350
36000 L2310: pr newpage
36100   if err=4148 then pr f "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2340
36200   goto L2350
36300 L2340: pr f "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
36400 L2350: pr f "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
36500   input fields "24,60,C 1,N": quitcode$
36600   if err=61 and rtrm$(uprc$(quitcode$))="Q" then goto SCREEN_1 else goto L2410
36700   pr f "23,3,C 78,N": ""
36800   pr f "24,3,C 78,N": ""
36900   retry 
...
43300 !         sc1$(4)="3 = Collections"
43400 !         sc1$(5)="4 = Credit Memos"
43500 !      !
43600 !         fl1$(1)='6,5,c 20'
43700 !         fl1$(2)='7,5,c 20'
43800 !         fl1$(3)='8,5,c 20'
43900 !         fl1$(4)='9,5,c 20'
44000 !         fl1$(5)='10,5,c 20'
44100 !         fl1$(6)='3,10,c 50,h,n'
44200 !         fl1$(7)='13,10,c 50,h,n'
44300 !      !
44400 !         sc3$(1)="TOTAL ACCOUNT #'S"
44500 !         sc3$(2)="TOTAL INVOICES"
44600 !         sc3$(3)="TOTAL DEBIT MEMOS"
44700 !         sc3$(4)="TOTAL COLLECTIONS"
44800 !         sc3$(5)="TOTAL CREDIT MEMOS"
44900 !         flo3$(1)='6,26,n 11.2'
45000 !         flo3$(2)='7,26,n 11.2'
45100 !         flo3$(3)='8,26,n 11.2'
45200 !         flo3$(4)='9,26,n 11.2'
45300 !         flo3$(5)='10,26,n 11.2'
45400 !         flo3$(6)='11,26,n 11.2'
45500 !      !
45600 !         flo1$(1)='3,5,c 20'
45700 !         flo1$(2)='4,5,c 20'
45800 !         flo1$(3)='5,5,c 20'
45900 !         flo1$(4)='6,5,c 20'
46000 !         flo1$(5)='7,5,c 20'
46100 !         flo1$(6)='8,5,c 20'
46200 !         flo1$(7)='9,5,c 20'
46300 !         flo1$(8)='11,20,c 20'
46400 !         flo1$(9)='11,40,c 20'
46500 !         flo1$(10)='1,15,c 40,h,n'
46600 !         flo1$(11)='2,5,c 45,h,n'
46700 !      !
46800 !         ot1$(01)='3,30,C 5,ut,n'
46900 !         ot1$(02)='4,30,c 12,ut,n'
47000 !         ot1$(03)='5,30,n 6,ut,n'
47100 !         ot1$(04)='6,30,n 11.2,ut,n'
47200 !         ot1$(05)='7,30,c 20,ut,n'
47300 !         ot1$(06)='8,30,n 11.2,ut,n'
47400 !         ot1$(07)='9,34,n 6,ut,n'
47500 !         ot1$(08)='12,24,n 6,ut,n'
47600 !         ot1$(09)='12,40,n 11.2,ut,n'
47700 !         ot1$(10)='13,24,n 6,ut,n'
47800 !         ot1$(11)='13,40,n 11.2,ut,n'
47900 !         ot1$(12)='14,24,n 6,ut,n'
48000 !         ot1$(13)='14,40,n 11.2,ut,n'
48100 !         ot1$(14)='15,24,n 6,ut,n'
48200 !         ot1$(15)='15,40,n 11.2,ut,n'
48300 !         ot1$(16)='16,24,n 6,ut,n'
48400 !         ot1$(17)='16,40,n 11.2,ut,n'
48500 !         ot1$(18)='17,24,n 6,ut,n'
48600 !         ot1$(19)='17,40,n 11.2,ut,n'
48700 !         ot1$(20)='18,24,n 6,ut,n'
48800 !         ot1$(21)='18,40,n 11.2,ut,n'
48900 !         ot1$(22)='19,24,n 6,ut,n'
49000 !         ot1$(23)='19,40,n 11.2,ut,n'
49100 !         ot1$(24)='20,24,n 6,ut,n'
49200 !         ot1$(25)='20,40,n 11.2,ut,n'
49300 !         ot1$(26)='21,24,n 6,ut,n'
49400 !         ot1$(27)='21,40,n 11.2,ut,n'
49500 !      !
49600 !         fli1$(01)='3,30,C 5,ut,n'
49700 !         fli1$(02)='4,30,c 12,cu,n'
49800 !         fli1$(03)='5,30,n 6,ut,n'
49900 !         fli1$(04)='6,30,n 11.2,ut,n'
50000 !         fli1$(05)='7,30,c 20,ut,n'
50100 !         fli1$(06)='8,30,n 11.2,ut,n'
50200 !         fli1$(07)='9,34,n 6,ut,n'
50300 !         fli1$(08)='12,24,n 6,ut,n'
50400 !         fli1$(09)='12,40,n 11.2,ut,n'
50500 !         fli1$(10)='13,24,n 6,ut,n'
50600 !         fli1$(11)='13,40,n 11.2,ut,n'
50700 !         fli1$(12)='14,24,n 6,ut,n'
50800 !         fli1$(13)='14,40,n 11.2,ut,n'
50900 !         fli1$(14)='15,24,n 6,ut,n'
51000 !         fli1$(15)='15,40,n 11.2,ut,n'
51100 !         fli1$(16)='16,24,n 6,ut,n'
51200 !         fli1$(17)='16,40,n 11.2,ut,n'
51300 !         fli1$(18)='17,24,n 6,ut,n'
51400 !         fli1$(19)='17,40,n 11.2,ut,n'
51500 !         fli1$(20)='18,24,n 6,ut,n'
51600 !         fli1$(21)='18,40,n 11.2,ut,n'
51700 !         fli1$(22)='19,24,n 6,ut,n'
51800 !         fli1$(23)='19,40,n 11.2,ut,n'
51900 !         fli1$(24)='20,24,n 6,ut,n'
52000 !         fli1$(25)='20,40,n 11.2,ut,n'
52100 !         fli1$(26)='21,24,n 6,ut,n'
52200 !         fli1$(27)='21,40,n 11.2,ut,n'
52300 !      !
52400 !         sc2$(1)='Client #'
52500 !         sc2$(2)='Invoice #'
52600 !         sc2$(3)='Date'
52700 !         sc2$(4)='Amount'
52800 !         sc2$(5)='Description'
52900 !         sc2$(6)='Cost Of Goods'
53000 !         sc2$(7)=''
53100 !         sc2$(8)='G/L Account #'
53200 !         sc2$(9)='Amount'
53300 !        else 
...
56600 ! r: headings
56700     fn_get_next_line(line$) : line_count+=1
56800     str2mat(line$,mat item$,',',"QUOTES:TRIM")
