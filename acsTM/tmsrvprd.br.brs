...
00190   print newpage
00200   print fields "10,5,c 57,n": "ENTER DATE FOR SERVICE PRODUCTION REPORT IN MMDDYY FORMAT"
00210   print fields "10,65,n 6,n": dat
00220   print fields "13,30,c 20": "Press F5 to Stop"
...
00270   close #8: 
00280   print newpage
00290   print fields "10,15,c 57,n": "PRINT SERVICE PRODUCTION REPORT IN PROCESS"
00300   print fields "23,2,C 30,N": "Press F5 to stop"
00310   gosub L800
00320 L320: read #1,using L330: sc$,ds$,th,sf eof L460 ioerr L920
00330 L330: form pos 1,c 4,c 30,pd 4.2,pd 5.2
00340   let catno$=sc$(1:2)
00350   let catno=val(catno$)
...
00490 XIT: let fnxit
00500 L500: print #255,using L510: catno*100,cat$(catno)
00510 L510: form pos 2,pic(zzzz),pos 8,c 30,skip 1
00520   let hcatno=catno
00530   return 
00540 L540: if th><0 then goto L600
00550   print #255,using L640: sc$,ds$,th,sf,0 pageoflow L570
00560   goto L650
00570 L570: print #255: newpage
00580   gosub L800
00590   goto L650
00600 L600: print #255,using L640: sc$,ds$,th,sf,sf/th pageoflow L620
00610   goto L650
00620 L620: print #255: newpage
00630   gosub L800
00640 L640: form pos 5,c 4,pos 14,c 30,pos 53,n 13.2,n 13.2,n 13.2,skip 1
00650 L650: let b1=b1+th
00660   let b2=b2+sf
00670   let m$=r$
...
00730 L730: let b0=0
00740 L740: print #255,using L750: "TOTAL",cat$(hcatno),b1,b2,b0
...
00810   print #255,using L820: date$,cnam$,"PAGE",p1
00820 L820: form skip 3,pos 1,c 8,pos namtab,c 40,pos 75,c 5,pic(zzz),skip 1
00830   print #255,using L840: time$,"SERVICE PRODUCTION REPORT"
00840 L840: form pos 1,c 8,pos 29,c 25,skip 1
00850   print #255,using L860: "FOR YEAR-TO-DATE",dat
00860 L860: form pos 29,c 16,pos 46,pic(zz/zz/zz),skip 4
00870   print #255,using L880: "SERVICE","CHARGED","AVERAGE"
00880 L880: form pos 4,c 7,pos 70,c 7,pos 83,c 7,skip 1
00890   print #255,using L900: "CODE","DESCRIPTION","HOURS","AT STANDARD","HOURLY RATE"
00900 L900: form pos 5,c 4,pos 18,c 11,pos 60,c 5,pos 68,c 11,pos 81,c 11,skip 3
00910   return 
00920 L920: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L940
00930   goto L980
00940 L940: print newpage
00950   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L970
00960   goto L980
00970 L970: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00980 L980: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00990   input fields "24,60,C 1,N": quitcode$
01000   if rtrm$(uprc$(quitcode$))="Q" then goto L1040
01010   print fields "23,3,C 78,N": ""
01020   print fields "24,3,C 78,N": ""
01030   retry 
