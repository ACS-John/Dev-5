...
00110   pr f "11,10,c 70": "This program zeros the current period totals in"
00120   pr f "12,10,c 70": "the employee master file.  Be sure you have run"
00130   pr f "13,10,c 70": "all of the current period reports before continuing."
00140   pr f "15,10,c 62": "[1] Continue  [2] Exit"
...
00190   open #1: "Name=S:\Core\Data\acsllc\EMmstr.H[cno],KFName=S:\Core\Data\acsllc\EMIndex.h[cno],Shr",internal,outIn,keyed ioerr L280
...
00310   if err=4148 then pr f "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L330
00320   goto L340
00330 L330: pr f "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00340 L340: pr f "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00350   input fields "24,60,C 1,N": quitcode$
00360   if rtrm$(uprc$(quitcode$))="Q" then goto L400
00370   pr f "23,3,C 78,N": ""
00380   pr f "24,3,C 78,N": ""
00390   retry 
00400 L400: goto XIT
