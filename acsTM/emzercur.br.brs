...
00110   pr fields "11,10,c 70": "This program zeros the current period totals in"
00120   pr fields "12,10,c 70": "the employee master file.  Be sure you have run"
00130   pr fields "13,10,c 70": "all of the current period reports before continuing."
00140   pr fields "15,10,c 62": "[1] Continue  [2] Exit"
00150 L150: input fields "15,75,n 1,eu,n": a conv L150
00160   on a goto L170,XIT none L90
00170 L170: pr newpage
00180   pr fields "10,10,c 60,n": "ZERO CURRENT FIELDS IN EMPLOYEE MASTER FILE IN PROCESS"
...
00270 XIT: let fnxit
00280 L280: if err=61 then pr fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L300
00290   goto L340
00300 L300: pr newpage
00310   if err=4148 then pr fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L330
00320   goto L340
00330 L330: pr fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00340 L340: pr fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00350   input fields "24,60,C 1,N": quitcode$
00360   if rtrm$(uprc$(quitcode$))="Q" then goto L400
00370   pr fields "23,3,C 78,N": ""
00380   pr fields "24,3,C 78,N": ""
00390   retry 
00400 L400: goto XIT
