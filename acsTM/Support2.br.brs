...
01700   open #open_file_count+=1: "Name=S:\Core\Data\acsllc\Support.h420,Version=2,KFName=S:\Core\Data\acsllc\Support-Idx.h420,Use,RecL=246,KPs=1/7,KLn=6/2,Shr",internal,outIn,keyed 
01800 return 
...
35520  !
35540     fnH2AddComboF(1,'S:\Core\Data\acsllc\Clmstr.h420',1,5,6,30,'S:\Core\Data\acsllc\CLIndex.h420',1)
35560  !
...
55220 ! old program !    execute "Index S:\Core\Data\acsllc\support.h420  S:\Core\Data\acsllc\support-idx.h420 1/7,6/2,replace,DupKeys"
...
55320 ! old program !    open #open_file_count+=1: "Name=S:\Core\Data\acsllc\Support.h420,Version=2,KFName=S:\Core\Data\acsllc\Support-Idx.h420,Use,RecL=246,KPs=1/7,KLn=6/2,Shr",internal,outIn,keyed 
...
57020 ! old program !    c$(cl,2)="S:\Core\Data\acsllc\Clmstr.h420"
...
57120 ! old program !    c$(cl,7)="S:\Core\Data\acsllc\CLIndex.h420"
57140 ! old program !    c$(cl,8)=limit_to_list$
57160 ! old program !    cl=3 : c$(cl,1)='ComboF'
57180 ! old program !    c$(cl,2)="S:\Core\Data\acsllc\Systems.h420"
57200 ! old program !    c$(cl,3)='1' : c$(cl,4)='2'
57220 ! old program !    c$(cl,5)='3' : c$(cl,6)='50'
57240 ! old program !    c$(cl,7)="S:\Core\Data\acsllc\Systems-Idx.h420"
57260 ! old program !    c$(cl,8)=limit_to_list$
57280 ! old program !    cl=5 : c$(cl,1)='ComboF'
57300 ! old program !    c$(cl,2)="S:\Core\Data\acsllc\TimeFrame.h420"
57320 ! old program !    c$(cl,3)='1' : c$(cl,4)='2'
57340 ! old program !    c$(cl,5)='3' : c$(cl,6)='50'
57360 ! old program !    c$(cl,7)="S:\Core\Data\acsllc\TimeFrame-Idx.h420"
