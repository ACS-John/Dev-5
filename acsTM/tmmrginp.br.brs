...
00100   pr newpage
00110   pr fields "10,20,c 60,h,n": "T/M MERGE INPUT IN PROCESS"
...
00800   close #6: 
00810 XIT: let fnxit
00820 L820: if err=61 then pr fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L840
00830   goto L880
00840 L840: pr newpage
00850   if err=4148 then pr fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L870
00860   goto L880
00870 L870: pr fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00880 L880: pr fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00890   input fields "24,60,C 1,N": quitcode$
00900   if rtrm$(uprc$(quitcode$))="Q" then goto L940
00910   pr fields "23,3,C 78,N": ""
00920   pr fields "24,3,C 78,N": ""
00930   retry 
00940 L940: goto XIT
