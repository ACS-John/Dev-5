...
00040   let fntop(program$,cap$="Merge")
...
00100   print newpage
00110   print fields "10,20,c 60,h,n": "T/M MERGE INPUT IN PROCESS"
...
00440 L440: let lta4=lrec(4)+1
00450   mat ta=(0)
00460   mat fb=(0)
00470   let ca(b(5))=lta4
...
00610   let e(1,b(5))=e(1,b(5))+b(1)
00620   let e(2,b(5))=e(2,b(5))+b(1)
00630   let e(3,b(5))=e(3,b(5))+b(3)
00640   let e(4,b(5))=e(4,b(5))+b(3)
...
00690   let sc(1)=sc(1)+b(1)
00700   let sc(2)=sc(2)+b(3)
00710   rewrite #6,using L680,key=sc$: mat sc nokey L730
00720   goto L200
00730 L730: print #255: "SERVICE CODE ";sc$;" IS NOT ON FILE"
00740   goto L200
00750 L750: close #1: 
00760   close #2: 
00770   close #3: 
...
00800   close #6: 
00810 XIT: let fnxit
00820 L820: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L840
00830   goto L880
00840 L840: print newpage
00850   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L870
00860   goto L880
00870 L870: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00880 L880: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00890   input fields "24,60,C 1,N": quitcode$
00900   if rtrm$(uprc$(quitcode$))="Q" then goto L940
00910   print fields "23,3,C 78,N": ""
00920   print fields "24,3,C 78,N": ""
00930   retry 
00940 L940: goto XIT
