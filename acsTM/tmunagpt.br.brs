...
00200   print newpage
00210   print fields "10,10,Cc 60,n": "Printing Unbilled Aging by Partner..."
00220   print fields "12,30,Cc 20,B,5": "Cancel (F5)"
...
00330   gosub L350
00340   goto L420
00350 L350: print #255,using L360: "_________   _________  _________  _________  _________  _________"
00360 L360: form pos 36,c 65,skip 1
00370   print #255,using L380: mat t
00380 L380: form x 20,"Total",pos 34,n 11.2,x 1,5*n 11.2,skip 1
00390   print #255,using L360: "=========   =========  =========  =========  =========  ========="
00400   return 
...
00510 L510: print #255: newpage
00520 L520: print #255,using L530: date$,cnam$
00530 L530: form skip 2,pos 1,c 8,pos namtab,c 40,skip 1
00540   print #255,using L550: time$,"Unbilled Work in Process - Aging Summary"
00550 L550: form pos 1,c 8,pos 46,c 40,skip 1
00560   print #255,using L570: dat
00570 L570: form pos 62,pic(zz/zz/zz),skip 2
00580   print #255,using L590: "Client     Client ","Accumulated","Current","30 - 60"," 60 - 90"," Over 90","Oldest    Category"
00590 L590: form pos 3,c 18,pos 43,c 11,pos 61,c 7,pos 72,c 7,pos 82,c 8,pos 93,c 8,pos 103,c 18,skip 1
00600   print #255,using L610: "Number      Name","Hours      Amount","Days","Days","Days","Item"
...
00640 L640: print #255: newpage
00650   print #255,using L660: cnam$,"Unbilled Work in Process Summarized by Partner in Charge"
00660 L660: form skip 2,pos namtab,c 40,skip 1,pos 39,c 56,skip 1
00670   print #255,using L570: dat
00680   print #255,using L690: "Partner Name","Accumulated","Current","30 - 60"," 60 - 90"," Over 90"
00690 L690: form pos 3,c 18,pos 42,c 11,pos 61,c 7,pos 72,c 7,pos 81,c 8,pos 95,c 8,pos 103,c 18,skip 1
00700   print #255,using L710: "Hours      Amount","Days","Days","Days"
...
00780   print #255,using L790: cno$,cna$,d(3),d(4),d(5),d(6),d(7),d(8),d8,"/",d9,"/",d7,cat$(d(1))(1:22) pageoflow L810
...
01050 L1050: print #255,using L1060: e$,l(j,1),l(j,2),l(j,3),l(j,4),l(j,5),l(j,6)
