...
00040   open #2: "Name=[Q]\TMmstr\ARTrans.h[cno],Shr",internal,outIn,relative 
00050   open #1: "Name=[Q]\TMmstr\CLmstr.h[cno],KFName=[Q]\TMmstr\CLIndex.h[cno],Shr",internal,outIn,keyed 
