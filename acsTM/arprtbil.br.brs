...
00220   close #1: 
00230   let at=int(65-len(rtrm$(name$(1)))/2)
00240   def fnc(x)=int(100*(x+sgn(x)*.0001))
00250   form pos 1,c 5,pos 6,c 12,n 6,2*pd 5.2,pd 2,2*n 1,c 20,pd 3
00260   print newpage
00270   print fields "7,14,c 39,h,n": "POSITION A/R STATEMENT FORMS IN PRINTER"
00280   print fields "10,10,c 50": "ENTER STATEMENT DATE IN FORMAT: MMDDYY"
00290   print fields "10,51,N 6,N": d1
00300   print fields "12,28,c 20": "Press F5 to Stop"
...
00370 L370: print newpage
00380   print fields "10,5,c 53": "ENTER CLIENT NUMBER TO START PRINTING, ELSE ENTER 0"
00390   input fields "10,60,C 5,UE,N": st1$ conv L370
00400   print newpage
00410   let fnopenprn
00420   print fields "10,20,c 40,h,n": "STATEMENT PRINT IN PROCESS"
00430   print fields "23,2,C 30,N": "Press F5 to stop"
...
00630   if all=0 then let bal=bal+tr(3) else goto L690
00640   goto L670
00650 L650: let prebal=prebal-tr(3)
00660   if all=0 then let bal=bal-tr(3) else goto L690
00670 L670: if ta=0 then goto L1010 ! 10/19/87
00680   if all=0 then goto L560
00690 L690: let iv$=ltrm$(iv$)
00700   if tr(5)=4 or tr(5)=6 then let bal=bal-tr(3) else let bal=bal+tr(3)
...
00800 L800: print #255,using L810: tr(1),iv$(1:8),id$,tr(3),bal
...
01140   print #255,using L1150: "CURRENT","PAST",age(1),"PAST",age(2),"PAST",age(3)
01150 L1150: form skip sk,pos 15,c 7,x 10,c 4,pic(zzzz),x 11,c 4,pic(zzzz),x 10,c 4,pic(zzzz),skip 2
01160   print #255,using L1170: e(1),e(2),e(3),e(4)+e(5),ar(1)
01170 L1170: form pos 10,n 10.2,x 8,n 10.2,x 9,n 10.2,x 8,n 10.2,pos 77,n 12.2
01180 ! print #255,using 1226:"Please be sure to remit to  P O Box 758"
01190 ! form skip 5,pos 15,c 60,skip 1
01200   if align=3 then print #255: newpage: goto L1330
01210   let fncloseprn
01220   print newpage
01230   print fields "10,5,C 60": "CHECK FORM ALIGNMENT"
01240   print fields "12,5,C 60": "ENTER 1 TO REPRINT SAME STATEMENT"
01250   print fields "13,5,C 60": "      2 TO PRINT NEXT STATEMENT AND STOP"
01260   print fields "14,5,C 60": "      3 TO PRINT ALL REMAINING STATEMENTS"
01270   print fields "23,30,c 20": "Press F5 to Cancel"
...
01330 L1330: let p=0
01340   print newpage
01350   print fields "10,20,c 40,h,n": "STATEMENT PRINT IN PROCESS"
01360   print fields "23,2,C 30,N": "Press F5 to stop"
01370   let bal=0
...
01450   if ar(1)<0 then let cb1=cb1+(-ar(1)) else let db1=db1+ar(1)
01460   mat e=(0)
...
01530   let ag1=mo(mm)+dd+yy*365+int(yy/4)
01540   if yy-int(yy/4)*4=0 and mm>2 then let ag1=ag1+1
01550   let ag2=ag0-ag1
...
01990   let ag0=mo(mm)+dd+yy*365+int(yy/4)
02000   if yy-int(yy/4)*4=0 and mm>2 then let ag0=ag0+1
02010   return 
02020 L2020: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L2040
02030   goto L2080
02040 L2040: print newpage
02050   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2070
02060   goto L2080
02070 L2070: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
02080 L2080: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
02090   input fields "24,60,C 1,N": quitcode$
02100   if rtrm$(uprc$(quitcode$))="Q" then goto L2140
02110   print fields "23,3,C 78,N": ""
02120   print fields "24,3,C 78,N": ""
02130   retry 
