...
00140   read mat mo
00150   open #8: "Name=S:\Core\Data\acsllc\pedate.h[cno],RecL=20,use,Shr",internal,outIn,relative 
...
00190   open #1: "Name=S:\Core\Data\acsllc\Company.h[cno],Shr",internal,input ioerr L2020
...
00260   pr newpage
00270   pr f "7,14,c 39,h,n": "POSITION A/R STATEMENT FORMS IN PRINTER"
00280   pr f "10,10,c 50": "ENTER STATEMENT DATE IN FORMAT: MMDDYY"
00290   pr f "10,51,N 6,N": d1
00300   pr f "12,28,c 20": "Press F5 to Stop"
...
00340   gosub L1960
00350   open #1: "Name=S:\Core\Data\acsllc\CLmstr.h[cno],KFName=S:\Core\Data\acsllc\CLIndex.h[cno],Shr",internal,outIn,keyed ioerr L2020
00360   open #2: "Name=S:\Core\Data\acsllc\ARTrans.h[cno],Shr",internal,input,relative ioerr L2020
...
00400   pr newpage
00410   fnopenprn
00420   pr f "10,20,c 40,h,n": "STATEMENT pr IN PROCESS"
00430   pr f "23,2,C 30,N": "Press F5 to stop"
...
01550   ag2=ag0-ag1
01560   if ag2>=age(4) then e(5)=e(5)+tr3 else goto L1580
01570   goto L1790
01580 L1580: if ag2>=age(3) then e(4)=e(4)+tr3 else goto L1600
01590   goto L1790
01600 L1600: if ag2>=age(2) then e(3)=e(3)+tr3 else goto L1620
01610   goto L1790
01620 L1620: if ag2>=age(1) then e(2)=e(2)+tr3 else goto L1640
01630   goto L1790
01640 L1640: e(1)=e(1)+tr3
01650   goto L1790
...
02010   return 
02020 L2020: if err=61 then pr f "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L2040
02030   goto L2080
02040 L2040: pr newpage
02050   if err=4148 then pr f "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L2070
02060   goto L2080
02070 L2070: pr f "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
02080 L2080: pr f "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
02090   input fields "24,60,C 1,N": quitcode$
02100   if rtrm$(uprc$(quitcode$))="Q" then goto L2140
02110   pr f "23,3,C 78,N": ""
02120   pr f "24,3,C 78,N": ""
02130   retry 
