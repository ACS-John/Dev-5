...
00130   print fields "10,10,c 48,n": "ENTER DATE FOR STAFF DIRECTORY IN MMDDYY FORMAT"
00140   print fields "10,60,n 6,n": dat
00150 L150: input fields "10,60,n 6,eu,n": dat conv L150
00160   if dat<10100 or dat>123199 then goto L120
00170   print newpage
00180   print fields "10,25,c 30,n": "STAFF DIRECTORY IN PROCESS"
...
00230   print #255,using L240: eno$,e$,dept,mat r pageoflow L260
00240 L240: form pos 1,c 9,pos 12,c 25,n 5,11*n 8.2,skip 1
00250   goto L210
00260 L260: print #255: newpage
00270   gosub L290
00280   goto L210
00290 L290: print #255,using L300: cnam$
00300 L300: form skip 3,pos namtab,c 40,skip 1
00310   print #255,using L320: "STAFF DIRECTORY"
00320 L320: form pos 58,c 15,skip 1
00330   print #255,using L340: dat
00340 L340: form pos 61,pic(zz/zz/zz),skip 3
00350   print #255,using L360: "EMPLOYEE","EMPLOYEE","DEPT"
00360 L360: form pos 2,c 8,pos 20,c 8,pos 38,c 4,skip 1
00370   print #255,using L380: "NUMBER","NAME","CODE","RATE-1  RATE-2  RATE-3  RATE-4  RATE-5  RATE-6  RATE-7  RATE-8  RATE-9 RATE-10 RATE-11"
...
00430   goto XIT
00440 L440: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L460
00450   goto L500
00460 L460: print newpage
00470   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L490
00480   goto L500
00490 L490: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00500 L500: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00510   input fields "24,60,C 1,N": quitcode$
00520   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
00530   print fields "23,3,C 78,N": ""
00540   print fields "24,3,C 78,N": ""
00550   retry 
00560 XIT: let fnxit
