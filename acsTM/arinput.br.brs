...
open #h_company:=1: "Name=S:\Core\Data\acsllc\Company.h[cno],Shr",internal,input
read #h_company,using L130: i3,i4,i5,mat gln1,mat gln2
! i3=1 ! ENTER G/L #'S
...
goto L1050
L990: !
	read #9,using L1000,key=p$,release: name$ nokey L1020
...
L1540: pt(tr5+1)=pt(tr5+1)+tr(3)
	...
	r3=r3+1
	tr(5)=tr5
	write #hAddr,using f3$,rec=r3: p$,iv$,mat tr,id$,mat pgl,mat gl
	p$=""
	q2=0
	goto L710
L1630: iv$=" "
	...
	id$=" "
	mat gl=(0)
L1670: rewrite #hAddr,using f3$,rec=r1: p$,iv$,mat tr,id$,mat pgl,mat gl
	p$=""
	goto L2060
L1690: vf=1
L1700: pr newpage
...
L1960: r=r+1
	read #hAddr,using L2110,rec=r: p$,iv$,mat tr,id$ eof L2040,noRec L2040
...
L2080: input fields "10,61,n 4,eu,n": r1 conv L2080
	...
	read #hAddr,using f3$,rec=r1: p$,iv$,mat tr,id$,mat pgl,mat gl noRec L2060
...
L2270: fnChain('S:\Time Management\Merge Transactions')
Xit: fnXit

TMSRCH: ! r: search for customer #
	file_num=hClmstr2 ! alpha index on clients
	dim form$*80
	form$="form pos 1,c 5,pos 6,c 30,pos 66,c 15,pos 283,pd 5.2"
	dim numeric_format$*20
	numeric_format$='pic($$$,$$$.##)'
	key_length=5
	dim heading$*70
	heading$="Acct #횼ame컴컴컴컴컴컴컴컴컴컴Address컴컴컴컴Balance"
	dim selection$*70
	fnsearch(hClmstr2,form$,numeric_format$,selection$,key_length)
