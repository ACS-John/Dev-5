...
00440   pr fields "11,21,C 14,N": "Client Number:"
00460   pr fields "13,22,C 32,B,5": "Cancel (Esc)"
00480   pr fields "14,22,C 32,B,6": "Search (F6)"
00500   pr fields "15,22,C 32,B,10": "Print all (F10)"
...
00740   pr fields "10,25,c 50,n": "PRINT CLIENT LABELS IN PROCESS"
00760   pr fields "12,34,C 11,B,5": "Cancel (F5)"
00780   let j=1
00800 READ_CLIENT: ! 
...
01840   if err=4148 then pr fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L900
01860   goto L910
01880 L900: pr fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
01900 L910: pr fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
01920   input fields "24,60,C 1,N": quitcode$
01940   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
01960   pr fields "23,3,C 78,N": ""
01980   pr fields "24,3,C 78,N": ""
02000   retry 
...
02120   let prtall=0
02140   pr fields "7,4,C 55,H,N": "Enter beginning search info. or blank for all:"
02160   pr fields "9,32,C 16,R,N": "Press F5 to stop"
...
02320   pr fields "1,10,C 5,R,N": "ACCT#"
02340   pr fields "1,17,C 30,R,N": "COMPANY NAME"
02360   cde=0
02380   for j=1 to 20
...
02480 L1200: cde=1
02500     pr fields str$(j+1)&",10,C 5,U,N": k$
02520     pr fields str$(j+1)&",17,C 30,U,N": a1$
...
02660   mat in2$(j)
02680 L1300: pr fields "24,08,C 60,R,N": "Enter to continue; F5 to stop or enter ACCOUNT #:"
