...
! pr client labels
	...
	library 'S:\Core\Library': fnopenprn,fncloseprn,fnaddlabel,fnlabel,fnxit,fntop
	fntop(program$,"Client Labels")
	on error goto L850

	dim label_text$(5)*40
	dim z$*5,a$(3)*30,prg$*20,bk$(20)*30,nam$*25,a1$*30
	dim ma(20),app(20),totalapp(20),totalma(20)
	dim a2$*30,a3$*30

	on fkey 5 goto L710
	! needs something like Let FNPRG$
	open #1: "Name=[Q]\TMmstr\CLmstr.H[cno],KFName=[Q]\TMmstr\CLIndex.H[cno],Shr",internal,input,keyed 
...
L250: input fields "11,46,C 5,UE,N": k$
...
L1450: selclp=0
	goto L990
SRCHEND: close #101: ioerr ignore
L1480: close #127: ioerr ignore
	goto L250
IGNORE: continue 
