...
00120   print newpage
00130   print fields "10,10,c 52,n": "ENTER 1 FOR NUMERIC LISTING, ENTER 2 FOR ALPHABETIC"
00140 L140: input fields "10,65,n 1,eu,n": numalp conv L230
00141   print newpage
00143   print fields "10,5,C 60": "ENTER APPLICATION NUMBER TO PRINT OR BLANK FOR ALL:"
...
00170 L170: open #1: "Name="&env$('Q')&"\TMmstr\CLmstr.h"&str$(cno)&",KFName="&env$('Q')&"\TMmstr\CLIndex.h"&str$(cno)&",Shr",internal,input,keyed ioerr L530
00180   goto L200
...
00210   print fields "10,10,c 46,n": "ENTER DATE FOR CLIENT LISTING IN MMDDYY FORMAT"
00220   print fields "10,60,n 6,n": dat
00230 L230: input fields "10,60,n 6,eu,n": dat conv L230
00240   if dat<10100 or dat>123199 then goto L200
00250   print newpage
00260   print fields "10,25,c 48,n": "CLIENT LISTING IN PROCESS"
00270   print fields "23,2,c 30,n": "Press F5 to stop"
00280   gosub L370
...
00306     if ma(j)>0 then let app(j)=2
00308 L308: next j
00310   print #255,using L320: z$,a$ pageoflow L340 ! MAT APP
00320 L320: form pos 1,c 5,pos 10,c 30,20*n 3,skip 1
00322 ! PRINT #255: TAB(10);A3$ PAGEOFLOW 340
00330   goto L290
00340 L340: print #255: newpage
00350   gosub L370
00360   continue 
00370 L370: let p1=p1+1
00380   print #255,using L390: date$,cnam$,"PAGE",p1
00390 L390: form skip 3,pos 1,c 8,pos namtab,c 40,pos 76,c 5,n 4,skip 1
00400   print #255,using L410: time$,"CLIENT LISTING"
00410 L410: form pos 1,c 8,pos 35,c 16,skip 1
00420   print #255,using L430: dat
00430 L430: form pos 39,pic(zz/zz/zz),skip 3
00440   print #255,using L450: "CLIENT"
00450 L450: form pos 2,c 6,skip 1
00460   print #255,using L470: "NUMBER","CLIENT NAME"
...
00520   goto XIT
00530 L530: if err=61 then print fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L550
00540   goto L590
00550 L550: print newpage
00560   if err=4148 then print fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L580
00570   goto L590
00580 L580: print fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00590 L590: print fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00600   input fields "24,60,C 1,N": quitcode$
00610   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
00620   print fields "23,3,C 78,N": ""
00630   print fields "24,3,C 78,N": ""
00640   retry 
00650 XIT: let fnxit
