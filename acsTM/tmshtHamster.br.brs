...
35280     let fnhamster_field_add("?? (N 9)",9,'N',0,mask_number)
...
35380     let fnhamster_field_add("Category",2,'N',0,mask_number)
35400     let fnhamster_field_add("?? (PD 2)",3,'PD',2,mask_number)
35420     let fnhamster_field_add("?? (PD 2)",2,'PD',1,mask_number)
...
35520     let fnhamster_field_add("Description",30)
