...
00130   pr fields "11,10,c 70": "THIS PROGRAM REMOVES ALL EMPLOYESS THAT ARE CODED"
00140   pr fields "12,10,c 70": "AS TERMINATED.  BE SURE THAT THE FIRM PRODUCTIVITY"
00150   pr fields "13,10,c 70": "REPORTS HAVE BEEN RUN BEFORE CONTINUING."
00160   pr fields "15,10,c 62": "ENTER 1 TO CONTINUE; ELSE ENTER 2 TO RETURN TO THE SYSTEM MENU"
00170 L170: input fields "15,75,N 1,UE,N": a conv L170
00180   on a goto L190,L310 none L110
00190 L190: pr newpage
00200   pr fields "10,20,c 50,n": "REMOVE TERMINATED EMPLOYEES IN PROCESS"
...
00300   goto XIT
00310 L310: goto XIT
00320 L320: if err=61 then pr fields "23,3,C 75,N": "THIS PROGRAM IS TRYING TO ACCESS A RECORD THAT IS IN USE!" else goto L340
00330   goto L380
00340 L340: pr newpage
00350   if err=4148 then pr fields "23,3,C 78,N": "THIS PROGRAM IS TRYING TO ACCESS A FILE THAT IS IN USE AND CANNOT BE SHARED!" else goto L370
00360   goto L380
00370 L370: pr fields "23,3,C 75,N": "YOU HAVE A WORKSTATION BASIC ERROR # "&str$(err)&" AT LINE # "&str$(line)&"."
00380 L380: pr fields "24,3,C 70,N": "PRESS ENTER TO RETRY; ELSE ENTER  Q  TO QUIT"
00390   input fields "24,60,C 1,N": quitcode$
00400   if rtrm$(uprc$(quitcode$))="Q" then goto XIT
00410   pr fields "23,3,C 78,N": ""
00420   pr fields "24,3,C 78,N": ""
00430   retry 
00440 XIT: let fnxit
