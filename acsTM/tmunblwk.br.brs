...
00160   open #1: "Name=S:\Core\Data\acsllc\TMCat.h[cno],Shr",internal,input,relative ioerr L2780
00170   read #1,using L180,rec=1: mat cat$ ioerr L2780
00180 L180: form pos 1,30*c 30
00190   close #1: 
00200   open #8: "Name=S:\Core\Data\acsllc\pedate.h[cno],RecL=20,use,Shr",internal,outIn,relative 
00210   if lrec(8)=0 then write #8,using "form pos 1,n 6": d1 else read #8,using "form pos 1,n 6",rec=1,release: dat
00220   open #1: "Name=S:\Core\Data\acsllc\CLmstr.h[cno],KFName=S:\Core\Data\acsllc\CLIndex.h[cno],Shr",internal,input,keyed ioerr L2780
00230   open #2: "Name=S:\Core\Data\acsllc\TMTRAddr.h[cno],Shr",internal,input,relative ioerr L2780
00240   open #3: "Name=S:\Core\Data\acsllc\TMTRANS.H[cno],Shr",internal,input,relative ioerr L2780
00250   open #4: "Name=S:\Core\Data\acsllc\EMmstr.H[cno],KFName=S:\Core\Data\acsllc\EMIndex.h[cno],Shr",internal,input,keyed ioerr L2780
00260   goto L460
...
00450 L450: return 
00460 L460: open #5: "Name=S:\Core\Data\acsllc\SCMSTR.H[cno],KFName=S:\Core\Data\acsllc\SCIndex.H[cno],Shr",internal,input,keyed ioerr L2780
00470   goto L530
...
00510 L510: scdesc$=" "
00520 L520: return 
00530 L530: open #6: "Name=S:\Core\Data\acsllc\Work2.H"&wsid$,internal,input ioerr L550
00540   close #6,free: 
00550 L550: open #6: "Name=S:\Core\Data\acsllc\Work2.H"&wsid$&",SIZE=0,RecL=76",internal,output ioerr L2780
...
00870   open #7: "Name=S:\Core\Data\acsllc\Work1.h"&wsid$,internal,input ioerr L890
00880   close #7,free: 
00890 L890: open #7: "Name=S:\Core\Data\acsllc\Work1.h"&wsid$&",SIZE=0,RecL=5",internal,output ioerr L2780
...
01040   open #7: "Name=S:\Core\Data\acsllc\Work1.h"&wsid$&",NoShr",internal,input ioerr L2780
