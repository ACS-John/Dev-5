	...
	dim fl1$(20),sc1$(19)*256,io1$(27),hd1$*50,cap$*128,cnam$*40
	...
	goto L500
	close #1,free:
L480: open #1: "Name=S:\Core\Data\acsllc\Company.h[cno],Replace,RecL=245",internal,outIn,relative ioerr L750
