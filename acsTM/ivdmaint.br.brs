...
00140   pr fields "3,9,C 50,N": "INVOICE DESCRIPTION FILE MENU"
00150   pr fields "4,6,C 72,N": "COMPANY NUMBER "&str$(cno)&"  "&ltrm$(cnam$)
00160   pr fields "6,9,C 60": "1 = INITIAL FILE PREPARATION"
00170   pr fields "7,9,C 60": "2 = ADD OR FILE MAINTENANCE / INQUIRY"
00180   pr fields "8,9,C 60": "3 = pr PROOF LIST"
00190   pr fields "10,9,C 60": "0 = COMPLETED (RETURN TO T/M MENU)"
00200   pr fields "12,9,C 20": "ENTER SELECTION #:"
...
00260   pr fields "7,"&str$(ctab)&",C 40,N": cnam$
00270   pr fields "10,31,C 19,RB,N": "  *** WARNING ***"
00280   pr fields "12,4,C 70": "YOU HAVE CHOSEN TO INITIALLY PREPARE THE INVOICE DESCRIPTION FILE."
00290   pr fields "13,1,C 78": "IF YOU CONTINUE ALL EXISTING INVOICE DESCRIPTION RECORDS WILL BE ERASED."
00300   pr fields "15,6,C 70": "ENTER PASSWORD TO CONTINUE; ELSE PRESS ENTER TO RETURN TO MENU"
...
00520   pr fields "10,5,C 60": "ENTER DESCRIPTION CODE OR BLANK TO STOP:"
...
00610   pr fields "7,15,C 26,N": "***  FILE MAINTENANCE  ***"
00620   goto L640
00630 L630: pr fields "7,15,C 26,N": "********   ADD   *********"
00640 L640: pr fields "12,5,C 60": "ENTER INVOICE DESCRIPTION OR BLANK TO DELETE THIS ENTRY"
00650   pr fields "16,5,C 60": "STANDARD CHARGE AMOUNT OR ZERO:"
00660   pr fields "18,9,C 60": "GENERAL LEDGER NUMBER:"
00670   pr fields mat io1$: des$,da,mat gl
